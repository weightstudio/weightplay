...
(() => {
  ...
  const arabicAuthoredStages = [
    ["بوابة الخنزير البري", "تعلّم الممرات الوسطى مع الخنازير البرية السريعة."],
    ["الحوافر المتشعبة", "تتناوب الخنازير بين الاقتراب من اليسار واليمين."],
    ["درب المحتال", "تدخل الضباع المتعرجة من المسارات الخارجية."],
    ["القطيع المتقاطع", "تحافظ الخنازير على الممرات بينما تتشابك الضباع بينها."],
    ["مطاردة الخنزير", "يطلق زعيم سريع طلقات مطاردة سريعة خلف حراس مختلطين.", "طلقات تصويب سريعة"],
    ["ستار وحيد القرن", "تحتل وحيدات القرن المدرعة الوسط بينما تنزلق الخنازير حولها."],
    ["حراسة كاسر الجدار", "تتقدم الجواميس الكاسرة للجدار بين حراس مدرعين."],
    ["متاهة الساحر", "تجذب الدببة والضباع المتعرجة التصويب نحو الجانبين."],
    ["اندفاع السماء", "تندفع الصقور والنمور عبر الممرات الأرضية الثابتة."],
    ["نيران الضبع المتقاطعة", "يرسل الزعيم نيرانًا متقاطعة مزدوجة بينما يغيّر القطيع الممرات.", "نيران متقاطعة مزدوجة"],
    ["عمود وحيد القرن", "يكافئ العمود المدرع الخالص الاختراق والضرر المستمر."],
    ["العداؤون التوأم", "تتسابق الخنازير والنمور على جانبين متقابلين."],
    ["خط كاسري الجدار", "تملأ الجواميس والتماسيح الكاسرة ثلاثة ممرات ثابتة."],
    ["تشابك المحتال", "تتناوب الضباع والدببة في منحنيات غير متوقعة."],
    ["حصن وحيد القرن", "يجب كسر ست ضربات درع قبل أن يتلقى الزعيم المدرع ضررًا كاملًا.", "درع بست ضربات وجرم ثقيل"],
    ["غوص الصقر", "تنقض الصقور من نقاط إطلاق خارجية متناوبة."],
    ["سباق النمور", "تتناوب النمور والخنازير والصقور في ضغط السرعة المتكرر."],
    ["السماء فوق الدرع", "تثبت وحيدات القرن المدرعة الممرات تحت صقور غاطسة."],
    ["قطيع الريح المتقاطعة", "تهاجم الوحوش الساحرة المتعرجة والصقور من حواف متغيرة."],
    ["حصار الجاموس", "يستهدف جرم حصار ثقيل مركز الجدار بينما تتقدم الكواسر.", "جرم حصار ثقيل مركزي"],
    ["اندفاع محمي", "يختبئ العداؤون خلف ممرات وحيد القرن والجاموس المتناوبة."],
    ["سباق متعرج", "تتطلب الوحوش الساحرة المنحنية والعداؤون المستقيمون إعادة التصويب بسرعة."],
    ["بوابة الوحوش الثقيلة", "تضغط الوحوش المدرعة والكاسرة وحدها على الوسط."],
    ["الجناح والكسر", "تسحب الوحوش المندفعة التصويب للخارج بينما تهدد التماسيح الجدار."],
    ["سرب غوص الصقور", "ينقض الزعيم مرارًا ويطلق انتشارًا سريعًا من طلقتين.", "اندفاع وطلقتان سريعتان"],
    ["مراجعة الوحوش الثمانية", "تعود كل الأدوار في موجات واضحة من ثلاثة ممرات."],
    ["ستار الساحرات", "تنحني الوحوش الساحرة خلف حراس مدرعين وغواصين متناوبين."],
    ["حصار التمساح", "يختبر تشكيل كاسر ثقيل في الوسط الضرر المساحي وإصلاح الجدار."],
    ["تحدي المهرجان", "تتناوب كل أدوار الوحوش عبر البوابتين الخارجيتين."],
