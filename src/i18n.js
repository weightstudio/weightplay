(function () {
  ...
  Object.assign(dictionaries.ar, {
    ...
    "status.all_games": "جميع الألعاب",
    "status.games_found_one": "تم العثور على لعبة واحدة",
    "status.games_found_many": "تم العثور على {count} لعبة",
    "status.no_games": "لا توجد ألعاب تطابق عوامل التصفية الحالية.",
    "status.clear_filters": "مسح عوامل التصفية",
    "status.search_term": "البحث: {query}",
