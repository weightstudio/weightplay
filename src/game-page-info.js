(function () {
  ...
  const classicPlayerInfoTitles = Object.freeze({
    en: "Player, Device, and Save Information", "zh-Hant": "玩家、裝置與保存資訊", "zh-Hans": "玩家、设备与保存信息", ja: "プレイヤー・端末・保存情報", ko: "플레이어·기기·저장 정보", es: "Información de jugador, dispositivo y guardado", "pt-BR": "Informações de jogador, dispositivo e salvamento", fr: "Informations joueur, appareil et sauvegarde", de: "Spieler-, Geräte- und Speicherinformationen", it: "Informazioni sul giocatore, dispositivo e salvataggio", ru: "Информация об игроке, устройстве и сохранении", hi: "खिलाड़ी, डिवाइस और सेव करने की जानकारी", ar: "معلومات اللاعب والجهاز والحفظ",
  });
  ...
  const games = {
    "maze-chase": {
      ...
      story: [
        "The moonlit archive is built from one readable maze rather than a random field. Each stage keeps the corridor language familiar while moving Wisp homes and increasing pressure, so route knowledge becomes a useful advantage without turning the run into memorization alone.",
        "Four Wisps behave differently: one closes distance directly, one predicts the current heading, one aims beyond the next turn, and one wanders through open choices. Their role markers make the threat readable before the player commits to a corridor.",
      ],
      systems: [
        "Move Orla one corridor step at a time with Arrow keys or WASD. On touch, use the visible direction pad or swipe the maze; the same route state is used by keyboard and touch input.",
        "Every star mote must be collected to clear a stage. A Beacon is a larger power item: collecting it gives a limited window in which Wisps can be chased and scored instead of avoided.",
        "A collision costs a life and resets the current position while preserving the stage route. The run ends only after the available lives are spent, so a mistake is feedback rather than an instant restart.",
        "Score, Best, Stage, lives, sound, Restart, a leave confirmation, and success or failure Result recovery are part of the same run flow. Best is stored locally in this browser.",
      ],
      how: [
        "Start from Main and watch the first corridor opening before choosing a direction.",
        "Collect the small star motes while keeping one turn available as an escape route.",
        "Read the Wisp markers and avoid walking into a corridor that removes every safe option.",
        "Take a Beacon when the chase is close enough to reward a reversal, then use the power window to score a Wisp.",
        "Clear all three stages to finish the route, or use Restart to practice the current opening again.",
      ],
      strategyTips: [
        "Do not commit to the deepest corridor first; leave a turn that lets you change heading when a Wisp approaches.",
        "Use the direct Wisp to learn when to rotate early, then watch the predicted and ambush paths before taking a Beacon.",
        "A safe detour that collects two nearby motes is often better than a short line toward one isolated mote.",
        "Save a Beacon for a crowded junction when several Wisps are visible, because one reversal can create both score and space.",
        "When a collision resets the player, use the grace period to re-read the next corridor instead of repeating the same turn.",
      ],
      progression: [
        "Stage 1 teaches collection and corridor reading with slower Wisp movement.",
        "Stage 2 rotates the Wisp starting homes and raises pursuit speed so route choices must be made earlier.",
        "Stage 3 combines the fastest pressure with the same fixed maze, rewarding Beacon timing, short detours, and calm recovery.",
      ],
      designNote: "Maze Chase uses an original Canvas maze, original characters and sound tones, four visibly differentiated chase logics, one responsive logical canvas, low-latency keyboard input, touch controls, localized controls, and a complete Main-Battle-Result flow.",
      parent: "Maze Chase is a general-audience browser arcade game recommended for ages 9+ and family play. No account or purchase is required; Best score and sound preference stay in this browser.",
      faq: [
        ["How do I clear a stage?", "Collect every star mote in the fixed maze. The Beacon is optional for clearing but useful for score and safe counterattacks."],
        ["Do the Wisps use the same chase logic?", "No. Direct, predictive, ambush, and wandering Wisps choose routes differently and show distinct role markers."],
        ["What does a Beacon do?", "A Beacon starts a short power window in which nearby Wisps can be chased for bonus points."],
        ["What happens after a collision?", "You lose one life and return to the current route with a brief grace period. The stage remains active until lives run out."],
        ["Can I play on a phone?", "Yes. Swipe the maze or use the on-screen direction pad; keyboard arrows and WASD are also supported on desktop."],
        ["Is progress saved?", "The Best score and sound preference are stored locally in this browser. No account is required."],
      ],
    },
    "space-rocks": {
      title: "Space Rocks",
      ...
      story: [
        ...
        "Large rocks break into medium and small fragments. Later waves add a moving UFO, Rapid Fire opportunities, denser pressure, and a guardian core that gives the final wave a readable target and payoff.",
      ],
      systems: [
        "Rotate with Left and Right, thrust with Up or W, fire with Space, and tap or press Shift for a limited Shield charge. Touch controls mirror the same actions for mobile play.",
        "Shots travel through the wraparound field. A large rock splits into two medium rocks, each medium rock splits into small fragments, and every clear contributes to Score, Combo, and the fragment total.",
        "Rapid Fire temporarily shortens the fire interval. Shield absorbs a close hit but has a finite capacity, so holding it for every pass removes the resource needed for the guardian phase.",
        "Wave 3 adds an orange guardian core, while a collision resets the ship and costs a hit. Five hits end the run; clearing all three waves opens the success Result.",
      ],
      how: [
        "Start from Main and tap thrust once to see the opening drift cue before committing to a long burn.",
        "Rotate toward the nearest large rock, fire in bursts, and let momentum carry the ship around the field.",
        "Watch for split fragments after every hit; a large rock is not cleared until its smaller children are handled.",
        "Collect Rapid Fire when it appears, but keep Shield for a close pass or the guardian's crowded phase.",
        "Clear the three waves, or use Restart to reset the run and practice the first orbit with a clean resource set.",
      ],
      strategyTips: [
        "Use short thrusts instead of holding Up continuously; braking is achieved by changing orientation and planning the next arc.",
        "Shoot before a rock reaches the ship's path, then rotate away from the fragment spread rather than stopping in place.",
        "A sustained Combo rewards a deliberate sequence of large, medium, and small clears, but survival is more valuable than a risky close shot.",
        "Use Shield as a timing tool for a crossing, not as permanent armor, because its capacity is limited.",
        "During Wave 3, keep the ship moving around the guardian and use the orange core cue to prioritize the dangerous target.",
      ],
      progression: [
        "Wave 1 teaches rotation, thrust, inertial drift, and the large-to-small split chain with a short opening field.",
        "Wave 2 adds more rocks, a moving UFO, and Rapid Fire pressure so aim and movement must be balanced together.",
      ...
      faq: [
        ...
        ["What is Rapid Fire?", "Rapid Fire is a temporary pickup that shortens the time between shots, making a dense fragment field easier to clear."],
        ["How should I use Shield?", "Tap Shield for a dangerous crossing or guardian pass. Its capacity is limited and five unprotected hits end the run."],
        ["What changes in Wave 3?", "Wave 3 introduces an orange guardian core and denser pressure, so the core cue and Shield timing become important."],
        ["Is progress saved?", "The Best score and sound preference are stored locally in this browser. No account is required."],
      ],
    },
    "block-blast": {
    ...
    "hexa-sort": {
      ...
      how: ["Choose one of the 30 stages, or start Endless from Main.", "Select one of the three offered stacks.", "Tap an open hex to place the complete stack.", "Let every adjacent merge and clear finish before planning the next placement.", "Complete the displayed objective within the move budget, or keep scoring in Endless until the board fills."],
    ...
    "klondike-solitaire": {
      ...
      how: ["Use New Game for a fresh deal or Restart Current Game to return to the initial seed board.", "Choose Draw 1 or Draw 3 from the battle header and draw from Stock into Waste.", "Tap a card to select it. Drag it, or tap a highlighted destination, to move it.", "Use Undo freely to step back from uncertain routes and continue with fresh decisions.", "When no strategy remains, use Auto-Finish to settle remaining legal foundation moves and finish quickly."],
    ...
    "freecell-solitaire": {
      title: "FreeCell Solitaire", age: "9+", difficulty: "Easy to Hard", time: "5-20 minutes", skills: ["Planning", "Spatial Reasoning", "Focus"],
      intro: "FreeCell Solitaire is a classic 52-card puzzle where every card starts face up. Build four suit foundations from Ace to King while using four Free Cells and eight tableau columns as working space.",
      story: ["FreeCell removes hidden information and puts the decision in the player's hands: every move is visible, but one careless occupied cell can close the route to a foundation.", "The game keeps the familiar Card Engine controls and turns open information into a long-form planning challenge that rewards creating empty columns at the right time."],
      systems: ["Build tableau sequences downward in alternating colors. Any exposed card can move to a Free Cell, a legal tableau destination, or its next foundation space.", "A multi-card sequence moves only when the current Free Cells and empty columns provide enough temporary capacity. Empty tableau columns accept Kings or King-led groups.", "Hint highlights one legal move without playing it. Undo restores the complete prior board, and Restart returns to the same seed.", "Touch, mouse, and keyboard-friendly buttons use the same rules and the same undo snapshots."],
      how: ["Start a seeded deal with Start Game, or use New Game for a fresh deal.", "Move exposed cards between alternating-color columns, using Free Cells for temporary storage.", "Open a tableau column when possible so longer sequences can move.", "Send each suit to its Foundation from Ace through King.", "Use Hint to inspect a legal route and Undo when a choice reduces your working space."],
      strategyTips: ["Protect empty columns; they are often more valuable than a spare Free Cell.", "Move Aces and low cards toward Foundation when doing so does not seal a needed route.", "Build long same-suit runs only when they will expose useful cards or create space.", "Before moving a group, count both empty columns and open Free Cells rather than guessing.", "Use Restart to compare a new line from the same deal."],
      progression: ["Every deal is a complete classic FreeCell board with no facedown cards.", "Repeated plays teach the value of empty columns, temporary storage, and foundation timing.", "The challenge comes from planning several moves ahead, not from a timer or hidden purchase system."],
      designNote: "FreeCell shares WeightPlay's Card Engine, responsive battle canvas, touch and mouse input, sound preference, tutorial, hint, undo snapshots, and original card visual language with the other classic solitaire games.",
      parent: "FreeCell Solitaire is a general-audience card strategy game recommended for ages 9+ and family play. No account is required; preferences stay in this browser.",
      related: ["klondike-solitaire", "spider-solitaire"], relatedIds: ["klondike-solitaire", "spider-solitaire"],
    ...
    "pyramid-solitaire": {
      ...
      how: ["Tap one exposed pyramid card, then tap its partner whose ranks total 13.", "Tap a King to remove it by itself.", "Use the Waste as one half of a pair when it completes 13 with an exposed card.", "Turn Stock only when the visible pyramid has no useful pair.", "Clear every pyramid card before the Stock route runs out."],
    ...
    "tripeaks-solitaire": {
      title: "TriPeaks Solitaire", age: "9+", difficulty: "Easy to Challenging", time: "3-10 minutes", skills: ["Pattern Recognition", "Planning", "Focus"],
      intro: "TriPeaks Solitaire uses three overlapping peaks and a Waste chain. Play an exposed card exactly one rank above or below the Waste card, keep the combo alive, and clear all 28 peak cards.",
      story: ["The three peaks hide one another in a compact reveal puzzle. A single good choice can uncover a complete row, while a rushed choice can break a chain and spend the Stock too early.", "This strict classic version keeps Ace and King at the ends of the rank line, so an Ace does not wrap to King and a King does not wrap to Ace."],
      systems: ["The layout contains 28 cards across three overlapping peaks. Only cards with no covering peak card are exposed.", "An exposed card may move to Waste when its rank is exactly one above or below the current Waste card. Suits do not matter.", "Each consecutive tableau play increases Combo; turning Stock starts a new route when the chain stops.", "Hint highlights a legal exposed card. Undo restores the peaks, Waste, Stock, combo, and score."],
      how: ["Start with the face-up Waste card.", "Tap an exposed peak card one rank above or below it.", "Continue the chain to build Combo and reveal the covered rows.", "Turn one Stock card when no useful exposed card remains.", "Clear all three peaks before the Stock is exhausted."],
      strategyTips: ["Prefer a play that uncovers more of the next row.", "Keep a long chain alive when it also reveals a peak card; a short chain may be less valuable.", "Remember that this version has no Ace-King wrap.", "Use Hint and Undo to compare which exposed card opens the next peak.", "Do not spend Stock while a legal tableau play can extend the route."],
      progression: ["Every round uses a 28-card three-peak tableau and a visible Stock route.", "Early plays reward simple rank matching; later decisions ask you to protect a long chain and reveal multiple peaks.", "Combo score and replayable deals make improvement easy to see without adding a timer."],
      designNote: "TriPeaks shares the Card Engine, responsive Canvas scale, original card art language, sound preference, first-play tutorial, touch and mouse input, Hint, and reversible Undo with the other classic games.",
      parent: "TriPeaks Solitaire is a general-audience card puzzle recommended for ages 9+ and family play. No account is required; preferences stay in this browser.",
    ...
    "golf-solitaire": {
      ...
      strategyTips: ["Look across all seven exposed cards before choosing the first move.", "Prefer a move that exposes a fresh column end and keeps several ranks available.", "Remember that Ace and King do not wrap in this version.", "Protect the Stock for moments when no tableau route remains.", "Use Undo to test whether the longer-looking route actually opens more cards."],
      progression: ["Every deal uses 35 face-up tableau cards and a supporting Stock.", "The short loop is easy to learn but rewards increasingly careful route selection.", "Longer chains improve Combo and make the clear feel satisfying without relying on a timer."],
      designNote: "Golf uses the shared Card Engine and battle canvas with a compact seven-column layout, original visuals, touch and mouse play, tutorial, Hint, Undo, and sound preference.",
      parent: "Golf Solitaire is a general-audience card puzzle recommended for ages 9+ and family play. No account is required; preferences stay in this browser.",
      related: ["tripeaks-solitaire", "pyramid-solitaire"], relatedIds: ["tripeaks-solitaire", "pyramid-solitaire"],
    ...
    "yukon-solitaire": {
      ...
      how: ["Select an exposed card or any face-up group.", "Move it onto the next higher rank of the opposite color, or place a single eligible card on its Foundation.", "Expose facedown cards by clearing their covering cards.", "Use an empty column only when a King-led group can occupy it.", "Complete all four suit foundations to win."],
      strategyTips: ["Expose facedown cards before making surface-only changes.", "Treat an empty column as a King reserve, not just free space.", "Use arbitrary face-up groups to reveal hidden cards, but do not strand a useful lower card.", "Move Aces and low foundation cards when they open a column or unblock a face-down card.", "Use Undo to compare a bold group move with a slower reveal route."],
      progression: ["Every deal uses all 52 cards on the tableau and has no Stock phase.", "Early rounds teach the difference between moving a sequence and moving any face-up group.", "Higher challenge comes from preserving landing space and planning multiple reveals ahead."],
      designNote: "Yukon shares the Card Engine, responsive battle canvas, original card visual language, touch and mouse controls, tutorial, Hint, Undo, and sound preference with the rest of the classic solitaire set.",
      parent: "Yukon Solitaire is a general-audience card strategy game recommended for ages 9+ and family play. No account is required; preferences stay in this browser.",
      related: ["freecell-solitaire", "klondike-solitaire"], relatedIds: ["freecell-solitaire", "klondike-solitaire"],
      faq: [["Is there a Stock?", "No. All 52 cards begin on the tableau."], ["Can any face-up group move?", "Yes. Any face-up card may carry every face-up card below it."], ["What can fill an empty column?", "A King or a group whose first card is a King."], ["Do tableau suits alternate?", "Yes. Tableau builds descend by rank in alternating colors."], ["Can I undo?", "Yes. Undo restores the full prior tableau and foundations."]],
    },
    "animal-color-link": {
  ...
  localizedGames["zh-Hant"]["maze-chase"] = {
    title: "星徑迷宮",
    age: "9+",
    difficulty: "容易到具挑戰性",
    time: "3–8 分鐘",
    ...
    guideKicker: "WeightPlay 原創遊戲指南",
    guideTitleSuffix: "遊戲指南",
    intro: "在固定迷宮中引導奧拉收集星塵，讀懂四種光靈追逐模式，並用信標把危險走廊變成短暫的反擊窗口。",
    story: [
      "月光檔案館由一座容易讀懂的固定迷宮組成，而不是每局隨機生成的場地。每關保留熟悉的走廊語言，同時移動光靈起點並提高壓力，讓路線經驗有用但不必死背。",
      "四種光靈各有不同：有的直接逼近，有的預測目前方向，有的瞄準下一個轉彎後的位置，還有的會在開放路線間游移。角色標記會在你進入走廊前提示威脅類型。",
    ],
    systems: [
      "使用方向鍵或 WASD 讓奧拉一次走一格；手機可使用畫面方向鍵或滑動迷宮，兩種操作共用同一套路線判定。",
      "收集全部星塵才能完成關卡。較大的信標會開啟短暫能力窗口，讓你追逐並得分，而不是只能躲避光靈。",
      "碰撞會失去一條生命並回到目前路線，關卡仍會保留。只有生命耗盡才會結束本輪，失誤會提供回饋而不是立刻重來。",
      "分數、最高分、關卡、生命、音效、重新開始、離開確認，以及成功或失敗後的結果回復，都屬於同一個遊戲流程。最高分只保存在這個瀏覽器。",
    ],
    how: [
      "從主畫面開始，先觀察第一個走廊開口再選方向。",
      "收集小星塵時，至少保留一個轉彎作為逃生路線。",
      "閱讀光靈標記，避免走進會封死所有安全選項的走廊。",
      "在追逐距離合適時取得信標，利用能力窗口反過來追擊光靈得分。",
      "完成三個關卡即可結束路線，也可以重新開始練習目前的開局。",
    ],
    strategyTips: [
      "不要先衝進最深的走廊；保留能改變方向的轉彎，才能應對逼近的光靈。",
      "先觀察直接逼近的光靈，再留意預測型與伏擊型路線，最後選擇信標時機。",
      "能收集兩個鄰近星塵的安全繞路，通常比直奔一個孤立星塵更值得。",
      "多個光靈聚在路口時再使用信標，一次反轉可以同時取得分數與空間。",
      "碰撞重置位置後，利用短暫保護時間重新閱讀走廊，不要重複同一個轉彎。",
    ],
    progression: [
      "第 1 關以較慢的光靈速度教授收集與走廊判讀。",
      "第 2 關會旋轉光靈起始位置並提高追逐速度，必須更早做出路線選擇。",
      "第 3 關結合最快壓力與同一座固定迷宮，獎勵信標時機、短繞路與冷靜回復。",
    ],
    designNote: "星徑迷宮使用原創 Canvas 迷宮、角色與音效，四種可辨識的追逐邏輯、單一響應式邏輯畫布、鍵盤與觸控操作、在地化控制，以及完整的主畫面—戰鬥—結果流程。",
    parent: "星徑迷宮是適合一般玩家與家庭遊玩的 9+ 瀏覽器街機遊戲。不需要帳號或付費；最高分與音效偏好只會保存在這個瀏覽器。",
    faq: [
      ["如何完成一個關卡？", "在固定迷宮中收集全部星塵。信標不是通關必要條件，但有助於得分與安全反擊。"],
      ["光靈都使用同一種追逐邏輯嗎？", "不是。直接、預測、伏擊與游移型光靈會採用不同路線，並顯示不同角色標記。"],
      ["信標有什麼作用？", "信標會開啟短暫能力窗口，讓附近光靈可以被追擊並提供額外分數。"],
      ["碰撞後會發生什麼？", "你會失去一條生命並回到目前路線，短暫保護時間後關卡會繼續，直到生命耗盡。"],
      ["手機可以玩嗎？", "可以。手機可滑動迷宮或使用方向鍵，桌面也支援方向鍵與 WASD。"],
      ["進度會保存嗎？", "最高分與音效偏好會保存在這個瀏覽器，不需要帳號。"],
    ],
  };
  ...
  localizedGames["zh-Hans"]["animal-rune-tactics"] = {
    ...
    "story": [
      ...
      "玩家指挥三位符文守卫修复道路。狮王负责近战前线，猫头鹰能隔两格攻击，乌龟则保护并治疗全队。通过任务代表该段符文已稳定，可以继续前进。石角巨鹿、铁根犀王、泽环巨蛇、烬鬃狮王与蚀月狮鹫各占据一章；符冠奇美拉吸收了所有系统。第 30 任务击败它，代表典藏库重新连线，而不是再冒出不存在的第 31 任务。"
    ],
    "systems": [
    ...
    "progression": [
      ...
      "任务 21-25 用沉默与远程标记限制技能时机，再让外圈旋转；蚀月狮鹫改变能伤害它的英雄与危险列。",
  ...
  localizedGames["zh-Hans"]["shadow-wolf"] = {
    ...
    "noteTitle": "玩家与存档说明",
    "hideScoreBands": true,
    "intro": "《影狼传说》是一款 30 关横向动作平台战役。玩家带领探险影狼穿越遗迹岩台、判读地形警示、迎战影兽、收集经验，并在升级时精确分配两点属性。每五关会遇到一名区域首领；它们的防御状态与攻击规则各不相同。",
    "story": [
    ...
    "how": [
      ...
      "看到虚线地形时先决定退路；看到敌人外围的护甲或护盾圈时，先触发它的反制空档再攻击。",
  ...
  Object.assign(localizedGames["zh-Hans"]["animal-one-line"], {
    ...
    intro: "One Line 一笔到底是由彩虹跳跳米米主演的 30 关格子解谜游戏。从发光脚印开始，只能走到上下左右相邻的空格；每格只能走一次，必须用同一条路线填满全部空格。",
    systems: ["有效路线必须从发光脚印开始，只走相邻格；每一步只能进入共享边线的空格，不能斜走或跳格。", "途中可以松手思考；重复走进已上色格、提前放开，或在仍有空格时走入死路，都会重置本次尝试。", "提示会标出其中一种解法的下一格；重新开始与提示都不消耗资源。", "解锁、星级、完成记录与最佳时间只储存在当前浏览器。"],
    how: ["从横向关卡列选择已解锁棋盘。", "按住发光脚印格开始。", "拖曳到上下左右相邻的空格。", "避开所有已经上色的格子。", "填满全部空格后完成关卡。"],
    strategyTips: ["开始前先观察角落与只有一个出口的区域。", "不要过早封住尚未完成区域的入口。", "卡住时可用提示查看其中一种完整解法的下一步。", "游戏不要求速度，可以停在当前格子思考。"],
    progression: ["第 1–5 关教学相邻移动与不可重复；第 6–10 关练习转角规划；第 11–15 关加入石块切割棋盘。", "第 16–20 关延长路线；第 21–25 关增加容易误判的分岔；第 26–30 关综合大型棋盘、石块与窄出口。"],
  ...
  localizedGames["ar"] ||= {};
  localizedGames["hi"] ||= {};
  localizedGames["ar"]["animal-rootvault-pins"] = {
    ...
    how: ["اختر غرفة مفتوحة من شريط الغرف الأفقي.", "افحص كل غرفة ومادة ووجهة وقفل رون.", "حدد دبوسًا ذهبيًا كاملًا واسحبه.", "أوصل تارو ونواة النجم بأمان إلى الملجأ."],
    guideAccess: "المس الدبوس واسحبه، أو حدده ثم اضغط Enter أو Space؛ لا يتكرر الإدخال المستمر.",
    strategyTips: ["برّد Emberlight قبل أن ترسل تارو عبره.", "اجمع درع القوقعة قبل كشف تارو أمام Shadow Wisp.", "سلّم كل مفتاح رون قبل الاعتماد على الدبوس الذي يحمل علامته.", "خطط لموضع نهاية تارو ونواة النجم معًا، ولا تركز على التفاعل التالي فقط."],
    progression: ["تعلّم الغرف 1–5 ترتيب المسار. وتضيف الفصول اللاحقة تفاعلات البخار والدروع والظلال والتيارين المتزامنين والأقفال الرونية، ثم تجمع القواعد كلها حتى الغرفة 30."],
    designNote: "كل غرفة محددة الحل ويمكن قراءة حالتها قبل السحب الأول. تستخدم اللمسة والماوس ولوحة المفاتيح فعلًا واحدًا متطابقًا، بينما تحافظ شاشات Main وStage وBattle وResult على تخطيط منطقي مركزي بحد أقصى 920 بكسلًا ومنطقة منفصلة أسفل الشاشة بارتفاع 56 بكسل.",
    parent: "لا يلزم إنشاء حساب. تبقى عمليات التقدم وترقيات الورشة في هذا المتصفح، وقد يؤدي مسح بيانات الموقع أو استخدام التصفح الخاص أو تغيير المتصفح أو الجهاز إلى إنشاء حفظ منفصل أو إزالة الحفظ الحالي. لا يشكل هذا الدليل تقييمًا طبيًا أو مدرسيًا أو مهنيًا.",
    faq: [["كم عدد الغرف المضمنة؟", "هناك 30 غرفة مؤلفة موزعة على ستة فصول لقواعد المواد."], ["هل يمكن سحب الدبوس جزئيًا؟", "لا. تنقل كل عملية دبوسًا ذهبيًا كاملًا."], ["ماذا تفعل مياه القمر؟", "تُبرّد مياه القمر Emberlight وتحوله إلى بخار آمن."], ["ما عناصر التحكم وأحجام الشاشات المدعومة؟", "تتبع اللمسة والماوس ولوحة المفاتيح القواعد نفسها، وتتدرج الواجهة كتخطيط واحد على الهاتف والوضع الأفقي وسطح المكتب."], ["هل ينتقل التقدم تلقائيًا إلى جهاز آخر؟", "لا. يُحفظ هذا اللعب في تخزين المتصفح المحلي فقط، لذلك يملك كل متصفح أو جهاز تقدمًا منفصلًا."], ["هل يُحفظ التقدم؟", "نعم، محليًا في هذا المتصفح فقط." ]]
  };
  localizedGames["hi"]["animal-rootvault-pins"] = {
    ...games["animal-rootvault-pins"],
    title: "पशु रूटवॉल्ट पिन", difficulty: "आसान से चुनौतीपूर्ण", time: "प्रति कक्ष 2–6 मिनट", gameplay: "सामग्री-प्रतिक्रिया पिन पहेली", genre: ["पहेली", "रणनीति", "पशु"], skills: ["तर्क", "योजना", "समस्या समाधान"],
    guideKicker: "WeightPlay की मौलिक गेम गाइड", guideTitleSuffix: "गेम गाइड",
    intro: "पशु रूटवॉल्ट पिन मॉस शैल टैरो अभिनीत 30-कक्षीय पिन पहेली है। सुनहरी पिनों को सुरक्षित क्रम में खींचें, दिखाई देने वाली सामग्री प्रतिक्रियाओं को हल करें और टैरो व स्टार कोर को अभयारण्य तक पहुंचाएं।",
    story: ["टैरो के जीवित किले के खोल के नीचे मूनवाटर चैनल एम्बरलाइट, शैडो विस्प्स, वार्ड और प्राचीन रूण तालों से उलझ गए हैं। सभी छह अध्यायों को बहाल करने पर रूटवॉल्ट फिर से खुलता है।"],
    systems: ["हर पुल स्रोत कक्ष की सभी वस्तुओं को गंतव्य कक्ष में ले जाता है। मूनवाटर एम्बरलाइट को ठंडा करके भाप बनाता है, शेल वार्ड टैरो की एक बार रक्षा करता है और रूण कुंजियां मेल खाते चिह्न वाले पिन खोलती हैं।", "पुनः आरंभ करने पर वही बनाया हुआ कक्ष ठीक उसी स्थिति में लौटता है। पूर्णताएं, सर्वश्रेष्ठ पुल संख्या, बीज चिह्न और वर्कशॉप अपग्रेड इसी ब्राउज़र में स्थानीय रूप से सहेजे जाते हैं।"],
    how: ["क्षैतिज कक्ष पट्टी से खुला हुआ कक्ष चुनें।", "हर कक्ष, सामग्री, गंतव्य और रूण लॉक का निरीक्षण करें।", "एक पूरी सुनहरी पिन चुनकर उसे खींचें।", "टैरो और स्टार कोर को सुरक्षित रूप से अभयारण्य तक पहुंचाएं।"],
    guideAccess: "पिन को टैप करके खींचें, या उसे फ़ोकस करके Enter या Space दबाएं; दबाकर रखने पर इनपुट दोहराया नहीं जाता।",
    strategyTips: ["टैरो को भेजने से पहले एम्बरलाइट को ठंडा करें।", "टैरो को शैडो विस्प के सामने लाने से पहले शेल वार्ड लें।", "चिह्नित पिन पर निर्भर होने से पहले हर रूण कुंजी पहुंचाएं।", "केवल अगली प्रतिक्रिया नहीं, बल्कि टैरो और स्टार कोर दोनों के अंतिम स्थान की योजना बनाएं।"],
    progression: ["कक्ष 1–5 मार्ग क्रम सिखाते हैं। आगे के अध्याय भाप प्रतिक्रियाएं, वार्ड और छायाएं, दोहरी धाराएं, रूण लॉक और अंततः कक्ष 30 तक सभी नियमों का संयुक्त उपयोग जोड़ते हैं।"],
    designNote: "हर कक्ष का समाधान निश्चित है और पहली पिन खींचने से पहले उसकी स्थिति पढ़ी जा सकती है। टच, माउस और कीबोर्ड एक ही एक-क्रिया इनपुट साझा करते हैं; Main, Stage, Battle और Result स्क्रीन अधिकतम 920 पिक्सेल वाले एक केंद्रित तार्किक लेआउट और नीचे अलग 56 पिक्सेल क्षेत्र का उपयोग करती हैं।",
  ...
  const spiderGuideLocalizedCopy = {
    "zh-Hant": {
      title: "蜘蛛接龍", age: "9+", difficulty: "簡單到困難", time: "5～20 分鐘", gameplay: "卡牌策略遊戲", genre: ["益智", "紙牌", "策略", "家庭"], skills: ["規劃", "圖形辨識", "專注"],
      intro: "蜘蛛接龍使用兩副牌分布在十個牌桌欄位。將牌依序向下排列，適時分開混合花色，完成八組同花色 K 到 A 的牌組即可清空牌桌。",
      story: ["蜘蛛接龍保留經典接龍的牌組操作，但每一欄都會影響下一步；牌庫每次會碰到十欄，而空欄雖然強大，發牌前卻必須重新填滿。", "1 花色適合學習節奏，2 花色加入花色分離，4 花色則要求更長期的規劃，核心操作維持不變。"],
      systems: ["牌面依點數遞減排列。單張正面牌可以放到下一個較高點數上；只有正面、連續且同花色的牌組才能整組移動。", "完成同花色 K 到 A 後，牌組會以清楚的完成動畫收走；收走八組即可獲勝。", "牌庫會向十個非空欄位各發一張正面牌。回退會還原牌桌、翻牌狀態、牌庫、發牌次數、分數與完成牌組。", "提示會優先標示可揭開暗牌、延伸同花色、完成牌組與建立空欄的實用合法步。"],
      how: ["在 Main 選擇 1、2 或 4 花色。", "將正面牌或合法的同花色牌組拖到下一個較高點數。", "使用空欄重新整理單牌或合法牌組。", "先揭開暗牌；只有每欄都有牌時才能發下一列。", "完成八組同花色 K 到 A 牌組即可獲勝。"],
      strategyTips: ["優先揭開暗牌，不要只做表面變化。", "保留同花色牌組；混合花色只能暫時墊牌，不能整組移動。", "把空欄當作暫存空間，用來分離花色或揭開暗牌。", "還有可揭牌或同花色合併時，不要急著發牌。", "4 花色時保護最乾淨的牌組，並用回退比較不同目的地。"],
      progression: ["1 花色教你熟悉節奏，2 花色加入花色衝突，4 花色是經典高難度模式。", "每種難度分開記錄遊戲場次、勝利、勝率、最佳時間與最少步數。", "重新開始會使用同一副牌；新遊戲會建立新的洗牌結果。"],
      designNote: "Spider 使用 WeightPlay 的 Card Engine、響應式 Battle 畫布、拖曳層、觸控輸入、動畫節奏、音效偏好、回退快照與紙牌視覺語言。",
      noteTitle: "玩家與儲存資訊", parent: "蜘蛛接龍適合一般玩家與家庭遊玩，建議 9 歲以上。不需要帳號；難度統計與偏好只會儲存在這個瀏覽器。", related: ["klondike-solitaire"], relatedIds: ["klondike-solitaire"],
      faq: [["使用幾張牌？", "使用兩副標準牌，共 104 張；初始牌桌有 54 張，牌庫有 50 張。"], ["有幾個欄位？", "共有十欄；前四欄從六張開始，其餘六欄從五張開始。"], ["不同花色可以疊放嗎？", "可以依點數跨花色向下疊放，但只有同花色連續牌組能整組移動或收走。"], ["為什麼牌庫不能發牌？", "經典蜘蛛接龍要求十欄都有牌後，才能發出下一列。"], ["要完成幾組才能獲勝？", "必須收走八組同花色 K 到 A。"], ["難度差在哪裡？", "1、2、4 花色改變花色組成，但保留相同的十欄規則。"], ["可以重新玩同一副牌嗎？", "可以，重新開始會使用同一副牌；新遊戲會重新洗牌。"], ["回退會還原完成牌組嗎？", "會，回退會完整還原上一個牌桌與完成牌組數。"]],
    },
  };
  for (const [guideLocale, copy] of Object.entries(spiderGuideLocalizedCopy)) {
  ...
  const addSpiderGuideCopy = (guideLocale, copy) => {
    localizedGames[guideLocale] = localizedGames[guideLocale] || {};
    localizedGames[guideLocale]["spider-solitaire"] = {
      ...(localizedGames[guideLocale]["spider-solitaire"] || {}),
      ...copy,
  ...
  addSpiderGuideCopy("zh-Hans", {
    title: "蜘蛛接龙", age: "9+", difficulty: "简单到困难", time: "5～20 分钟", gameplay: "卡牌策略游戏", genre: ["益智", "纸牌", "策略", "家庭"], skills: ["规划", "图形识别", "专注"],
    intro: "蜘蛛接龙使用两副牌分布在十个牌桌列中。将牌按顺序向下排列，适时分开混合花色，完成八组同花色 K 到 A 的牌组即可清空牌桌。",
    story: ["蜘蛛接龙保留经典接龙的牌组操作，但每一列都会影响下一步；牌库每次会碰到十列，而空列虽然强大，发牌前却必须重新填满。", "1 花色适合学习节奏，2 花色加入花色分离，4 花色则要求更长期的规划，核心操作保持不变。"],
    systems: ["牌面按点数递减排列。单张正面牌可以放到下一个较高点数上；只有正面、连续且同花色的牌组才能整组移动。", "完成同花色 K 到 A 后，牌组会以清晰的完成动画收走；收走八组即可获胜。", "牌库会向十个非空列各发一张正面牌。撤销会还原牌桌、翻牌状态、牌库、发牌次数、分数与完成牌组。", "提示会优先标示可揭开暗牌、延伸同花色、完成牌组与建立空列的实用合法步骤。"],
    how: ["在 Main 选择 1、2 或 4 花色。", "将正面牌或合法的同花色牌组拖到下一个较高点数。", "使用空列重新整理单牌或合法牌组。", "先揭开暗牌；只有每列都有牌时才能发下一列。", "完成八组同花色 K 到 A 牌组即可获胜。"],
    strategyTips: ["优先揭开暗牌，不要只做表面变化。", "保留同花色牌组；混合花色只能暂时垫牌，不能整组移动。", "把空列当作暂存空间，用来分离花色或揭开暗牌。", "还有可揭牌或同花色合并时，不要急着发牌。", "4 花色时保护最干净的牌组，并用撤销比较不同目的地。"],
    progression: ["1 花色教你熟悉节奏，2 花色加入花色冲突，4 花色是经典高难度模式。", "每种难度分开记录游戏场次、胜利、胜率、最佳时间与最少步数。", "重新开始会使用同一副牌；新游戏会建立新的洗牌结果。"],
    designNote: "Spider 使用 WeightPlay 的 Card Engine、响应式 Battle 画布、拖拽层、触控输入、动画节奏、音效偏好、撤销快照与纸牌视觉语言。",
    noteTitle: "玩家与保存信息", parent: "蜘蛛接龙适合一般玩家与家庭游玩，建议 9 岁以上。不需要账号；难度统计与偏好只会保存在这个浏览器。", related: ["klondike-solitaire"], relatedIds: ["klondike-solitaire"],
    faq: [["使用多少张牌？", "使用两副标准牌，共 104 张；初始牌桌有 54 张，牌库有 50 张。"], ["有多少列？", "共有十列；前四列从六张开始，其余六列从五张开始。"], ["不同花色可以叠放吗？", "可以按点数跨花色向下叠放，但只有同花色连续牌组能整组移动或收走。"], ["为什么牌库不能发牌？", "经典蜘蛛接龙要求十列都有牌后，才能发出下一列。"], ["完成几组才能获胜？", "必须收走八组同花色 K 到 A。"], ["难度有什么区别？", "1、2、4 花色改变花色组成，但保留相同的十列规则。"], ["可以重新玩同一副牌吗？", "可以，重新开始会使用同一副牌；新游戏会重新洗牌。"], ["撤销会还原完成牌组吗？", "会，撤销会完整还原上一个牌桌与完成牌组数。"]],
  });
  addSpiderGuideCopy("ko", {
    title: "스파이더 솔리테어", age: "9+", difficulty: "쉬움부터 어려움", time: "5~20분", gameplay: "카드 전략 게임", genre: ["퍼즐", "카드", "전략", "가족"], skills: ["계획", "패턴 인식", "집중"],
    intro: "스파이더 솔리테어는 두 덱을 열 개의 테이블 열에 배치합니다. 카드를 내림차순으로 쌓고 필요할 때 무늬가 섞인 줄을 나누며 같은 무늬 K부터 A까지 여덟 세트를 완성해 테이블을 비우세요.",
    story: ["스파이더는 클래식 솔리테어의 카드 조작감을 유지하면서 모든 열이 다음 선택에 영향을 줍니다. 덱은 열 개 모두에 닿고 빈 열은 강력하지만 배분 전에 다시 채워야 합니다.", "1 무늬는 흐름을 익히고 2 무늬는 무늬 분리를 더하며 4 무늬는 장기 계획을 요구합니다."],
    systems: ["카드는 숫자가 내려가도록 놓습니다. 앞면 한 장은 바로 높은 숫자 위에 놓을 수 있고 같은 무늬의 연속된 앞면 묶음만 함께 움직입니다.", "같은 무늬 K-A를 완성하면 애니메이션과 함께 수거되며 여덟 세트를 수거하면 승리합니다.", "덱은 비어 있지 않은 열 열 곳에 앞면 카드 한 장씩 배분합니다. 실행 취소는 테이블, 앞면 상태, 덱, 배분, 점수와 완성 세트를 복원합니다.", "힌트는 뒤집힌 카드 공개, 같은 무늬 확장, 완성 세트와 빈 열 만들기에 유용한 합법 수를 우선 표시합니다."],
    how: ["Main에서 1, 2 또는 4 무늬를 선택합니다.", "앞면 카드나 합법적인 같은 무늬 묶음을 다음 높은 숫자 위로 드래그합니다.", "빈 열을 사용해 카드나 묶음을 재배치합니다.", "뒷면 카드를 먼저 공개하고 모든 열에 카드가 있을 때만 새 줄을 배분합니다.", "같은 무늬 K-A 여덟 세트를 완성하면 승리합니다."],
    strategyTips: ["표면만 바꾸는 수보다 뒷면 카드 공개를 우선하세요.", "같은 무늬 묶음은 함께 유지하고 섞인 무늬 묶음은 임시 발판으로만 사용하세요.", "빈 열을 예비 공간으로 사용해 무늬를 나누거나 뒷면 카드를 공개하세요.", "공개나 같은 무늬 합체가 가능하다면 바로 배분하지 마세요.", "4 무늬에서는 가장 깨끗한 줄을 보호하고 실행 취소로 목적지를 비교하세요."],
    progression: ["1 무늬는 기본 흐름, 2 무늬는 무늬 충돌, 4 무늬는 클래식 고난도 모드입니다.", "난이도별 플레이 수, 승리, 승률, 최고 시간과 최소 이동을 따로 저장합니다.", "재시작은 같은 딜을 사용하고 새 게임은 새로 섞습니다."],
    designNote: "Spider는 WeightPlay Card Engine, 반응형 Battle 캔버스, 드래그 레이어, 터치 입력, 애니메이션, 사운드 설정, 실행 취소 스냅샷과 카드 시각 언어를 공유합니다.",
    noteTitle: "플레이어 및 저장 정보", parent: "스파이더 솔리테어는 일반 플레이어와 가족 플레이에 맞으며 9세 이상을 권장합니다. 계정은 필요 없고 난이도 통계와 설정은 이 브라우저에만 저장됩니다.", related: ["klondike-solitaire"], relatedIds: ["klondike-solitaire"],
    faq: [["카드는 몇 장인가요?", "표준 덱 두 개, 총 104장입니다. 처음 테이블에 54장, 덱에 50장이 있습니다."], ["열은 몇 개인가요?", "열은 열 개이며 처음 네 열은 여섯 장, 나머지는 다섯 장으로 시작합니다."], ["다른 무늬를 쌓을 수 있나요?", "숫자는 다른 무늬에도 내려갈 수 있지만 같은 무늬 연속 묶음만 함께 이동하거나 수거할 수 있습니다."], ["왜 덱이 막히나요?", "클래식 스파이더는 열 개 모두에 카드가 있어야 다음 줄을 배분합니다."], ["몇 세트를 완성해야 하나요?", "같은 무늬 K-A 여덟 세트를 수거해야 합니다."], ["난이도는 무엇이 다른가요?", "1, 2, 4 무늬가 무늬 구성을 바꾸지만 열 개 규칙은 같습니다."], ["같은 딜을 다시 할 수 있나요?", "재시작은 같은 딜을 사용하고 새 게임은 새로 섞습니다."], ["실행 취소로 완성 세트도 돌아오나요?", "네, 이전 테이블과 완성 세트 수를 모두 복원합니다."]],
  });
  addSpiderGuideCopy("pt-BR", {
    title: "Spider Solitaire", age: "9+", difficulty: "Fácil a difícil", time: "5 a 20 minutos", gameplay: "Jogo de estratégia com cartas", genre: ["Puzzle", "Cartas", "Estratégia", "Família"], skills: ["Planejamento", "Reconhecimento de padrões", "Foco"],
    intro: "Spider Solitaire usa dois baralhos em dez colunas. Monte sequências decrescentes, separe naipes misturados quando possível e complete oito sequências do mesmo naipe, do Rei ao Ás, para limpar a mesa.",
    story: ["Spider mantém a sensação familiar do solitário, mas cada coluna importa. Cada rodada do estoque toca as dez colunas e uma coluna vazia é poderosa, embora precise ser preenchida antes de distribuir.", "Um naipe ensina o ritmo, dois naipes acrescentam conflitos e quatro naipes exigem planejamento de longo prazo."],
    systems: ["As cartas descem por valor. Uma carta virada para cima pode ser colocada no próximo valor maior; somente uma sequência visível, contínua e do mesmo naipe se move junta.", "Complete uma sequência do mesmo naipe do Rei ao Ás para recolhê-la com uma animação clara; oito sequências vencem a partida.", "O estoque distribui uma carta virada para cima em cada coluna não vazia. Desfazer restaura mesa, cartas viradas, estoque, distribuições, pontuação e sequências completas.", "A Dica prioriza movimentos legais que revelam cartas, estendem o mesmo naipe, completam sequências ou criam colunas vazias."],
    how: ["Escolha 1, 2 ou 4 naipes no Main.", "Arraste uma carta visível ou uma sequência legal do mesmo naipe para o próximo valor maior.", "Use colunas vazias para reorganizar uma carta ou sequência legal.", "Revele cartas viradas e distribua uma nova fila somente quando todas as colunas tiverem cartas.", "Complete oito sequências do mesmo naipe, do Rei ao Ás, para vencer."],
    strategyTips: ["Priorize revelar uma carta virada em vez de apenas mudar a superfície.", "Mantenha sequências do mesmo naipe juntas; sequências misturadas são apenas apoio temporário.", "Use uma coluna vazia como reserva para separar naipes ou revelar cartas.", "Não distribua enquanto ainda houver uma revelação ou união do mesmo naipe útil.", "Em quatro naipes, proteja a sequência mais limpa e use Desfazer para comparar destinos."],
    progression: ["Um naipe ensina o ritmo, dois naipes acrescentam conflitos e quatro naipes é o modo clássico mais difícil.", "Cada dificuldade guarda partidas, vitórias, taxa de vitória, melhor tempo e menor número de movimentos separadamente.", "Reiniciar usa a mesma distribuição; Novo jogo cria uma nova mistura."],
    designNote: "Spider compartilha o Card Engine, o canvas responsivo de Battle, a camada de arrastar, o toque, o ritmo de animação, a preferência de som, os snapshots de Desfazer e a linguagem visual das cartas do WeightPlay.",
    noteTitle: "Informações do jogador e salvamento", parent: "Spider Solitaire é um jogo de estratégia com cartas para o público geral, recomendado para maiores de 9 anos e para jogar em família. Não requer conta; estatísticas e preferências ficam neste navegador.", related: ["klondike-solitaire"], relatedIds: ["klondike-solitaire"],
    faq: [["Quantas cartas são usadas?", "São usados dois baralhos padrão: 104 cartas, com 54 na mesa inicial e 50 no estoque."], ["Quantas colunas existem?", "São dez colunas; as quatro primeiras começam com seis cartas e as outras seis com cinco."], ["Posso empilhar naipes diferentes?", "Sim, os valores podem descer entre naipes, mas somente uma sequência do mesmo naipe se move ou é recolhida como grupo."], ["Por que o estoque está bloqueado?", "O Spider clássico exige uma carta em cada coluna antes de distribuir uma nova fila."], ["Quantas sequências preciso completar?", "Você precisa recolher oito sequências do mesmo naipe, do Rei ao Ás."], ["O que muda entre as dificuldades?", "1, 2 e 4 naipes mudam a mistura, mantendo as mesmas regras de dez colunas."], ["Posso reiniciar a mesma distribuição?", "Sim. Reiniciar usa a mesma distribuição; Novo jogo embaralha uma nova partida."], ["Desfazer restaura uma sequência completa?", "Sim. Desfazer restaura a mesa anterior e a quantidade de sequências recolhidas."]],
  });
  addSpiderGuideCopy("it", {
    title: "Spider Solitaire", age: "9+", difficulty: "Da facile a difficile", time: "5-20 minuti", gameplay: "Gioco di strategia con le carte", genre: ["Puzzle", "Carte", "Strategia", "Famiglia"], skills: ["Pianificazione", "Riconoscimento dei pattern", "Concentrazione"],
    intro: "Spider Solitaire usa due mazzi in dieci colonne. Costruisci sequenze discendenti, separa i semi misti quando puoi e completa otto sequenze dello stesso seme dal Re all'Asso per liberare il tavolo.",
    story: ["Spider conserva la sensazione familiare del solitario, ma ogni colonna conta. Ogni riga del tallone tocca tutte le colonne e una colonna vuota è potente, anche se va riempita prima di distribuire.", "Un seme insegna il ritmo, due semi aggiungono conflitti e quattro semi richiedono pianificazione a lungo termine."],
    systems: ["Le carte scendono per valore. Una carta scoperta può essere posata sul valore successivo più alto; solo una sequenza scoperta, continua e dello stesso seme si muove insieme.", "Completa una sequenza dello stesso seme dal Re all'Asso per raccoglierla con un'animazione chiara; otto sequenze fanno vincere la partita.", "Il tallone distribuisce una carta scoperta in ogni colonna non vuota. Annulla ripristina tavolo, carte scoperte, tallone, distribuzioni, punteggio e sequenze completate.", "Suggerimento privilegia le mosse legali che rivelano carte, estendono lo stesso seme, completano sequenze o creano colonne vuote."],
    how: ["Scegli 1, 2 o 4 semi nel Main.", "Trascina una carta scoperta o una sequenza legale dello stesso seme sul valore successivo più alto.", "Usa le colonne vuote per riorganizzare una carta o una sequenza valida.", "Rivela le carte coperte e distribuisci una nuova riga solo quando tutte le colonne hanno una carta.", "Completa otto sequenze dello stesso seme dal Re all'Asso per vincere."],
    strategyTips: ["Dai priorità alla scoperta di una carta coperta invece di cambiare solo la superficie.", "Tieni unite le sequenze dello stesso seme; le sequenze miste sono solo un appoggio temporaneo.", "Usa una colonna vuota come riserva per separare i semi o scoprire una carta.", "Non distribuire se è ancora possibile una scoperta o un'unione utile dello stesso seme.", "Con quattro semi, proteggi la sequenza più pulita e usa Annulla per confrontare le destinazioni."],
    progression: ["Un seme insegna il ritmo, due semi aggiungono conflitti e quattro semi è la modalità classica più difficile.", "Ogni difficoltà salva separatamente partite, vittorie, percentuale, miglior tempo e minor numero di mosse.", "Riavvia usa la stessa distribuzione; Nuova partita crea un nuovo mescolamento."],
    designNote: "Spider condivide il Card Engine, il canvas Battle responsivo, il livello di trascinamento, il tocco, il ritmo delle animazioni, le preferenze audio, gli snapshot di Annulla e il linguaggio visivo delle carte di WeightPlay.",
    noteTitle: "Informazioni sul giocatore e salvataggio", parent: "Spider Solitaire è un gioco di strategia con le carte per il pubblico generale, consigliato dai 9 anni e adatto alla famiglia. Non serve un account; statistiche e preferenze restano in questo browser.", related: ["klondike-solitaire"], relatedIds: ["klondike-solitaire"],
    faq: [["Quante carte vengono usate?", "Si usano due mazzi standard: 104 carte, di cui 54 sul tavolo iniziale e 50 nel tallone."], ["Quante colonne ci sono?", "Ci sono dieci colonne; le prime quattro iniziano con sei carte e le altre sei con cinque."], ["Si possono impilare semi diversi?", "Sì, i valori possono scendere tra semi diversi, ma solo una sequenza dello stesso seme si muove o viene raccolta insieme."], ["Perché il tallone è bloccato?", "Spider richiede una carta in tutte le colonne prima di distribuire una nuova riga."], ["Quante sequenze servono per vincere?", "Devi raccogliere otto sequenze dello stesso seme dal Re all'Asso."], ["Cosa cambia tra le difficoltà?", "1, 2 e 4 semi cambiano la combinazione dei semi, mantenendo le stesse regole a dieci colonne."], ["Posso riavviare la stessa distribuzione?", "Sì. Riavvia usa la stessa distribuzione; Nuova partita mescola una nuova mano."], ["Annulla ripristina una sequenza completata?", "Sì. Annulla ripristina il tavolo precedente e il numero di sequenze raccolte."]],
  });
  addSpiderGuideCopy("ru", {
    title: "Пасьянс Паук", age: "9+", difficulty: "От простой до сложной", time: "5–20 минут", gameplay: "Карточная стратегия", genre: ["Головоломка", "Карты", "Стратегия", "Семейная"], skills: ["Планирование", "Распознавание узоров", "Внимание"],
    intro: "В Пасьянсе Пауке используются две колоды в десяти колонках. Собирайте нисходящие последовательности, разделяйте смешанные масти и завершите восемь последовательностей одной масти от Короля до Туза.",
    story: ["Паук сохраняет привычное управление пасьянсом, но каждая колонка влияет на следующий выбор. Каждая раздача касается всех десяти колонок, а пустая колонка сильна, но перед раздачей её нужно заполнить.", "Одна масть знакомит с ритмом, две масти добавляют конфликты, а четыре масти требуют долгого планирования."],
    systems: ["Карты выкладываются по убыванию. Открытую карту можно положить на следующий старший ранг; вместе перемещается только открытая непрерывная последовательность одной масти.", "Завершённая последовательность одной масти от Короля до Туза убирается с понятной анимацией; восемь последовательностей приносят победу.", "Колода выдаёт по одной открытой карте в каждую непустую колонку. Отмена восстанавливает стол, открытые карты, колоду, раздачи, счёт и завершённые последовательности.", "Подсказка сначала показывает полезные допустимые ходы для открытия скрытой карты, продолжения масти, завершения серии или создания пустой колонки."],
    how: ["Выберите 1, 2 или 4 масти в Main.", "Перетащите открытую карту или допустимую последовательность одной масти на следующий старший ранг.", "Используйте пустые колонки для перестановки карты или допустимой последовательности.", "Открывайте скрытые карты и раздавайте новый ряд только когда во всех колонках есть карты.", "Завершите восемь последовательностей одной масти от Короля до Туза."],
    strategyTips: ["Сначала открывайте скрытую карту, а не просто меняйте верхний слой.", "Сохраняйте последовательности одной масти; смешанные последовательности — временная опора.", "Используйте пустую колонку как резерв для разделения мастей или открытия карты.", "Не раздавайте карты, пока доступно полезное открытие или соединение одной масти.", "В режиме четырёх мастей защищайте самую чистую серию и сравнивайте цели с помощью Отмены."],
    progression: ["Одна масть обучает ритму, две добавляют конфликты, четыре — классический сложный режим.", "Для каждой сложности отдельно сохраняются игры, победы, процент побед, лучшее время и минимум ходов.", "Перезапуск использует ту же раздачу, а Новая игра создаёт новую."],
    designNote: "Spider использует Card Engine WeightPlay, адаптивную Battle-сцену, слой перетаскивания, сенсорный ввод, анимации, настройку звука, снимки Отмены и единый язык карточного интерфейса.",
    noteTitle: "Данные игрока и сохранение", parent: "Пасьянс Паук — карточная стратегия для широкой аудитории, рекомендованная с 9 лет и подходящая для семейной игры. Аккаунт не нужен; статистика и настройки хранятся в этом браузере.", related: ["klondike-solitaire"], relatedIds: ["klondike-solitaire"],
    faq: [["Сколько используется карт?", "Две стандартные колоды, всего 104 карты: 54 на столе и 50 в колоде."], ["Сколько колонок?", "Десять колонок; первые четыре начинаются с шести карт, остальные — с пяти."], ["Можно ли складывать разные масти?", "Да, ранги можно понижать между мастями, но вместе перемещается и убирается только серия одной масти."], ["Почему колода заблокирована?", "Классический Паук требует карты во всех колонках перед новой раздачей."], ["Сколько серий нужно для победы?", "Нужно убрать восемь последовательностей одной масти от Короля до Туза."], ["Чем отличаются сложности?", "1, 2 и 4 масти меняют состав мастей, но сохраняют правила десяти колонок."], ["Можно повторить ту же раздачу?", "Да. Перезапуск использует ту же раздачу, а Новая игра перемешивает новую."], ["Отмена возвращает завершённую серию?", "Да, Отмена полностью восстанавливает предыдущий стол и число собранных серий."]],
  });
  addSpiderGuideCopy("hi", {
    title: "स्पाइडर सॉलिटेयर", age: "9+", difficulty: "आसान से कठिन", time: "5–20 मिनट", gameplay: "कार्ड रणनीति खेल", genre: ["पहेली", "कार्ड", "रणनीति", "परिवार"], skills: ["योजना", "पैटर्न पहचान", "ध्यान"],
    intro: "स्पाइडर सॉलिटेयर में दस कॉलम पर दो डेक रखे जाते हैं। घटते क्रम बनाएं, जरूरत पड़ने पर मिले-जुले सूट अलग करें और राजा से इक्का तक एक ही सूट की आठ श्रृंखलाएं पूरी करें।",
    story: ["स्पाइडर सॉलिटेयर में क्लासिक कार्ड नियंत्रण बना रहता है, लेकिन हर कॉलम अगली पसंद को प्रभावित करता है। हर डील दसों कॉलम तक जाती है और खाली कॉलम शक्तिशाली होने के साथ डील से पहले भरना जरूरी है।", "एक सूट लय सिखाता है, दो सूट अलगाव जोड़ते हैं और चार सूट लंबे समय की योजना मांगते हैं।"],
    systems: ["कार्ड रैंक के अनुसार नीचे की ओर बनते हैं। खुला कार्ड अगले बड़े रैंक पर रखा जा सकता है; केवल खुले, लगातार और एक ही सूट के कार्ड साथ चलते हैं।", "एक ही सूट की K से A श्रृंखला पूरी होने पर वह स्पष्ट एनीमेशन के साथ हटती है; आठ श्रृंखलाएं जीत दिलाती हैं।", "स्टॉक हर खाली न होने वाले कॉलम में एक खुला कार्ड देता है। वापस लेने पर टेबल, खुले कार्ड, स्टॉक, डील, स्कोर और पूरी श्रृंखलाएं लौटती हैं।", "संकेत छिपे कार्ड खोलने, एक ही सूट बढ़ाने, श्रृंखला पूरी करने और खाली कॉलम बनाने वाले उपयोगी वैध कदम पहले दिखाता है।"],
    how: ["Main में 1, 2 या 4 सूट चुनें।", "खुले कार्ड या वैध समान-सूट समूह को अगले बड़े रैंक पर खींचें।", "खाली कॉलम से कार्ड या वैध समूह व्यवस्थित करें।", "छिपे कार्ड खोलें और तभी नई पंक्ति बांटें जब हर कॉलम में कार्ड हो।", "एक ही सूट की K से A आठ श्रृंखलाएं पूरी करके जीतें।"],
    strategyTips: ["सिर्फ ऊपर की परत बदलने से पहले छिपा कार्ड खोलें।", "एक ही सूट की श्रृंखलाएं साथ रखें; मिले-जुले समूह केवल अस्थायी सहारा हैं।", "खाली कॉलम को सूट अलग करने या छिपा कार्ड खोलने के लिए सुरक्षित जगह बनाएं।", "जब उपयोगी खोलना या समान-सूट जोड़ना संभव हो तो तुरंत डील न करें।", "चार सूट में सबसे साफ श्रृंखला बचाएं और अलग लक्ष्य आजमाने के लिए वापस लें।"],
    progression: ["एक सूट लय सिखाता है, दो सूट टकराव जोड़ते हैं और चार सूट क्लासिक कठिन मोड है।", "हर कठिनाई के खेल, जीत, जीत दर, सर्वश्रेष्ठ समय और सबसे कम चाल अलग सहेजे जाते हैं।", "फिर शुरू करना वही डील रखता है; नया खेल नया मिश्रण बनाता है।"],
    designNote: "Spider में WeightPlay Card Engine, responsive Battle canvas, drag layer, touch input, animation rhythm, sound preference, undo snapshots और card visual language साझा हैं।",
    noteTitle: "खिलाड़ी और सहेजने की जानकारी", parent: "स्पाइडर सॉलिटेयर सामान्य और पारिवारिक खिलाड़ियों के लिए है, 9 वर्ष से ऊपर की उम्र के लिए सुझाया गया है। खाते की जरूरत नहीं; आंकड़े और पसंद इसी ब्राउज़र में रहते हैं।", related: ["klondike-solitaire"], relatedIds: ["klondike-solitaire"],
    faq: [["कितने कार्ड हैं?", "दो मानक डेक, कुल 104 कार्ड: शुरुआती टेबल में 54 और स्टॉक में 50।"], ["कितने कॉलम हैं?", "दस कॉलम हैं; पहले चार छह कार्ड और बाकी छह पांच कार्ड से शुरू होते हैं।"], ["क्या अलग सूट रख सकते हैं?", "हां, रैंक अलग सूटों के बीच घट सकते हैं, लेकिन साथ चलने या हटने वाला समूह एक ही सूट का होना चाहिए।"], ["स्टॉक क्यों रुकता है?", "क्लासिक स्पाइडर में नई डील से पहले सभी कॉलम में कार्ड होना जरूरी है।"], ["जीतने के लिए कितनी श्रृंखलाएं?", "राजा से इक्का तक एक ही सूट की आठ श्रृंखलाएं हटानी होती हैं।"], ["कठिनाई में क्या बदलता है?", "1, 2 और 4 सूट सूटों का मिश्रण बदलते हैं, दस कॉलम के नियम नहीं।"], ["क्या वही डील फिर खेल सकते हैं?", "हां, फिर शुरू करना वही डील रखता है और नया खेल नई डील बनाता है।"], ["क्या वापस लेने से पूरी श्रृंखला लौटती है?", "हां, पिछली टेबल और पूरी हुई श्रृंखलाओं की संख्या बहाल होती है।"]],
  });
  addSpiderGuideCopy("ar", {
    title: "سوليتير العنكبوت", age: "9+", difficulty: "من سهل إلى صعب", time: "5–20 دقيقة", gameplay: "لعبة استراتيجية بالبطاقات", genre: ["ألغاز", "بطاقات", "استراتيجية", "عائلية"], skills: ["التخطيط", "تمييز الأنماط", "التركيز"],
    intro: "تستخدم لعبة سوليتير العنكبوت مجموعتين من البطاقات في عشرة أعمدة. ابنِ تسلسلات تنازلية، وافصل الأنواع المختلطة عند الإمكان، وأكمل ثماني سلاسل من النوع نفسه من K إلى A لإخلاء الطاولة.",
    story: ["تحافظ اللعبة على إحساس التحكم المألوف في السوليتير، لكن كل عمود يؤثر في القرار التالي. تصل كل توزيعة إلى الأعمدة العشرة، والعمود الفارغ قوي لكنه يجب أن يمتلئ قبل التوزيع.", "النوع الواحد يعلّم الإيقاع، والنوعان يضيفان الفصل، والأربعة أنواع تتطلب تخطيطاً بعيد المدى."],
    systems: ["تنخفض البطاقات حسب الرتبة. يمكن وضع بطاقة مكشوفة على الرتبة الأعلى التالية؛ ولا تتحرك معاً إلا سلسلة مكشوفة متصلة من النوع نفسه.", "عند إكمال سلسلة K إلى A من النوع نفسه تُجمع بحركة واضحة، ويؤدي جمع ثماني سلاسل إلى الفوز.", "توزع الرزمة بطاقة مكشوفة على كل عمود غير فارغ. يعيد التراجع الطاولة والبطاقات المكشوفة والرزمة والتوزيعات والنتيجة والسلاسل المكتملة.", "يعرض التلميح الحركات القانونية المفيدة لفتح بطاقة مخفية أو تمديد النوع نفسه أو إكمال سلسلة أو إنشاء عمود فارغ أولاً."],
    how: ["اختر نوعاً واحداً أو نوعين أو أربعة أنواع في Main.", "اسحب بطاقة مكشوفة أو سلسلة قانونية من النوع نفسه إلى الرتبة الأعلى التالية.", "استخدم الأعمدة الفارغة لإعادة ترتيب بطاقة أو سلسلة قانونية.", "اكشف البطاقات المخفية ووزع صفاً جديداً فقط عندما يحتوي كل عمود على بطاقة.", "أكمل ثماني سلاسل من النوع نفسه من K إلى A للفوز."],
    strategyTips: ["افتح بطاقة مخفية قبل تغيير الطبقة الظاهرة فقط.", "حافظ على سلاسل النوع نفسه معاً؛ السلاسل المختلطة دعامة مؤقتة فقط.", "استخدم العمود الفارغ كمساحة احتياط لفصل الأنواع أو كشف بطاقة.", "لا توزع ما دام هناك كشف أو دمج مفيد من النوع نفسه.", "في أربعة أنواع احمِ السلسلة الأنظف واستخدم التراجع لمقارنة الوجهات."],
    progression: ["النوع الواحد يعلّم الإيقاع، والنوعان يضيفان التعارض، والأربعة أنواع هي الوضع الكلاسيكي الأصعب.", "يحفظ كل مستوى الألعاب والانتصارات ونسبة الفوز وأفضل وقت وأقل عدد من الحركات بشكل منفصل.", "إعادة البدء تستخدم التوزيعة نفسها، بينما تنشئ اللعبة الجديدة خلطاً جديداً."],
    designNote: "تستخدم Spider محرك البطاقات من WeightPlay ولوحة Battle المتجاوبة وطبقة السحب والإدخال باللمس وإيقاع الحركة وتفضيل الصوت ولقطات التراجع ولغة البطاقات المرئية.",
  ...
  games["animal-skyport-dispatch"] = {
    ...
    intro: "Animal Skyport Dispatch is a five-shift route-management strategy game set at Cloudline Skyport. Read each arriving animal airship, draw a safe approach to a compatible dock, assign limited service resources, and finish the shift before congestion or missed flights reach the failure limit.",
    ...
    progression: ["Shift 1 teaches two docks, route drawing, and four forgiving arrivals. Shift 2 opens the third dock and cargo-passenger priorities. Shift 3 adds a moving storm and weather beacon. Shift 4 adds damaged flights, repair parts, and a maintenance closure. Shift 5 combines ten arrivals, overlapping windows, and optional festival contracts."],
    ...
    parent: "No account is required. Shift unlocks, medals, reputation, upgrades, logbook discoveries, tutorial state, and settings remain in this browser. Optional Diamond actions require confirmation and are never required to finish all five shifts.",
    faq: [["How many shifts are included?", "There are five authored shifts with different arrival, dock, weather, repair, and festival rules."], ["How do I draw a route?", "Drag from the selected flight's holding marker to a compatible open dock and release on the dock."], ["Why is a route amber?", "It crosses active traffic and will raise congestion while both flights occupy the conflict."], ["What causes failure?", "The shift ends at full congestion or after three flights leave unserved."], ["Is retry free?", "Yes. A failed shift always offers a free retry first."], ["What is saved?", "Shift progress, medals, reputation, upgrades, discoveries, tutorial state, and settings stay in this browser."], ["Are Diamonds required?", "No. Optional contract rerolls and insurance require confirmation and are not needed for completion."], ["What happens after Shift 5?", "Result returns to Shift Select because there is no nonexistent Shift 6."]]
  };
  ...
  localizedGames["zh-Hant"]["animal-skyport-dispatch"] = {
    ...
    intro: "《動物天空港調度隊》是以雲際天空港為舞台的五班次航線管理策略遊戲。閱讀每艘動物飛船的需求，畫出通往相容碼頭的安全進場路線，分配有限服務資源，並在壅塞或漏接飛船達到失敗門檻前完成班次。",
    story: ["月帽奧拉負責調度塔，齒輪角犀維護貨運、客運與維修碼頭，泡泡鰭諾里則執行緊急快遞與救援航班。他們要一起處理一般進場、貨運交會、暴風、維修窗口與最終慶典尖峰。", "服務指定數量的飛船並達成聲望目標即可完成班次。安排專用碼頭、畫出有效率的路線及完成可選精通目標能取得勳章，但不要求每次都完美。"],
    systems: ["點選等待中的飛船，再從等待標記拖到相容的空碼頭。畫面曲線與碰撞判定使用同一組取樣點，因此指標或手指下方的線就是飛船真正會走的路線。", "貨運碼頭 A 適合貨物，客運碼頭 B 處理旅客與快遞，維修碼頭 C 適合受損飛船。使用非專用碼頭會多花時間或組員，紅色不相容狀態不能確認。", "穿越使用中的航線會產生琥珀色衝突並提高壅塞。暴風區會減速並可能造成損傷，除非氣象信標保護該段；交通恢復順暢後，壅塞會逐步下降。", "組員、燃料與維修零件在每班都有限。服務完成會歸還組員，短而安全的路線可節省燃料，零件應保留給受損飛船。漏接三艘或壅塞全滿會失敗，並可免費重試。"],
    how: ["選擇一艘進場飛船，閱讀目標碼頭、耐心、貨客需求與損傷狀態。", "從等待標記拖向相容空碼頭，同時避開使用中的航線、暴風與關閉的維修通道。", "在碼頭上放開以確認路線，靠港後選擇畫面要求的服務動作。", "完成班次目標並守住三艘漏接上限，結算後可前往下一班或返回班次選擇。"],
    strategyTips: ["替緊急進場保留一座碼頭與一條可用航道。", "耐心偏低時優先使用專用碼頭，但若航線衝突代價更高，可改用較慢但安全的碼頭。", "維修零件要保留給沒有零件就無法安全離場的飛船。", "預覽線穿過暴風或占用航線時，在放開前重新畫線；畫面路線就是實際判定。"],
    progression: ["班次 1 教兩座碼頭、畫線與四艘寬鬆進場；班次 2 開放第三碼頭及貨客優先；班次 3 加入移動暴風與氣象信標；班次 4 加入受損飛船、維修零件與關閉通道；班次 5 綜合十艘飛船、重疊時窗與可選慶典合約。"],
    designNote: "這是主動調度而不是放置自動運作；每艘飛船都需要玩家決定航線與服務。Main、Stage、Battle、Result 遵循共用響應式 Canvas，Battle 在 920px 上限內填滿安全寬度，General 的 56px 預留區獨立於 Canvas。觸控與滑鼠共用同一組路線取樣，因此畫線會對準手指或指標。",
    parent: "不需要帳號。班次解鎖、勳章、聲望、升級、圖鑑、教學與設定只保存在目前瀏覽器。可選鑽石操作都要先確認，而且完成五個班次不需要使用鑽石。",
    faq: [["共有幾個班次？", "共有五個人工設計班次，分別加入進場、碼頭、天候、維修與慶典規則。"], ["怎麼畫航線？", "從已選飛船的等待標記拖到相容空碼頭，並在碼頭上放開。"], ["航線為什麼變成琥珀色？", "它穿越使用中的交通，兩艘飛船同時通過時會提高壅塞。"], ["什麼情況會失敗？", "壅塞全滿或有三艘飛船未服務離場時，班次就會結束。"], ["重試免費嗎？", "是，失敗後會優先提供免費重試。"], ["哪些資料會保存？", "班次、勳章、聲望、升級、圖鑑、教學與設定會留在目前瀏覽器。"], ["一定要用鑽石嗎？", "不用；合約重抽與保險都要確認，也不是通關必要條件。"], ["班次 5 之後呢？", "結算會返回班次選擇，不會出現不存在的班次 6。"]]
  };
  ...
  localizedGames["zh-Hans"]["animal-skyspire-drop"] = {
    ...games["animal-skyspire-drop"],
    title: "动物天塔坠击", difficulty: "中等", time: "每次坠落 2–6 分钟", gameplay: "旋转高塔街机挑战", genre: ["街机", "动作", "动物"], skills: ["反应", "专注", "手眼协调"],
    guideKicker: "WeightPlay 原创游戏指南", guideTitleSuffix: "游戏指南",
    intro: "旋转水晶环塔，引导菲亚穿越 30 座不稳定的天空尖塔，对准安全缺口，并在诅咒区域终止坠落前蓄满彗星破击。",
    story: ["菲亚乘着彗星护罩穿越一连串不稳定的天空尖塔。每通过一座塔，就会修复高空路线的一段，离救援之门更近一步。"],
    systems: ["在高塔上拖动，或使用左右方向键，同时旋转所有环塔。青绿色平台安全；紫色诅咒区域会结束本次挑战，除非护盾或已充能的彗星破击保护菲亚。", "连续穿过缺口会为彗星破击充能。完成高塔获得的天空碎片与星星会保存在本机，并可用于提升操控、护盾和其他彗星工坊升级。"],
    how: ["从水平天塔轨道选择已解锁的关卡。", "旋转环塔，让缺口或安全的青绿色平台在下一次落地前移到菲亚下方。", "保持连续安全坠落来充能彗星破击，并前往救援之门。"],
    strategyTips: ["需要时间判断下一环时，先落在短距离安全平台，不必勉强每次都穿越缺口。", "长距离连续坠落充能较快，但下一次落地也更快；行动前先规划下一个缺口。", "把护盾或已充能的彗星破击留给拥挤的诅咒区段。"],
    progression: ["30 座手工设计的天空尖塔分为六个章节。后期会加入易碎玻璃、漂移环塔、反向控制、充能水晶、护盾闸门，以及结合全部规则的王冠坠落塔。"],
    designNote: "每座塔都保持直接的旋转操作，再通过环塔时机与危险配置改变挑战；难度来自判断下一次落地，而不是学习新的控制方式。",
    parent: "不需要账号。星星、最佳时间、天空碎片与升级都保存在此浏览器；清除网站数据或使用其他浏览器可能会建立新的进度。",
    faq: [["共有多少座天空尖塔？", "六个章节共有 30 座手工设计的天空尖塔。"], ["如何为彗星破击充能？", "连续穿过缺口即可累积充能；充满后可突破一次危险。"], ["进度会保存吗？", "会。完成的高塔、星星、最佳时间、天空碎片与彗星工坊升级都会保存在本机。"]]
  };
  localizedGameplayProfiles["zh-Hans"]["animal-skyspire-drop"] = { gameplay: "旋转高塔街机挑战", genre: ["街机", "动作", "动物"] };
  localizedGames["ar"]["animal-skyspire-drop"] = {
    ...games["animal-skyspire-drop"],
    title: "هبوط الحيوانات من البرج السماوي", difficulty: "متوسط", time: "2–6 دقائق لكل هبوط", gameplay: "لعبة البرج الدوّار", genre: ["أركيد", "حركة", "حيوانات"], skills: ["رد الفعل", "التركيز", "التنسيق بين اليد والعين"],
    guideKicker: "دليل لعبة WeightPlay الأصلية", guideTitleSuffix: "دليل اللعبة",
    intro: "أدر ثلاثين برجًا سماويًا بلوريًا، ووجّه فيا عبر الفتحات المتغيرة، واشحن ضربة المذنب قبل أن توقف الحلقات الملعونة رحلة الهبوط.",
    story: ["تسافر فيا داخل كرة مذنب عبر سلسلة من الأبراج السماوية غير المستقرة. يعيد كل برج مكتمل جزءًا من المسار المرتفع ويقرّب بوابة الإنقاذ."],
    systems: ["اسحب عبر البرج أو استخدم اليسار واليمين لتدوير الحلقات معًا. المنصة الفيروزية آمنة؛ وينهي القطاع البنفسجي الملعون الجولة ما لم يحمِ فيا درع أو ضربة مذنب مشحونة.", "يشحن المرور المتتالي عبر الفجوات ضربة المذنب. تُحفظ شظايا السماء والنجوم محليًا ويمكن استخدامها لتحسين التحكم والدروع وترقيات مسبك المذنب."],
    how: ["اختر برجًا سماويًا مفتوحًا من شريط الأبراج الأفقي.", "أدر الحلقات حتى تصبح فتحة أو منصة فيروزية آمنة تحت فيا قبل الهبوط التالي.", "حافظ على سلسلة هبوط نظيفة لشحن ضربة المذنب، ثم تابع حتى بوابة الإنقاذ."],
    strategyTips: ["استخدم ارتدادًا آمنًا قصيرًا عندما تحتاج إلى وقت لقراءة الحلقة التالية.", "تبني سلسلة الفجوات الطويلة الطاقة بسرعة، لكن الهبوط التالي يصل أسرع؛ خطط للفتحة التالية قبل الالتزام.", "احتفظ بدرع أو ضربة مذنب مشحونة لقطاع ملعون مزدحم."],
  ...
  registerExpandedGuide("animal-bus-jam", {
    ...
    how: ["Select an unlocked terminal.", "Read the active bus, its remaining seats, and the next buses in the convoy.", "Compare every queue front before sending a future color into the holding lane.", "Fill every bus without deadlocking the holding lane to unlock the next terminal."],
  ...
  const busJamGuideLocales = {
    "zh-Hant": {
      title: "潘可的巴士疏運", gameplay: "車隊與候車通道策略", difficulty: "簡單至具挑戰性", time: "每站 2–8 分鐘", genre: ["益智", "策略", "動物"], skills: ["邏輯", "規劃", "問題解決"], guideKicker: "WeightPlay 原創遊戲指南", guideTitleSuffix: "遊戲指南",
      intro: "判讀固定發車順序，安排露出的乘客，別讓有限的先進先出候車通道堵死轉運站。",
      story: ["三十座夜間轉運站都在滿載運作。只有當前公車能讓乘客上車，其他顏色都必須依照派出順序等待在候車通道。", "所有決策都清楚可見：完整車隊、每條隊列、當前公車座位，以及每個已占用的候車位。失敗來自路線選擇，而不是隱藏車流或倒數計時。"],
      systems: ["每條隊列只能移動最前方的乘客。顏色相符的乘客會立即登上當前公車。", "顏色不符的乘客會進入候車通道；必須先清出最前方的乘客，後面的人才能上車。", "當前公車坐滿後會發車，下一台公車成為當前目標；候車通道最前方顏色相符的乘客會自動上車。", "候車通道已滿，且沒有露出的乘客能完成當前路線時，轉運站就會堵死。復原會回到精確的上一個狀態，重新開始會還原關卡。"],
      how: ["選擇已解鎖的轉運站。", "閱讀當前公車、剩餘座位，以及車隊中的下一台公車。", "把未來顏色送進候車通道前，先比較每條隊列的最前方乘客。", "在不堵死候車通道的前提下坐滿所有公車，解鎖下一個轉運站。"],
      strategyTips: ["把每個候車位視為稀缺資源，而不是免費倉庫。", "送出未來顏色前，先確認它會不會成為最前方的阻塞點。", "候車通道接近滿載時，優先露出當前顏色。", "只要派出乘客改變了你規劃的候車順序，就立即使用復原。"],
      progression: ["第 1 站教你熟悉流程；從第 2 站開始，錯誤路線可能造成真正的堵死。", "後續章節加入第四條路線、更長的車隊、更多隊列與重複顏色，並以兩格候車通道取代固定的三車配置。"],
      designNote: "四條路線同時使用顏色與字母代碼。固定車隊、先進先出候車通道、確定性的隊列與驗證過的解法，共同構成一個在手機與桌面上都清楚易讀的策略益智遊戲。完整介面使用置中的單一邏輯版面，最大寬度為 920 像素。手機、橫向與桌面畫面會一起縮放相同的控制項、點擊區、美術與遊戲座標，不會個別拉伸。因此觸控、滑鼠與鍵盤都操作同一套合法狀態。主畫面海報與開始遊戲動作獨立於關卡管理；關卡選擇、戰鬥、對話框與結果則各自保有界線清楚的內容與返回路徑。",
      parent: "這是一款一般向、不計時的策略益智遊戲，不需要帳號、購買或公開排行榜。通關紀錄只保存在此瀏覽器。你可以不建立帳號直接遊玩；進度儲存在目前瀏覽器設定檔的本機儲存空間，不是線上帳號或跨裝置資料庫。清除網站資料、使用私密瀏覽、換瀏覽器或換裝置，都可能建立獨立存檔或移除現有進度。瀏覽器允許儲存時，語言、音效與減少動態效果偏好會跟隨 WeightPlay 共用控制。指南結果不代表醫療、學校或專業評估。",
      faq: [["可以從隊列中間派出乘客嗎？", "不行。每次只能移動露出的最前方乘客。"], ["為什麼乘客進入候車通道？", "只有當前公車能上客；其他路線都依派出順序等待。"], ["為什麼轉運站堵死？", "候車順序卡住了當前路線，而且沒有露出的乘客能解除阻塞。"], ["所有轉運站都能解嗎？", "可以。三十條記錄中的解法路徑都經過自動檢查。"], ["支援哪些控制方式與螢幕尺寸？", "遊戲規則支援觸控、滑鼠與鍵盤；介面會在指定手機、橫向與桌面視窗中以單一邏輯版面縮放。"], ["進度會自動移到其他裝置嗎？", "不會。目前只儲存在本機瀏覽器；其他瀏覽器設定檔或裝置會有獨立進度。"]]
    },
    "zh-Hans": {
      title: "胖达巴士疏导", gameplay: "车队与候车通道策略", difficulty: "简单至具挑战性", time: "每站 2–8 分钟", genre: ["益智", "策略", "动物"], skills: ["逻辑", "规划", "问题解决"], guideKicker: "WeightPlay 原创游戏指南", guideTitleSuffix: "游戏指南",
      intro: "判断固定发车顺序，安排露出的乘客，别让有限的先进先出候车通道堵死换乘站。",
      story: ["三十座夜间换乘站都在满载运作。只有当前公交车能让乘客上车，其他颜色都必须按派出顺序等待在候车通道。", "所有决策都清楚可见：完整车队、每条队列、当前公交车座位，以及每个已占用的候车位。失败来自路线选择，而不是隐藏车流或倒计时。"],
      systems: ["每条队列只能移动最前方的乘客。颜色相符的乘客会立即登上当前公交车。", "颜色不符的乘客会进入候车通道；必须先清出最前方的乘客，后面的人才能上车。", "当前公交车坐满后会发车，下一辆成为当前目标；候车通道最前方颜色相符的乘客会自动上车。", "候车通道已满，且没有露出的乘客能完成当前路线时，换乘站就会堵死。撤销会回到精确的上一步，重新开始会还原关卡。"],
      how: ["选择已解锁的换乘站。", "阅读当前公交车、剩余座位，以及车队中的下一辆公交车。", "把未来颜色送进候车通道前，先比较每条队列最前方的乘客。", "在不堵死候车通道的前提下坐满所有公交车，解锁下一座换乘站。"],
      strategyTips: ["把每个候车位视为稀缺资源，而不是免费仓库。", "送出未来颜色前，先确认它会不会成为最前方的阻塞点。", "候车通道接近满载时，优先露出当前颜色。", "只要派出乘客改变了你规划的候车顺序，就立即使用撤销。"],
      progression: ["第 1 站教你熟悉流程；从第 2 站开始，错误路线可能造成真正的堵死。", "后续章节加入第四条路线、更长的车队、更多队列与重复颜色，并以两格候车通道取代固定的三车配置。"],
      designNote: "四条路线同时使用颜色与字母代码。固定车队、先进先出候车通道、确定性的队列与验证过的解法，共同构成一个在手机与桌面上都清楚易读的策略益智游戏。完整界面使用居中的单一逻辑版面，最大宽度为 920 像素。手机、横向与桌面画面会一起缩放相同的控件、点击区、美术与游戏坐标，不会个别拉伸。因此触控、鼠标与键盘都操作同一套合法状态。主画面海报与开始游戏动作独立于关卡管理；关卡选择、战斗、对话框与结果则各自保有边界清楚的内容与返回路径。",
      parent: "这是一款一般向、不计时的策略益智游戏，不需要账号、购买或公开排行榜。通关记录只保存在此浏览器。你可以不创建账号直接游玩；进度储存在当前浏览器配置文件的本地存储中，不是在线账号或跨设备数据库。清除网站数据、使用隐私浏览、换浏览器或换设备，都可能创建独立存档或移除现有进度。浏览器允许存储时，语言、音效与减少动态效果偏好会跟随 WeightPlay 共用控件。指南结果不代表医疗、学校或专业评估。",
      faq: [["可以从队列中间派出乘客吗？", "不行。每次只能移动露出的最前方乘客。"], ["为什么乘客进入候车通道？", "只有当前公交车能上客；其他路线都按派出顺序等待。"], ["为什么换乘站堵死？", "候车顺序卡住了当前路线，而且没有露出的乘客能解除阻塞。"], ["所有换乘站都能解吗？", "可以。三十条记录中的解法路径都经过自动检查。"], ["支持哪些控制方式和屏幕尺寸？", "游戏规则支持触控、鼠标和键盘；界面会在指定手机、横向和桌面窗口中以单一逻辑版面缩放。"], ["进度会自动移到其他设备吗？", "不会。目前只保存在本地浏览器；其他浏览器配置文件或设备会有独立进度。"]]
    },
    ja: {
      title: "パン子のバスジャム", gameplay: "車列と待機レーンの戦略", difficulty: "やさしい〜手ごたえあり", time: "1ステージ 2〜8分", genre: ["パズル", "戦略", "動物"], skills: ["論理", "計画", "問題解決"], guideKicker: "WeightPlay オリジナルゲームガイド", guideTitleSuffix: "ゲームガイド",
      intro: "固定された出発順を読み、見えている乗客を送り、限られた先入れ先出しの待機レーンを詰まらせないようにしましょう。",
      story: ["30か所の夜間ターミナルが満員で稼働しています。乗客を乗せられるのは現在のバスだけで、ほかの色は送った順に待機レーンで待ちます。", "すべての判断材料が見えています。車列全体、各列、現在のバスの空席、埋まった待機枠を確認できます。失敗は隠れた交通やタイマーではなく、ルートの選択から起こります。"],
      systems: ["各列で動かせるのは先頭の乗客だけです。同じ色の乗客はすぐ現在のバスに乗ります。", "色が違う乗客は待機レーンに入り、その先頭を出すまで後ろの乗客は乗れません。", "現在のバスが満席になると出発し、次のバスが現在の目標になります。待機レーンの先頭が同じ色なら自動で乗車します。", "待機レーンが満杯で、見えている乗客から現在のルートを完成できないとターミナルが詰まります。「戻す」は直前の状態を復元し、「やり直す」はステージを初期化します。"],
      how: ["解放済みのターミナルを選びます。", "現在のバス、空席、車列の次のバスを確認します。", "先の色を待機レーンへ送る前に、各列の先頭を比べます。", "待機レーンを詰まらせず全バスを満席にして、次のターミナルを解放します。"],
      strategyTips: ["待機枠は無料の収納ではなく、限られた資源として扱いましょう。", "先の色を送る前に、それが先頭の詰まりになるか確認します。", "待機レーンが満杯に近いときは、現在の色を先に見えるようにします。", "送り出した乗客で考えていた待機順が変わったら、すぐ「戻す」を使います。"],
      progression: ["ターミナル1で流れを学び、2以降では間違ったルートが本当の詰まりを生みます。", "後半は4路線、長い車列、多い列、同じ色のバスを追加し、固定3台構成ではなく2枠の待機レーンを使います。"],
      designNote: "4つのルートは色と文字コードを併用します。固定車列、FIFO待機レーン、決定的な列、検証済みの解答が、スマートフォンでもデスクトップでも読みやすい戦略パズルを作ります。完全な画面は中央寄せの単一論理レイアウトで、最大幅は920ピクセルです。スマートフォン、横画面、デスクトップでも操作、タップ領域、アート、ゲーム座標を一緒に拡大縮小し、個別には引き伸ばしません。そのためタッチ、マウス、キーボードは同じ合法状態を操作します。メインのポスターと開始操作はステージ管理から分離され、ステージ選択、バトル、ダイアログ、リザルトはそれぞれの範囲と戻り道を保ちます。",
      parent: "アカウント、購入、公開ランキングのない、一般向けで時間制限のない戦略パズルです。クリア状況はこのブラウザだけに保存されます。アカウントなしで遊べます。進行状況は現在のブラウザプロフィールのローカルストレージに保存され、オンラインアカウントや端末間データベースには保存されません。サイトデータの削除、プライベートブラウズ、ブラウザや端末の変更で別のセーブが作られたり、現在の進行が消えたりすることがあります。保存が許可される場合、言語、サウンド、動きを減らす設定は WeightPlay 共通コントロールに従います。ガイドの結果は医療、学校、専門的な評価ではありません。",
      faq: [["列の途中から乗客を送れますか？", "いいえ。見えている各列の先頭だけを動かせます。"], ["なぜ乗客が待機レーンに入ったのですか？", "乗れるのは現在のバスだけで、ほかのルートは送った順に待つからです。"], ["なぜターミナルが詰まったのですか？", "待機順が現在のルートを塞ぎ、見えている乗客から解消できなかったためです。"], ["すべてのターミナルは解けますか？", "はい。30本の解答ルートはすべて自動検証されています。"], ["対応する操作と画面サイズは？", "タッチ、マウス、キーボードを使える場所では同じルールで遊べます。指定のスマートフォン、横画面、デスクトップで単一の論理レイアウトが拡大縮小します。"], ["進行状況は別の端末へ自動で移りますか？", "いいえ。現在はブラウザ内だけに保存され、別のプロフィールや端末には別の進行状況ができます。"]]
    },
    ko: {
      title: "판코의 버스 정리", gameplay: "차량 행렬과 대기 통로 전략", difficulty: "쉬움부터 도전적", time: "정류장당 2~8분", genre: ["퍼즐", "전략", "동물"], skills: ["논리", "계획", "문제 해결"], guideKicker: "WeightPlay 오리지널 게임 가이드", guideTitleSuffix: "게임 가이드",
      intro: "고정된 출발 순서를 읽고 노출된 승객을 배차하며, 한정된 선입선출 대기 통로가 막히지 않게 하세요.",
      story: ["30개의 야간 터미널이 가득 찬 상태로 운영됩니다. 현재 버스만 승객을 태울 수 있고, 다른 색은 배차된 순서대로 대기 통로에서 기다립니다.", "모든 판단 정보가 보입니다. 전체 차량 행렬, 각 대기열, 현재 버스의 좌석, 사용 중인 대기 칸을 확인할 수 있습니다. 실패는 숨겨진 교통이나 타이머가 아니라 경로 선택에서 발생합니다."],
      systems: ["각 대기열에서 움직일 수 있는 것은 맨 앞 승객뿐입니다. 색이 맞는 승객은 즉시 현재 버스에 탑승합니다.", "색이 맞지 않는 승객은 대기 통로로 들어가며, 맨 앞 승객을 먼저 비워야 뒤의 승객이 탑승할 수 있습니다.", "현재 버스가 차면 출발하고 다음 버스가 현재 목표가 됩니다. 대기 통로 맨 앞의 색이 맞으면 자동으로 탑승합니다.", "대기 통로가 가득 차고 노출된 승객으로 현재 경로를 완성할 수 없으면 터미널이 막힙니다. 되돌리기는 정확한 이전 상태를 복원하고 다시 시작은 정류장을 초기화합니다."],
      how: ["잠금 해제된 터미널을 선택하세요.", "현재 버스와 남은 좌석, 차량 행렬의 다음 버스를 확인하세요.", "미래 색을 대기 통로로 보내기 전에 모든 대기열의 맨 앞을 비교하세요.", "대기 통로를 막지 않고 모든 버스를 채워 다음 터미널을 잠금 해제하세요."],
      strategyTips: ["대기 칸을 무료 보관함이 아닌 한정 자원으로 취급하세요.", "미래 색을 보내기 전에 그 승객이 맨 앞의 방해물이 될지 확인하세요.", "대기 통로가 거의 차면 현재 색을 먼저 노출하세요.", "배차로 계획한 대기 순서가 바뀌면 바로 되돌리기를 사용하세요."],
      progression: ["터미널 1에서 흐름을 배우고, 터미널 2부터는 잘못된 경로가 실제 막힘을 만들 수 있습니다.", "후반에는 네 번째 노선, 긴 차량 행렬, 더 많은 대기열, 반복 색을 추가하고 고정된 세 대 구성이 아닌 두 칸 대기 통로를 사용합니다."],
      designNote: "네 노선은 색과 문자 코드를 함께 사용합니다. 고정된 차량 행렬, FIFO 대기 통로, 결정적인 대기열, 검증된 해답이 휴대폰과 데스크톱 모두에서 읽기 쉬운 전략 퍼즐을 만듭니다. 전체 인터페이스는 중앙 정렬 단일 논리 레이아웃이며 최대 너비는 920픽셀입니다. 휴대폰, 가로 화면, 데스크톱은 같은 조작, 터치 영역, 아트, 게임 좌표를 함께 확대·축소하며 개별 요소를 늘이지 않습니다. 따라서 터치, 마우스, 키보드는 같은 합법 상태를 조작합니다. 메인 포스터와 시작 동작은 스테이지 관리와 분리되고, 스테이지 선택, 배틀, 대화창, 결과는 각자의 경계와 돌아가기 경로를 유지합니다.",
      parent: "계정, 구매, 공개 순위표가 없는 일반 대상의 무시간 전략 퍼즐입니다. 클리어 기록은 이 브라우저에만 저장됩니다. 계정 없이 플레이할 수 있습니다. 진행은 현재 브라우저 프로필의 로컬 저장소에 저장되며 온라인 계정이나 기기 간 데이터베이스에는 저장되지 않습니다. 사이트 데이터를 지우거나, 시크릿 브라우징을 사용하거나, 브라우저 또는 기기를 바꾸면 별도 저장이 생기거나 기존 진행이 사라질 수 있습니다. 브라우저가 저장을 허용하면 언어, 사운드, 동작 줄이기 설정은 WeightPlay 공통 컨트롤을 따릅니다. 가이드 결과는 의료·학교·전문 평가가 아닙니다.",
      faq: [["대기열 중간의 승객을 보낼 수 있나요?", "아니요. 노출된 각 대기열의 맨 앞만 움직일 수 있습니다."], ["왜 승객이 대기 통로로 갔나요?", "현재 버스만 탑승시키고 다른 경로는 배차 순서대로 기다리기 때문입니다."], ["왜 터미널이 막혔나요?", "대기 순서가 현재 경로를 막았고 노출된 승객으로 풀 수 없었기 때문입니다."], ["모든 터미널을 풀 수 있나요?", "네. 기록된 30개의 해답 경로를 모두 자동으로 확인합니다."], ["어떤 조작과 화면 크기를 지원하나요?", "게임이 사용하는 곳에서는 터치, 마우스, 키보드가 같은 규칙을 따릅니다. 지정된 휴대폰·가로·데스크톱 화면에서 하나의 논리 레이아웃으로 크기가 조정됩니다."], ["진행이 다른 기기로 자동 이동하나요?", "아니요. 현재는 브라우저에만 저장되므로 다른 프로필이나 기기는 별도 진행을 가집니다."]]
    },
    es: {
      title: "Atasco de autobús de Panko", gameplay: "Estrategia de convoy y carril de espera", difficulty: "De fácil a desafiante", time: "2–8 minutos por terminal", genre: ["Puzle", "Estrategia", "Animales"], skills: ["Lógica", "Planificación", "Resolución de problemas"], guideKicker: "Guía de juego original de WeightPlay", guideTitleSuffix: "Guía del juego",
      intro: "Lee el orden fijo de salida, descubre los pasajeros correctos y evita que el limitado carril de espera FIFO bloquee la terminal.",
      story: ["Treinta terminales nocturnas funcionan al límite. Solo el autobús activo puede recoger pasajeros; los demás colores esperan en el carril de espera en el orden exacto de envío.", "Todas las decisiones están a la vista: el convoy completo, cada fila, los asientos del autobús activo y cada espacio ocupado. El fracaso nace de una elección de ruta, no de tráfico oculto ni de un temporizador."],
      systems: ["Solo puede moverse el primer pasajero de cada fila. Un pasajero del color correcto sube de inmediato al autobús activo.", "Un pasajero de otro color entra en el carril de espera. Hay que liberar a su primer pasajero antes de que pueda subir cualquiera que esté detrás.", "Cuando el autobús activo se llena, parte y el siguiente pasa a ser el activo. Los pasajeros que coinciden con el frente del carril suben automáticamente.", "Si el carril está lleno y ningún pasajero visible puede completar la ruta activa, la terminal se bloquea. Deshacer recupera el estado anterior exacto; Reiniciar restaura la terminal creada."],
      how: ["Elige una terminal desbloqueada.", "Lee el autobús activo, sus asientos libres y los siguientes autobuses del convoy.", "Compara el primer pasajero de cada fila antes de enviar un color futuro al carril de espera.", "Llena todos los autobuses sin bloquear el carril para desbloquear la siguiente terminal."],
      strategyTips: ["Trata cada espacio de espera como un recurso escaso, no como almacenamiento gratis.", "Antes de enviar un color futuro, comprueba si se convertirá en el bloqueo del frente.", "Cuando el carril esté casi lleno, descubre primero el color activo.", "Usa Deshacer en cuanto un envío cambie el orden de espera que habías planeado."],
      progression: ["La Terminal 1 enseña el flujo. Desde la Terminal 2, las rutas equivocadas pueden crear un bloqueo real.", "Los capítulos posteriores añaden una cuarta ruta, convoyes más largos, más filas y colores repetidos, además de un carril de dos espacios en lugar de repetir la configuración de tres autobuses."],
      designNote: "Las cuatro rutas usan códigos de color y de letras. El convoy fijo, el carril FIFO, las filas deterministas y la solución verificada forman un puzle estratégico legible en móvil y escritorio. La interfaz completa usa un único diseño lógico centrado, con un máximo de 920 píxeles. Móvil, paisaje y escritorio escalan juntos los mismos controles, zonas táctiles, ilustraciones y coordenadas del juego, sin estirar piezas por separado. Por eso el tacto, el ratón y el teclado actúan sobre el mismo estado legal. El póster principal y la acción de empezar quedan separados de la gestión de niveles; la selección de nivel, la batalla, los diálogos y el resultado conservan su contenido acotado y su retorno.",
      parent: "Es un puzle estratégico para público general, sin límite de tiempo, cuenta, compras ni clasificación pública. Las terminales superadas se guardan solo en este navegador. Puedes jugar sin crear una cuenta. El progreso se guarda en el almacenamiento local del perfil actual, no en una cuenta en línea ni en una base de datos entre dispositivos. Borrar datos, usar navegación privada, cambiar de navegador o de dispositivo puede crear otra partida o borrar la actual. Si el navegador permite guardar, idioma, sonido y reducción de movimiento siguen los controles compartidos de WeightPlay. El resultado de la guía no es una evaluación médica, escolar ni profesional.",
      faq: [["¿Puedo enviar desde el centro de una fila?", "No. Solo puede moverse el primer pasajero visible de cada fila."], ["¿Por qué entró un pasajero en el carril de espera?", "Solo el autobús activo recoge pasajeros; las rutas futuras esperan en orden."], ["¿Por qué se bloqueó la terminal?", "El orden de espera bloqueó la ruta activa y ningún pasajero visible podía despejarla."], ["¿Se pueden resolver todas las terminales?", "Sí. Las treinta rutas de solución registradas se comprueban automáticamente."], ["¿Qué controles y tamaños de pantalla se admiten?", "Las mismas reglas funcionan con tacto, ratón y teclado donde estén disponibles. La interfaz escala como un único diseño lógico en móvil, paisaje y escritorio."], ["¿El progreso pasa automáticamente a otro dispositivo?", "No. Actualmente se guarda solo en el navegador; otro perfil o dispositivo tiene su propio progreso."]]
    },
    "pt-BR": {
      title: "Engarrafamento do ônibus Panko", gameplay: "Estratégia de comboio e faixa de espera", difficulty: "Fácil a desafiador", time: "2–8 minutos por terminal", genre: ["Puzzle", "Estratégia", "Animais"], skills: ["Lógica", "Planejamento", "Resolução de problemas"], guideKicker: "Guia de jogo original do WeightPlay", guideTitleSuffix: "Guia do jogo",
      intro: "Leia a ordem fixa de saída, revele os passageiros certos e não deixe a limitada faixa de espera FIFO bloquear o terminal.",
      story: ["Trinta terminais noturnos operam no limite. Apenas o ônibus ativo pode embarcar passageiros; as outras cores aguardam na faixa de espera na ordem exata em que foram enviadas.", "Todas as decisões ficam visíveis: o comboio completo, cada fila, os assentos do ônibus ativo e cada vaga ocupada. A derrota vem de uma escolha de rota, não de trânsito oculto ou cronômetro."],
      systems: ["Só o primeiro passageiro de cada fila pode se mover. Um passageiro da cor certa embarca imediatamente no ônibus ativo.", "Um passageiro de outra cor entra na faixa de espera. O primeiro precisa sair antes que alguém atrás dele possa embarcar.", "Quando o ônibus ativo lota, ele parte e o próximo se torna ativo. Passageiros que combinam com a frente da faixa embarcam automaticamente.", "Se a faixa estiver cheia e nenhum passageiro visível puder completar a rota ativa, o terminal trava. Desfazer restaura o estado anterior exato; Reiniciar restaura o terminal criado."],
      how: ["Escolha um terminal desbloqueado.", "Leia o ônibus ativo, os assentos restantes e os próximos ônibus do comboio.", "Compare o primeiro passageiro de cada fila antes de enviar uma cor futura para a faixa de espera.", "Encha todos os ônibus sem travar a faixa para desbloquear o próximo terminal."],
      strategyTips: ["Trate cada vaga de espera como recurso limitado, não como armazenamento grátis.", "Antes de enviar uma cor futura, veja se ela virará o bloqueio da frente.", "Quando a faixa estiver quase cheia, revele primeiro a cor ativa.", "Use Desfazer assim que um envio mudar a ordem de espera que você planejou."],
      progression: ["O Terminal 1 ensina o fluxo. A partir do Terminal 2, rotas erradas podem causar um bloqueio real.", "Os capítulos seguintes adicionam uma quarta rota, comboios mais longos, mais filas e cores repetidas, além de uma faixa com duas vagas em vez da mesma configuração de três ônibus."],
      designNote: "As quatro rotas usam códigos de cor e de letras. O comboio fixo, a faixa FIFO, as filas determinísticas e a solução verificada formam um puzzle estratégico legível no celular e no desktop. A interface completa usa um único layout lógico centralizado, com no máximo 920 pixels. Celular, paisagem e desktop escalam juntos os mesmos controles, áreas de toque, artes e coordenadas do jogo, sem esticar peças separadamente. Por isso toque, mouse e teclado atuam no mesmo estado válido. O pôster da tela inicial e a ação de começar ficam separados da gestão de fases; seleção de fase, batalha, diálogos e resultado mantêm seu conteúdo delimitado e caminho de retorno.",
      parent: "Este é um puzzle estratégico para o público geral, sem tempo limite, conta, compras ou placar público. As vitórias ficam apenas neste navegador. Você pode jogar sem criar uma conta. O progresso fica no armazenamento local do perfil atual, não em uma conta online ou banco de dados entre dispositivos. Limpar dados, usar navegação privada, trocar de navegador ou dispositivo pode criar outro salvamento ou apagar o atual. Quando permitido pelo navegador, idioma, som e redução de movimento seguem os controles compartilhados do WeightPlay. O resultado do guia não é uma avaliação médica, escolar ou profissional.",
      faq: [["Posso enviar alguém do meio da fila?", "Não. Só o primeiro passageiro visível de cada fila pode se mover."], ["Por que um passageiro entrou na faixa de espera?", "Só o ônibus ativo embarca; as rotas futuras aguardam na ordem de envio."], ["Por que o terminal travou?", "A ordem de espera bloqueou a rota ativa e nenhum passageiro visível podia liberá-la."], ["Todos os terminais têm solução?", "Sim. As trinta rotas de solução registradas são verificadas automaticamente."], ["Quais controles e tamanhos de tela são compatíveis?", "As mesmas regras funcionam com toque, mouse e teclado onde disponíveis. A interface escala como um único layout lógico no celular, paisagem e desktop."], ["O progresso vai automaticamente para outro dispositivo?", "Não. Hoje ele fica apenas no navegador; outro perfil ou dispositivo terá progresso separado."]]
    },
    fr: {
      title: "Panko's Bus Jam", gameplay: "Stratégie de convoi et de voie d’attente", difficulty: "Facile à exigeant", time: "2 à 8 minutes par terminal", genre: ["Puzzle", "Stratégie", "Animaux"], skills: ["Logique", "Planification", "Résolution de problèmes"], guideKicker: "Guide de jeu original de WeightPlay", guideTitleSuffix: "Guide du jeu",
      intro: "Lisez l’ordre fixe des départs, révélez les bons passagers et empêchez la voie d’attente FIFO limitée de bloquer le terminal.",
      story: ["Trente terminaux nocturnes fonctionnent à pleine capacité. Seul le bus actif peut prendre des passagers ; les autres couleurs attendent dans l’ordre exact d’envoi.", "Toutes les décisions sont visibles : le convoi complet, chaque file, les places du bus actif et chaque emplacement occupé. L’échec vient d’un choix de route, pas d’un trafic caché ou d’un chronomètre."],
      systems: ["Seul le premier passager de chaque file peut bouger. Un passager de la bonne couleur monte immédiatement dans le bus actif.", "Un passager d’une autre couleur entre dans la voie d’attente. Il faut libérer son premier passager avant que ceux derrière puissent monter.", "Quand le bus actif est plein, il part et le suivant devient actif. Les passagers correspondant au premier de la voie montent automatiquement.", "Si la voie est pleine et qu’aucun passager visible ne peut terminer la route active, le terminal se bloque. Annuler restaure l’état exact précédent ; Recommencer restaure le terminal créé."],
      how: ["Choisissez un terminal déverrouillé.", "Lisez le bus actif, ses places restantes et les bus suivants du convoi.", "Comparez le premier passager de chaque file avant d’envoyer une couleur future dans la voie d’attente.", "Remplissez tous les bus sans bloquer la voie pour déverrouiller le terminal suivant."],
      strategyTips: ["Considérez chaque place d’attente comme une ressource rare, pas comme un stockage gratuit.", "Avant d’envoyer une couleur future, vérifiez si elle deviendra le blocage de tête.", "Quand la voie est presque pleine, révélez d’abord la couleur active.", "Utilisez Annuler dès qu’un envoi modifie l’ordre d’attente prévu."],
      progression: ["Le Terminal 1 enseigne le principe. À partir du Terminal 2, les mauvaises routes peuvent créer un vrai blocage.", "Les chapitres suivants ajoutent une quatrième route, des convois plus longs, davantage de files et des couleurs répétées, avec une voie de deux places au lieu de répéter la configuration de trois bus."],
      designNote: "Les quatre routes utilisent des codes de couleur et de lettres. Le convoi fixe, la voie FIFO, les files déterministes et la solution vérifiée forment un puzzle stratégique lisible sur téléphone et ordinateur. L’interface complète utilise une seule disposition logique centrée, limitée à 920 pixels. Le téléphone, le paysage et le bureau agrandissent ensemble les mêmes commandes, zones tactiles, illustrations et coordonnées du jeu, sans étirer les éléments séparément. Le tactile, la souris et le clavier agissent donc sur le même état valide. L’affiche de l’accueil et l’action de démarrage restent séparées de la gestion des niveaux ; la sélection de niveau, la bataille, les dialogues et le résultat gardent leur contenu borné et leur retour.",
      parent: "Il s’agit d’un puzzle stratégique grand public sans limite de temps, compte, achat ni classement public. Les terminaux réussis restent dans ce navigateur. Vous pouvez jouer sans créer de compte. La progression est enregistrée dans le stockage local du profil actuel, pas dans un compte en ligne ni une base entre appareils. Effacer les données, utiliser la navigation privée, changer de navigateur ou d’appareil peut créer une autre sauvegarde ou supprimer l’actuelle. Lorsque le navigateur l’autorise, la langue, le son et la réduction des mouvements suivent les contrôles communs de WeightPlay. Le résultat du guide n’est pas une évaluation médicale, scolaire ou professionnelle.",
      faq: [["Puis-je envoyer un passager au milieu d’une file ?", "Non. Seul le premier passager visible de chaque file peut bouger."], ["Pourquoi un passager est-il entré dans la voie d’attente ?", "Seul le bus actif prend des passagers ; les routes futures attendent dans l’ordre d’envoi."], ["Pourquoi le terminal s’est-il bloqué ?", "L’ordre d’attente bloquait la route active et aucun passager visible ne pouvait la libérer."], ["Tous les terminaux sont-ils solvables ?", "Oui. Les trente parcours de solution enregistrés sont vérifiés automatiquement."], ["Quels contrôles et formats d’écran sont pris en charge ?", "Les mêmes règles fonctionnent au tactile, à la souris et au clavier lorsque ces entrées sont disponibles. L’interface se redimensionne comme une seule disposition logique sur téléphone, paysage et bureau."], ["La progression se transfère-t-elle automatiquement vers un autre appareil ?", "Non. Elle est actuellement enregistrée dans le navigateur ; un autre profil ou appareil aura sa propre progression."]]
    },
    de: {
      title: "Pankos Bus Jam", gameplay: "Strategie mit Konvoi und Wartezone", difficulty: "Leicht bis anspruchsvoll", time: "2–8 Minuten pro Terminal", genre: ["Rätsel", "Strategie", "Tier"], skills: ["Logik", "Planung", "Problemlösung"], guideKicker: "WeightPlay-Leitfaden für Originalspiele", guideTitleSuffix: "Spielanleitung",
      intro: "Lies die feste Abfahrtsfolge, lege die richtigen Fahrgäste frei und verhindere, dass die begrenzte FIFO-Wartezone das Terminal blockiert.",
      story: ["Dreißig Nachtterminals arbeiten an ihrer Kapazitätsgrenze. Nur der aktive Bus nimmt Fahrgäste auf; alle anderen Farben warten in der genauen Reihenfolge ihres Einsatzes.", "Alle Entscheidungen sind sichtbar: der komplette Konvoi, jede Reihe, die Plätze des aktiven Busses und jeder belegte Warteplatz. Der Fehler entsteht durch eine Routenwahl, nicht durch versteckten Verkehr oder einen Timer."],
      systems: ["Nur der erste Fahrgast jeder Reihe kann sich bewegen. Ein passender Fahrgast steigt sofort in den aktiven Bus ein.", "Ein Fahrgast der falschen Farbe kommt in die Wartezone. Erst muss ihr erster Fahrgast entfernt werden, bevor jemand dahinter einsteigen kann.", "Wenn der aktive Bus voll ist, fährt er ab und der nächste wird aktiv. Passende Fahrgäste am Anfang der Wartezone steigen automatisch ein.", "Ist die Wartezone voll und kann kein sichtbarer Fahrgast die aktive Route beenden, blockiert das Terminal. Rückgängig stellt den exakten vorherigen Zustand her; Neustart stellt das erstellte Terminal wieder her."],
      how: ["Wähle ein freigeschaltetes Terminal.", "Lies den aktiven Bus, seine freien Plätze und die nächsten Busse des Konvois.", "Vergleiche die ersten Fahrgäste aller Reihen, bevor du eine spätere Farbe in die Wartezone schickst.", "Fülle alle Busse, ohne die Wartezone zu blockieren, um das nächste Terminal freizuschalten."],
      strategyTips: ["Behandle jeden Warteplatz als knappe Ressource, nicht als kostenlosen Speicher.", "Prüfe vor einer späteren Farbe, ob sie zum vorderen Blocker wird.", "Wenn die Wartezone fast voll ist, lege zuerst die aktive Farbe frei.", "Nutze Rückgängig sofort, wenn ein Zug deine geplante Warteordnung verändert."],
      progression: ["Terminal 1 erklärt den Ablauf. Ab Terminal 2 können falsche Routen eine echte Blockade erzeugen.", "Spätere Kapitel ergänzen eine vierte Route, längere Konvois, mehr Reihen und wiederholte Farben sowie eine Wartezone mit zwei Plätzen statt derselben Drei-Bus-Anordnung."],
      designNote: "Die vier Routen verwenden Farb- und Buchstabencodes. Der feste Konvoi, die FIFO-Wartezone, deterministische Reihen und der geprüfte Lösungsweg ergeben ein übersichtliches Strategiespiel auf Handy und Desktop. Die vollständige Oberfläche nutzt ein zentriertes, einheitliches logisches Layout mit maximal 920 Pixeln. Handy, Querformat und Desktop skalieren dieselben Steuerelemente, Trefferflächen, Grafiken und Spielkoordinaten gemeinsam, statt einzelne Teile zu strecken. Touch, Maus und Tastatur greifen daher auf denselben gültigen Zustand zu. Das Poster der Hauptseite und der Start bleiben von der Levelverwaltung getrennt; Levelauswahl, Battle, Dialoge und Ergebnis behalten ihren begrenzten Inhalt und Rückweg.",
      parent: "Dies ist ein zeitloses Strategiespiel für ein allgemeines Publikum ohne Konto, Kauf oder öffentliche Rangliste. Erfolge bleiben in diesem Browser. Du kannst ohne Konto spielen. Der Fortschritt wird im lokalen Speicher des aktuellen Browserprofils und nicht in einem Onlinekonto oder einer geräteübergreifenden Datenbank gespeichert. Das Löschen von Websitedaten, privates Surfen, ein anderer Browser oder ein anderes Gerät kann einen separaten Spielstand erzeugen oder den vorhandenen löschen. Wenn der Browser Speicherung erlaubt, folgen Sprache, Ton und reduzierte Bewegung den gemeinsamen WeightPlay-Steuerelementen. Das Ergebnis des Leitfadens ist keine medizinische, schulische oder berufliche Bewertung.",
      faq: [["Kann ich aus der Mitte einer Reihe schicken?", "Nein. Nur der sichtbare erste Fahrgast jeder Reihe kann bewegt werden."], ["Warum kam ein Fahrgast in die Wartezone?", "Nur der aktive Bus nimmt Fahrgäste auf; spätere Routen warten in Einsatzreihenfolge."], ["Warum wurde das Terminal blockiert?", "Die Warteordnung blockierte die aktive Route, und kein sichtbarer Fahrgast konnte sie lösen."], ["Sind alle Terminals lösbar?", "Ja. Alle dreißig aufgezeichneten Lösungswege werden automatisch geprüft."], ["Welche Steuerungen und Bildschirmgrößen werden unterstützt?", "Wo verfügbar gelten für Touch, Maus und Tastatur dieselben Regeln. Die Oberfläche skaliert als ein logisches Layout auf Handy, im Querformat und auf dem Desktop."], ["Wird der Fortschritt automatisch auf ein anderes Gerät übertragen?", "Nein. Er wird derzeit nur im Browser gespeichert; ein anderes Profil oder Gerät hat einen eigenen Fortschritt."]]
    },
    it: {
      title: "L'inceppamento del bus di Panko", gameplay: "Strategia di convoglio e corsia d’attesa", difficulty: "Da facile a impegnativo", time: "2–8 minuti per terminal", genre: ["Puzzle", "Strategia", "Animali"], skills: ["Logica", "Pianificazione", "Risoluzione dei problemi"], guideKicker: "Guida al gioco originale WeightPlay", guideTitleSuffix: "Guida del gioco",
      intro: "Leggi l’ordine fisso delle partenze, scopri i passeggeri giusti e impedisci che la corsia d’attesa FIFO, limitata, blocchi il terminal.",
      story: ["Trenta terminal notturni lavorano a pieno regime. Solo l’autobus attivo può far salire i passeggeri; gli altri colori aspettano nella corsia d’attesa nell’ordine esatto di invio.", "Ogni decisione è visibile: il convoglio completo, ogni fila, i posti dell’autobus attivo e ogni spazio occupato. La sconfitta nasce da una scelta di percorso, non da traffico nascosto o da un timer."],
      systems: ["Può muoversi solo il primo passeggero di ogni fila. Un passeggero del colore giusto sale subito sull’autobus attivo.", "Un passeggero di un altro colore entra nella corsia d’attesa. Il primo deve uscire prima che possa salire chiunque sia dietro.", "Quando l’autobus attivo è pieno, parte e il successivo diventa attivo. I passeggeri che corrispondono al primo della corsia salgono automaticamente.", "Se la corsia è piena e nessun passeggero visibile può completare il percorso attivo, il terminal si blocca. Annulla ripristina lo stato precedente esatto; Ricomincia ripristina il terminale creato."],
      how: ["Scegli un terminale sbloccato.", "Leggi l’autobus attivo, i posti rimasti e i prossimi autobus del convoglio.", "Confronta il primo passeggero di ogni fila prima di inviare un colore futuro nella corsia d’attesa.", "Riempi tutti gli autobus senza bloccare la corsia per sbloccare il terminale successivo."],
      strategyTips: ["Tratta ogni spazio d’attesa come una risorsa rara, non come deposito gratuito.", "Prima di inviare un colore futuro, controlla se diventerà il blocco in testa.", "Quando la corsia è quasi piena, scopri prima il colore attivo.", "Usa Annulla appena un invio cambia l’ordine d’attesa che avevi pianificato."],
      progression: ["Il Terminale 1 insegna il flusso. Dal Terminale 2, i percorsi sbagliati possono creare un blocco reale.", "I capitoli successivi aggiungono una quarta rotta, convogli più lunghi, più file e colori ripetuti, con una corsia da due spazi invece della stessa configurazione a tre autobus."],
      designNote: "Le quattro rotte usano codici di colore e lettere. Il convoglio fisso, la corsia FIFO, le file deterministiche e la soluzione verificata formano un puzzle strategico leggibile su telefono e desktop. L’interfaccia completa usa un unico layout logico centrato, largo al massimo 920 pixel. Telefono, orizzontale e desktop ridimensionano insieme gli stessi comandi, aree di tocco, immagini e coordinate di gioco, senza allungare singoli elementi. Tocco, mouse e tastiera agiscono quindi sullo stesso stato valido. Il poster della schermata principale e l’avvio restano separati dalla gestione dei livelli; selezione, battaglia, dialoghi e risultato conservano contenuti delimitati e percorso di ritorno.",
      parent: "È un puzzle strategico per il pubblico generale, senza timer, account, acquisti o classifica pubblica. I terminali completati restano solo in questo browser. Puoi giocare senza account. I progressi sono salvati nella memoria locale del profilo del browser attuale, non in un account online o in un database tra dispositivi. Cancellare i dati del sito, usare la navigazione privata, cambiare browser o dispositivo può creare un salvataggio separato o cancellare quello attuale. Quando il browser lo consente, lingua, suono e riduzione del movimento seguono i controlli comuni WeightPlay. Il risultato della guida non è una valutazione medica, scolastica o professionale.",
      faq: [["Posso inviare un passeggero dal centro della fila?", "No. Può muoversi solo il primo passeggero visibile di ogni fila."], ["Perché un passeggero è entrato nella corsia d’attesa?", "Solo l’autobus attivo fa salire i passeggeri; le rotte future aspettano nell’ordine di invio."], ["Perché il terminal si è bloccato?", "L’ordine d’attesa ha bloccato la rotta attiva e nessun passeggero visibile poteva liberarla."], ["Tutti i terminal sono risolvibili?", "Sì. I trenta percorsi soluzione registrati vengono controllati automaticamente."], ["Quali controlli e dimensioni dello schermo sono supportati?", "Dove disponibili, tocco, mouse e tastiera usano le stesse regole. L’interfaccia si ridimensiona come un unico layout logico su telefono, orizzontale e desktop."], ["I progressi passano automaticamente a un altro dispositivo?", "No. Al momento sono salvati solo nel browser; un altro profilo o dispositivo avrà progressi separati."]]
    },
    ru: {
      title: "Автобусный джем Панко", gameplay: "Стратегия конвоя и зоны ожидания", difficulty: "От лёгкой до сложной", time: "2–8 минут на терминал", genre: ["Головоломка", "Стратегия", "Животные"], skills: ["Логика", "Планирование", "Решение задач"], guideKicker: "Оригинальное руководство WeightPlay", guideTitleSuffix: "Руководство по игре",
      intro: "Следите за фиксированным порядком отправления, открывайте нужных пассажиров и не допускайте блокировки ограниченной FIFO-зоны ожидания.",
      story: ["Тридцать ночных терминалов работают на пределе. Пассажиров принимает только активный автобус, а остальные цвета ждут в зоне ожидания в точном порядке отправки.", "Все решения видны: полный конвой, каждая очередь, места активного автобуса и каждый занятый слот ожидания. Поражение вызывается выбором маршрута, а не скрытым движением или таймером."],
      systems: ["Двигаться может только первый пассажир каждой очереди. Пассажир подходящего цвета сразу садится в активный автобус.", "Пассажир другого цвета попадает в зону ожидания. Сначала нужно освободить её первого пассажира, и только потом смогут сесть следующие.", "Когда активный автобус заполнен, он отправляется, а следующим активным становится другой. Подходящие пассажиры в начале зоны ожидания садятся автоматически.", "Если зона заполнена и видимые пассажиры не могут завершить активный маршрут, терминал блокируется. Отмена возвращает точное предыдущее состояние, а перезапуск восстанавливает созданный терминал."],
      how: ["Выберите открытый терминал.", "Проверьте активный автобус, свободные места и следующие автобусы конвоя.", "Сравните первых пассажиров всех очередей перед отправкой будущего цвета в зону ожидания.", "Заполните все автобусы, не блокируя зону ожидания, чтобы открыть следующий терминал."],
      strategyTips: ["Считайте каждый слот ожидания редким ресурсом, а не бесплатным складом.", "Перед отправкой будущего цвета проверьте, не станет ли он передним препятствием.", "Когда зона почти заполнена, сначала откройте активный цвет.", "Используйте отмену сразу, как только отправка меняет запланированный порядок ожидания."],
      progression: ["Терминал 1 знакомит с потоком. Начиная с терминала 2 неверные маршруты могут создать настоящую блокировку.", "Поздние главы добавляют четвёртый маршрут, длинные конвои, больше очередей и повторяющиеся цвета, а также двухместную зону ожидания вместо одной схемы с тремя автобусами."],
      designNote: "Четыре маршрута используют цветовые и буквенные коды. Фиксированный конвой, FIFO-зона ожидания, детерминированные очереди и проверенное решение создают понятную стратегическую головоломку для телефона и компьютера. Полный интерфейс использует единую центрированную логическую компоновку шириной до 920 пикселей. На телефоне, в альбомном режиме и на компьютере одни и те же элементы управления, области нажатия, изображения и координаты игры масштабируются вместе, а не растягиваются по отдельности. Поэтому сенсорный ввод, мышь и клавиатура работают с одним допустимым состоянием. Постер главного экрана и запуск отделены от управления уровнями; выбор уровня, сражение, диалоги и результат сохраняют собственное ограниченное содержимое и путь возврата.",
      parent: "Это стратегическая головоломка для широкой аудитории без таймера, аккаунта, покупок и публичной таблицы лидеров. Пройденные терминалы сохраняются только в этом браузере. Играть можно без аккаунта. Прогресс хранится в локальном хранилище текущего профиля браузера, а не в онлайн-аккаунте или базе между устройствами. Очистка данных сайта, приватный режим, смена браузера или устройства могут создать отдельное сохранение или удалить текущее. Если браузер разрешает хранение, язык, звук и уменьшение движения используют общие настройки WeightPlay. Результат руководства не является медицинской, школьной или профессиональной оценкой.",
      faq: [["Можно отправить пассажира из середины очереди?", "Нет. Двигаться может только первый видимый пассажир каждой очереди."], ["Почему пассажир попал в зону ожидания?", "Пассажиров принимает только активный автобус, а будущие маршруты ждут в порядке отправки."], ["Почему терминал заблокирован?", "Порядок ожидания перекрыл активный маршрут, и ни один видимый пассажир не мог его освободить."], ["Все терминалы решаемы?", "Да. Все тридцать записанных маршрутов решения проверяются автоматически."], ["Какие способы управления и размеры экрана поддерживаются?", "Где доступно, сенсорный ввод, мышь и клавиатура используют одни правила. Интерфейс масштабируется как единая логическая компоновка на телефоне, в альбомном режиме и на компьютере."], ["Прогресс автоматически переносится на другое устройство?", "Нет. Сейчас он хранится только в браузере; у другого профиля или устройства будет отдельный прогресс."]]
    },
    hi: {
      title: "पंको की बस जाम", gameplay: "काफिला और प्रतीक्षा लेन रणनीति", difficulty: "आसान से चुनौतीपूर्ण", time: "प्रति टर्मिनल 2–8 मिनट", genre: ["पहेली", "रणनीति", "पशु"], skills: ["तर्क", "योजना", "समस्या समाधान"], guideKicker: "WeightPlay मूल गेम गाइड", guideTitleSuffix: "गेम गाइड",
      intro: "तय प्रस्थान क्रम पढ़ें, सही यात्रियों को सामने लाएँ और सीमित FIFO प्रतीक्षा लेन को जाम होने से बचाएँ।",
      story: ["तीस रात के टर्मिनल पूरी क्षमता पर चल रहे हैं। केवल सक्रिय बस यात्री ले सकती है; बाकी रंग भेजे गए क्रम में प्रतीक्षा लेन में रुकते हैं।", "हर निर्णय दिखाई देता है: पूरा काफिला, हर कतार, सक्रिय बस की सीटें और भरी हुई प्रतीक्षा जगहें। हार किसी छिपे यातायात या टाइमर से नहीं, मार्ग चुनने से होती है।"],
      systems: ["हर कतार का केवल पहला यात्री चल सकता है। सही रंग का यात्री तुरंत सक्रिय बस में बैठता है।", "गलत रंग का यात्री प्रतीक्षा लेन में जाता है। उसके पहले यात्री को हटाए बिना पीछे का कोई यात्री नहीं बैठ सकता।", "सक्रिय बस भरने पर रवाना होती है और अगली बस सक्रिय बनती है। प्रतीक्षा लेन के आगे का सही रंग अपने-आप बस में जाता है।", "प्रतीक्षा लेन भर जाए और दिख रहे यात्रियों से सक्रिय मार्ग पूरा न हो सके तो टर्मिनल जाम हो जाता है। पूर्ववत पिछली स्थिति लौटाता है और फिर शुरू करें टर्मिनल को मूल स्थिति में लाता है।"],
      how: ["खुले हुए टर्मिनल का चयन करें।", "सक्रिय बस, खाली सीटें और काफिले की अगली बसें पढ़ें।", "भविष्य के रंग को प्रतीक्षा लेन में भेजने से पहले हर कतार के पहले यात्री की तुलना करें।", "प्रतीक्षा लेन जाम किए बिना हर बस भरें और अगला टर्मिनल खोलें।"],
      strategyTips: ["हर प्रतीक्षा जगह को सीमित संसाधन समझें, मुफ्त भंडारण नहीं।", "भविष्य का रंग भेजने से पहले देखें कि वह आगे की रुकावट तो नहीं बनेगा।", "लेन भरने के करीब हो तो पहले सक्रिय रंग को सामने लाएँ।", "भेजने से आपकी योजना का क्रम बदलते ही पूर्ववत का उपयोग करें।"],
      progression: ["टर्मिनल 1 प्रवाह सिखाता है। टर्मिनल 2 से गलत मार्ग वास्तविक जाम बना सकते हैं।", "बाद के अध्याय चौथा मार्ग, लंबे काफिले, अधिक कतारें और दोहराए रंग जोड़ते हैं, तथा तीन बसों की एक जैसी रचना के बजाय दो जगह वाली प्रतीक्षा लेन देते हैं।"],
      designNote: "चारों मार्ग रंग और अक्षर कोड दोनों का उपयोग करते हैं। स्थिर काफिला, FIFO प्रतीक्षा लेन, निश्चित कतारें और जाँचा हुआ समाधान फोन व डेस्कटॉप पर पढ़ने योग्य रणनीति पहेली बनाते हैं। पूरा इंटरफ़ेस 920 पिक्सेल की अधिकतम चौड़ाई वाले एक केंद्रित तार्किक लेआउट का उपयोग करता है। फोन, लैंडस्केप और डेस्कटॉप पर वही नियंत्रण, स्पर्श क्षेत्र, कला और गेम निर्देशांक साथ-साथ स्केल होते हैं, अलग-अलग खिंचते नहीं। इसलिए स्पर्श, माउस और कीबोर्ड एक ही वैध स्थिति पर काम करते हैं। मुख्य पोस्टर और शुरू करने की क्रिया स्टेज प्रबंधन से अलग रहती है; स्टेज चयन, बैटल, संवाद और परिणाम अपने सीमित कंटेंट व वापसी पथ रखते हैं।",
      parent: "यह सामान्य दर्शकों के लिए बिना टाइमर की रणनीति पहेली है; इसमें खाता, खरीद या सार्वजनिक लीडरबोर्ड नहीं है। साफ किए गए टर्मिनल इसी ब्राउज़र में रहते हैं। बिना खाता बनाए खेल सकते हैं। प्रगति वर्तमान ब्राउज़र प्रोफ़ाइल के स्थानीय संग्रह में रहती है, ऑनलाइन खाते या उपकरणों के बीच डेटाबेस में नहीं। साइट डेटा हटाने, निजी ब्राउज़िंग, ब्राउज़र या उपकरण बदलने से अलग सेव बन सकता है या वर्तमान प्रगति हट सकती है। ब्राउज़र संग्रह की अनुमति दे तो भाषा, ध्वनि और कम गति की पसंद WeightPlay के साझा नियंत्रणों का पालन करती है। गाइड का परिणाम चिकित्सीय, विद्यालयी या पेशेवर मूल्यांकन नहीं है।",
      faq: [["क्या कतार के बीच से यात्री भेज सकते हैं?", "नहीं। हर कतार का केवल दिख रहा पहला यात्री चल सकता है।"], ["यात्री प्रतीक्षा लेन में क्यों गया?", "केवल सक्रिय बस यात्री लेती है; भविष्य के मार्ग भेजे गए क्रम में प्रतीक्षा करते हैं।"], ["टर्मिनल जाम क्यों हुआ?", "प्रतीक्षा क्रम ने सक्रिय मार्ग रोक दिया और कोई दिखता यात्री उसे खोल नहीं सका।"], ["क्या सभी टर्मिनल हल किए जा सकते हैं?", "हाँ। दर्ज किए गए सभी तीस समाधान मार्ग अपने-आप जाँचे जाते हैं।"], ["कौन से नियंत्रण और स्क्रीन आकार समर्थित हैं?", "जहाँ उपलब्ध हों वहाँ स्पर्श, माउस और कीबोर्ड समान नियमों से काम करते हैं। इंटरफ़ेस फोन, लैंडस्केप और डेस्कटॉप पर एक तार्किक लेआउट के रूप में स्केल होता है।"], ["क्या प्रगति अपने-आप दूसरे उपकरण पर जाती है?", "नहीं। अभी यह केवल ब्राउज़र में सहेजी जाती है; दूसरे प्रोफ़ाइल या उपकरण की प्रगति अलग होगी।"]]
    },
    ar: {
      title: "ازدحام حافلة بانكو", gameplay: "استراتيجية الموكب ومسار الانتظار", difficulty: "من السهل إلى المتحدي", time: "2–8 دقائق لكل محطة", genre: ["ألغاز", "استراتيجية", "حيوانات"], skills: ["المنطق", "التخطيط", "حل المشكلات"], guideKicker: "دليل لعبة WeightPlay الأصلية", guideTitleSuffix: "دليل اللعبة",
      intro: "اقرأ ترتيب المغادرة الثابت، وأظهر الركاب المناسبين، وامنع مسار الانتظار المحدود بنظام الوارد أولًا من الانسداد.",
      story: ["تعمل ثلاثون محطة ليلية بأقصى طاقتها. الحافلة النشطة وحدها تستقبل الركاب، بينما تنتظر الألوان الأخرى في مسار الانتظار حسب ترتيب إرسالها الدقيق.", "كل القرارات واضحة: الموكب الكامل، وكل صف، ومقاعد الحافلة النشطة، وكل مكان انتظار مشغول. تأتي الخسارة من اختيار المسار، لا من حركة مرور مخفية أو مؤقت."],
      systems: ["لا يمكن تحريك سوى الراكب الأول في كل صف. يصعد الراكب المطابق للون فورًا إلى الحافلة النشطة.", "يدخل الراكب غير المطابق إلى مسار الانتظار. يجب إخراج راكبه الأول قبل أن يتمكن أي شخص خلفه من الصعود.", "عندما تمتلئ الحافلة النشطة تغادر وتصبح الحافلة التالية نشطة. يصعد الركاب المطابقون لأول مسار الانتظار تلقائيًا.", "إذا امتلأ مسار الانتظار ولم يتمكن أي راكب ظاهر من إكمال المسار النشط، تنسد المحطة. يعيد التراجع الحالة السابقة بدقة، وتعيد إعادة البدء المحطة إلى حالتها الأصلية."],
      how: ["اختر محطة مفتوحة.", "اقرأ الحافلة النشطة والمقاعد المتبقية والحافلات التالية في الموكب.", "قارن أول راكب في كل صف قبل إرسال لون مستقبلي إلى مسار الانتظار.", "املأ كل الحافلات من دون سد مسار الانتظار لفتح المحطة التالية."],
      strategyTips: ["اعتبر كل مكان انتظار موردًا محدودًا، لا مخزنًا مجانيًا.", "قبل إرسال لون مستقبلي، تحقق من أنه لن يصبح العائق الأمامي.", "عندما يقترب المسار من الامتلاء، أظهر اللون النشط أولًا.", "استخدم التراجع فورًا عندما يغير الإرسال ترتيب الانتظار الذي خططت له."],
      progression: ["تعلمك المحطة 1 التدفق. ابتداءً من المحطة 2 يمكن للمسارات الخاطئة إنشاء انسداد حقيقي.", "تضيف الفصول اللاحقة مسارًا رابعًا وموكبًا أطول وصفوفًا أكثر وألوانًا متكررة، مع مسار انتظار من مكانين بدل تكرار ترتيب الحافلات الثلاث."],
      designNote: "تستخدم المسارات الأربعة رموز الألوان والحروف معًا. ويكوّن الموكب الثابت، ومسار الانتظار FIFO، والصفوف المحددة، ومسار الحل المتحقق منه لغزًا استراتيجيًا واضحًا على الهاتف وسطح المكتب. تستخدم الواجهة الكاملة تخطيطًا منطقيًا واحدًا في المنتصف بحد أقصى يبلغ 920 بكسلًا. تعمل عروض الهاتف والوضع الأفقي وسطح المكتب على تغيير حجم عناصر التحكم ومناطق النقر والرسومات وإحداثيات اللعبة نفسها معًا بدلًا من تمديد العناصر منفردة. لذلك تعمل اللمسة والماوس ولوحة المفاتيح على الحالة القانونية نفسها. يبقى ملصق الشاشة الرئيسية وإجراء البدء منفصلين عن إدارة المراحل، بينما يحافظ اختيار المرحلة والمعركة والنوافذ والنتيجة على محتواها المحدود ومسار العودة الخاص بها.",
      parent: "هذه لعبة ألغاز استراتيجية عامة بلا مؤقت، ولا تتطلب حسابًا أو شراءً أو لوحة متصدرين عامة. تبقى المحطات المكتملة في هذا المتصفح فقط. يمكنك اللعب دون إنشاء حساب. يُحفظ التقدم في التخزين المحلي لملف المتصفح الحالي، وليس في حساب عبر الإنترنت أو قاعدة بيانات بين الأجهزة. قد يؤدي مسح بيانات الموقع أو التصفح الخاص أو تغيير المتصفح أو الجهاز إلى إنشاء حفظ منفصل أو حذف التقدم الحالي. عندما يسمح المتصفح بالتخزين، تتبع اللغة والصوت وتقليل الحركة عناصر تحكم WeightPlay المشتركة. لا تمثل نتيجة الدليل تقييمًا طبيًا أو مدرسيًا أو مهنيًا.",
      faq: [["هل يمكنني إرسال راكب من منتصف الصف؟", "لا. لا يمكن تحريك سوى الراكب الأول الظاهر في كل صف."], ["لماذا دخل الراكب إلى مسار الانتظار؟", "الحافلة النشطة وحدها تستقبل الركاب، أما المسارات المستقبلية فتنتظر حسب ترتيب الإرسال."], ["لماذا انسدت المحطة؟", "أوقف ترتيب الانتظار المسار النشط ولم يتمكن أي راكب ظاهر من فتحه."], ["هل يمكن حل كل المحطات؟", "نعم. تُفحص مسارات الحل الثلاثون المسجلة تلقائيًا."], ["ما عناصر التحكم وأحجام الشاشة المدعومة؟", "تستخدم اللمسة والماوس ولوحة المفاتيح القواعد نفسها حيث تتوفر. تتدرج الواجهة كتخطيط منطقي واحد على الهاتف والوضع الأفقي وسطح المكتب."], ["هل ينتقل التقدم تلقائيًا إلى جهاز آخر؟", "لا. يُحفظ حاليًا في المتصفح فقط؛ وسيملك الملف أو الجهاز الآخر تقدمًا منفصلًا."]]
    }
  };
  ...
  games.snake.intro = "Snake is an original WeightPlay grid survival arcade game. Guide a growing star-serpent through a bounded board, collect food sparks, and keep a clean route open.";
  games.snake.how = ["Use Arrow keys or WASD on desktop, visible direction controls on touch screens, or swipe across the board on mobile.", "Turn before the next grid cell closes; opposite-direction turns are ignored to protect the current route.", "Keep moving and collect food sparks while the serpent grows; there is no fixed food-count finish.", "Hitting a wall or your own trail ends the run; Retry starts a fresh board while Best stays in local storage."];
  const snakeContinuousCopy = {
    en: { title: "Snake", gameplay: "Grid Survival Arcade", genre: ["Classic", "Arcade", "Action"], skills: ["Planning", "Reaction", "Space Reading"], difficulty: "Easy to Challenging", time: "1-4 minutes per run", intro: "Snake is an original WeightPlay grid survival arcade game. Guide a growing star-serpent through a bounded board, collect food sparks, and keep a clean route open.", story: ["A small star-serpent wakes inside a night grid. Each food spark adds another segment, turning every safe turn into the next spatial decision.", "Each run rotates through Open, Gate, and Orbit board patterns. The visible route changes without hiding the rules, so a replay asks you to read the space again rather than repeat one memorized path."], systems: ["The serpent moves continuously on a grid. Food increases its length and score, while walls or the serpent's own body end the round.", "Gate and Orbit patterns add visible obstacle cells that cannot be entered or used for food. Reaching the current food milestone settles the bonus immediately, then the run continues toward a higher target."], how: ["Use Arrow keys or WASD on desktop, visible direction controls on touch screens, or swipe across the board on mobile.", "Turn before the next grid cell closes; opposite-direction turns are ignored to protect the current route.", "Keep moving and collect food sparks while the serpent grows; there is no fixed food-count finish.", "Hitting a wall or your own trail ends the run; Retry starts a fresh board while Best stays in local storage."], strategyTips: ["Plan two turns ahead instead of chasing the nearest spark.", "Use the outer edge early, then leave a turning lane before the serpent grows.", "Choose a longer route when it keeps the next corner open.", "Short, deliberate direction changes keep the route readable as the trail grows.", "Treat a visible obstacle as a route boundary, not a target. Check the next two open cells before committing to a turn.", "After a milestone, use the bonus feedback as a pause to reassess the new target and the space left by the longer trail."], progression: ["The first spark teaches grid steering. Later sparks lengthen the trail and increase the spatial risk, making each safe turn matter more.", "The opening pace leaves room to learn. Food thresholds tighten the timer, run numbers raise the milestone, and the rotating board patterns create a fresh route decision on replay."], designNote: "Snake uses WeightPlay's own star-serpent, night-grid palette, food sparks, visible obstacle language, responsive shell, localized controls, immediate milestone feedback, and continuous survival loop.", parent: "This General browser game has no account, purchase, chat, leaderboard, or advertising flow. Score, Best, and the current short-run record stay in this browser; no account is required.", faq: [["What ends a run?", "A wall, an obstacle, or the serpent's own trail ends the run."], ["Does the serpent move continuously?", "Yes. It advances on a timed grid until the player collides or chooses to return."], ["Which controls work?", "Arrow keys, WASD, visible direction controls, and horizontal or vertical swipe."], ["Is progress saved?", "Only the local Best score is saved in this browser."], ["What changes between runs?", "The run number, milestone target, and board pattern rotate so the route must be read again."], ["What happens at a milestone?", "The current food pickup immediately adds the bonus, shows localized feedback, and keeps the endless run active."]] },
    "zh-Hant": { title: "貪食蛇", gameplay: "格線生存街機", genre: ["經典", "街機", "動作"], skills: ["規劃", "反應", "空間判讀"], difficulty: "容易上手，逐步挑戰", time: "每局約 1–4 分鐘", intro: "貪食蛇是 WeightPlay 原創的格線生存街機遊戲。帶領成長中的星蛇穿過有限棋盤，收集食物火花並持續前進。", story: ["一條小小的星蛇在夜色格線中醒來。每枚食物火花都會增加一節蛇身，讓每次安全轉彎都成為下一個空間決策。"], systems: ["蛇會在格線上持續前進。吃到食物會增加蛇身與分數；撞到牆壁或自己的身體就會結束回合。"], how: ["桌面使用方向鍵或 WASD；手機使用方向按鈕或滑動。", "在下一格封閉前先規劃轉向，反向輸入不會打斷目前路線。", "持續前進並收集食物火花，蛇身會逐步變長；沒有固定的食物數量終點。", "撞到牆壁或自己的軌跡會結束本局；重試會保留本機最佳分數。"], strategyTips: ["不要只追最近的火花，先想好接下來兩個轉彎。", "前期可沿著外圍走，但要在蛇身變長前留下轉向空間。", "只要能保留下一個轉角，繞遠路通常比硬切近路更安全。", "蛇身變長後，短而明確的轉向能讓路線更容易判讀。"], progression: ["第一枚火花教你掌握格線轉向；後續火花會拉長蛇身並增加空間風險，讓每次安全轉彎都更重要。"], designNote: "貪食蛇使用 WeightPlay 自有的星蛇、夜間格線、食物火花、響應式外框、13 語系控制與持續生存玩法。", parent: "這款一般向瀏覽器遊戲沒有帳號、購買、聊天、排行榜或廣告流程；分數與最佳紀錄只保存在目前瀏覽器。", faq: [["什麼情況會結束？", "撞到牆壁或自己的蛇身軌跡就會結束。"], ["蛇會自己持續移動嗎？", "會。蛇會依照計時在格線上前進，直到撞擊或玩家返回。"], ["支援哪些操作？", "方向鍵、WASD、畫面方向按鈕，以及水平或垂直滑動。"], ["進度會保存嗎？", "只有本機最佳分數會保存在目前瀏覽器。"]] },
    "zh-Hans": { title: "贪吃蛇", gameplay: "格线生存街机", genre: ["经典", "街机", "动作"], skills: ["规划", "反应", "空间判断"], difficulty: "容易上手，逐步挑战", time: "每局约 1–4 分钟", intro: "贪吃蛇是 WeightPlay 原创的格线生存街机游戏。带领成长中的星蛇穿过有限棋盘，收集食物火花并持续前进。", story: ["一条小小的星蛇在夜色格线中醒来。每枚食物火花都会增加一节蛇身，让每次安全转弯都成为下一次空间决策。"], systems: ["蛇会在格线上持续前进。吃到食物会增加蛇身和分数；撞到墙壁或自己的身体就会结束回合。"], how: ["桌面使用方向键或 WASD；手机使用方向按钮或滑动。", "在下一格封闭前先规划转向，反向输入不会打断当前路线。", "持续前进并收集食物火花，蛇身会逐步变长；没有固定的食物数量终点。", "撞到墙壁或自己的轨迹会结束本局；重试会保留本机最佳分数。"], strategyTips: ["不要只追最近的火花，先想好接下来两个转弯。", "前期可以沿外圈走，但要在蛇身变长前留下转向空间。", "只要能保留下一个转角，绕远路通常比硬切近路更安全。", "蛇身变长后，短而明确的转向能让路线更容易判断。"], progression: ["第一枚火花教你掌握格线转向；后续火花会拉长蛇身并增加空间风险，让每次安全转弯都更重要。"], designNote: "贪吃蛇使用 WeightPlay 自有的星蛇、夜间格线、食物火花、响应式外框、13 语系控制和持续生存玩法。", parent: "这款普通向浏览器游戏没有账号、购买、聊天、排行榜或广告流程；分数和最佳记录只保存在当前浏览器。", faq: [["什么情况会结束？", "撞到墙壁或自己的蛇身轨迹就会结束。"], ["蛇会自己持续移动吗？", "会。蛇会按照计时在格线上前进，直到撞击或玩家返回。"], ["支持哪些操作？", "方向键、WASD、画面方向按钮，以及水平或垂直滑动。"], ["进度会保存吗？", "只有本机最佳分数会保存在当前浏览器。"]] },
    ja: { title: "スネーク", gameplay: "グリッド・サバイバルアーケード", genre: ["クラシック", "アーケード", "アクション"], skills: ["計画", "反応", "空間認識"], difficulty: "やさしく、徐々に挑戦的", time: "1プレイ約1～4分", intro: "スネークはWeightPlayオリジナルのグリッド生存アーケードです。成長する星のヘビを導き、食べ物を集めながら進み続けます。", story: ["小さな星のヘビが夜のグリッドで目を覚まします。食べ物を1つ取るたびに体が伸び、安全な曲がり角が次の空間判断になります。"], systems: ["ヘビはグリッドを自動で進み続けます。食べ物で体とスコアが増え、壁や自分の体に当たるとラウンドが終わります。"], how: ["デスクトップは矢印キーまたはWASD、モバイルは方向ボタンかスワイプです。", "次のマスが閉じる前に曲がり、反対方向の入力で進路を壊さないようにします。", "食べ物を集めてヘビを成長させながら進み続けます。固定された個数のゴールはありません。", "壁や自分の軌跡に当たると終了し、リトライしてもローカルのベストは残ります。"], strategyTips: ["近い食べ物だけを追わず、次の2回の曲がり方を先に考えます。", "序盤は外周を使い、体が伸びる前に曲がる余地を残します。", "次の角を開けておけるなら、遠回りの方が安全です。", "体が長くなった後は短く明確な方向変更でルートを読みやすくします。"], progression: ["最初の食べ物でグリッド操作を学び、後半は体が伸びて空間リスクが高まります。安全な1回の旋回がより重要になります。"], designNote: "スネークはWeightPlay独自の星のヘビ、夜のグリッド、食べ物の光、レスポンシブな外枠、13言語の操作表示、連続サバイバルループを使います。", parent: "この一般向けブラウザゲームにアカウント、購入、チャット、ランキング、広告はありません。スコアとベストはこのブラウザに保存されます。", faq: [["何が起きると終了しますか？", "壁または自分の軌跡に当たると終了します。"], ["ヘビは自動で進みますか？", "はい。プレイヤーが衝突するか戻るまで、時間に合わせて進みます。"], ["どの操作に対応していますか？", "矢印キー、WASD、画面の方向ボタン、水平・垂直スワイプです。"], ["進行は保存されますか？", "このブラウザのローカルなベストスコアだけが保存されます。"]] },
    ko: { title: "스네이크", gameplay: "격자 생존 아케이드", genre: ["클래식", "아케이드", "액션"], skills: ["계획", "반응", "공간 판단"], difficulty: "쉽게 시작해 점점 도전적으로", time: "한 판 약 1~4분", intro: "스네이크는 WeightPlay 오리지널 격자 생존 아케이드입니다. 성장하는 별뱀을 조종해 먹이를 모으며 계속 이동하세요.", story: ["작은 별뱀이 밤의 격자에서 깨어납니다. 먹이 하나를 먹을 때마다 몸이 길어지고, 안전한 회전이 다음 공간 판단이 됩니다."], systems: ["뱀은 격자에서 자동으로 계속 이동합니다. 먹이를 먹으면 몸과 점수가 늘어나며, 벽이나 자신의 몸에 닿으면 라운드가 끝납니다."], how: ["데스크톱은 방향키나 WASD, 모바일은 방향 버튼이나 스와이프를 사용합니다.", "다음 칸이 막히기 전에 회전하고 반대 방향 입력으로 경로를 끊지 않습니다.", "먹이를 모으며 계속 이동해 뱀을 키우세요. 고정된 먹이 개수의 종료 지점은 없습니다.", "벽이나 자신의 궤적에 닿으면 종료되며 재시작해도 로컬 최고 점수는 남습니다."], strategyTips: ["가장 가까운 먹이만 쫓지 말고 다음 두 번의 회전을 먼저 생각하세요.", "초반에는 바깥쪽을 활용하되 몸이 길어지기 전에 회전 공간을 남기세요.", "다음 모서리를 열어 둘 수 있다면 먼 길이 더 안전합니다.", "몸이 길어진 뒤에는 짧고 분명한 방향 전환으로 경로를 읽기 쉽게 하세요."], progression: ["첫 먹이가 격자 조작을 가르치고, 이후에는 몸이 길어지며 공간 위험이 커집니다. 안전한 한 번의 회전이 점점 중요해집니다."], designNote: "스네이크는 WeightPlay 고유의 별뱀, 밤의 격자, 먹이 불꽃, 반응형 외곽, 13개 언어 조작 표시와 연속 생존 루프를 사용합니다.", parent: "이 일반 브라우저 게임에는 계정, 구매, 채팅, 순위표, 광고가 없습니다. 점수와 최고 기록은 이 브라우저에 저장됩니다.", faq: [["무엇이 라운드를 끝내나요?", "벽이나 자신의 궤적에 부딪히면 끝납니다."], ["뱀이 자동으로 움직이나요?", "네. 충돌하거나 플레이어가 돌아갈 때까지 시간에 맞춰 이동합니다."], ["어떤 조작을 지원하나요?", "방향키, WASD, 화면 방향 버튼, 가로·세로 스와이프를 지원합니다."], ["진행 상황이 저장되나요?", "이 브라우저의 로컬 최고 점수만 저장됩니다."]] },
    es: { title: "Serpiente", gameplay: "Supervivencia en cuadrícula", genre: ["Clásico", "Arcada", "Acción"], skills: ["Planificación", "Reacción", "Lectura espacial"], difficulty: "Fácil al principio, cada vez más desafiante", time: "1-4 minutos por partida", intro: "Serpiente es un arcade original de supervivencia en cuadrícula de WeightPlay. Guía una serpiente estelar, recoge chispas y sigue avanzando.", story: ["Una pequeña serpiente estelar despierta en una cuadrícula nocturna. Cada chispa añade un segmento y convierte cada giro seguro en una nueva decisión espacial."], systems: ["La serpiente avanza automáticamente por la cuadrícula. La comida aumenta su longitud y puntuación; una pared o su propio cuerpo termina la ronda."], how: ["Usa flechas o WASD; en móvil, usa botones de dirección o desliza.", "Gira antes de que se cierre la siguiente casilla y no inviertas la dirección actual.", "Sigue avanzando y recoge chispas mientras la serpiente crece; no hay un límite fijo de comida.", "Chocar con una pared o con tu rastro termina la partida; el mejor resultado local se conserva al reintentar."], strategyTips: ["No persigas solo la chispa más cercana: piensa en los dos próximos giros.", "Usa el borde al principio y deja espacio para girar antes de que crezca la serpiente.", "Una ruta larga es más segura si mantiene abierto el siguiente giro.", "Cuando el rastro crezca, usa cambios de dirección breves y claros para leer la ruta."], progression: ["La primera chispa enseña a girar en la cuadrícula. Las siguientes alargan el rastro y aumentan el riesgo espacial, haciendo más importante cada giro seguro."], designNote: "Serpiente usa la serpiente estelar, la cuadrícula nocturna, las chispas, el marco adaptable, los controles en 13 idiomas y el bucle de supervivencia propios de WeightPlay.", parent: "Este juego de navegador para público general no tiene cuenta, compras, chat, clasificación ni anuncios. La puntuación y el mejor resultado se guardan en este navegador.", faq: [["¿Qué termina una partida?", "Chocar con una pared o con tu propio rastro."], ["¿La serpiente se mueve sola?", "Sí. Avanza con el tiempo hasta chocar o volver al inicio."], ["¿Qué controles funcionan?", "Flechas, WASD, botones de dirección y deslizamiento horizontal o vertical."], ["¿Se guarda el progreso?", "Solo se guarda el mejor resultado local en este navegador."]] },
    "pt-BR": { title: "Snake", gameplay: "Arcade de sobrevivência em grade", genre: ["Clássico", "Arcade", "Ação"], skills: ["Planejamento", "Reação", "Leitura espacial"], difficulty: "Fácil no início, cada vez mais desafiador", time: "1–4 minutos por partida", intro: "Snake é um arcade original de sobrevivência em grade do WeightPlay. Guie uma serpente estelar, colete faíscas e continue avançando.", story: ["Uma pequena serpente estelar desperta em uma grade noturna. Cada faísca acrescenta um segmento e transforma cada curva segura em uma nova decisão espacial."], systems: ["A serpente avança automaticamente pela grade. A comida aumenta seu tamanho e pontuação; uma parede ou o próprio corpo encerra a rodada."], how: ["Use setas ou WASD; no celular use botões de direção ou deslize.", "Vire antes que a próxima casa feche e não inverta a direção atual.", "Continue avançando e colete faíscas enquanto a cobra cresce; não há um limite fixo de alimentos.", "Bater na parede ou no próprio rastro encerra a partida; o melhor placar local fica salvo ao tentar novamente."], strategyTips: ["Não persiga só a faísca mais próxima; pense nas duas próximas curvas.", "Use a borda no começo e deixe espaço para virar antes de a serpente crescer.", "Uma rota mais longa é segura quando mantém a próxima esquina aberta.", "Com o rastro maior, use mudanças de direção curtas e claras para ler a rota."], progression: ["A primeira faísca ensina a direção na grade. As seguintes alongam o rastro e aumentam o risco espacial, valorizando cada curva segura."], designNote: "Snake usa a serpente estelar, a grade noturna, as faíscas, o quadro responsivo, os controles em 13 idiomas e o loop de sobrevivência próprios do WeightPlay.", parent: "Este jogo de navegador para o público geral não tem conta, compra, chat, ranking ou anúncios. A pontuação e o melhor placar ficam neste navegador.", faq: [["O que encerra uma partida?", "Bater em uma parede ou no próprio rastro."], ["A serpente se move sozinha?", "Sim. Ela avança com o tempo até colidir ou voltar ao início."], ["Quais controles funcionam?", "Setas, WASD, botões de direção e deslize horizontal ou vertical."], ["O progresso é salvo?", "Somente o melhor placar local é salvo neste navegador."]] },
    fr: { title: "Serpent", gameplay: "Arcade de survie sur grille", genre: ["Classique", "Arcade", "Action"], skills: ["Planification", "Réaction", "Lecture de l'espace"], difficulty: "Facile au départ, puis plus exigeant", time: "1 à 4 minutes par partie", intro: "Serpent est un arcade original de survie sur grille de WeightPlay. Guide un serpent-étoile, collecte des étincelles et continue d’avancer.", story: ["Un petit serpent-étoile se réveille dans une grille nocturne. Chaque étincelle ajoute un segment et transforme chaque virage sûr en nouvelle décision spatiale."], systems: ["Le serpent avance automatiquement sur la grille. La nourriture augmente sa longueur et le score ; un mur ou son propre corps termine la manche."], how: ["Utilise les flèches ou WASD ; sur mobile, touche une direction ou glisse.", "Tourne avant que la prochaine case ne se ferme et ne renverse pas la direction actuelle.", "Continue d’avancer et collecte des étincelles pendant que le serpent grandit ; aucun nombre fixe ne termine la partie.", "Un mur ou ta propre trace termine la partie ; le meilleur score local reste après une nouvelle tentative."], strategyTips: ["Ne poursuis pas seulement l’étincelle la plus proche : anticipe les deux prochains virages.", "Utilise le bord au début et garde un espace de virage avant que le serpent ne grandisse.", "Un détour est plus sûr s’il garde le prochain angle ouvert.", "Quand la trace s’allonge, utilise des changements de direction courts et nets pour lire la route."], progression: ["La première étincelle apprend les virages sur grille. Les suivantes allongent la trace et augmentent le risque spatial, ce qui rend chaque virage sûr plus important."], designNote: "Serpent utilise le serpent-étoile, la grille nocturne, les étincelles, le cadre adaptatif, les contrôles en 13 langues et la boucle de survie propres à WeightPlay.", parent: "Ce jeu de navigateur grand public ne contient ni compte, ni achat, ni chat, ni classement, ni publicité. Le score et le meilleur résultat restent dans ce navigateur.", faq: [["Qu'est-ce qui termine une partie ?", "Un mur ou ta propre trace termine la partie."], ["Le serpent avance-t-il seul ?", "Oui. Il avance avec le temps jusqu'à une collision ou un retour au menu."], ["Quels contrôles sont disponibles ?", "Les flèches, WASD, les boutons de direction et le glissement horizontal ou vertical."], ["La progression est-elle sauvegardée ?", "Seul le meilleur score local est enregistré dans ce navigateur."]] },
    de: { title: "Snake", gameplay: "Raster-Survival-Arcade", genre: ["Klassiker", "Arcade", "Action"], skills: ["Planung", "Reaktion", "Raumgefühl"], difficulty: "Einfacher Start, zunehmend anspruchsvoll", time: "1–4 Minuten pro Runde", intro: "Snake ist ein originales Raster-Survival-Arcade-Spiel von WeightPlay. Führe eine wachsende Sternenschlange, sammle Funken und bleibe in Bewegung.", story: ["Eine kleine Sternenschlange erwacht in einem nächtlichen Raster. Jeder Futterfunke verlängert sie und macht jede sichere Kurve zur nächsten räumlichen Entscheidung."], systems: ["Die Schlange bewegt sich automatisch über das Raster. Futter verlängert sie und erhöht den Punktestand; eine Wand oder der eigene Körper beendet die Runde."], how: ["Nutze Pfeile oder WASD; mobil verwendest du Richtungsbuttons oder wischst.", "Drehe vor der nächsten geschlossenen Rasterzelle und kehre nicht die aktuelle Richtung um.", "Bleibe in Bewegung und sammle Funken, während die Schlange wächst; es gibt kein festes Futterlimit.", "Eine Wand oder die eigene Spur beendet den Lauf; beim erneuten Versuch bleibt der lokale Bestwert erhalten."], strategyTips: ["Jage nicht nur den nächsten Funken, sondern plane die nächsten zwei Kurven.", "Nutze am Anfang den Rand und lasse eine Abbiegespur frei, bevor die Schlange wächst.", "Ein Umweg ist sicherer, wenn er die nächste Ecke offen hält.", "Bei längerer Spur helfen kurze, klare Richtungswechsel, die Route lesbar zu halten."], progression: ["Der erste Funke lehrt die Rastersteuerung. Spätere Funken verlängern die Spur und erhöhen das räumliche Risiko, sodass jede sichere Kurve wichtiger wird."], designNote: "Snake nutzt WeightPlays eigene Sternenschlange, das Nachtraster, Futterfunken, den responsiven Rahmen, Steuerungen in 13 Sprachen und den kontinuierlichen Survival-Loop.", parent: "Dieses allgemeine Browserspiel hat kein Konto, keine Käufe, keinen Chat, keine Bestenliste und keine Werbung. Punkte und Bestwert bleiben in diesem Browser.", faq: [["Was beendet eine Runde?", "Eine Wand oder die eigene Spur beendet den Lauf."], ["Bewegt sich die Schlange automatisch?", "Ja. Sie bewegt sich zeitgesteuert, bis sie kollidiert oder du zurückgehst."], ["Welche Steuerung funktioniert?", "Pfeile, WASD, sichtbare Richtungsbuttons und horizontales oder vertikales Wischen."], ["Wird der Fortschritt gespeichert?", "Nur der lokale Bestwert wird in diesem Browser gespeichert."]] },
    it: { title: "Snake", gameplay: "Arcade di sopravvivenza su griglia", genre: ["Classico", "Arcade", "Azione"], skills: ["Pianificazione", "Reazione", "Lettura dello spazio"], difficulty: "Facile all'inizio, poi più impegnativo", time: "1–4 minuti per partita", intro: "Snake è un arcade originale di sopravvivenza su griglia WeightPlay. Guida un serpente stellare, raccogli scintille e continua a muoverti.", story: ["Un piccolo serpente stellare si sveglia in una griglia notturna. Ogni scintilla aggiunge un segmento e trasforma ogni curva sicura nella prossima decisione spaziale."], systems: ["Il serpente avanza automaticamente sulla griglia. Il cibo aumenta lunghezza e punteggio; un muro o il proprio corpo termina il round."], how: ["Usa le frecce o WASD; su mobile usa i pulsanti direzionali o scorri.", "Svolta prima che la prossima casella si chiuda e non invertire la direzione attuale.", "Continua a muoverti e raccogli scintille mentre il serpente cresce; non c’è un limite fisso di cibo.", "Un muro o la tua scia termina la partita; il record locale resta dopo un nuovo tentativo."], strategyTips: ["Non inseguire solo la scintilla più vicina: pensa alle prossime due curve.", "All'inizio usa il bordo e lascia spazio per girare prima che il serpente cresca.", "Una strada più lunga è sicura se lascia aperto il prossimo angolo.", "Quando la scia si allunga, usa cambi di direzione brevi e chiari per leggere il percorso."], progression: ["La prima scintilla insegna a girare sulla griglia. Le successive allungano la scia e aumentano il rischio spaziale, rendendo più importante ogni curva sicura."], designNote: "Snake usa il serpente stellare, la griglia notturna, le scintille, il guscio responsivo, i controlli in 13 lingue e il loop di sopravvivenza propri di WeightPlay.", parent: "Questo gioco per browser destinato a tutti non ha account, acquisti, chat, classifica o pubblicità. Punteggio e record restano in questo browser.", faq: [["Cosa termina una partita?", "Un muro o la tua scia termina la partita."], ["Il serpente si muove da solo?", "Sì. Avanza a tempo finché non collide o torni al menu."], ["Quali controlli funzionano?", "Frecce, WASD, pulsanti direzionali e scorrimento orizzontale o verticale."], ["I progressi vengono salvati?", "Solo il record locale viene salvato in questo browser."]] },
    ru: { title: "Змейка", gameplay: "Аркада на выживание в сетке", genre: ["Классика", "Аркада", "Экшен"], skills: ["Планирование", "Реакция", "Пространственное мышление"], difficulty: "Легко начать, сложнее по мере игры", time: "1–4 минуты за раунд", intro: "«Змейка» — оригинальная аркада WeightPlay на выживание в сетке. Проводи растущую звёздную змейку, собирай искры и продолжай движение.", story: ["Маленькая звёздная змейка просыпается в ночной сетке. Каждая искра добавляет сегмент и превращает безопасный поворот в новое пространственное решение."], systems: ["Змейка автоматически движется по сетке. Еда увеличивает длину и счёт; столкновение со стеной или собственным телом завершает раунд."], how: ["Используй стрелки или WASD; на телефоне нажимай направление или делай свайп.", "Поворачивай до закрытия следующей клетки и не разворачивай текущий ход.", "Продолжай движение и собирай искры по мере роста змейки; фиксированного лимита еды нет.", "Стена или собственный след завершает забег; лучший локальный результат сохраняется после повтора."], strategyTips: ["Не гонись только за ближайшей искрой: заранее продумай два следующих поворота.", "В начале используй край поля, но оставляй место для поворота до роста змейки.", "Длинный путь безопаснее, если сохраняет свободным следующий угол.", "Когда след становится длиннее, делай короткие ясные повороты, чтобы видеть маршрут."], progression: ["Первая искра обучает управлению на сетке. Дальше след удлиняется и пространственный риск растёт, поэтому каждый безопасный поворот важнее."], designNote: "«Змейка» использует собственных звёздную змейку, ночную сетку, искры еды, адаптивную оболочку, управление на 13 языках и непрерывный цикл выживания WeightPlay.", parent: "В этой браузерной игре для широкой аудитории нет аккаунта, покупок, чата, таблицы лидеров или рекламы. Счёт и рекорд хранятся в этом браузере.", faq: [["Что завершает забег?", "Стена или собственный след завершает игру."], ["Змейка движется сама?", "Да. Она движется по таймеру, пока не столкнётся или игрок не вернётся."], ["Какие способы управления доступны?", "Стрелки, WASD, экранные кнопки направлений и горизонтальный или вертикальный свайп."], ["Сохраняется ли прогресс?", "В этом браузере сохраняется только локальный лучший результат."]] },
    hi: { title: "साँप", gameplay: "ग्रिड सर्वाइवल आर्केड", genre: ["क्लासिक", "आर्केड", "एक्शन"], skills: ["योजना", "प्रतिक्रिया", "स्थानिक समझ"], difficulty: "शुरुआत में आसान, धीरे-धीरे चुनौतीपूर्ण", time: "हर रन 1–4 मिनट", intro: "साँप WeightPlay का मौलिक ग्रिड सर्वाइवल आर्केड है। बढ़ते सितारा-साँप को चलाएँ, भोजन-चिंगारियाँ लें और चलते रहें।", story: ["एक छोटा सितारा-साँप रात की ग्रिड में जागता है। हर भोजन-चिंगारी एक खंड जोड़ती है और हर सुरक्षित मोड़ को अगला स्थानिक निर्णय बनाती है।"], systems: ["साँप ग्रिड पर अपने आप आगे बढ़ता है। भोजन उसकी लंबाई और स्कोर बढ़ाता है; दीवार या अपने शरीर से टकराने पर राउंड समाप्त होता है।"], how: ["डेस्कटॉप पर तीर या WASD, मोबाइल पर दिशा बटन या स्वाइप इस्तेमाल करें।", "अगला खाना बंद होने से पहले मोड़ें और मौजूदा दिशा को उलटें नहीं।", "साँप के बढ़ने पर भोजन-चिंगारियाँ लेते हुए चलते रहें; भोजन की कोई तय अंतिम संख्या नहीं है।", "दीवार या अपनी पूँछ से टकराने पर रन समाप्त होता है; दोबारा खेलने पर स्थानीय सर्वश्रेष्ठ स्कोर रहता है।"], strategyTips: ["सबसे पास की चिंगारी के पीछे ही न भागें; अगले दो मोड़ों की योजना बनाएँ।", "शुरुआत में किनारे का उपयोग करें और साँप बढ़ने से पहले मोड़ने की जगह छोड़ें।", "अगर अगला कोना खुला रहता है तो लंबा रास्ता अधिक सुरक्षित है।", "लंबी पूँछ के बाद छोटे और साफ दिशा-परिवर्तन से रास्ता समझ में आता रहता है।"], progression: ["पहली चिंगारी ग्रिड नियंत्रण सिखाती है। बाद की चिंगारियाँ पूँछ लंबी करती हैं और स्थानिक जोखिम बढ़ाती हैं, इसलिए हर सुरक्षित मोड़ अधिक महत्वपूर्ण होता है।"], designNote: "साँप WeightPlay के अपने सितारा-साँप, रात की ग्रिड, भोजन-चिंगारियाँ, उत्तरदायी फ्रेम, 13 भाषाओं के नियंत्रण और निरंतर सर्वाइवल लूप का उपयोग करता है।", parent: "यह सामान्य दर्शकों का ब्राउज़र गेम है; इसमें खाता, खरीद, चैट, लीडरबोर्ड या विज्ञापन नहीं हैं। स्कोर और सर्वश्रेष्ठ रिकॉर्ड इसी ब्राउज़र में रहते हैं।", faq: [["रन कैसे समाप्त होता है?", "दीवार या अपनी पूँछ से टकराने पर रन समाप्त होता है।"], ["क्या साँप अपने आप चलता है?", "हाँ। टकराने या मेनू पर लौटने तक वह समय के साथ आगे बढ़ता है।"], ["कौन से नियंत्रण काम करते हैं?", "तीर, WASD, दिशा बटन और क्षैतिज या लंबवत स्वाइप।"], ["क्या प्रगति सुरक्षित रहती है?", "इस ब्राउज़र में केवल स्थानीय सर्वश्रेष्ठ स्कोर सहेजा जाता है।"]] },
    ar: { title: "الثعبان", gameplay: "أركيد البقاء على الشبكة", genre: ["كلاسيكي", "أركيد", "حركة"], skills: ["التخطيط", "رد الفعل", "قراءة المساحة"], difficulty: "سهل البداية ويزداد تحدياً", time: "من دقيقة إلى 4 دقائق للجولة", intro: "الثعبان لعبة بقاء أصلية من WeightPlay على شبكة. قد ثعباناً نجمياً ينمو، واجمع شرارات الطعام واستمر في الحركة.", story: ["يستيقظ ثعبان نجمي صغير داخل شبكة ليلية. تضيف كل شرارة طعام جزءاً جديداً، فيصبح كل انعطاف آمن قراراً مكانياً جديداً."], systems: ["يتحرك الثعبان تلقائياً على الشبكة. يزيد الطعام طوله ونقاطه؛ وينتهي الدور عند الاصطدام بالجدار أو بجسمه."], how: ["استخدم الأسهم أو WASD؛ على الهاتف اضغط الاتجاه أو اسحب.", "انعطف قبل إغلاق الخلية التالية ولا تعكس الاتجاه الحالي.", "استمر في الحركة واجمع شرارات الطعام بينما ينمو الثعبان؛ لا توجد نهاية بعدد ثابت من الطعام.", "ينتهي اللعب عند الاصطدام بالجدار أو بالمسار الخاص؛ يبقى أفضل سجل محلياً عند الإعادة."], strategyTips: ["لا تطارد الشرارة الأقرب فقط؛ خطط للانعطافين التاليين.", "استخدم الحافة في البداية واترك مساحة للانعطاف قبل أن يطول الثعبان.", "يكون المسار الأطول أكثر أماناً إذا أبقى الزاوية التالية مفتوحة.", "بعد أن يطول المسار، استخدم تغييرات اتجاه قصيرة وواضحة لتبقى الطريق مفهومة."], progression: ["تعلّمك الشرارة الأولى التحكم على الشبكة. تطيل الشرارات التالية المسار وتزيد الخطر المكاني، لذلك يصبح كل انعطاف آمن أهم."], designNote: "يستخدم الثعبان ثعبان WeightPlay النجمي وشبكته الليلية وشرارات الطعام وإطاره المتجاوب وعناصر التحكم بثلاث عشرة لغة وحلقة البقاء المستمرة الخاصة به.", parent: "هذه لعبة متصفح عامة ولا تتضمن حساباً أو شراءً أو دردشة أو لوحة متصدرين أو إعلانات. تبقى النقاط وأفضل نتيجة في هذا المتصفح.", faq: [["ما الذي ينهي الجولة؟", "ينتهي اللعب عند الاصطدام بالجدار أو بالمسار الخاص."], ["هل يتحرك الثعبان تلقائياً؟", "نعم. يتحرك مع الوقت حتى يصطدم أو يعود اللاعب إلى القائمة."], ["ما عناصر التحكم المتاحة؟", "الأسهم وWASD وأزرار الاتجاه والسحب الأفقي أو العمودي."], ["هل يُحفظ التقدم؟", "يُحفظ أفضل سجل محلي فقط في هذا المتصفح."]] },
  };
  ...
  const alienExpansionGuideLocales = {
    "zh-Hant": { title: "星際守衛", intro: "星際守衛是 WeightPlay 原創的固定畫面波次射擊遊戲。移動、射擊並讀懂四波外星編隊，守住訊號站。", how: ["桌面用左右鍵或 A/D 移動，Space 射擊。", "手機按住左右控制並點擊射擊。", "觀察敵方隊形，在下墜攻擊出現時提早走位。", "清除四波敵人；第 4 波會以交錯接力隊形與交替隊長錨點收緊射擊節奏。"] },
    "zh-Hans": { title: "星际守卫", intro: "星际守卫是 WeightPlay 原创的固定画面波次射击游戏。移动、射击并读懂四波外星编队，守住信号站。", how: ["桌面用左右键或 A/D 移动，Space 射击。", "手机按住左右控制并点击射击。", "观察敌方队形，在下坠攻击出现时提前走位。", "清除四波敌人；第 4 波会以交错接力队形和交替队长锚点收紧射击节奏。"] },
    ja: { title: "エイリアン・ディフェンダー", intro: "エイリアン・ディフェンダーはWeightPlayオリジナルの固定画面ウェーブシューティングです。4つの編隊から基地を守ります。", how: ["左右キーまたはA/Dで動き、Spaceで撃ちます。", "モバイルでは左右を押してFireをタップします。", "編隊と落下弾を読み、早めに移動します。", "4ウェーブを全て倒します。4ウェーブは交互の隊長を含むリレー編隊で射撃のリズムが締まります。"] },
    ko: { title: "에일리언 디펜더", intro: "에일리언 디펜더는 WeightPlay 오리지널 고정 화면 웨이브 슈터입니다. 네 외계인 대형에서 기지를 지키세요.", how: ["방향키나 A/D로 이동하고 Space로 발사합니다.", "모바일에서는 좌우를 누른 뒤 Fire를 탭합니다.", "대형과 낙하 탄환을 읽고 일찍 움직입니다.", "네 웨이브를 모두 처치하세요. 4웨이브는 교차 릴레이 대형과 번갈아 배치된 대장으로 더 촘촘해집니다."] },
    es: { title: "Defensor Alienígena", intro: "Defensor Alienígena es un shooter de oleadas original de WeightPlay. Muévete y dispara para proteger la estación durante cuatro oleadas.", how: ["Usa izquierda/derecha o A/D y Espacio para disparar.", "En móvil, mantén izquierda o derecha y toca Disparar.", "Lee la formación y muévete antes de los disparos descendentes.", "Despeja cuatro oleadas; la cuarta usa una formación de relevo escalonada con capitanes alternos."] },
    "pt-BR": { title: "Defensor Alienígena", intro: "Defensor Alienígena é um shooter de ondas original do WeightPlay. Mova-se e atire para proteger a estação durante quatro ondas.", how: ["Use esquerda/direita ou A/D e Espaço para atirar.", "No celular, segure esquerda ou direita e toque em Atirar.", "Leia a formação e mova-se antes dos disparos.", "Elimine quatro ondas; a quarta usa uma formação de revezamento escalonada com capitães alternados."] },
    fr: { title: "Défenseur Alien", intro: "Défenseur Alien est un shooter de vagues original de WeightPlay. Bouge et tire pour protéger la station pendant quatre vagues.", how: ["Utilise gauche/droite ou A/D et Espace pour tirer.", "Sur mobile, maintiens gauche ou droite puis touche Tirer.", "Lis la formation et bouge avant les tirs descendants.", "Élimine quatre vagues ; la quatrième utilise une formation relais décalée avec des capitaines alternés."] },
    de: { title: "Alien-Verteidiger", intro: "Alien-Verteidiger ist ein originaler Wellen-Shooter von WeightPlay. Bewege dich und schieße, um die Station durch vier Wellen zu schützen.", how: ["Nutze links/rechts oder A/D und die Leertaste zum Schießen.", "Mobil hältst du links oder rechts und tippst Feuer.", "Lies die Formation und bewege dich vor fallenden Schüssen.", "Räume vier Wellen; die vierte nutzt eine versetzte Relaisformation mit wechselnden Kapitänen."] },
    it: { title: "Difensore Alieno", intro: "Difensore Alieno è uno shooter a ondate originale WeightPlay. Muoviti e spara per proteggere la stazione per quattro ondate.", how: ["Usa sinistra/destra o A/D e Spazio per sparare.", "Su mobile tieni sinistra o destra e tocca Fuoco.", "Leggi la formazione e muoviti prima dei colpi discendenti.", "Elimina quattro ondate; la quarta usa una formazione a staffetta sfalsata con capitani alternati."] },
    ru: { title: "Защитник от пришельцев", intro: "«Защитник от пришельцев» — оригинальная аркада WeightPlay с четырьмя волнами. Двигайся и стреляй, защищая станцию.", how: ["Используй влево/вправо или A/D и пробел для стрельбы.", "На телефоне удерживай влево или вправо и нажимай огонь.", "Читай строй и двигайся до появления падающих снарядов.", "Уничтожь четыре волны; четвёртая вводит шахматный релейный строй с чередующимися капитанами."] },
    hi: { title: "एलियन रक्षक", intro: "एलियन रक्षक WeightPlay का मौलिक लहर शूटर है। चार लहरों में चलें और गोली चलाकर सिग्नल स्टेशन बचाएँ।", how: ["बाएँ/दाएँ या A/D से चलें और Space से गोली चलाएँ।", "मोबाइल पर बाएँ या दाएँ दबाकर Fire दबाएँ।", "गठन पढ़ें और गिरती गोलियों से पहले चलें।", "चार लहरें साफ़ करें; चौथी लहर बारी-बारी कप्तानों वाले तिरछे रिले गठन से दबाव बढ़ाती है।"] },
  ...
  snakeGuideLocales.de.title = "Schlange";
  snakeGuideLocales.de.intro = snakeGuideLocales.de.intro.replace(/^Snake\b/u, "Schlange");
  for (const [code, entry] of Object.entries(snakeGuideLocales)) {
    arcadeGuideLocales[code] ||= {};
    arcadeGuideLocales[code].snake = entry;
  }
  for (const [code, entry] of Object.entries(snakeContinuousCopy)) {
    arcadeGuideLocales[code] ||= {};
    arcadeGuideLocales[code].snake = entry;
  }
