(function () {
  ...
  Object.assign(localizedGames["zh-Hant"]["animal-one-line"], {
    ...
    systems: ["有效路線必須從發光腳印開始，每一步只能進入共享邊線的空格，不能斜走或跳格。", "重複走進已上色格、提早放開，或在仍有空格時走入死路，都會重設本次嘗試。", "提示會標出其中一種解法的下一格；重新開始與提示都不消耗資源。", "解鎖、星級、完成紀錄與最佳時間只儲存在目前瀏覽器。"],
  ...
  Object.assign(localizedGames["zh-Hans"]["animal-one-line"], {
    ...
    systems: ["有效路线必须从发光脚印开始，每一步只能进入共享边线的空格，不能斜走或跳格。", "重复走进已上色格、提前放开，或在仍有空格时走入死路，都会重置本次尝试。", "提示会标出其中一种解法的下一格；重新开始与提示都不消耗资源。", "解锁、星级、完成记录与最佳时间只储存在当前浏览器。"],
