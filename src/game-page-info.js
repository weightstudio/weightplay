(function () {
  ...
  const localizedGameplayProfiles = {
    "zh-Hant": {
      ...
      "beast-tactician": { gameplay: "\u56de\u5408\u5236\u5c0f\u968a RPG", genre: ["\u6230\u8853", "RPG", "\u52d5\u7269"] },
  ...
  localizedGames["zh-Hant"]["beast-tactician"] = {
    ...
    genre: ["戰術", "RPG", "動物"],
    skills: ["邏輯", "解題能力", "專注"],
    intro: "獸王牌組是一款 13+ 回合制動物小隊 RPG。玩家帶領守護熊、烈焰虎與自然鹿進入遺跡房間，管理行動順序、施放技能、收集武器與護甲，最後挑戰巨獸首領。",
    how: ["選擇目前行動英雄下方的技能卡。", "依技能類型點擊敵人或隊友，完成攻擊、嘲諷、治療或延後行動。", "清空房間後領取裝備，並選擇一個遺物強化小隊。", "通過第 3 房間並擊敗巨獸首領即可完成遠征。"],
    strategyTips: ["守護熊適合先用鐵壁防禦吸收傷害，保護虎與鹿。", "烈焰虎可以先使用狂熱，再接暗影斬打出爆發傷害。", "自然鹿負責治療與延後敵人行動，能讓隊伍撐過危險回合。", "迷霧護符是可選永久升級，會讓每次開局更穩定。"],
    parent: "這款遊戲讓青少年練習回合規劃、資源管理、目標排序與團隊配合。所有進度都存在本機，不收集兒童個人資料，也不是正式能力測驗。",
    faq: [["獸王牌組是免費遊戲嗎？", "是。WeightPlay 的瀏覽器遊戲都可以免費遊玩。"], ["行動順序怎麼決定？", "角色會依速度排序，時間軸中較前面的角色會先行動。"], ["鑽石升級會強迫購買嗎？", "不會。迷霧護符只是可選的永久升級，遊戲本身仍可正常遊玩。"]],
  };
