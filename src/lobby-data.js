...
].map(([id, title, type, description, meta]) => ({ id, title: classicLogicText(title), status: "planned", statusText: classicLogicStatusText, type: classicLogicText(type), categories: ["Classic", "Puzzle", "Strategy", "Family"], skills: ["Logic", "Planning", "Focus"], ages: ["9", "family"], ageLabel: classicLogicText(["9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+"]), href: `games/${id}/`, internalTrial: "index.html?trial=1", description: classicLogicText(description), meta: classicLogicMeta(meta), art: { kind: "image", background: id === "cat-color-sudoku" ? "assets/cat-color-sudoku-cover-v1.webp" : "assets/classic-logic-lab-cover.webp", hideHero: true } }));
