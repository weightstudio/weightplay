...
].map(([id, title, type, description, meta]) => ({ id, title: classicLogicText(title), status: "planned", statusText: classicLogicStatusText, type: classicLogicText(type), categories: ["Classic", "Puzzle", "Strategy", "Family"], skills: ["Logic", "Planning", "Focus"], ages: ["9", "family"], ageLabel: classicLogicText(["9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+"]), href: `games/${id}/`, internalTrial: "index.html?trial=1", description: classicLogicText(description), meta: classicLogicMeta(meta), art: { kind: "image", background: id === "cat-color-sudoku" ? "assets/cat-color-sudoku-cover-v1.png" : "assets/classic-logic-lab-cover.webp", hideHero: true } }));
...
const nextFiveGeneralCandidates = [
  ...
  },
  {
    ...
    description: { en: "Swipe a crystal canister, rotate it in the air, and land upright on the next workshop surface.", "zh-Hant": "滑動晶體罐讓它在空中旋轉，並直立落在下一個工坊表面。", "zh-Hans": "滑动晶体罐让它在空中旋转，并直立落在下一个工坊表面。", ja: "クリスタル容器をスワイプし、空中で回転させ、次の工房面に立てて着地させよう。", ko: "크리스털 용기를 스와이프해 공중에서 회전시키고 다음 작업대에 똑바로 착지하세요.", es: "Desliza el recipiente de cristal, hazlo girar y aterrízalo de pie en la siguiente superficie.", "pt-BR": "Deslize o recipiente de cristal, gire-o no ar e pouse em pé na próxima superfície.", fr: "Fais glisser le réservoir de cristal, fais-le tourner et pose-le debout sur la prochaine surface.", de: "Wische den Kristallbehälter, drehe ihn in der Luft und lande aufrecht auf der nächsten Werkfläche.", it: "Scorri il contenitore di cristallo, fallo ruotare in aria e fallo atterrare in piedi sulla superficie successiva.", ru: "Проведите по кристальному контейнеру, вращайте его и посадите вертикально на следующую поверхность.", hi: "क्रिस्टल कनस्तर पर स्वाइप करें, उसे हवा में घुमाएँ और अगली सतह पर सीधा उतारें।", ar: "مرر على الحاوية البلورية ودورها في الهواء وأنزلها واقفة على سطح الورشة التالي." },
...
const marketFiveCandidates = [
  {
    ...
    categories: ["Sports", "Arcade", "Animal"], skills: ["Timing", "Aim"], art: { kind: "image", background: "games/animal-hoop-league/assets/animal-hoop-league-cover.png", hideHero: true }, href: "games/animal-hoop-league/", internalTrial: "index.html?trial=1",
  },
  {
    ...
    categories: ["Puzzle", "Geography", "Animal"], skills: ["Deduction", "Observation"], art: { kind: "image", background: "games/animal-habitat-atlas/assets/animal-habitat-atlas-cover.png", hideHero: true }, href: "games/animal-habitat-atlas/", internalTrial: "index.html?trial=1",
  },
  {
    ...
    categories: ["Puzzle", "Escape", "Animal"], skills: ["Route Planning", "Logic"], art: { kind: "image", background: "games/animal-moonlight-workshop/assets/animal-moonlight-workshop-cover.png", hideHero: true }, href: "games/animal-moonlight-workshop/", internalTrial: "index.html?trial=1",
  },
  {
    ...
    categories: ["Puzzle", "Memory", "Animal"], skills: ["Visual Memory", "Focus"], art: { kind: "image", background: "games/animal-chameleon-blend/assets/animal-chameleon-blend-cover.png", hideHero: true }, href: "games/animal-chameleon-blend/", internalTrial: "index.html?trial=1",
  },
  {
    ...
    categories: ["Strategy", "Builder", "Animal"], skills: ["Planning", "Resource Balance"], art: { kind: "image", background: "games/animal-habitat-builder/assets/animal-habitat-builder-cover.png", hideHero: true }, href: "games/animal-habitat-builder/", internalTrial: "index.html?trial=1",
  },
];
