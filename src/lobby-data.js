window.WONDER_LOBBY = {
  ...
  games: [
    ...
    },
    {
      ...
      categories: ["Animal Games", "Puzzle", "Strategy"], skills: ["Logic", "Planning"], ages: ["9", "family"],
      href: "games/animal-number-match/", internalTrial: "index.html?trial=1",
      description: {
        en: "Clear equal numbers or pairs that add to ten, opening sight lines across 30 calm groves.",
        "zh-Hant": "消除相同或相加等於 10 的數字，在 30 座悠閒花園中打開配對視線。",
        "zh-Hans": "消除相同或相加等于 10 的数字，在 30 座悠闲花园中打开配对视线。",
        ja: "同じ数字か合計10のペアを消し、30の森で見通しを開こう。",
        ko: "같은 숫자나 합이 10인 짝을 지워 30개 숲의 길을 여세요.",
        es: "Elimina números iguales o que sumen diez en 30 bosques tranquilos.",
        "pt-BR": "Elimine números iguais ou que somem dez em 30 bosques tranquilos.",
        fr: "Effacez les nombres identiques ou dont la somme vaut dix dans 30 bosquets.",
        de: "Entferne gleiche Zahlen oder Paare mit Summe zehn in 30 ruhigen Hainen.",
        it: "Elimina numeri uguali o con somma dieci in 30 boschetti rilassanti.",
        ru: "Убирайте одинаковые числа или пары с суммой десять в 30 спокойных рощах.",
        hi: "30 शांत उपवनों में समान या जोड़ दस वाले नंबर हटाएँ।",
        ar: "أزل الأرقام المتساوية أو التي مجموعها عشرة عبر 30 بستانًا هادئًا.",
      },
      meta: {
        en: ["30 Groves", "Same or Sum 10", "Untimed"], "zh-Hant": ["30 座花園", "相同或湊 10", "沒有計時"],
        "zh-Hans": ["30 座花园", "相同或凑 10", "没有计时"], ja: ["30の森", "同じか合計10", "時間制限なし"],
        ko: ["30개 숲", "같거나 합 10", "시간 제한 없음"], es: ["30 bosques", "Iguales o suman 10", "Sin tiempo"],
        "pt-BR": ["30 bosques", "Iguais ou soma 10", "Sem tempo"], fr: ["30 bosquets", "Égaux ou somme 10", "Sans chrono"],
        de: ["30 Haine", "Gleich oder Summe 10", "Ohne Zeitdruck"], it: ["30 boschetti", "Uguali o somma 10", "Senza tempo"],
