window.WONDER_LOBBY = {
  ...
  games: [
    {"id":"fusekeep","audience":"general","status":"planned","internalOnly":true,"internalTrial":"index.html?preview=1","title":{"en":"Fusekeep","zh-Hant":"合成守城","zh-Hans":"合成守城","ja":"合成の砦","ko":"합성 요새","es":"Fortaleza Fusión","pt-BR":"Fortaleza da Fusão","fr":"Forteresse Fusion","de":"Fusionsfestung","it":"Fortezza Fusione","ru":"Крепость слияния","hi":"विलय दुर्ग","ar":"حصن الدمج","__localizedExact":true},"type":{"en":"Merge Defense","zh-Hant":"合成防守"},"description":{"__localizedExact":true,"en":"Merge same-rank animal soldiers into random equipped troops and defend a winter wall through 30 missions of 15 waves.","zh-Hant":"拖曳同級動物士兵，隨機合成出戰兵種，配置五種陣容，挑戰 30 關、每關 15 波的冰雪守城戰。","zh-Hans":"拖动同级动物士兵，随机合成出战兵种，配置五种阵容，挑战 30 关、每关 15 波的冰雪守城战。","ja":"同ランクの動物兵士をランダム合成。5種類の部隊を組み、各15ウェーブの30ステージで冬の城壁を守ろう。","ko":"같은 등급의 동물 병사를 무작위 출전 병종으로 합성하세요. 다섯 병종을 꾸려 15공세씩 30스테이지의 겨울 성벽을 지킵니다.","es":"Fusiona soldados animales del mismo rango en tropas equipadas aleatorias y defiende una muralla invernal en 30 misiones de 15 oleadas.","pt-BR":"Funda soldados animais do mesmo nível em tropas equipadas aleatórias e defenda uma muralha de inverno em 30 missões de 15 ondas.","fr":"Fusionnez des soldats animaux de même rang en types équipés aléatoires et défendez un rempart d’hiver dans 30 missions de 15 vagues.","de":"Verschmelze Tiersoldaten gleichen Rangs zu zufälligen ausgerüsteten Typen und verteidige die Wintermauer in 30 Missionen mit je 15 Wellen.","it":"Fondi soldati animali dello stesso rango in tipi equipaggiati casuali e difendi le mura invernali in 30 missioni da 15 ondate.","ru":"Сливайте звериных бойцов одного ранга в случайные выбранные типы и защищайте зимнюю стену в 30 миссиях по 15 волн.","hi":"समान रैंक के पशु सैनिकों को चुने दल के अनियमित प्रकार में मिलाएँ और 15 लहरों वाले 30 मिशनों में शीत दीवार बचाएँ।","ar":"ادمج جنود الحيوانات من الرتبة نفسها في أنواع عشوائية من فريقك، ودافع عن سور الشتاء عبر 30 مهمة من 15 موجة."},"categories":["Strategy","Animal Games"],"skills":["Planning","Timing"],"ages":["general"],"href":"games/fusekeep/","meta":{"en":["30 Stages","Merge & Defend"],"zh-Hant":["30 關","合成守城"]},"art":{"kind":"image","background":"assets/fusekeep/poster.webp","hideHero":true}},
    {
