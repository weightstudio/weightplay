...
window.WONDER_LOBBY.games.push({
  id:"animal-penalty-cup",audience:"general",status:"planned",href:"games/animal-penalty-cup/",internalTrial:"index.html?trial=1",categories:["Featured","Animal Games","Sports","Family"],skills:["Timing","Reaction","Pattern Reading"],ages:["9","family"],ageLabel:{en:"9+","zh-Hant":"9+","zh-Hans":"9+",ja:"9+",ko:"9+",es:"9+","pt-BR":"9+",fr:"9+",de:"9+",it:"9+",ru:"9+",hi:"9+",ar:"9+"},art:{kind:"image",background:"games/animal-penalty-cup/assets/animal-penalty-cup-cover-v1.webp",hideHero:true},
