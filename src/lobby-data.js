  ...
  games: [
    {
      ...
      description: {"en":"Guide a red panda ranger through 30 forest missions: gather timber, rescue friends and face six guardians.","zh-Hant":"帶領小熊貓巡林員挑戰 30 項森林任務：採集木材、救援夥伴，迎戰六位守衛。","zh-Hans":"带领小熊猫巡林员挑战 30 项森林任务：采集木材、救援伙伴，迎战六位守卫。","ja":"レッサーパンダの森の番人と30の任務へ。木材を集め、仲間を救い、6体の守護者に挑もう。","ko":"레서판다 순찰대원과 30개의 숲 임무에 도전하세요. 목재를 모으고 친구를 구하며 여섯 수호자와 맞서세요.","es":"Guía a un panda rojo por 30 misiones del bosque: reúne madera, rescata amigos y enfrenta a seis guardianes.","pt-BR":"Guie um panda-vermelho por 30 missões na floresta: reúna madeira, resgate amigos e enfrente seis guardiões.","fr":"Guidez un panda roux dans 30 missions en forêt : récoltez du bois, sauvez vos amis et affrontez six gardiens.","de":"Führe einen Roten Panda durch 30 Waldmissionen: Sammle Holz, rette Freunde und stelle dich sechs Wächtern.","it":"Guida un panda rosso in 30 missioni nella foresta: raccogli legna, salva gli amici e affronta sei guardiani.","ru":"Пройдите с малой пандой 30 лесных заданий: собирайте древесину, спасайте друзей и сразитесь с шестью стражами.","hi":"लाल पांडा वनरक्षक के साथ 30 वन मिशन पूरे करें: लकड़ी जुटाएँ, मित्रों को बचाएँ और छह रक्षकों का सामना करें।","ar":"قد رينجر الباندا الأحمر في 30 مهمة غابية: اجمع الخشب وأنقذ الأصدقاء وواجه ستة حراس."},
