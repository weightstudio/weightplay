window.WONDER_LOBBY = {
  ...
  games: [
    ...
    },
    {
      ...
      description: {
        en: "Read monster intent, hold one of three rune reels, and chain animal attacks, guards, hexes, Focus, and Mimi's rabbit healing across 30 crafted battles.",
        "zh-Hant": "觀察怪物意圖、保留三軸中的一軸，並在 30 場設計戰鬥中連鎖動物攻擊、防守、咒術、專注與咪咪的兔子治療。",
        "zh-Hans": "观察怪物意图、保留三轴中的一轴，并在 30 场设计战斗中连锁动物攻击、防守、咒术、专注与咪咪的兔子治疗。",
        ja: "怪物の予告を読み、3リールから1つを保持し、30の戦闘で攻撃、防御、弱体、集中、ミミの回復を連鎖しよう。",
        ko: "괴물의 의도를 읽고 세 룬 릴 중 하나를 고정해 30개 전투에서 공격, 방어, 약화, 집중, 미미의 치유를 연계하세요.",
        es: "Lee la intención del monstruo, conserva uno de tres rodillos y encadena ataques, defensas, maldiciones, concentración y la cura de Mimi en 30 batallas.",
        "pt-BR": "Leia a intenção do monstro, segure um dos três carretéis e encadeie ataques, defesas, feitiços, Foco e a cura da Mimi em 30 batalhas.",
        fr: "Lisez l'intention du monstre, gardez un des trois rouleaux et enchaînez attaques, gardes, maléfices, Concentration et soins de Mimi dans 30 combats.",
        de: "Lies die Monsterabsicht, halte eine von drei Walzen und verknüpfe Angriffe, Schutz, Flüche, Fokus und Mimis Heilung in 30 Kämpfen.",
        it: "Leggi l'intento del mostro, conserva uno dei tre rulli e concatena attacchi, difese, malefici, concentrazione e cure di Mimi in 30 battaglie.",
        ru: "Читайте намерение монстра, удерживайте один из трёх барабанов и соединяйте атаки, защиту, чары, фокус и лечение Мими в 30 боях.",
        hi: "राक्षस की चाल पढ़ें, तीन में से एक रील रोकें और 30 युद्धों में हमले, रक्षा, मंत्र, फोकस तथा मिमी के उपचार की शृंखला बनाएँ।",
        ar: "راقب نية الوحش، وثبّت بكرة من ثلاث، واربط الهجمات والدفاع والتعاويذ والتركيز وشفاء ميمي عبر 30 معركة.",
      },
      meta: {
        en: ["30 Battles", "Hold One Reel", "Rabbit Healing"], "zh-Hant": ["30 場戰鬥", "保留一軸", "兔子治療"],
        "zh-Hans": ["30 场战斗", "保留一轴", "兔子治疗"], ja: ["30戦", "1リール保持", "ウサギ回復"],
        ko: ["30개 전투", "릴 하나 고정", "토끼 치유"], es: ["30 batallas", "Conserva un rodillo", "Cura de conejo"],
        "pt-BR": ["30 batalhas", "Segure um carretel", "Cura do coelho"], fr: ["30 combats", "Gardez un rouleau", "Soin du lapin"],
        de: ["30 Kämpfe", "Eine Walze halten", "Hasenheilung"], it: ["30 battaglie", "Conserva un rullo", "Cura del coniglio"],
        ru: ["30 боёв", "Удержание барабана", "Лечение кроликом"], hi: ["30 युद्ध", "एक रील रोकें", "खरगोश उपचार"],
        ar: ["30 معركة", "تثبيت بكرة", "شفاء الأرنب"],
      },
