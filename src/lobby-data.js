...
if (tetrisPublic) {
  Object.assign(tetrisPublic, {
    ...
    searchAliases: [
      "tetromino", "tetromino puzzle", "line clear", "clear lines", "falling blocks", "falling block game", "falling block puzzle", "falling tetromino", "block stacking", "stacking blocks",
      "方塊堆疊", "消行", "消除整行", "落下方塊",
      "方块堆叠", "消行", "消除整行", "下落方块",
