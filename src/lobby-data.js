...
// Owner-preview batch: these ten classic rulesets are playable only through
...
].map(([id, title, type, description, meta]) => ({ id, title: classicLogicText(title), status: "planned", statusText: classicLogicStatusText, type: classicLogicText(type), categories: ["Classic", "Puzzle", "Strategy", "Family"], skills: ["Logic", "Planning", "Focus"], ages: ["9", "family"], ageLabel: classicLogicText(["9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+", "9+"]), href: `games/${id}/`, internalTrial: "index.html?trial=1", description: classicLogicText(description), meta: classicLogicMeta(meta), art: { kind: "image", background: "assets/classic-logic-lab-cover.webp", hideHero: true } }));
...
// Next-five Mode 2 candidates remain noindex/internal until every Tester,
// Gameplay Reviewer, Director, and Release Preflight gate is complete.
const nextFiveGeneralCandidates = [
  {
    ...
    art: { kind: "image", background: "games/animal-trap-trail/assets/animal-trap-trail-cover.png", hideHero: true },
  ...
  },
  {
    ...
    art: { kind: "image", background: "games/animal-canopy-cut/assets/animal-canopy-cut-cover.png", hideHero: true },
  ...
  },
  {
    ...
    art: { kind: "image", background: "games/animal-bounce-brawl/assets/animal-bounce-brawl-cover.png", hideHero: true },
  ...
  },
  {
    ...
    art: { kind: "image", background: "games/animal-frost-maze/assets/animal-frost-maze-cover.png", hideHero: true },
  ...
  },
  {
    ...
    art: { kind: "image", background: "games/animal-flip-foundry/assets/animal-flip-foundry-cover.png", hideHero: true },
...
for (const candidate of nextFiveGeneralCandidates) {
  if (!window.WONDER_LOBBY.games.some((game) => game.id === candidate.id)) window.WONDER_LOBBY.games.push({ ...candidate, status: "planned", statusText: { en: "Coming Soon", "zh-Hant": "敬請期待", "zh-Hans": "敬请期待", ja: "近日公開", ko: "출시 예정", es: "Próximamente", "pt-BR": "Em breve", fr: "Bientôt disponible", de: "Demnächst", it: "Prossimamente", ru: "Скоро", hi: "जल्द आ रहा है", ar: "قريبًا" } });
