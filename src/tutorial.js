(() => {
  ...
  const tutorials = {
    ...
    "wonder-crash": {
      ...
      steps: [
        {"icon":"★","en":["Drag to move","Drag to move · automatic fire and passive skills · no skill buttons"],"zh-Hant":["拖曳移動","拖曳移動・自動射擊與被動技能・不需按技能"],"zh-Hans":["拖动移动","拖动移动・自动射击与被动技能・无需技能按钮"],"ja":["ドラッグで移動","ドラッグで移動・自動射撃と自動スキル・スキルボタンなし"],"ko":["드래그 이동","드래그 이동 · 자동 사격과 패시브 스킬 · 스킬 버튼 없음"],"es":["Arrastra para moverte","Arrastra para moverte · disparos y habilidades automáticos"],"pt-BR":["Arraste para mover","Arraste para mover · tiros e habilidades automáticos"],"fr":["Glissez pour bouger","Glissez pour bouger · tirs et compétences automatiques"],"de":["Ziehen zum Bewegen","Ziehen zum Bewegen · automatische Schüsse und passive Fähigkeiten"],"it":["Trascina per muoverti","Trascina per muoverti · colpi e abilità automatici"],"ru":["Тяните для движения","Тяните для движения · автоогонь и пассивные навыки"],"hi":["खींचकर चलें","खींचकर चलें · स्वतः गोलीबारी और निष्क्रिय कौशल"],"ar":["اسحب للتحرك","اسحب للتحرك · إطلاق ومهارات تلقائية"]},
    ...
    "pawaxe": {
      title: {
        en: "Your forest expedition",
        "zh-Hant": "森林探險指南",
        "zh-Hans": "森林探险指南",
        ja: "森の冒険ガイド",
        ko: "숲 탐험 안내",
        es: "Tu expedición por el bosque",
        "pt-BR": "Sua expedição pela floresta",
        fr: "Votre expédition en forêt",
        de: "Deine Waldexpedition",
        it: "La tua spedizione nella foresta",
        ru: "Путешествие по лесу",
        hi: "आपका जंगल अभियान",
        ar: "رحلتك الاستكشافية في الغابة",
      },
      steps: [
        {
          icon: "1",
          en: ["Reach the end", "Clear waves to move forward. Fill the route meter to reach the finish."],
          "zh-Hant": ["走到路線終點", "清除每一波敵人就會往前走，填滿進度條即可抵達終點。"],
          "zh-Hans": ["走到路线终点", "清除每一波敌人就会前进，填满进度条即可抵达终点。"],
          ja: ["ゴールを目指そう", "敵の波を倒すと前進します。進行バーを満たしてゴールへ進みましょう。"],
          ko: ["목표 지점에 도착하세요", "적의 웨이브를 처치하면 앞으로 나아갑니다. 진행도를 채워 결승점에 도달하세요."],
          es: ["Llega al final", "Avanza al derrotar cada oleada. Llena la barra de ruta para alcanzar la meta."],
          "pt-BR": ["Chegue ao fim", "Avance ao derrotar cada onda. Encha a barra da rota para alcançar o destino."],
          fr: ["Atteignez la fin", "Avancez en éliminant chaque vague. Remplissez la barre du parcours pour arriver au bout."],
          de: ["Erreiche das Ziel", "Besiege jede Welle, um weiterzugehen. Fülle die Routenleiste bis zum Ziel."],
          it: ["Raggiungi la fine", "Avanzi sconfiggendo ogni ondata. Riempi la barra del percorso per arrivare al traguardo."],
          ru: ["Дойдите до конца", "Побеждайте волны врагов, чтобы идти дальше. Заполните шкалу маршрута."],
          hi: ["अंत तक पहुँचें", "हर लहर को हराकर आगे बढ़ें। मंज़िल तक पहुँचने के लिए मार्ग पट्टी भरें।"],
          ar: ["صل إلى النهاية", "تقدّم بعد هزيمة كل موجة. املأ شريط المسار للوصول إلى النهاية."],
        },
        {
          icon: "2",
          en: ["Tap to swing", "Tap the battlefield or Slash. Auto attacks for you; call your ally when ready."],
          "zh-Hant": ["點擊就能揮斧", "點戰場或揮斧按鈕即可攻擊。開啟自動戰鬥，準備好時召喚夥伴。"],
          "zh-Hans": ["点击即可挥斧", "点击战场或挥斧按钮即可攻击。开启自动战斗，准备好时召唤伙伴。"],
          ja: ["タップで攻撃", "戦場か攻撃ボタンをタップ。自動攻撃を使い、準備ができたら仲間を呼びましょう。"],
          ko: ["눌러서 도끼질", "전장이나 공격 버튼을 누르세요. 자동 전투를 켜고 준비되면 동료를 부르세요."],
          es: ["Toca para atacar", "Toca el campo o Cortar. Auto ataca por ti; llama a tu aliado cuando esté listo."],
          "pt-BR": ["Toque para atacar", "Toque no campo ou em Golpear. O Auto ataca por você; chame seu aliado quando estiver pronto."],
          fr: ["Touchez pour frapper", "Touchez le terrain ou Frapper. Auto attaque pour vous ; appelez votre allié quand il est prêt."],
          de: ["Tippe zum Angriff", "Tippe aufs Feld oder auf Schlagen. Auto kämpft für dich; rufe deinen Begleiter, wenn er bereit ist."],
          it: ["Tocca per colpire", "Tocca il campo o Colpisci. Auto attacca per te; chiama il tuo alleato quando è pronto."],
          ru: ["Нажмите для удара", "Нажимайте на поле или кнопку удара. Авто атакует за вас; зовите союзника, когда он готов."],
          hi: ["दबाकर वार करें", "मैदान या वार बटन दबाएँ। ऑटो आपके लिए हमला करता है; तैयार होने पर साथी को बुलाएँ।"],
          ar: ["اضغط للهجوم", "اضغط ساحة القتال أو زر الهجوم. يقاتل الوضع التلقائي عنك؛ استدعِ رفيقك عند استعداده."],
        },
        {
          icon: "3",
          en: ["Clear or keep hunting", "At 100%, tap the checkmark to settle or keep fighting for drops. Defeat ends the run."],
          "zh-Hant": ["通關或繼續刷怪", "進度到 100% 後，點勾勾結算，也能繼續打怪拿掉落。生命耗盡就會結束本次探險。"],
          "zh-Hans": ["通关或继续刷怪", "进度到 100% 后，点击勾号结算，也能继续打怪拿掉落。生命耗尽就会结束本次探险。"],
          ja: ["クリアするか狩り続ける", "100%でチェック印を押すと結果を表示。続けて戦えばドロップを狙えます。倒されると冒険終了です。"],
          ko: ["완료하거나 계속 사냥하세요", "100%에서 체크 표시를 누르면 결과가 나옵니다. 계속 싸우면 전리품을 얻을 수 있고, 쓰러지면 탐험이 끝납니다."],
          es: ["Cobra o sigue cazando", "Al 100 %, toca la marca para cobrar o sigue luchando por botín. Si caes, termina la expedición."],
          "pt-BR": ["Conclua ou continue caçando", "Em 100%, toque na marca para concluir ou continue lutando por saques. Se for derrotado, a expedição termina."],
          fr: ["Terminez ou continuez la chasse", "À 100 %, touchez la coche pour conclure ou continuez à combattre. Une défaite termine l’expédition."],
          de: ["Schließe ab oder jage weiter", "Tippe bei 100 % auf das Häkchen oder kämpfe weiter um Beute. Bei einer Niederlage endet der Lauf."],
          it: ["Riscuoti o continua la caccia", "Al 100% tocca la spunta per concludere o continua a lottare per il bottino. Una sconfitta termina il viaggio."],
          ru: ["Завершите или продолжайте охоту", "При 100% нажмите галочку для итога или продолжайте сражаться за добычу. Поражение завершит поход."],
          hi: ["पूरा करें या शिकार जारी रखें", "100% पर परिणाम के लिए निशान दबाएँ या लूट के लिए लड़ते रहें। हारने पर अभियान समाप्त होगा।"],
          ar: ["أنه الرحلة أو واصل الصيد", "عند 100% اضغط علامة الإكمال لعرض النتيجة أو واصل القتال لجمع الغنائم. تنتهي الرحلة عند الهزيمة."],
        },
      ],
    },
    "animal-layer-grove": {
