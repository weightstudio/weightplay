(() => {
  ...
  const tutorials = {
    ...
    "wonder-crash": {
      ...
      steps: [
        { icon: "★", en: ["Lion roar", "Press Roar or Space to push nearby attackers back. Recharge: 8 seconds; Bosses resist knockback."], "zh-Hant": ["獅吼擊退", "按獅吼或空白鍵，擊退附近進攻者。冷卻 8 秒；首領較難擊退。"], "zh-Hans": ["狮吼击退", "按狮吼或空格键，击退附近进攻者。冷却 8 秒；首领较难击退。"], ja: ["獅子の咆哮", "咆哮ボタンかスペースで近くの敵を押し戻します。再使用は8秒後。ボスには効果が弱まります。"], ko: ["사자 포효", "포효 버튼 또는 스페이스로 가까운 적을 밀어내세요. 재사용 8초. 보스는 덜 밀려납니다."], es: ["Rugido", "Pulsa Rugido o Espacio para repeler enemigos cercanos. Recarga: 8 segundos. Los jefes resisten más."], "pt-BR": ["Rugido", "Use Rugido ou Espaço para repelir inimigos próximos. Recarga: 8 segundos. Chefes resistem mais."], fr: ["Rugissement", "Rugissement ou Espace repousse les ennemis proches. Recharge : 8 secondes. Les boss résistent davantage."], de: ["Löwenbrüllen", "Brüllen oder Leertaste stößt nahe Gegner zurück. Abklingzeit: 8 Sekunden. Bosse widerstehen stärker."], it: ["Ruggito", "Premi Ruggito o Spazio per respingere i nemici vicini. Ricarica: 8 secondi. I boss resistono di più."], ru: ["Рёв льва", "Кнопка рёва или пробел отталкивает ближайших врагов. Перезарядка: 8 секунд. Боссы устойчивее."], hi: ["शेर की दहाड़", "दहाड़ या स्पेस दबाकर पास के दुश्मनों को पीछे धकेलें। दोबारा उपयोग: 8 सेकंड बाद। बॉस कम पीछे हटते हैं।"], ar: ["زئير الأسد", "اضغط الزئير أو المسافة لدفع المهاجمين القريبين. إعادة الشحن: 8 ثوانٍ. يقاوم الزعماء الدفع أكثر."] },
