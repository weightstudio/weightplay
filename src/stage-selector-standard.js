(function () {
  ...
  const nativeStageScalers = new Set(["wonder-crash", "campus-dash", "color-lunchbox", "animal-rope-rescue", "animal-coloring-studio", "animal-bubble-safari", "animal-rift-salvage", "animal-rune-reels", "animal-triple-match", "garden-tiles"]);
  ...
  function updateStageCanvas() {
    ...
    if (reserve) {
      ...
      const reserveDeclarations = {
        ...
        width: `${renderedWidth}px`, "min-width": "0", "max-width": `${DESKTOP_CANVAS_MAX_WIDTH}px`, height: `${reserveHeight}px`, "min-height": `${reserveHeight}px`, transform: "none",
      };
