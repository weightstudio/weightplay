(function () {
  ...
  function start() { state.stage = 0; state.links = []; state.selectedAnchor = null; state.previewAnchor = null; $("#resultCard").hidden = true; $("#feedback").textContent = ""; setScreen("battle"); renderStageText(); draw(); track("bridge_start", {}); }
