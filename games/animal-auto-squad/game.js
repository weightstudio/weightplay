...
const GAME_VERSION = "v36";
  ...
  const text = {
    en: {
      ...
      synergyTitle: "Voxel Squad Link",
      synergyHint: "Match roles to unlock a small automatic battle bonus.",
      synergyGuardian: "Guardian link",
      synergyStriker: "Striker link",
      synergySupport: "Support link",
      synergyReady: "Lv.{level} · {count} linked",
      synergyNone: "No link yet · add two matching roles",
  ...
  text.es = {
    ...
    quitConfirm: "Nivel {stage}, oleada {round}/5, corazones {hearts}/4, suministros {supplies}. Al salir se pierde el escuadrón temporal y el progreso sin resolver; el entrenamiento permanente y los niveles desbloqueados quedan a salvo.",
  ...
  text.ja = {
    ...
    quitConfirm: "ステージ{stage}、ウェーブ{round}/5、ハート{hearts}/4、物資{supplies}。離脱すると今回の一時編成と未確定進行は失われます。恒久トレーニングと解放済みステージは保持されます。",
  ...
  text.ar = {
    ...
    quitConfirm: "المرحلة {stage}، الموجة {round}/5، القلوب {hearts}/4، المؤن {supplies}. المغادرة تفقد التشكيل والتقدم المؤقت لهذه الرحلة، بينما يبقى التدريب الدائم والمراحل المفتوحة محفوظًا.",
  ...
  // v20 locale-owned decision copy. The older catalog intentionally keeps
  // historical language overlays, but these high-frequency Main → Stage →
  // Preparation → Battle → Result strings must never be assembled from an
  ...
  // Voxel Squad Links are intentionally derived from the existing roster so
  // old saves, unlocks, and card ids remain valid. They add readable strategy
  // without introducing another manual combat control.
  const ANIMAL_ROLE_TAGS = {
    0: "striker", 1: "support", 2: "guardian", 3: "striker", 4: "guardian",
    5: "support", 6: "guardian", 7: "striker", 8: "striker", 9: "guardian"
  };
  ...
  const localeOwnedCombatMetadata = {
    ko: {
      ...
      animalDescs: ["앞줄을 대상으로 레벨만큼 도약 피해를 준 뒤 일반 공격을 하여 두 번 공격합니다.", "매 교전 전에 가장 약한 아군을 레벨만큼 회복합니다. 자신의 차례에는 가장 약한 아군을 공격력의 절반(최소 1)만큼 회복합니다.", "전투 시작 시 모든 아군의 최대 체력과 체력을 레벨만큼 올립니다. 자신의 차례에는 모든 아군에게 레벨 보호막을 부여합니다.", "별똥별로 뒷줄을 공격한 뒤 그 줄의 두 번째 적을 공격합니다. 필요하면 앞줄을 대신 공격합니다.", "전투 시작 시 레벨 보호막을 얻습니다. 자신의 차례에는 모든 아군에게 레벨 보호막을 부여합니다. 쓰러질 때 다음 아군을 보호막으로 감쌉니다.", "자신의 차례에 공격하는 대신 가장 약한 아군을 공격력의 절반(최소 1)만큼 회복합니다.", "자신의 차례에 공격하는 대신 공격력의 절반(최소 1)에 해당하는 보호막을 얻습니다.", "앞줄의 모든 적에게 공격력의 70% 피해를 주고, 앞줄이 비면 뒷줄을 공격합니다. 쓰러지면 남은 아군의 공격력과 체력이 레벨만큼 증가합니다.", "전투 시작 시 모든 아군의 공격력이 레벨만큼 증가합니다. 자신의 차례에는 모든 아군의 공격력을 레벨만큼, 체력을 1 증가시킵니다.", "일반 공격을 합니다. 쓰러질 때 선두 적에게 레벨의 4배 피해를 줍니다."],
    ...
    "pt-BR": {
      ...
      animalDescs: ["Ataca a linha de frente com um salto de dano igual ao Nv. e depois faz seu ataque normal, acertando duas vezes.", "Antes de cada confronto, cura o aliado com menos Vida em uma quantidade igual ao Nv. No próprio turno, cura o aliado com menos Vida em metade do ATQ (mínimo 1).", "No início da batalha, todas as unidades aliadas ganham Nv. de Vida máxima e Vida. No próprio turno, todas ganham um escudo de Nv.", "Ataca a retaguarda com Chuva Estelar e depois atinge um segundo inimigo dessa linha. Se necessário, recua para atacar a linha de frente.", "No início da batalha, ganha um escudo de Nv. No próprio turno, todas as unidades aliadas ganham um escudo de Nv. Ao cair, protege o próximo aliado com um escudo.", "No próprio turno, cura o aliado com menos Vida em metade do ATQ (mínimo 1) em vez de atacar.", "No próprio turno, ganha um escudo igual à metade do ATQ (mínimo 1) em vez de atacar.", "Varre todos os inimigos da linha de frente com 70% do ATQ, recuando para a retaguarda se necessário. Ao cair, os aliados restantes ganham Nv. de ATQ e Vida.", "No início da batalha, todos os aliados ganham Nv. de ATQ. No próprio turno, todos ganham Nv. de ATQ e 1 de Vida.", "Ataca normalmente. Ao cair, causa 4 x Nv. de dano ao inimigo da frente."],
    ...
    fr: {
      ...
      animalDescs: ["Cible la première ligne et frappe deux fois : un bond infligeant des dégâts égaux au niv., puis son attaque normale.", "Avant chaque affrontement, soigne l’allié le plus faible de la valeur de son niv. À son tour, soigne l’allié le plus faible de la moitié de l’ATQ (minimum 1).", "Au début du combat, tous les alliés gagnent le niv. en PV max et en PV. À son tour, donne à tous les alliés un bouclier égal au niv.", "Cible la ligne arrière avec Pluie d’étoiles, puis frappe un deuxième ennemi de cette ligne. Si besoin, revient à la première ligne.", "Au début du combat, gagne un bouclier égal au niv. À son tour, donne à tous les alliés un bouclier égal au niv. À sa défaite, protège l’allié suivant.", "À son tour, soigne l’allié le plus faible de la moitié de l’ATQ (minimum 1) au lieu d’attaquer.", "À son tour, gagne un bouclier égal à la moitié de l’ATQ (minimum 1) au lieu d’attaquer.", "Balaye tous les ennemis de la première ligne à 70 % de l’ATQ et passe à la ligne arrière si nécessaire. À sa défaite, les alliés restants gagnent le niv. en ATQ et en PV.", "Au début du combat, tous les alliés gagnent le niv. en ATQ. À son tour, tous les alliés gagnent le niv. en ATQ et 1 PV.", "Attaque normalement. À sa défaite, inflige 4 × niv. dégâts à l’ennemi en tête."],
    ...
    de: {
      ...
      animalDescs: ["Zielt auf die Frontreihe und trifft zweimal: ein Sprungangriff mit Schaden in Höhe der Stufe, gefolgt vom normalen Angriff.", "Vor jedem Aufeinandertreffen heilt es den schwächsten Verbündeten um die Stufe. In seinem Zug heilt es den schwächsten Verbündeten um die Hälfte des ANG (mindestens 1).", "Zu Kampfbeginn erhalten alle Verbündeten Stufe zusätzliche max. TP und TP. In seinem Zug erhalten alle Verbündeten einen Schild in Höhe der Stufe.", "Zielt mit Sternenfall auf die hintere Reihe und trifft danach einen zweiten Gegner dieser Reihe. Falls nötig, wechselt es zur Frontreihe.", "Zu Kampfbeginn erhält es einen Schild in Höhe der Stufe. In seinem Zug erhalten alle Verbündeten einen Schild in Höhe der Stufe. Beim Besiegen schützt es den nächsten Verbündeten.", "Heilt in seinem Zug den schwächsten Verbündeten um die Hälfte des ANG (mindestens 1), statt anzugreifen.", "Erhält in seinem Zug einen Schild in Höhe der Hälfte des ANG (mindestens 1), statt anzugreifen.", "Fegt alle Gegner der Frontreihe mit 70 % ANG hinweg und wechselt bei Bedarf zur hinteren Reihe. Beim Besiegen erhalten die übrigen Verbündeten ANG und TP in Höhe der Stufe.", "Zu Kampfbeginn erhalten alle Verbündeten ANG in Höhe der Stufe. In seinem Zug erhalten alle Verbündeten ANG in Höhe der Stufe und 1 TP.", "Greift normal an. Beim Besiegen fügt es dem vordersten Gegner 4 × Stufe Schaden zu."],
    ...
    it: {
      ...
      animalDescs: ["Colpisce la prima linea due volte: prima con un balzo che infligge danni pari al Liv., poi con il suo attacco normale.", "Prima di ogni scontro, cura l’alleato più debole di un valore pari al Liv. Nel suo turno, cura l’alleato più debole per metà dell’ATT (minimo 1).", "All’inizio della battaglia, tutti gli alleati ottengono Liv. Salute massima e Salute. Nel suo turno, tutti gli alleati ottengono uno scudo pari al Liv.", "Colpisce la retroguardia con Pioggia stellare, poi attacca un secondo nemico in quella fila. Se necessario, passa alla prima linea.", "All’inizio della battaglia, ottiene uno scudo pari al Liv. Nel suo turno, tutti gli alleati ottengono uno scudo pari al Liv. Quando cade, protegge l’alleato successivo.", "Nel suo turno, cura l’alleato più debole per metà dell’ATT (minimo 1) invece di attaccare.", "Nel suo turno, ottiene uno scudo pari a metà dell’ATT (minimo 1) invece di attaccare.", "Spazza tutti i nemici della prima linea con il 70% dell’ATT, passando alla retroguardia se necessario. Quando cade, gli alleati rimasti ottengono Liv. ATT e Salute.", "All’inizio della battaglia, tutti gli alleati ottengono Liv. ATT. Nel suo turno, tutti gli alleati ottengono Liv. ATT e 1 Salute.", "Attacca normalmente. Quando cade, infligge 4 × Liv. danni al nemico in testa."],
    ...
    ru: {
      ...
      animalDescs: ["Атакует передний ряд дважды: сначала прыжком наносит урон, равный уровню, затем выполняет обычную атаку.", "Перед каждым столкновением лечит самого слабого союзника на величину уровня. В свой ход лечит самого слабого союзника на половину атаки (минимум 1).", "В начале боя все союзники получают по уровню к макс. здоровью и здоровью. В свой ход все союзники получают щит, равный уровню.", "Атакует задний ряд «Звездопадом», затем поражает второго врага в этом ряду. При необходимости переключается на передний ряд.", "В начале боя получает щит, равный уровню. В свой ход все союзники получают щит, равный уровню. После падения защищает следующего союзника щитом.", "В свой ход лечит самого слабого союзника на половину атаки (минимум 1) вместо атаки.", "В свой ход получает щит, равный половине атаки (минимум 1), вместо атаки.", "Поражает всех врагов переднего ряда на 70% атаки, а если там никого нет — задний ряд. После падения оставшиеся союзники получают по уровню к атаке и здоровью.", "В начале боя все союзники получают по уровню к атаке. В свой ход все союзники получают по уровню к атаке и 1 к здоровью.", "Атакует обычно. После падения наносит 4 × уровень урона врагу впереди."],
    ...
    hi: {
      ...
      animalDescs: ["आगे की पंक्ति को निशाना बनाकर पहले स्तर के बराबर छलांग का नुकसान, फिर सामान्य हमला करता है।", "हर भिड़ंत से पहले सबसे कमज़ोर साथी को स्तर के बराबर स्वास्थ्य देता है। अपनी बारी में सबसे कमज़ोर साथी को आक्रमण के आधे (कम से कम 1) से ठीक करता है।", "लड़ाई शुरू होने पर सभी साथियों को स्तर के बराबर अधिकतम स्वास्थ्य और स्वास्थ्य मिलता है। अपनी बारी में सभी साथियों को स्तर की ढाल देता है।", "तारापात से पीछे की पंक्ति को निशाना बनाता है, फिर उसी पंक्ति के दूसरे शत्रु पर वार करता है। ज़रूरत होने पर आगे की पंक्ति को निशाना बनाता है।", "लड़ाई शुरू होने पर स्तर की ढाल पाता है। अपनी बारी में सभी साथियों को स्तर की ढाल देता है। गिरने पर अगले साथी को ढाल देता है।", "अपनी बारी में हमला करने के बजाय सबसे कमज़ोर साथी को आक्रमण के आधे (कम से कम 1) से ठीक करता है।", "अपनी बारी में हमला करने के बजाय आक्रमण के आधे (कम से कम 1) के बराबर ढाल पाता है।", "आगे की पंक्ति के हर शत्रु पर आक्रमण के 70% से वार करता है; ज़रूरत होने पर पीछे की पंक्ति को निशाना बनाता है। गिरने पर बचे साथियों को स्तर के बराबर आक्रमण और स्वास्थ्य मिलता है।", "लड़ाई शुरू होने पर सभी साथियों को स्तर के बराबर आक्रमण मिलता है। अपनी बारी में सभी साथियों को स्तर के बराबर आक्रमण और 1 स्वास्थ्य मिलता है।", "सामान्य हमला करता है। गिरने पर सबसे आगे वाले शत्रु को स्तर के 4 गुना नुकसान देता है।"],
  ...
  for (const [localeKey, copy] of Object.entries(localeOwnedCombatMetadata)) {
    const applyFields = (records, names, roles, descriptions) => {
      records.forEach((record, index) => {
        ...
        if (descriptions?.[index]) {
          ...
          record.descLocaleOwned[localeKey] = descriptions[index];
        }
      });
    };
  ...
  // v20 locale-owned Stage metadata. The shared runtime can translate common
  // nouns, but authored region/stage names are game content and must not be
  // left to an English fallback on the Stage decision surface.
  const localeOwnedStageMetadata = {
    "zh-Hans": {
      regions: ["荆棘林", "水晶洞窟", "沉没遗迹", "余烬山峰", "月光城堡", "虚空王冠"],
      stages: ["苔藓小径", "狐狸伏击", "狼穴", "根之门", "荆棘王座", "闪耀通道", "棱晶巢穴", "碎片之桥", "蔚蓝宝库", "棱晶之心", "潮汐阶梯", "珊瑚档案馆", "淹没广场", "利维坦之门", "沉没王冠", "灰烬小径", "余烬熔炉", "熔岩堤道", "黑曜竞技环", "火山口之王", "银月花园", "月蚀大厅", "星辰图书馆", "月轮尖塔", "午夜宫廷", "破碎天路", "重力深井", "虚空长廊", "王冠之路", "终夜之战"]
    },
    ko: {
      regions: ["쏜우드", "수정 동굴", "침몰 유적", "잿불 봉우리", "달빛 성채", "공허의 왕관"],
      stages: ["이끼 오솔길", "여우 매복", "늑대 소굴", "뿌리 관문", "쏜우드 왕좌", "빛나는 통로", "프리즘 둥지", "파편 다리", "푸른 보물고", "프리즘 심장", "조수 계단", "산호 기록관", "침몰 광장", "리바이어던 관문", "침몰 왕관", "잿빛 길", "잿불 대장간", "용암 둑길", "흑요석 링", "칼데라의 왕", "은빛 정원", "일식 회랑", "별의 서고", "달 첨탑", "한밤의 궁정", "부서진 천상로", "중력 우물", "공허 회랑", "왕관으로 가는 길", "밤의 끝 전투"]
    },
    "pt-BR": {
      regions: ["Floresta Espinhosa", "Cavernas de Cristal", "Ruínas Submersas", "Pico das Brasas", "Cidadela ao Luar", "Coroa do Vazio"],
      stages: ["Trilha Musgosa", "Emboscada da Raposa", "Covil do Lobo", "Portão das Raízes", "Trono da Floresta Espinhosa", "Passagem Brilhante", "Ninho Prismático", "Ponte dos Fragmentos", "Cofre Azul", "Coração Prismático", "Escadaria da Maré", "Arquivo de Coral", "Praça Submersa", "Portão do Leviatã", "Coroa Submersa", "Caminho das Cinzas", "Forja das Brasas", "Estrada de Lava", "Anel de Obsidiana", "Rei da Caldeira", "Jardim Prateado", "Salão do Eclipse", "Biblioteca Estelar", "Pináculo Lunar", "Corte da Meia-Noite", "Caminho Celeste Partido", "Poço Gravitacional", "Galeria Nula", "Estrada da Coroa", "Batalha do Fim da Noite"]
    },
    fr: {
      regions: ["Bois épineux", "Cavernes de cristal", "Ruines immergées", "Pic des braises", "Citadelle au clair de lune", "Couronne du Vide"],
      stages: ["Sentier moussu", "Embuscade du renard", "Tanière du loup", "Porte des racines", "Trône du Bois épineux", "Passage étincelant", "Nid prismatique", "Pont des éclats", "Coffre azur", "Cœur prismatique", "Escalier des marées", "Archives de corail", "Place noyée", "Porte du Léviathan", "Couronne immergée", "Chemin des cendres", "Forge des braises", "Chaussée de lave", "Anneau d'obsidienne", "Roi de la caldeira", "Jardin argenté", "Salle de l'éclipse", "Bibliothèque des étoiles", "Flèche lunaire", "Cour de minuit", "Voie céleste brisée", "Puits gravitationnel", "Galerie nulle", "Chemin de la couronne", "Bataille de la fin de la nuit"]
    },
    de: {
      regions: ["Dornwald", "Kristallhöhlen", "Versunkene Ruinen", "Aschengipfel", "Mondlichtzitadelle", "Leerekrone"],
      stages: ["Moospfad", "Fuchshinterhalt", "Wolfshöhle", "Wurzeltor", "Dornwaldthron", "Glitzerpassage", "Prismennest", "Splitterbrücke", "Azurgewölbe", "Prismenherz", "Gezeitentreppe", "Korallenarchiv", "Versunkener Platz", "Leviathantor", "Versunkene Krone", "Aschenpfad", "Glutschmiede", "Lavastraße", "Obsidianring", "König der Caldera", "Silbergarten", "Eklipssaal", "Sternenbibliothek", "Mondturm", "Mitternachtshof", "Zerbrochener Himmelsweg", "Gravitationsbrunnen", "Nullgalerie", "Weg zur Krone", "Schlacht am Ende der Nacht"]
    },
    it: {
      regions: ["Bosco Spinoso", "Caverne di Cristallo", "Rovine Sommerse", "Picco delle Braci", "Cittadella al Chiaro di Luna", "Corona del Vuoto"],
      stages: ["Sentiero Muschioso", "Agguato della Volpe", "Tana del Lupo", "Porta delle Radici", "Trono del Bosco Spinoso", "Passaggio Scintillante", "Nido Prismático", "Ponte delle Schegge", "Tesoro Azzurro", "Cuore Prismático", "Scala della Marea", "Archivio del Corallo", "Piazza Sommersa", "Porta del Leviatano", "Corona Sommersa", "Sentiero delle Ceneri", "Forgia delle Braci", "Strada di Lava", "Anello d'Ossidiana", "Re della Caldera", "Giardino d'Argento", "Sala dell'Eclissi", "Biblioteca delle Stelle", "Guglia Lunare", "Corte di Mezzanotte", "Via Celeste Spezzata", "Pozzo Gravitazionale", "Galleria Nulla", "Via della Corona", "Battaglia della Fine della Notte"]
    },
    ru: {
      regions: ["Терновый лес", "Хрустальные пещеры", "Затонувшие руины", "Пик углей", "Лунная цитадель", "Корона пустоты"],
      stages: ["Мшистая тропа", "Лисья засада", "Волчье логово", "Врата корней", "Трон Тернового леса", "Сверкающий проход", "Призматическое гнездо", "Мост осколков", "Лазурная сокровищница", "Призматическое сердце", "Лестница прилива", "Коралловый архив", "Затопленная площадь", "Врата Левиафана", "Затонувшая корона", "Тропа пепла", "Кузница углей", "Лавовая дорога", "Обсидиановое кольцо", "Король кальдеры", "Серебряный сад", "Зал затмения", "Звёздная библиотека", "Лунный шпиль", "Полночный двор", "Разбитый небесный путь", "Гравитационный колодец", "Нулевая галерея", "Дорога к короне", "Битва конца ночи"]
    },
    hi: {
      regions: ["काँटों का वन", "क्रिस्टल गुफाएँ", "डूबी हुई खंडहर", "अंगार शिखर", "चाँदनी दुर्ग", "शून्य मुकुट"],
      stages: ["काई वाली पगडंडी", "लोमड़ी का घात", "भेड़िए की माँद", "जड़ों का द्वार", "काँटों के वन का सिंहासन", "चमकीला मार्ग", "प्रिज्म घोंसला", "टुकड़ों का पुल", "नीला खजाना", "प्रिज्म हृदय", "ज्वार की सीढ़ी", "मूंगा अभिलेखागार", "डूबा हुआ चौक", "लेवियाथन द्वार", "डूबा हुआ मुकुट", "राख की राह", "अंगार भट्ठी", "लावा पथ", "ओब्सीडियन घेरा", "काल्डेरा का राजा", "चाँदी का बगीचा", "ग्रहण कक्ष", "सितारा पुस्तकालय", "चंद्र शिखर", "आधी रात का दरबार", "टूटा आकाश मार्ग", "गुरुत्व कुआँ", "शून्य दीर्घा", "मुकुट की राह", "रात के अंत की लड़ाई"]
    }
  };
  Object.entries(localeOwnedStageMetadata).forEach(([localeKey, copy]) => {
    REGION_METADATA.forEach((region, index) => {
      region.nameLocaleOwned ||= {};
      region.nameLocaleOwned[localeKey] = copy.regions[index];
    });
    STAGE_DEFINITIONS.forEach((definition, index) => {
      definition.nameLocaleOwned ||= {};
      definition.nameLocaleOwned[localeKey] = copy.stages[index];
    });
  });
  ...
  Object.assign(zhRuntimeText, {
    ...
    trainingGold: "\u8a13\u7df4\u91d1\u5e63",
    synergyTitle: "方塊小隊羈絆",
    synergyHint: "湊齊相同定位即可啟動自動戰鬥加成。",
    synergyGuardian: "守護羈絆",
    synergyStriker: "輸出羈絆",
    synergySupport: "支援羈絆",
    synergyReady: "{count} 名連結 · 等級 {level}",
    synergyNone: "尚未形成羈絆 · 湊齊兩名相同定位",
    bossWarning: "首領即將出現",
    actionCritical: "暴擊",
    actionCombo: "連攜命中",
    blockBreak: "方塊破裂",
  ...
  function squadSynergy(cards = state.squad.filter(Boolean)) {
    const counts = { guardian: 0, striker: 0, support: 0 };
    cards.filter(Boolean).forEach((card) => {
      const tag = ANIMAL_ROLE_TAGS[Number(card.id)];
      if (tag && counts[tag] !== undefined) counts[tag] += 1;
    });
    const links = Object.entries(counts)
      .filter(([, count]) => count >= 2)
      .map(([tag, count]) => ({ tag, count, level: count >= 3 ? 2 : 1 }));
    const best = links.reduce((winner, link) => (link.level > (winner?.level || 0) || link.count > (winner?.count || 0) ? link : winner), null);
    return {
      counts,
      links,
      primary: best?.tag || "",
      level: best?.level || 0,
      atk: Math.min(2, links.find((link) => link.tag === "striker")?.level || 0),
      hp: Math.min(2, links.find((link) => link.tag === "guardian")?.level || 0),
      healBoost: Math.min(2, links.find((link) => link.tag === "support")?.level || 0)
    };
  }

  function synergyLabel(synergy) {
    if (!synergy?.primary) return t("synergyNone");
    const nameKey = `synergy${synergy.primary[0].toUpperCase()}${synergy.primary.slice(1)}`;
    return `${t(nameKey)} · ${t("synergyReady", { level: synergy.level, count: synergy.counts[synergy.primary] })}`;
  }
  ...
  function firstWavePreviewCopy(key, data = {}) {
    const copy = firstWavePreviewCatalog[actualGameLocale()] || firstWavePreviewCatalog.en;
    const source = copy[key] || firstWavePreviewCatalog.en[key] || key;
    return Object.entries(data).reduce((value, [name, item]) => value.replaceAll(`{${name}}`, String(item)), source);
  }

  function firstWavePreviewCounter(enemyUnits, frontCount, backCount) {
    const targetModes = new Set(enemyUnits.map((enemy) => enemy.targetMode));
    if (targetModes.has("row")) return firstWavePreviewCopy("spread");
    if (targetModes.has("back")) return firstWavePreviewCopy(backCount ? "protectBack" : "backMissing");
    return firstWavePreviewCopy(frontCount ? "protectFront" : "frontMissing");
  }
  ...
  const firstWavePreviewCatalog = {
    en: {
      ...
      protectBack: "Keep a healer or shielded animal in back.",
      spread: "Spread your squad across both rows before Start Battle."
    },
    "zh-Hant": {
      title: "\u7b2c\u4e00\u6ce2\u8a08\u756b",
    ...
    ja: {
      ...
      protectBack: "\u5f8c\u5217\u306b\u56de\u5fa9\u5f79\u304b\u30b7\u30fc\u30eb\u30c9\u6301\u3061\u3092\u7f6e\u304d\u307e\u3057\u3087\u3046\u3002",
      spread: "\u30d0\u30c8\u30eb\u958b\u59cb\u524d\u306b\u4e21\u65b9\u306e\u5217\u306b\u5206\u6563\u3055\u305b\u307e\u3057\u3087\u3046\u3002"
    },
    ko: {
      title: "1\ucc28 \uc6e8\uc774\ube0c \uacc4\ud68d",
      ...
      protectBack: "\ud6c4\uc5f4\uc5d0 \ud68c\ubcf5 \ub610\ub294 \uc2e0\ub4dc \uc5ed\ud560\uc744 \ub450\uc138\uc694.",
      spread: "\uc804\ud22c \uc2dc\uc791 \uc804\uc5d0 \ubd84\ub300\ub97c \uc591\ucabd \uc5f4\uc5d0 \ub098\ub220 \ubc30\uce58\ud558\uc138\uc694."
    },
    es: {
      ...
      protectBack: "Mant\u00e9n atr\u00e1s un animal con curaci\u00f3n o escudo.",
      spread: "Reparte tu escuadr\u00f3n en ambas filas antes de empezar la batalla."
    },
    "pt-BR": {
      ...
      protectBack: "Mantenha atr\u00e1s um animal com cura ou escudo.",
      spread: "Distribua seu esquadr\u00e3o nas duas linhas antes de iniciar a batalha."
    },
    fr: {
      ...
      protectBack: "Gardez derri\u00e8re un animal capable de soigner ou prot\u00e9g\u00e9.",
      spread: "R\u00e9partissez votre \u00e9quipe sur les deux lignes avant le combat."
    },
    de: {
      ...
      protectBack: "Halte hinten ein heilendes oder gesch\u00fctztes Tier bereit.",
      spread: "Verteile deinen Trupp vor dem Gefecht auf beide Reihen."
    },
    it: {
      ...
      protectBack: "Tieni dietro un animale con cure o scudo.",
      spread: "Distribuisci la squadra su entrambe le file prima della battaglia."
    },
    ru: {
      ...
      protectBack: "\u041e\u0441\u0442\u0430\u0432\u044c\u0442\u0435 \u043f\u043e\u0437\u0430\u0434\u0438 \u043b\u0435\u043a\u0430\u0440\u044f \u0438\u043b\u0438 \u0437\u0430\u0449\u0438\u0449\u0451\u043d\u043d\u043e\u0435 \u0436\u0438\u0432\u043e\u0442\u043d\u043e\u0435.",
      spread: "\u0414\u043e \u0431\u043e\u044f \u0440\u0430\u0441\u043f\u0440\u0435\u0434\u0435\u043b\u0438\u0442\u0435 \u043e\u0442\u0440\u044f\u0434 \u043f\u043e \u043e\u0431\u043e\u0438\u043c \u0440\u044f\u0434\u0430\u043c."
    },
    hi: {
      ...
      protectBack: "\u092a\u0940\u091b\u0947 \u092e\u0947\u0902 \u0907\u0932\u093e\u091c \u092f\u093e \u0936\u0940\u0932\u094d\u0921 \u0935\u093e\u0932\u093e \u091c\u093e\u0928\u0935\u0930 \u0930\u0916\u0947\u0902\u0964",
      spread: "\u092c\u093e\u0924\u094d\u0924\u0940 \u0936\u0941\u0930\u0942 \u0915\u0930\u0928\u0947 \u0938\u0947 \u092a\u0939\u0932\u0947 \u0926\u094b\u0928\u094b\u0902 \u092a\u0902\u0915\u094d\u0924\u093f\u092f\u094b\u0902 \u092e\u0947\u0902 \u0926\u0932 \u092c\u093e\u0902\u091f\u0947\u0902\u0964"
    },
    ar: {
      ...
      protectBack: "\u0623\u0628\u0642\u0650 \u062d\u064a\u0648\u0627\u0646\u064b\u0627 \u0645\u0639 \u0627\u0644\u0639\u0644\u0627\u062c \u0623\u0648 \u0627\u0644\u062f\u0631\u0639 \u0641\u064a \u0627\u0644\u062e\u0644\u0641.",
      spread: "\u0648\u0632\u0651\u0639 \u0641\u0631\u064a\u0642\u0643 \u0628\u064a\u0646 \u0627\u0644\u0635\u0641\u064a\u0646 \u0642\u0628\u0644 \u0628\u062f\u0621 \u0627\u0644\u0645\u0639\u0631\u0643\u0629."
    }
  };
  ...
  function updateTrainingStageCanvas() {
    ...
    const availableHeight = Math.max(1, height - (window.WeightPlayLayout?.reserveHeight ?? 0));
  ...
  function desiredStageWindow(stage) {
    return Math.max(1, Math.min(stageWindowLimit(), Math.round(stage) - Math.floor(STAGE_CARD_POOL_SIZE / 2)));
  }

  function bindStageCard(card, stage) {
    ...
    const browsed = stage === Math.round(stageBrowseLogical);
    ...
    const bossText = definition.bossId ? ` \u00b7 ${t("stageBoss")}` : "";
    card.className = `stage-card${stage === save.selectedStage ? " is-selected" : ""}${browsed ? " is-browsed" : ""}${cleared ? " is-cleared" : ""}${definition.bossId ? " is-boss-stage" : ""}`;
    ...
    card.setAttribute("aria-posinset", String(stage));
  ...
  function syncStageCards() {
    stageCardPool.forEach((card) => bindStageCard(card, Number(card.dataset.stage)));
  }
  ...
  function moveStageWindow(targetStart) {
    ...
    rail.dataset.wpStageWindowEnd = String(stageWindowStart + stageCardPool.length - 1);
    if (recycled) rail.dataset.wpStageRecycleCount = String(Number(rail.dataset.wpStageRecycleCount || 0) + recycled);
  }

  function ensureStageWindow(stage) {
    moveStageWindow(desiredStageWindow(stage));
    syncStageCards();
  }
  ...
  function stageRailGeometry() {
    ...
    const pitch = first && second ? Math.abs((second.left + second.width / 2) - (first.left + first.width / 2)) : 278;
    return { rail, center: railRect.left + railRect.width / 2, pitch: pitch || 278 };
  }

  function positionStageRail(logical) {
    const value = Math.max(1, Math.min(STAGE_COUNT, logical));
    const anchor = Math.round(value);
    moveStageWindow(desiredStageWindow(anchor));
    const card = nodes.stageRail.querySelector(`[data-stage="${anchor}"]`);
    if (!card) return value;
    card.scrollIntoView({ behavior: "auto", block: "nearest", inline: "center" });
    const geometry = stageRailGeometry();
    nodes.stageRail.scrollLeft += (value - anchor) * geometry.pitch;
  ...
  function renderStageSelector(shouldScroll = true) {
    ...
    // Recommend the first playable uncleared expedition while preserving
    // save.selectedStage as the last committed Battle choice.
    stageBrowseLogical = save.completedStages.includes(save.selectedStage)
      ? Array.from({ length: save.unlockedStage }, (_, index) => index + 1).find((stage) => !save.completedStages.includes(stage)) || save.selectedStage
      : save.selectedStage;
    ...
    nodes.stageRail.dataset.wpStagePoolSize = String(stageCardPool.length);
    nodes.stageRail.dataset.wpStageTotal = String(STAGE_COUNT);
  ...
  function setBrowsedStageOwner(owner) {
    ...
    stageBrowseLogical = Number(owner.dataset.stage);
  ...
  function handleStageCardKeydown(event) {
    ...
    const currentStage = Number(card.dataset.stage);
    let targetStage = null;
    if (event.key === "ArrowRight") targetStage = currentStage + (rtl ? -1 : 1);
    else if (event.key === "ArrowLeft") targetStage = currentStage + (rtl ? 1 : -1);
    else if (event.key === "Home") targetStage = 1;
    else if (event.key === "End") targetStage = STAGE_COUNT;
    ...
    const target = nodes.stageRail.querySelector(`[data-stage="${targetStage}"]`);
  ...
  function installVirtualStageDrag() {
    ...
    const finish = (event) => {
      ...
      if (event.cancelable) event.preventDefault();
      const from = logical;
      const target = Math.max(1, Math.min(STAGE_COUNT, Math.round(from)));
  ...
  function translateUI() {
    ...
    // The shared shell owns the generic #showStageBtn fallback, but this
    // button is game-owned and must retain the active locale's campaign CTA.
    nodes.showStageBtn.setAttribute("data-runtime-localize", "off");
  ...
  function renderFoodGuide() {
    ...
    const synergy = squadSynergy(state.squad.filter(Boolean));
    const backpackGuidance = t("backpackHint").split(/[.!?。！？]/u)[0];
    nodes.foodGuide.setAttribute("data-runtime-localize", "off");
    nodes.foodGuide.innerHTML = `<strong>${preview.title}</strong><span>${backpackGuidance} · ${preview.body}</span><em class="food-guide-coverage" data-role="threat-coverage">${preview.coverage}</em><em class="synergy-badge ${synergy.primary ? "is-ready" : ""}" data-role="squad-synergy"><b>${t("synergyTitle")}</b><span>${synergyLabel(synergy)}</span></em>`;
  ...
  function healWeakestAlly(squad, amount, team = "player") {
    ...
    if (!target) return;
    const synergyBoost = team === "player" ? Number(state.combat.synergy?.healBoost) || 0 : 0;
    const total = Math.max(1, Math.round(amount) + synergyBoost);
    target.hp = Math.min(target.maxHp, target.hp + total);
    const idx = Math.max(0, squad.indexOf(target));
    const point = combatPoint(team, idx);
    addCombatEffect("heal", point.x, point.y, `+${total}`, "#82ffd1");
  }
  ...
  function startBattle(event) {
    ...
    const bonus = teamBonus();
    const synergy = squadSynergy(activeSquad.map(({ card }) => card));
    state.combat.synergy = synergy;
    state.combat.playerSquad = activeSquad.map(({ card, formationSlot }) => ({
      ...card,
      formationSlot,
      hp: card.currentHp + bonus.hp + synergy.hp,
      maxHp: card.maxHp + bonus.hp + synergy.hp,
      atk: card.currentAtk + bonus.atk + synergy.atk,
    ...
    state.combat.bossWarningUntil = openingBoss ? performance.now() + 1600 : 0;
  ...
  function runCombatAnimation() {
    ...
    if (state.combat.bossWarningUntil > performance.now()) {
      ...
      canvasCtx.save();
      canvasCtx.globalAlpha = 0.72 + remaining * 0.28;
      canvasCtx.fillStyle = "rgba(91, 22, 47, .92)";
      canvasCtx.strokeStyle = "#ffe477";
      canvasCtx.lineWidth = 4;
      canvasCtx.beginPath();
      canvasCtx.roundRect(canvasWidth * .08, 42, canvasWidth * .84, 66, 18);
      canvasCtx.fill();
      canvasCtx.stroke();
      canvasCtx.font = "900 30px Outfit, system-ui";
      canvasCtx.textAlign = "center";
      canvasCtx.textBaseline = "middle";
      canvasCtx.fillStyle = "#fff2b3";
      canvasCtx.fillText(t("bossWarning"), canvasWidth / 2, 74);
      canvasCtx.restore();
    }
  ...
  function drawSquadLine(squad, team) {
    ...
    squad.forEach((unit, idx) => {
      ...
      const corner = unit.isBoss ? 14 : 10;
      canvasCtx.fillRect(x + 3, y + 3, corner, 4);
      canvasCtx.fillRect(x + 3, y + 3, 4, corner);
      canvasCtx.fillRect(x + drawW - corner - 3, y + drawH - 7, corner, 4);
      canvasCtx.fillRect(x + drawW - 7, y + drawH - corner - 3, 4, corner);
      if (isActing) {
  ...
  function startNextWaveBattle() {
    ...
    state.combat.bossWarningUntil = nextBoss ? performance.now() + 1600 : 0;
    combatLog(nextBoss ? `${t("bossWarning")} · ${t("bossIncoming", { boss: combatUnitName(nextBoss) })}` : t("nextWaveCombat", { round: state.round, total: WAVES_PER_STAGE }));
    updateCombatSummary();
    ensureCombatProgressTimer();
    runCombatAnimation();
