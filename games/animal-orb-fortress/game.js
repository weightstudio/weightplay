(() => {
  ...
  const text = {
    en: {
      ...
      raidPlanWin: "Raid plan: keep banking shots through crowded lanes and choose blessings that answer the next wave.",
    ...
    "zh-Hant": {
      ...
      raidPlanWin: "突襲策略：持續利用牆面反彈穿過密集路線，並選擇能應對下一波的祝福。",
  ...
  text.es = {
    ...
    bossCueRootbound:"Defensa de raíces elevada: rómpela y golpea el cristal del pecho.",bossCueBramble:"Placas de zarzas y anclas protegen al Coloso.",bossCueLunar:"La Matriarca cambia de fase: espera a que se abran los anillos lunares.",bossCuePrism:"Escudo prisma girando: ataca cuando el segmento dorado mire al frente.",bossCueTempest:"Carril de carga marcado: el Guardián queda expuesto tras correr.",bossCueVoid:"Cambió la fase del núcleo vacío: elimina la escolta y sigue el núcleo iluminado.",progressSaved:"Progreso guardado: {total} piedras; mejor ruta desbloqueada {best}.",raidPlanWin:"Plan de incursión: sigue usando rebotes por carriles llenos y elige bendiciones para la próxima oleada.",raidPlanLose:"Próxima incursión: apunta antes de que se cierre el frente y usa las paredes para golpear a varias bestias.",
  ...
  text.it = {
    ...
    bossCueRootbound:"La guardia di radici è attiva: spezzala, poi colpisci il cristallo esposto sul petto.",bossCueBramble:"Placche di rovi e ancore spinose proteggono il Colosso.",bossCueLunar:"La Matriarca sta cambiando fase: attendi che gli anelli lunari si aprano.",bossCuePrism:"Lo scudo prismatico ruota: attacca quando il segmento dorato è rivolto in avanti.",bossCueTempest:"Corsia di carica segnalata: il Guardiano è vulnerabile dopo lo scatto.",bossCueVoid:"La fase del Nucleo Vuoto è cambiata: elimina la scorta e segui il nucleo illuminato.",progressSaved:"Progresso salvato: {total} Pietre Stellari totali; il miglior percorso sbloccato resta {best}.",raidPlanWin:"Piano incursione: continua con rimbalzi nelle corsie affollate e scegli benedizioni per l'ondata successiva.",raidPlanLose:"Prossima incursione: mira prima che il fronte si chiuda e usa le pareti per colpire più bestie.",
  ...
  Object.assign(text.ar, {
    ...
    ruleSwarm: "سرب",
    ruleArmored: "مدرّع",
    ruleGuardian: "حارس نخبة",
    ruleBank: "مسار ارتداد",
    rulePriority: "ترتيب الأهداف",
    ruleAnchor: "مرساة شوكية",
    ruleArmor: "كسر الدرع",
    rulePhase: "توقيت الطور",
    rulePylon: "أعمدة المرايا",
    ruleSplitter: "منقسمو الكريستال",
    ruleCharge: "مسارات الاندفاع",
    ruleMastery: "إتقان مختلط",
    ruleBoss: "مواجهة الزعيم",
    tierShort: "المسار {tier}",
    keyboardAim: "التصويب بزاوية {angle}° من المركز. عدّل باليسار واليمين؛ اضغط Space أو Enter للإطلاق.",
    orbReady: "الكرة جاهزة. استخدم ارتداد الجدار لضرب وحوش الظل قبل وصولها إلى النواة.",
    orbFlying: "الكرة الروحية في الجو. راقب مسار الارتداد واستعد للتصويب التالي.",
    fortressHit: "أصاب وحش ظل النواة. صوّب أبكر أو استخدم زاوية ارتداد أوسع.",
    waveClear: "اكتملت الموجة. اختر بركة قبل الموجة التالية.",
    chooseUpgrade: "اختر بركة للحصن",
    reroll: "إعادة الاختيار مقابل 3 ألماسات",
    rerolled: "تم تحديث خيارات البركات.",
    rerollNeed: "تحتاج إلى 3 ألماسات. الرصيد الحالي {balance}/3.",
    rerollConfirm: "تأكيد 3 · {before}→{after}",
    rerollDecision: "حدّث البركات الثلاث مرة واحدة في هذه الموجة. اضغط مرة أخرى للتأكيد: {before} → {after} ألماسات.",
    rerollLabel: "حدّث خيارات البركات الثلاث مرة واحدة في هذه الموجة. التكلفة 3 ألماسات. الرصيد الحالي {balance}.",
    rerollConfirmLabel: "تأكيد إعادة اختيار بركة واحدة. أنفق 3 ألماسات. الرصيد من {before} إلى {after}.",
    upgradeDamage: "كرة أكبر",
    upgradeDamageDesc: "+1 إلى ضرر الكرة.",
    upgradeSplit: "كرة منقسمة",
    upgradeSplitDesc: "أضف كرة صدى ثالثة مع كل إطلاق.",
    upgradePierce: "بريق نافذ",
    upgradePierceDesc: "يمكن للكرة إصابة الوحش نفسه مجددًا بسرعة أكبر.",
    upgradeRecharge: "شحن أسرع",
    upgradeRechargeDesc: "جهّز الطلقة التالية بسرعة أكبر.",
    upgradeShield: "درع النواة",
    upgradeShieldDesc: "استعد 4 نقاط من صحة النواة.",
    upgradeMagnet: "مغناطيس الاستطلاع",
    upgradeMagnetDesc: "+2 من أحجار النجوم بعد الغارة.",
    roomForge: "مسبك الكرات",
    roomForgeDesc: "+1 إلى ضرر الكرة الأساسي لكل مستوى.",
    roomShield: "درع النواة",
    roomShieldDesc: "+4 إلى صحة النواة الابتدائية لكل مستوى.",
    roomDen: "وكر الرفيق",
    roomDenDesc: "يضيف ضررًا مساعدًا ابتداءً من المستوى 2.",
    companionLocked: "يفتح ضربات الرفيق عند المستوى 2.",
    companionCurrent: "ضربة الرفيق: {damage} ضرر كل 4 ثوانٍ.",
    companionNext: "المستوى التالي: {damage} ضرر.",
    roomTower: "برج الاستطلاع",
    roomTowerDesc: "+1 حجر نجوم إضافي لكل مستوى غارة.",
    level: "المستوى {n}",
    upgradeRoom: "ترقية {cost}",
    upgradeRoomLabel: "{name}: الترقية إلى المستوى {level} مقابل {cost} من أحجار النجوم. النتيجة: {effect}",
    maxRoomLabel: "{name}: أعلى مستوى هو {level}. {effect}",
    maxed: "الحد الأقصى",
    bossCueRootbound: "ارتفعت حراسة الجذور — حطّمها ثم اضرب بلورة الصدر المكشوفة.",
    bossCueBramble: "تحمي الصفائح الشوكية والمراسي الشوكية العملاق.",
    bossCueLunar: "تنتقل الأم إلى طور آخر — انتظر انفتاح الحلقات القمرية.",
    bossCuePrism: "درع المنشور يدور — هاجم عندما يواجه الجزء الذهبي الأمام.",
    bossCueTempest: "تم تحديد مسار الاندفاع — يصبح الحارس مكشوفًا بعد اندفاعه.",
    bossCueVoid: "تغيّر طور نواة الفراغ — تخلّص من المرافقين واتبع النواة المضيئة.",
  });
  ...
  Object.assign(text.ko, {
    raidPlanWin: "레이드 계획: 붐비는 길에서는 벽 반사를 이어 가고 다음 웨이브에 맞는 축복을 선택하세요.",
    raidPlanLose: "다음 레이드: 전선이 닫히기 전에 조준하고 벽 반사로 여러 야수를 공격하세요.",
  });
  Object.assign(text["pt-BR"], {
    raidPlanWin: "Plano de incursão: use ricochetes nas rotas cheias e escolha bênçãos para a próxima onda.",
    raidPlanLose: "Próxima incursão: mire antes que a linha feche e use as paredes para atingir várias feras.",
  });
  Object.assign(text.ru, {
    raidPlanWin: "План рейда: продолжайте рикошеты по загруженным линиям и выбирайте благословения для следующей волны.",
    raidPlanLose: "Следующий рейд: цельтесь до смыкания фронта и используйте стены, чтобы задеть нескольких зверей.",
  });
  Object.assign(text.hi, {
    raidPlanWin: "रेड योजना: भीड़ वाली लेनों में दीवार से टकराकर वार जारी रखें और अगली लहर के अनुसार आशीर्वाद चुनें।",
    raidPlanLose: "अगला रेड: मोर्चा बंद होने से पहले निशाना लगाएँ और दीवारों से टकराकर कई पशुओं पर वार करें।",
  });
  Object.assign(text.ar, {
    raidPlanWin: "خطة الغارة: واصل التسديدات المرتدة عبر المسارات المزدحمة واختر بركات تناسب الموجة التالية.",
  ...
  pageMeta.ar = {
    title: "حصن كرات الحيوانات - لعبة الارتداد",
    description: "وجّه الكرات الروحية عبر 30 مسارًا دفاعيًا مع أعداء خاصين وأعمدة مرايا متحركة وستة زعماء فريدين ونمو محلي للحصن.",
    ogDescription: "خطط لارتدادات الجدران والأعمدة عبر 30 مسارًا، وتصدَّ للدروع والأطوار والانقسامات والاندفاعات، ثم اهزم ستة زعماء.",
    twitterDescription: "احمِ النواة البلورية عبر 30 مسار ارتداد وست مناطق وأعداء خاصين وست معارك زعماء مختلفة.",
  };
  ...
  const arabicRaidDefs = [
    ["بوابة الكريستال", "اضبط توقيت الطلقات المباشرة على مسار واحد لوحش زاحف بطيء."],
    ["رواق الطحلب", "استخدم أول ارتداد عن الجدار للالتفاف حول المسار المركزي المغلق."],
    ["فناء الصدى", "اختر ارتدادًا يسارًا أو يمينًا بين مسارات الأعداء المنفصلة."],
    ["الممر المنقسم", "حطّم الحاجز الشوكي قبل مرور الأعداء المتحركين."],
    ["تاج الجذور", "حطّم حراسة الزعيم الأولى ثم ارتدِ نحو نقطة ضعفه."],
    ["جسر الأشواك", "أزل الدرع ذي الضربة الواحدة قبل هروب الطيف الخلفي."],
    ["حديقة السموم", "دمّر مرساة شوكية تحمي الوحوش المجاورة."],
    ["متاهة الجذور", "اختر مسار ارتداد بين صفَّين مدرّعين."],
    ["جدار العليق", "واجه المرساة والمهاجم المدرّع معًا."],
    ["عرش الأشواك", "حطّم صفيحتي الزعيم المدرّعتين مع إزالة المراسي."],
    ["درج القمر", "اقرأ أول إشارة للطور والظهور من جديد."],
    ["رواق الأطياف", "تتبّع طيفين يتناوبان في الدخول إلى الطور."],
    ["أطلال المرايا", "صوّب عبر بوابة قمرية متحركة تغيّر ممر الارتداد."],
    ["عبور القمر", "اجمع بين توقيت الطور وبوابة انعكاس متحركة."],
    ["حارس بئر القمر", "اضرب أثناء تعافي الأم بعد اندفاعها القمري."],
    ["بوابة الكسوف", "استخدم أول عمود مرآة ثابت كسطح ارتداد جديد."],
    ["قاعة الكريستال الأسود", "اهزم المنقسم قبل أن تنتشر شظيتاه."],
    ["مسبك المنشور", "اختر بين ممرَّي الأعمدة ومرافق مدرّع."],
    ["دائرة الشظايا", "أعد التخطيط عندما تُبطل الأعمدة المتحركة زاوية الطلقة القديمة."],
    ["وصي خزنة المرايا", "ارتدِ نحو الجزء المضيء من درع الزعيم الدوّار."],
    ["جسر العاصفة", "اقرأ أول مسار معلَّم قبل اندفاع المهاجم."],
    ["رواق الرعد", "تتبّع مهاجمين يتناوبان علامات المسار."],
    ["مسبك الريح", "تكيّف عندما تغيّر نبضات العاصفة سرعة الكرة."],
    ["المعقل الأخير", "اجمع بين تغيّر المسارات والاندفاع وتوقيت العاصفة."],
    ["تاج العاصفة", "هاجم بعد إتمام الزعيم ذي القرنين اندفاعه المعلَّم."],
    ["مقدمة الغول", "قدّم أولوية للأعداء المدرّعين وذوي الأطوار في تشكيل واحد."],
    ["مسبك النواة", "صل إلى المنقسمين المختبئين خلف المراسي الشوكية."],
    ["رواق الفراغ", "صوّب عبر الأعمدة المتحركة بينما يعلّم المهاجمون المسارات."],
    ["قلب الكسوف", "اصمد أمام ثلاثة تشكيلات باستخدام كل قواعد الأعداء."],
    ["قلب الحصن", "حطّم أطوار الزعيم الثلاثة الأخيرة والمرافقين والأعمدة المتغيرة."],
  ];
  raidDefs.forEach((raid, index) => {
    raid.name.ar = arabicRaidDefs[index][0];
    raid.desc.ar = arabicRaidDefs[index][1];
  });
  [
    "击破第一个首领的防护，再反弹命中弱点。",
    "清除锚点并击破首领的两层荆棘甲片。",
  ...
  ["غول الجذور","عملاق العليق","أم الأطياف القمرية","وصي الصدفة المنشورية","حارس قرن العاصفة","إمبراطور نواة الفراغ"].forEach((name,index)=>{bossDefs[index].name.ar=name;});
  const upgradeDefs = [
