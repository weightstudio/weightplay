(function () {
  ...
  function start() { state.round = 0; state.releases = 0; resetBattleStatus(); openMap(); }
  function startRound() { state.angle = 0; resetBattleStatus(); show("battleScreen"); renderBattle(); $("angleInput").focus(); }
