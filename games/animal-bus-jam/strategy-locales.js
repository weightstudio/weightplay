(() => {
  ...
  const copy = {
    en: {
      ...
      hintMove: "Hint: choose Queue {queue}'s {color} passenger.",
    ...
    "zh-Hant": {
      ...
      undone: "已復原上一步調度。", hintMove: "提示：選擇隊列 {queue} 的{color}乘客。", deadlockKicker: "路線堵塞", deadlockTitle: "候車通道已經堵死",
    ...
    "zh-Hans": {
      ...
      undone: "已撤销上一步调度。", hintMove: "提示：选择队列 {queue} 的{color}乘客。", deadlockKicker: "路线堵塞", deadlockTitle: "候车通道已经堵死",
    ...
    ja: {
      ...
      undone: "直前の操作を戻しました。", hintMove: "ヒント：列 {queue} の{color}の乗客を選びましょう。", deadlockKicker: "経路閉塞", deadlockTitle: "待機レーンが詰まりました",
    ...
    ko: {
      ...
      undone: "마지막 배차를 취소했습니다.", hintMove: "힌트: 대기열 {queue}의 {color} 승객을 선택하세요.", deadlockKicker: "노선 막힘", deadlockTitle: "대기 통로가 막혔습니다",
    ...
    es: {
      ...
      undone: "Último envío deshecho.", hintMove: "Pista: elige al pasajero {color} de la fila {queue}.", deadlockKicker: "RUTA BLOQUEADA", deadlockTitle: "El carril de espera está bloqueado",
    ...
    "pt-BR": {
      ...
      undone: "Último envio desfeito.", hintMove: "Dica: escolha o passageiro {color} da fila {queue}.", deadlockKicker: "ROTA TRAVADA", deadlockTitle: "A faixa de espera está bloqueada",
    ...
    fr: {
      ...
      undone: "Dernier envoi annulé.", hintMove: "Indice : choisissez le passager {color} de la file {queue}.", deadlockKicker: "LIGNE BLOQUÉE", deadlockTitle: "La voie d’attente est bloquée",
    ...
    de: {
      ...
      undone: "Letzten Zug rückgängig gemacht.", hintMove: "Hinweis: Wähle den {color}-Fahrgast in Reihe {queue}.", deadlockKicker: "ROUTE BLOCKIERT", deadlockTitle: "Die Wartezone ist blockiert",
    ...
    it: {
      ...
      undone: "Ultimo invio annullato.", hintMove: "Suggerimento: scegli il passeggero {color} della fila {queue}.", deadlockKicker: "PERCORSO BLOCCATO", deadlockTitle: "La corsia d’attesa è bloccata",
    ...
    ru: {
      ...
      undone: "Последний ход отменён.", hintMove: "Подсказка: выберите пассажира «{color}» в очереди {queue}.", deadlockKicker: "МАРШРУТ ЗАБЛОКИРОВАН", deadlockTitle: "Зона ожидания заблокирована",
    ...
    hi: {
      ...
      undone: "पिछला प्रेषण पूर्ववत किया।", hintMove: "संकेत: कतार {queue} के {color} यात्री को चुनें।", deadlockKicker: "मार्ग अवरुद्ध", deadlockTitle: "प्रतीक्षा लेन जाम है",
    ...
    ar: {
      ...
      undone: "تم التراجع عن آخر إرسال.", hintMove: "تلميح: اختر الراكب {color} من الصف {queue}.", deadlockKicker: "المسار مغلق", deadlockTitle: "مسار الانتظار مسدود",
