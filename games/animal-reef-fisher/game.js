(() => {
  ...
  function updateBattleScale() {
    ...
    document.documentElement.style.setProperty("--reef-battle-scale", String(scale));
    document.documentElement.style.setProperty("--reef-battle-width", `${390 * scale}px`);
    document.documentElement.style.setProperty("--reef-battle-height", `${788 * scale + 56}px`);
  }
