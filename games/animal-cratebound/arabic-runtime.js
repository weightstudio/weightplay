(()=>{
  ...
  if(!document.querySelector('script[data-wp-cratebound-interface7]')){
    const compat=document.createElement("script");
    compat.src=new URL("interface-7-compat.js?v=20260923-cratebound-interface7-cleanup1",document.currentScript?.src||location.href).href;
    compat.async=false;
    compat.dataset.wpCrateboundInterface7="true";
