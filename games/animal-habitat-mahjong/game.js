(() => {
  ...
  nodes.stageScreen.dataset.wpCanvasMaxWidth = "viewport";
  document.querySelector("#battleSlot .battle-canvas").dataset.wpCanvasMaxWidth = "viewport";
  const copy = {
