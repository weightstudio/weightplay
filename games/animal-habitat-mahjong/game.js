(() => {
  ...
  nodes.stageScreen.dataset.wpCanvasMaxWidth = "920";
  document.querySelector("#battleSlot .battle-canvas").dataset.wpCanvasMaxWidth = "920";
  const copy = {
  ...
  const habitatMahjongComparison = {
    "en": { heading:"Similar mahjong-solitaire reference", body:"Microsoft Mahjong and Habitat Mahjong both center on matching tiles and clearing boards, with Undo or reshuffle-style recovery when you need to reconsider a move. Microsoft’s official Xbox page offers selectable difficulties and boards, Daily Challenges across five modes, achievements, statistics, and cloud progress through a Microsoft account. Habitat Mahjong instead uses 30 authored browser boards across six rule chapters, with diamond-key seals, starred family rescues, alternating A/B patrol routes, no countdown failure, and progress stored only in this browser.", disclaimer:"Habitat Mahjong is an independent WeightPlay game, not an official version of Microsoft Mahjong. WeightPlay is not affiliated with, endorsed by, or partnered with Microsoft or Xbox Game Studios.", source:"Official source: Xbox — Microsoft Mahjong" },
    "zh-Hant": { heading:"相似麻將接龍玩法參考", body:"Microsoft Mahjong 與《動物棲地麻將》都以配對牌面、逐步清空牌局為核心，也都有復原或重新整理牌局的輔助方式。Microsoft 官方 Xbox 頁面提供難度與牌局選擇、五種每日挑戰模式、成就、統計資料，以及登入 Microsoft 帳號後的雲端進度。《動物棲地麻將》則是 30 個固定設計的瀏覽器關卡，分成六個規則章節，加入鑽石鑰匙封印、星號家庭救援、A/B 巡邏路線交替，沒有倒數失敗，進度只保存在這個瀏覽器。", disclaimer:"《動物棲地麻將》是 WeightPlay 的獨立作品，並非 Microsoft Mahjong 官方版本。WeightPlay 與 Microsoft 或 Xbox Game Studios 沒有隸屬、背書或合作關係。", source:"官方來源：Xbox — Microsoft Mahjong" },
    "zh-Hans": { heading:"相似麻将接龙玩法参考", body:"Microsoft Mahjong 与《动物栖地麻将》都以配对牌面、逐步清空牌局为核心，也都有撤销或重新整理牌局的辅助方式。Microsoft 官方 Xbox 页面提供难度与牌局选择、五种每日挑战模式、成就、统计数据，以及登录 Microsoft 账号后的云端进度。《动物栖地麻将》则是 30 个固定设计的浏览器关卡，分成六个规则章节，加入钻石钥匙封印、星号家庭救援、A/B 巡逻路线交替，没有倒计时失败，进度只保存在这个浏览器。", disclaimer:"《动物栖地麻将》是 WeightPlay 的独立作品，并非 Microsoft Mahjong 官方版本。WeightPlay 与 Microsoft 或 Xbox Game Studios 没有隶属、背书或合作关系。", source:"官方来源：Xbox — Microsoft Mahjong" },
    "ja": { heading:"似た麻雀ソリティアの参考作品", body:"Microsoft Mahjong と Habitat Mahjong は、牌をそろえて盤面を片づけていくことを中心にし、手順を見直すための元に戻す・並べ直し系の補助も備えています。Microsoft の Xbox 公式ページでは、難易度やボードの選択、5 種類のデイリーチャレンジ、実績、統計、Microsoft アカウントによるクラウド進行が案内されています。Habitat Mahjong は、6 章・30 個の固定ブラウザ盤面に、ダイヤの鍵による封印、星付き家族の救出、A/B 巡回ルートの交替を加え、時間切れによる失敗はなく、進行はこのブラウザだけに保存します。", disclaimer:"Habitat Mahjong は WeightPlay の独立作品であり、Microsoft Mahjong の公式版ではありません。WeightPlay は Microsoft または Xbox Game Studios と提携・協賛・共同開発していません。", source:"公式情報：Xbox — Microsoft Mahjong" },
    "ko": { heading:"비슷한 마작 솔리테어 참고 게임", body:"Microsoft Mahjong과 Habitat Mahjong은 모두 타일을 맞춰 보드를 비우는 플레이를 중심으로 하며, 수를 다시 생각할 수 있도록 되돌리기나 재배치 계열의 도움 기능을 제공합니다. Microsoft의 Xbox 공식 페이지는 난이도와 보드 선택, 5가지 일일 도전 모드, 도전 과제, 통계, Microsoft 계정 기반 클라우드 진행을 안내합니다. Habitat Mahjong은 대신 6개 규칙 장에 걸친 30개의 고정 브라우저 보드에 다이아몬드 열쇠 봉인, 별표 가족 구조, A/B 순찰 경로 교대를 넣었고 시간 제한 실패가 없으며 진행 상황은 이 브라우저에만 저장됩니다.", disclaimer:"Habitat Mahjong은 WeightPlay의 독립 작품이며 Microsoft Mahjong의 공식 버전이 아닙니다. WeightPlay은 Microsoft 또는 Xbox Game Studios와 제휴, 보증, 공동 개발 관계가 없습니다.", source:"공식 출처: Xbox — Microsoft Mahjong" },
    "es": { heading:"Referencia de mahjong solitario similar", body:"Microsoft Mahjong y Habitat Mahjong se centran en emparejar fichas y despejar tableros, con opciones de deshacer o reorganizar cuando hace falta replantear una jugada. La página oficial de Xbox de Microsoft ofrece selección de dificultad y tablero, Desafíos diarios en cinco modos, logros, estadísticas y progreso en la nube con una cuenta de Microsoft. Habitat Mahjong, en cambio, presenta 30 tableros diseñados para navegador en seis capítulos de reglas, con sellos de llave de diamante, rescates de familias con estrella, rutas de patrulla A/B alternas, sin fallo por cuenta atrás y con progreso guardado solo en este navegador.", disclaimer:"Habitat Mahjong es un juego independiente de WeightPlay, no una versión oficial de Microsoft Mahjong. WeightPlay no está afiliado, respaldado ni asociado con Microsoft o Xbox Game Studios.", source:"Fuente oficial: Xbox — Microsoft Mahjong" },
    "pt-BR": { heading:"Referência de mahjong solitaire semelhante", body:"Microsoft Mahjong e Habitat Mahjong têm como núcleo combinar peças e limpar tabuleiros, com recursos de desfazer ou reorganizar quando é preciso rever uma jogada. A página oficial da Xbox da Microsoft oferece escolha de dificuldade e tabuleiro, Desafios Diários em cinco modos, conquistas, estatísticas e progresso na nuvem com uma conta Microsoft. Habitat Mahjong, por outro lado, traz 30 tabuleiros de navegador criados à mão em seis capítulos de regras, com selos de chave de diamante, resgate de famílias marcadas com estrela, rotas de patrulha A/B alternadas, sem derrota por contagem regressiva e com progresso salvo apenas neste navegador.", disclaimer:"Habitat Mahjong é um jogo independente da WeightPlay, não uma versão oficial de Microsoft Mahjong. A WeightPlay não é afiliada, endossada nem parceira da Microsoft ou da Xbox Game Studios.", source:"Fonte oficial: Xbox — Microsoft Mahjong" },
    "fr": { heading:"Référence de mahjong solitaire similaire", body:"Microsoft Mahjong et Habitat Mahjong reposent tous deux sur l’association de tuiles et le nettoyage progressif du plateau, avec des aides de type annulation ou remélange pour revoir un choix. La page Xbox officielle de Microsoft propose le choix de la difficulté et du plateau, des défis quotidiens répartis en cinq modes, des succès, des statistiques et une progression dans le cloud via un compte Microsoft. Habitat Mahjong propose plutôt 30 plateaux de navigateur conçus à l’avance dans six chapitres de règles, avec des sceaux à clé diamant, des sauvetages de familles étoilées, des routes de patrouille A/B alternées, sans échec au compte à rebours et avec une progression enregistrée uniquement dans ce navigateur.", disclaimer:"Habitat Mahjong est une création indépendante de WeightPlay et non une version officielle de Microsoft Mahjong. WeightPlay n’est ni affilié, ni approuvé, ni partenaire de Microsoft ou Xbox Game Studios.", source:"Source officielle : Xbox — Microsoft Mahjong" },
    "de": { heading:"Referenz für ähnliches Mahjong-Solitaire", body:"Microsoft Mahjong und Habitat Mahjong drehen sich beide darum, Spielsteine zu paaren und das Brett nach und nach abzuräumen; Rückgängig- oder Neuordnen-Hilfen unterstützen dabei, einen Zug neu zu überdenken. Die offizielle Xbox-Seite von Microsoft nennt wählbare Schwierigkeitsgrade und Bretter, tägliche Herausforderungen in fünf Modi, Erfolge, Statistiken und Cloud-Fortschritt mit einem Microsoft-Konto. Habitat Mahjong bietet stattdessen 30 fest entworfene Browser-Bretter in sechs Regelkapiteln mit Diamantschlüssel-Siegeln, Rettung markierter Familien, wechselnden A/B-Patrouillenrouten, ohne Countdown-Niederlage und mit Fortschritt nur in diesem Browser.", disclaimer:"Habitat Mahjong ist ein eigenständiges WeightPlay-Spiel und keine offizielle Version von Microsoft Mahjong. WeightPlay ist weder mit Microsoft oder Xbox Game Studios verbunden noch von ihnen unterstützt oder als Partner beteiligt.", source:"Offizielle Quelle: Xbox — Microsoft Mahjong" },
    "it": { heading:"Riferimento a un mahjong solitaire simile", body:"Microsoft Mahjong e Habitat Mahjong ruotano entrambi attorno all’abbinamento delle tessere e alla pulizia progressiva del tabellone, con funzioni di annullamento o rimescolamento per ripensare una mossa. La pagina Xbox ufficiale di Microsoft offre scelta di difficoltà e tabellone, Sfide giornaliere in cinque modalità, obiettivi, statistiche e progressi cloud tramite un account Microsoft. Habitat Mahjong propone invece 30 tabelloni browser progettati a mano in sei capitoli di regole, con sigilli a chiave di diamante, salvataggi di famiglie contrassegnate da stelle, percorsi di pattuglia A/B alternati, nessuna sconfitta per conto alla rovescia e progressi salvati solo in questo browser.", disclaimer:"Habitat Mahjong è un gioco indipendente di WeightPlay, non una versione ufficiale di Microsoft Mahjong. WeightPlay non è affiliata, approvata o partner di Microsoft o Xbox Game Studios.", source:"Fonte ufficiale: Xbox — Microsoft Mahjong" },
    "ru": { heading:"Похожая игра в жанре маджонг-пасьянс", body:"Microsoft Mahjong и Habitat Mahjong строятся вокруг поиска пар и постепенной очистки поля, а отмена или перемешивание помогают пересмотреть неудачный ход. На официальной странице Xbox для Microsoft Mahjong указаны выбор сложности и раскладки, ежедневные задания в пяти режимах, достижения, статистика и облачное сохранение через учётную запись Microsoft. Habitat Mahjong вместо этого предлагает 30 заранее созданных браузерных раскладок в шести главах правил, печати с алмазными ключами, спасение отмеченных звёздами семей, чередующиеся маршруты патруля A/B, отсутствие проигрыша по таймеру и прогресс только в этом браузере.", disclaimer:"Habitat Mahjong — самостоятельная игра WeightPlay, а не официальная версия Microsoft Mahjong. WeightPlay не связана с Microsoft или Xbox Game Studios, не одобрена ими и не состоит с ними в партнёрстве.", source:"Официальный источник: Xbox — Microsoft Mahjong" },
    "hi": { heading:"मिलते-जुलते महजोंग सॉलिटेयर का संदर्भ", body:"Microsoft Mahjong और Habitat Mahjong दोनों में टाइलों के जोड़े बनाकर बोर्ड साफ करना मुख्य खेल है, और गलत चाल पर फिर सोचने के लिए Undo या reshuffle जैसे सहायक विकल्प मिलते हैं। Microsoft की आधिकारिक Xbox जानकारी में कठिनाई और बोर्ड चुनना, पाँच मोड वाले Daily Challenges, achievements, आँकड़े और Microsoft खाते के साथ cloud progress शामिल हैं। Habitat Mahjong इसके बजाय छह नियम-अध्यायों में 30 तयशुदा ब्राउज़र बोर्ड देता है, जिनमें diamond-key seals, सितारे वाले family rescues और बदलते A/B patrol routes हैं; इसमें countdown से हार नहीं होती और प्रगति केवल इसी ब्राउज़र में सहेजी जाती है।", disclaimer:"Habitat Mahjong, WeightPlay का स्वतंत्र खेल है और Microsoft Mahjong का आधिकारिक संस्करण नहीं है। WeightPlay का Microsoft या Xbox Game Studios से कोई संबद्धता, समर्थन या साझेदारी नहीं है।", source:"आधिकारिक स्रोत: Xbox — Microsoft Mahjong" },
    "ar": { heading:"مرجع للعب ماهجونغ سوليتير مشابه", body:"تتمحور Microsoft Mahjong وHabitat Mahjong حول مطابقة القطع وتنظيف اللوحة تدريجيًا، مع أدوات مثل التراجع أو إعادة الخلط لإعادة التفكير في الحركة. تذكر صفحة Xbox الرسمية من Microsoft إمكانية اختيار مستوى الصعوبة واللوحة، وتحديات يومية عبر خمسة أوضاع، والإنجازات والإحصاءات وحفظ التقدم سحابيًا عبر حساب Microsoft. أما Habitat Mahjong فتقدم 30 لوحة متصفح مصممة مسبقًا ضمن ستة فصول للقواعد، مع أختام مفاتيح ماسية وإنقاذ عائلات مميزة بالنجوم ومسارات دورية A/B تتناوب، ومن دون خسارة بسبب عدّ تنازلي، مع حفظ التقدم في هذا المتصفح فقط.", disclaimer:"Habitat Mahjong لعبة مستقلة من WeightPlay وليست إصدارًا رسميًا من Microsoft Mahjong. لا توجد علاقة انتساب أو تأييد أو شراكة بين WeightPlay وMicrosoft أو Xbox Game Studios.", source:"المصدر الرسمي: Xbox — Microsoft Mahjong" }
  };
  const habitatMahjongComparisonSource = "https://www.xbox.com/en-us/play/games/microsoft-mahjong/9WZDNCRFHWCP";
  function applyMarketComparison() {
    const block = document.querySelector('[data-habitat-mahjong-comparison]');
    if (!block) return;
    const activeLocale = actualLocale();
    const content = habitatMahjongComparison[activeLocale] || habitatMahjongComparison.en;
    const titleCatalog = window.WEIGHTPLAY_GAME_TITLES?.['animal-habitat-mahjong'];
    const ownTitle = titleCatalog?.[activeLocale] || titleCatalog?.en || 'Habitat Mahjong';
    const normalizeOwnTitle = (value) => ['Habitat Mahjong', '動物棲地麻將', '动物栖地麻将'].reduce((out, alias) => out.replaceAll(alias, ownTitle), String(value || ''));
    block.dataset.comparisonLocale = activeLocale;
    block.querySelector('[data-compare="heading"]').textContent = content.heading;
    block.querySelector('[data-compare="body"]').textContent = normalizeOwnTitle(content.body);
    block.querySelector('[data-compare="disclaimer"]').textContent = normalizeOwnTitle(content.disclaimer);
    const source = block.querySelector('[data-compare-source]');
    source.textContent = content.source;
    source.href = habitatMahjongComparisonSource;
  }
  function applyLocale() { locale = actualLocale(); document.documentElement.lang = locale; document.title = `${t("title")} - WeightPlay`; document.querySelectorAll("[data-ui]").forEach((el) => { el.textContent = t(el.dataset.ui); }); document.querySelectorAll("[data-aria]").forEach((el) => { el.setAttribute("aria-label", t(el.dataset.aria)); }); nodes.localeSelect.value = locale; applyMarketComparison(); renderMain(); renderStage(); if (state) renderBattle(); window.dispatchEvent(new CustomEvent("wonder:locale-change", { detail:{ locale } })); }
  ...
  const stageIntroDescriptionText = (habitat) => t(ruleKey(habitat));
