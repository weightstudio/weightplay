(() => {
  ...
  // Arabic owns the decision-critical game copy instead of inheriting the
  // English dictionary through the shared locale catalog. Keep this block
  // game-local so Battle labels, traits, status feedback, and accessibility
  // names stay coherent when the route is loaded directly in Arabic.
  text.ar = Object.assign({}, text.en, {
    title: "تكتيكات الرون للحيوانات",
    language: "اللغة",
    backToLobby: "العودة إلى الردهة",
    backToMenu: "العودة إلى المهام",
    backToMain: "العودة إلى القائمة الرئيسية",
    startGame: "ابدأ اللعبة",
    menuTitle: "قد فرقة الرون.",
    menuHint: "اختر مهمة، وحرّك أبطال الحيوانات على شبكة الرون، وتغلّب على الأعداء بتمركز ذكي.",
    profileLevel: "المستوى",
    profileXp: "الخبرة",
    profileBest: "أفضل مهمة",
    profileRunes: "الرونات",
    heroTrainingTitle: "تدريب الأبطال",
    heroTrainingHint: "أنفق الرونات لترقية كل بطل حيواني بشكل دائم.",
    heroLevel: "المستوى {level}",
    heroUpgradeCost: "ترقية {cost}",
    heroUpgradeMax: "أعلى مستوى",
    lionRole: "مهاجم الصف الأمامي",
    owlRole: "انفجار بعيد المدى",
    turtleRole: "حامي الفريق",
    missionSelect: "اختر مهمة",
    missionHint: "تُحفظ المهام المفتوحة على هذا الجهاز.",
    missionCard: "المهمة {n}",
    missionGoal: "الهدف: اهزم {enemies}",
    missionReward: "{xp} خبرة / {runes} رونات",
    missionEnemyLine: "الأعداء: {enemies}",
    locked: "مغلقة",
    trainingTitle: "خانة التدريب",
    trainingText: "دائم: يبدأ الأبطال كل مهمة بطاقة رون إضافية واحدة.",
    trainingOwned: "مملوكة: طاقة البداية +1.",
    trainingNeed: "تحتاج إلى {cost} ألماسة.",
    trainingBuy: "افتحها مقابل {cost}",
    trainingConfirm: "اضغط مرة أخرى لفتح طاقة بداية دائمة +1. الألماس {before} ← {after}.",
    trainingConfirmAction: "تأكيد خانة التدريب الدائمة. الألماس من {before} إلى {after}.",
    trainingPurchased: "فُتحت: طاقة البداية +1. الألماس {before} ← {after}.",
    ...
    skill: "مهارة",
    endTurn: "إنهاء الدور",
    chooseHero: "اختر بطلاً. حرّكه مرة، ثم نفّذ إجراءً واحداً.",
    chooseTarget: "{hero}: الصحة {hp}/{maxHp}، الطاقة {energy}.",
    ready: "جاهز",
    acted: "تم الإجراء",
    fallen: "سقط",
    positioned: "تمركز",
    turnRosterTitle: "إجراءات الفرقة",
    skillInfo: "المهارة: {skill} — {desc}",
    skillInfoLabel: "المهارة",
    skillLion: "وثبة الأسد",
    skillLionDesc: "تسبب ضرراً كبيراً لأقرب هدف.",
    skillOwl: "سهم الرون",
    skillOwlDesc: "اضرب من مسافة أبعد بسحر الرون.",
    skillTurtle: "حماية الدرع",
    skillTurtleDesc: "احرس الفرقة كلها واستعد نقطة صحة واحدة.",
    attackValue: "هجوم {value}",
    guardValue: "حراسة -1",
    guardHelp: "خفّض ضرر ضربة العدو التالية بمقدار 1.",
    skillValue: "مهارة {value}",
    actionTarget: "استخدم {action} لتسبب {value} من الضرر لـ {target}.",
    skillSquadResult: "{skill}: احرس جميع الأبطال واستعد لكل منهم حتى نقطة صحة واحدة.",
    skillEnergyChange: "تستهلك طاقة واحدة. الطاقة من {energy} إلى {remaining}.",
    skillEnergyNeed: "تحتاج إلى طاقة واحدة؛ الحالية {energy}.",
    skillSilenced: "غير متاحة أثناء الصمت.",
    health: "الصحة",
    energy: "الطاقة",
    heroTileLabel: "{hero}، الصحة {hp}/{maxHp}، {status}، الصف {row}، العمود {column}.",
    enemyTileLabel: "{enemy}، الصحة {hp}/{maxHp}، الصف {row}، العمود {column}.",
    moveTileLabel: "تحرك إلى الصف {row}، العمود {column}.",
    emptyTileLabel: "الصف {row}، العمود {column}.",
    moved: "تحرك {hero}.",
    attacked: "هاجم {hero} {enemy}.",
    guarded: "احتمى {hero}.",
    skillUsed: "استخدم {hero} مهارة رونية.",
    enemyTurn: "الأعداء يتحركون.",
    chooseReward: "اختر مكافأة رونية",
    reroll: "إعادة السحب 3",
    rerollNeed: "تحتاج إلى 3 ألماسات لإعادة السحب.",
    missionClear: "اكتملت المهمة",
    missionFailed: "فشلت المهمة",
    resultWin: "اكتملت المهمة {mission}. حصلت على {xp} خبرة و{runes} رونات.",
    resultLose: "سقطت فرقة الرون في المهمة {mission}. أبقِ حراسة السلحفاة في المقدمة.",
    resultPlan: "خطة المهمة التالية",
    planWin: "المهمة التالية: ابقَ في مسارات آمنة، وركّز على هدف واحد، واختر مكافأة تناسب سمة العدو التالي.",
    planLose: "خطة الإعادة: استخدم الحراسة قبل دور العدو، وأبقِ السلحفاة في المقدمة، وركّز على وحش واحد حتى يسقط.",
    ...
    turtle: "درع السلحفاة",
    wolf: "الذئب الظلي",
    raven: "الغراب البلوري",
    stag: "الأيل الحجري",
    boar: "الخنزير الشوكي",
    runeFox: "الثعلب الروني",
    tideTurtle: "سلحفاة المد",
    heron: "مالك الحزين الأثري",
    salamander: "سمندر الجمر",
    ram: "كبش الرماد",
    moth: "عثة القمر",
    archiveOwl: "بومة الأرشيف",
    mirrorWolf: "ذئب المرآة",
    sealRaven: "غراب الختم",
    rhinoBoss: "وحيد القرن جذر الحديد",
    serpentBoss: "أفعى ميركويل",
    emberLionBoss: "أسد عرف الجمر",
    griffinBoss: "غريفين الكسوف",
    chimeraBoss: "كيميرا تاج الرون",
    rewardPower: "رون القوة",
    rewardPowerDesc: "+1 لهجوم الأبطال.",
    rewardGuard: "ميدالية الحارس",
    rewardGuardDesc: "+1 للحد الأقصى لصحة جميع الأبطال.",
    rewardShard: "شظية رون",
    rewardShardDesc: "+35 خبرة بعد المهمة.",
    rewardRevive: "رمز الإحياء",
    rewardReviveDesc: "أعد بطلاً واحداً سقط بعد الانتصار.",
    rewardFocus: "رون التركيز",
    rewardFocusDesc: "+1 لطاقة البداية في المهمة التالية.",
    missionPlan: "الخطة: {plan}",
    missionTactic1: "افصل الذئبين قبل التركيز على هدف واحد.",
    missionTactic2: "أبقِ أضعف بطل خارج مدى الغراب.",
    missionTactic3: "اختر مساراً حول خانات الجسر المغلقة.",
    missionTactic4: "دع السلحفاة تثبت مساراً بينما يفرّق الأسد القطيع.",
    missionTactic5: "اكسر جلد الحجر مرتين وتجنب اندفاعة الزعيم.",
    missionTactic6: "استخدم مدى البومة لتجنب رد الخنزير الشوكي.",
    missionStatusCurrent: "محددة",
    missionStatusUnlocked: "اضغط للاختيار",
    missionRewardLabel: "مكافأة الإكمال",
    startSelectedMission: "ابدأ المهمة {n}",
    progressionTitle: "نمو دائم",
    progressionLevelLine: "مستوى الفرقة {level} / يتبقى {xp} خبرة للمستوى التالي",
    progressionHeroLine: "ترقيات الأبطال: الأسد {lion}، البومة {owl}، السلحفاة {turtle}",
    progressionBonusLine: "المكافآت المحفوظة: هجوم +{atk}، صحة +{hp}، طاقة +{energy}، رموز إحياء {revives}",
    progressionNextUpgrade: "الترقية التالية: يحتاج {hero} إلى {cost} رونات إضافية.",
    heroGrowthStats: "دائم: صحة +{hp} / هجوم +{atk}",
    heroNextStats: "المستوى التالي {level}: صحة +{hp} / هجوم +{atk}",
    heroUpgradeNeed: "تحتاج إلى {need} رونات إضافية",
    heroUpgradeReady: "جاهز للترقية",
    rewardPermanent: "نمو دائم",
    reviveTriggered: "استخدم {hero} رمز إحياء وعاد إلى المعركة.",
    resultProgressTitle: "التقدم المحفوظ",
    resultRewardChosen: "حُفظت المكافأة: {reward} — {effect}",
    resultRewardNone: "لم تُحفظ مكافأة رونية في هذه المحاولة.",
    resultProgressLine: "مستوى الفرقة {level} · {xp}/100 خبرة · {runes} رونات · أفضل مهمة {best}",
    resultMissionUnlocked: "فُتحت المهمة {mission}.",
    resultMissionReady: "ما زالت المهمة {mission} جاهزة.",
    resultCampaignComplete: "اكتملت المهام الثلاثون كلها. وما زالت كل مهمة قابلة لإعادة اللعب.",
    resultUpgradeReady: "يمكن ترقية {hero} الآن في قسم الأبطال.",
    resultUpgradeNeed: "يحتاج {hero} إلى {need} رونات إضافية للترقية.",
    enemyTraits: "سمات الأعداء: {traits}",
    traitWolf: "ناب القطيع",
    traitWolfShort: "قطيع",
    traitWolfDesc: "+1 ضرر عند الوقوف بجانب ذئب آخر.",
    traitRaven: "بصر الضعف",
    traitRavenShort: "اصطياد",
    traitRavenDesc: "يستهدف البطل ذي الصحة الأقل.",
    traitStag: "جلد حجري",
    traitStagShort: "درع",
    traitStagDesc: "يقلل أول ضربة في كل دور لاعب بمقدار 1.",
    traitBoar: "رد شوكي",
    traitBoarShort: "رد",
    traitBoarDesc: "يرد ضرراً واحداً بعد ضربة بطل مجاور.",
    traitRuneFox: "خطوة الثعلب",
    traitRuneFoxShort: "انتقال",
    traitRuneFoxDesc: "ينتقل خلف أضعف بطل بعد تنفيذ دوره.",
    traitTideTurtle: "قافلة الصدفة",
    traitTideTurtleShort: "حراسة",
    traitTideTurtleDesc: "يمنح الحليف الأقرب حماية من ضربة واحدة.",
    traitHeron: "جناح التيار",
    traitHeronShort: "دفع",
    traitHeronDesc: "يدفع البطل الذي يصيبه إلى خانة قانونية واحدة.",
    traitSalamander: "أثر الجمر",
    traitSalamanderShort: "حرق",
    traitSalamanderDesc: "يترك خانة حارقة مؤذية بعد الحركة.",
    traitRam: "خط الكبش",
    traitRamShort: "اندفاع",
    traitRamDesc: "يندفع في خط مستقيم عندما يرى بطلاً.",
    traitMoth: "غبار القمر",
    traitMothShort: "صمت",
    traitMothDesc: "تمنع ضربته مهارة البطل التالية.",
    traitArchiveOwl: "علامة المراقب",
    traitArchiveOwlShort: "علامة",
    traitArchiveOwlDesc: "يضع علامة تجعل الضربة البعيدة التالية تسبب +1 ضرر.",
    traitMirrorWolf: "انقسام المرآة",
    traitMirrorWolfShort: "نسخة",
    traitMirrorWolfDesc: "ينشئ نسخة مرآة مجاورة بصحة 1.",
    traitSealRaven: "امتصاص الختم",
    traitSealRavenShort: "امتصاص",
    traitSealRavenDesc: "يمتص طاقة واحدة من البطل الذي يصيبه.",
    traitRhinoBoss: "اندفاعة جذر الحديد",
    traitRhinoBossShort: "زعيم",
    traitRhinoBossDesc: "يتأهب، ويندفع عبر صف، ويترك أنقاضاً مغلقة.",
    traitSerpentBoss: "دوامة المستنقع",
    traitSerpentBossShort: "زعيم",
    traitSerpentBossDesc: "يغمر عموداً ويسحبه؛ ويتجدد ما لم يُضرب مرتين في دور واحد.",
    traitEmberLionBoss: "دورة الجمر",
    traitEmberLionBossShort: "زعيم",
    traitEmberLionBossDesc: "يتناوب بين الزئير والقفز وإجراءات إضافية عند الإصابة.",
    traitGriffinBoss: "طيران الكسوف",
    traitGriffinBossShort: "زعيم",
    traitGriffinBossDesc: "يتناوب بين مناعة الهجمات البعيدة أثناء الطيران والكنس على الأرض.",
    traitChimeraBoss: "التاج السداسي",
    traitChimeraBossShort: "نهائي",
    traitChimeraBossDesc: "يتناوب بين الاندفاع والمدّ والحرق والطيران واستدعاء النسخ في مراحل واضحة.",
    wolfPackHit: "ناب القطيع: سبب {enemy} ضرراً إضافياً قدره 1.",
    ravenWeakHit: "بصر الضعف: طارد {enemy} البطل الأضعف.",
    stagArmorHit: "خفّض الجلد الحجري ضرر {hero} بمقدار 1.",
    terrainRubble: "أنقاض",
    terrainSnare: "فخ الجذور",
    terrainTide: "مدّ",
    terrainBurn: "حرق",
    terrainCooling: "رون التبريد",
    terrainOrbit: "رون المدار",
    terrainSeal: "ختم الرون",
    tileTerrainLabel: "{terrain}. {tile}",
    silenceBlocked: "أسكت غبار القمر مهارة {hero}.",
    terrainBurnHit: "سبب الحرق ضرراً قدره 1 لـ {hero}.",
    terrainCoolingUsed: "استعاد {hero} طاقة واحدة على رون التبريد.",
    boarCounterHit: "ردّ الرد الشوكي ضرراً قدره 1 على {hero}.",
    turtleGuarded: "حمَت قافلة الصدفة {enemy}.",
    heronPushed: "دفع جناح التيار {hero}.",
    foxTeleported: "انتقلت خطوة الثعلب خلف {hero}.",
    ramCharged: "اندفع خط الكبش نحو {hero}.",
    mothSilenced: "أسكت غبار القمر {hero}.",
    owlMarked: "حددت علامة المراقب {hero}.",
    ravenDrained: "امتصاص الختم أزال طاقة واحدة من {hero}.",
    mirrorCloned: "أنشأ انقسام المرآة نسخة بصحة 1.",
    bossPhase: "دخل {boss} المرحلة {phase}.",
    boardLabel: "لوحة تكتيكات الرون",
    strategyTips: [
      "افصل الذئاب قبل تبادل الضرر؛ قد تزيل حركة واحدة ناب القطيع من هجومين.",
      "استخدم البومة من مسافة خانتين حتى لا يرد الخنزير الشوكي بهجوم قريب.",
      "يستطيع البطل الصامت التحرك والهجوم والحراسة؛ استغل الدور للخروج من مسار الاندفاع.",
      "اضرب أفعى ميركويل ببطلين مختلفين في الدور نفسه لإيقاف التجدد.",
      "استخدم الأسد أثناء طيران غريفين الكسوف، ثم تفرق قبل كنسه الأرضي.",
      "أزل نسخة المرآة ذات الصحة الواحدة قبل أن تسد خانة الحركة التي تحتاجها.",
      "اعتبر خانات التبريد والختم والمدار موارد؛ الإحصاءات الدائمة لا تعوض التموضع الصحيح.",
    ],
    positioned: "تمركز",
    moveReady: "تحرك {hero} وما زال قادراً على التصرف.",
    moveThenActHint: "تحرك مرة واحدة، ثم هاجم أو احرس أو استخدم مهارة.",
    runeChain: "سلسلة الرون x{count}: ضرر +{bonus}!",
    runeChainHint: "ركّز على {enemy}: تحصل ضربة الفرقة التالية على ضرر +{bonus}.",
    runeChainReady: "ابدأ سلسلة الرون بالتركيز على عدو واحد.",
    battlePreview: "موجز المهمة",
    squadRule: "قاعدة الفرقة",
    missionTactic: "خطة المهمة",
    pause: "إيقاف مؤقت",
    pauseTitle: "المعركة متوقفة مؤقتاً",
    pauseHint: "يتجمد دور العدو وكل إجراء معلّق حتى تتابع.",
    resume: "متابعة",
    pauseMenu: "العودة إلى المهام",
    battleDetails: "تفاصيل المعركة",
    endTurnDecision: "إنهاء الدور. ما زال {count} من الأبطال جاهزاً: {heroes}. سيتحرك الأعداء تالياً.",
    endTurnDecisionNone: "إنهاء الدور. تحرك كل الأبطال الأحياء. سيتحرك الأعداء تالياً.",
    nextThreatPreview: "التهديد التالي: {enemy} — {detail} مثال: إذا كانت صحة {hero} هي الأقل، انقله خارج المدى قبل دور العدو.",
    battleTraitGuide: "سمات الأعداء:",
    attackRangeHint: "الهجوم غير متاح: لا يوجد عدو ضمن مدى هذا البطل. اقترب أو اختر الحراسة أو المهارة.",
  });
  ...
  const missionCopyAr = [
    ["آثار الأقدام الأولى", "افصل الذئبين قبل التركيز على هدف واحد."],
    ["خط رؤية الغراب", "أبقِ أضعف بطل خارج مدى الغراب."],
    ["جسر الرون المكسور", "اختر مساراً حول خانات الجسر المغلقة."],
    ["مفترق القطيع", "دع السلحفاة تثبت مساراً بينما يفرّق الأسد القطيع."],
    ["اختبار القرن الحجري", "اكسر الجلد الحجري مرتين وتجنب اندفاعة الزعيم."],
    ["أسنان الشوك", "استخدم مدى البومة حتى لا يعاقبك الرد الشوكي."],
    ["بوابة خطوة الثعلب", "احمِ أضعف بطل قبل أن يصل الثعلب إلى الخلف."],
    ["فخ الجذور", "اعبر المركز من دون إنهاء دور البطل الخطأ على فخ الجذور."],
    ["كماشة الحدادة", "أزل جانباً من الثعلب قبل أن تقرّب الأسد من الخنزير."],
    ["وحيد القرن جذر الحديد", "أبعد اندفاعة وحيد القرن عن المركز قبل أن تغلق الأنقاض اللوحة."],
    ["النقش المغمور", "توقع انتقال خانات المد بعد دور العدو."],
    ["قافلة الصدفة", "استنفد حماية الضربة الواحدة قبل مهاجمة الحليف المحمي."],
    ["تيار مالك الحزين", "اترك خانات هبوط قانونية حتى لا يعزل جناح التيار البومة."],
    ["التشكيل الغارق", "قرر بين كسر الحراسة وإيقاف دفع مالك الحزين."],
    ["أفعى ميركويل", "اضرب الأفعى ببطلين في كل دور لإيقاف التجدد."],
    ["آثار الجمر", "راقب خانة السمندر السابقة قبل التقدم."],
    ["خط الكبش", "ابتعد عن صف الكبش بدلاً من تحمل الاندفاعة كلها."],
    ["رونات التبريد", "مرّر بطلاً منخفض الطاقة فوق رون تبريد."],
    ["انقسام فوهة البركان", "اترك خانة هروب مفتوحة بينما تقسم الاندفاعات الفرقة."],
    ["أسد عرف الجمر", "اقرأ دورة الزئير والقفز والإجراء الإضافي عند الإصابة."],
    ["غبار القمر", "استخدم مهارة قبل أن يُسكت غبار القمر ذلك البطل."],
    ["جثم المراقب", "حرّك البطل المحدد قبل الضربة البعيدة التالية."],
    ["رونات المدار", "توقع دوران الحلقة الخارجية مع عقارب الساعة عند نهاية الجولة."],
    ["نيران الكسوف المتقاطعة", "رتب المهارات والحركة والحراسة قبل تداخل الصمت والعلامات."],
    ["غريفين الكسوف", "استخدم القتال القريب أثناء الطيران ثم تفرق قبل كنسه الأرضي."],
    ["قطيع المرآة", "اترك خانة مجاورة أو أزل نسخة الصحة الواحدة فوراً."],
    ["محكمة الريش المختوم", "احمِ الطاقة بينما تتحكم في الخانة الحرة للنسخة."],
    ["أقفال الرونات الستة", "احتل ثلاث خانات ختم مترابطة لإزالة حماية العدو."],
    ["تحدي التاج", "واجه خمس آليات سابقة من دون فقدان السيطرة على التشكيل."],
    ["كيميرا تاج الرون", "تكيف كلما غيّرت مرحلة زعيم واضحة قاعدة اللوحة."],
  ];
  missionDefs.forEach((definition, index) => {
    [definition.nameAr, definition.tacticAr] = missionCopyAr[index];
  });
