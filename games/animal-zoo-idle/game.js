(() => {
  ...
  const ASSETS = {
    ...
    stage: "assets/animal-zoo-idle-zoo-voxel-v1.png",
    lion: "../../assets/weightplay-boom-mane-lion.png",
    giraffe: "assets/zoo-giraffe-voxel-v1.png",
    elephant: "assets/zoo-elephant-voxel-v1.png",
    panda: "assets/zoo-red-panda-voxel-v1.png",
    penguin: "assets/zoo-penguin-voxel-v1.png",
    ...
    gate1: "assets/zoo-gate-voxel-v1.png",
    gate2: "assets/zoo-gate-voxel-v1.png",
    gate3: "assets/zoo-gate-voxel-v1.png",
    ticketBooth: "assets/zoo-ticket-booth-voxel-v1.png",
