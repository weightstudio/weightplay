(function () {
  ...
  const dictionary = {
    ...
    es: {
      ...
      startTitle: "Elige un carril. Corre rápido.", startText: "Completa 30 rutas guardadas cuyas reglas, objetivos y patrones de guardianes cambian tu forma de correr.", controlTap: "Toca izquierda / derecha", controlSwipe: "Desliza entre carriles", controlKeyboard: "A/D o ←/→", start: "Comenzar juego",
