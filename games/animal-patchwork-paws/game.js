(function(){
  ...
  function show(screen){currentScreen=screen;document.querySelectorAll("[data-screen],.game-page-info-static").forEach(node=>{node.hidden=(node.dataset.screen||"main")!==screen});$("settingsPanel").hidden=true;$("mainReturn").hidden=screen!=="main";$("backBtn").hidden=screen==="main";}
