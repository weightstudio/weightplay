(() => {
  ...
  const dailyReset={en:'Resets daily · 00:00 UTC','zh-Hant':'每日 00:00 UTC 重置','zh-Hans':'每日 00:00 UTC 重置',ja:'毎日 00:00 UTC にリセット',ko:'매일 00:00 UTC 초기화',es:'Se reinicia cada día · 00:00 UTC','pt-BR':'Reinicia diariamente · 00:00 UTC',fr:'Réinitialisation quotidienne · 00:00 UTC',de:'Tägliche Rücksetzung · 00:00 UTC',it:'Ripristino giornaliero · 00:00 UTC',ru:'Сброс ежедневно · 00:00 UTC',hi:'रोज़ 00:00 UTC पर रीसेट',ar:'إعادة ضبط يومية · 00:00 UTC'};
  ...
  Object.keys(L).forEach(code=>{const values=copy[code]||copy.en,soundValues=sound[code]||sound.en,patch={weekly:weekly[code]||weekly.en,dailyReset:dailyReset[code]||dailyReset.en,rewardClaimed:rewardClaimed[code]||rewardClaimed.en,cooldown:cooldown[code]||cooldown.en,battleSpeed:battleSpeed[code]||battleSpeed.en,sound:soundValues[0],enableSound:soundValues[1],disableSound:soundValues[2]};keys.forEach((key,index)=>patch[key]=values[index]);Object.assign(L[code],patch)});
