(() => {
  ...
  const patches = {
    en: {
      ...
      heldNext: "This rune will be held for the next Spin.", autoLocked: "AUTO unlocks after this rift is cleared.", autoLockedShort: "Clear Rift",
    ...
    "zh-Hant": {
      ...
      heldNext: "這個符文會保留到下一次轉動。", autoLocked: "通過這個裂隙後才會開放自動戰鬥。", autoLockedShort: "通關解鎖",
    ...
    "zh-Hans": {
      ...
      heldNext: "这个符文会保留到下一次转动。", autoLocked: "通过这个裂隙后才会开放自动战斗。", autoLockedShort: "通关解锁",
    ...
    ja: {
      ...
      heldNext: "次のスピンまでこのルーンを保持します。", autoLocked: "このリフトのクリア後にAUTOが解放されます。", autoLockedShort: "クリアで解放",
    ...
    ko: {
      ...
      heldNext: "이 룬은 다음 스핀까지 유지됩니다.", autoLocked: "이 균열을 클리어하면 AUTO가 열립니다.", autoLockedShort: "클리어 후 해금",
    ...
    es: {
      ...
      heldNext: "Esta runa se guardará para el próximo giro.", autoLocked: "AUTO se desbloquea al superar esta grieta.", autoLockedShort: "Supera la grieta",
    ...
    "pt-BR": {
      ...
      heldNext: "Esta runa ficará guardada para o próximo giro.", autoLocked: "AUTO libera após concluir esta fenda.", autoLockedShort: "Conclua a fenda",
    ...
    fr: {
      ...
      heldNext: "Cette rune sera gardée pour le prochain tour.", autoLocked: "AUTO se débloque après cette faille.", autoLockedShort: "Terminez la faille",
    ...
    de: {
      ...
      heldNext: "Diese Rune bleibt für den nächsten Dreh erhalten.", autoLocked: "AUTO wird nach Abschluss dieses Risses freigeschaltet.", autoLockedShort: "Riss abschließen",
    ...
    it: {
      ...
      heldNext: "Questa runa resta per il prossimo giro.", autoLocked: "AUTO si sblocca dopo aver superato questa frattura.", autoLockedShort: "Completa la frattura",
    ...
    ru: {
      ...
      heldNext: "Руна сохранится для следующего вращения.", autoLocked: "AUTO откроется после прохождения этого разлома.", autoLockedShort: "Пройдите разлом",
    ...
    hi: {
      ...
      heldNext: "यह रून अगली स्पिन के लिए सुरक्षित रहेगा।", autoLocked: "इस रिफ्ट को पूरा करने के बाद AUTO खुलेगा।", autoLockedShort: "रिफ्ट पूरा करें",
    ...
    ar: {
      ...
      heldNext: "سيُحتفظ بهذه الرونة للدورة التالية.", autoLocked: "يفتح AUTO بعد اجتياز هذا الصدع.", autoLockedShort: "أكمل الصدع",
