(function () {
  ...
  const en={
    ...
    guideChapterOneWalkthroughTitle:"Chapter One: Break the Veil",guideChapterOneRange:"Missions 1–23",
    guideChapterOneWalkthrough:"Begin by speaking with Orla, then interview all ten witnesses in Signal Town; the forest gate stays locked until the complete report is returned. In Veilwood, defeat the first eight patrols and use True Vision around cyan traces to expose cloaked targets and the laboratory entrance. Search the side paths for the Pulse Blade and Signal Charm before entering the lab. Clear all fifteen field enemies, recover Ranger Armor, and approach the Commander. During the Boss fight, circle the volleys, leave its charge line, and punish the brief stun. Recovering the stable device completes mission 23 but does not end the campaign.",
    guideChapterTwoWalkthroughTitle:"Chapter Two: Moonfall Relay",guideChapterTwoRange:"Missions 24–33",
    guideChapterTwoWalkthrough:"After the Commander Result, choose Continue Exploring and speak to Orla again. Her briefing opens the eastern gate to Moonfall Relay. Defeat all eight corrupted sentries before operating the archive: partial kill milestones advance the story, but the displayed objective correctly remains out of eight. Activate Origin, Memory, and Warning in that order. The records reveal that the supposed invasion fleet carried refugees and that Helix weaponized their signal. Return through the western gate and report the complete archive to Orla to finish mission 33.",
    guideChapterThreeWalkthroughTitle:"Chapter Three: Ashfall Witness",guideChapterThreeRange:"Missions 34–45",
    guideChapterThreeWalkthrough:"Speak to Orla after the Moonfall debrief, cross Moonfall again, and take its eastern gate to Ashfall Observatory. Meet Aster Vale, then alternate investigation and combat: defeat two agents, read the evacuation manifest, reach four defeated agents, disable the perception jammer, and clear all six before opening the black box. Broadcasting the evidence grants +2 Attack but exposes the source; protecting Aster grants +8 maximum health and +2 Defense. Carry the chosen outcome back through Moonfall to Orla. Either branch unlocks Chapter Four, and the next briefing remembers what you chose.",
    guideChapterFourWalkthroughTitle:"Chapter Four: Hollow Moon Archive",guideChapterFourRange:"Missions 46–57",
    guideChapterFourWalkthrough:"After completing mission 45, speak to Orla once more. Travel Signal Town → Moonfall → Ashfall and use Ashfall's new eastern gate. At the Hollow Moon Archive, read the Arrival Beacon, defeat two pursuers, decode the Cipher Well, defeat four, open the Lunar Nursery Record, defeat six, and inspect the Hollow Core. Eliminate all eight pursuers before returning to the core for the final route decision. Answering the sanctuary grants +1 Attack and +1 Defense; shielding its coordinates grants +12 maximum health. Return through all three western gates and report to Orla to reach 57/57.",
  ...
  const zhHant={
    ...
    guideChapterOneWalkthroughTitle:"第一章：擊破帷幕",guideChapterOneRange:"任務 1–23",
    guideChapterOneWalkthrough:"先和歐拉交談，再訪問訊號鎮全部十名目擊者；完整回報之前，森林門不會開啟。進入帷幕森林後先擊敗八名巡邏，看到青色痕跡就切換真實視界，揭露隱形敵人與實驗室入口。進實驗室前搜尋支路，取得脈衝刃與訊號護符。接著清除共十五名場景敵人、取得遊俠護甲並接近指揮官。頭目戰要繞開彈幕、離開直線衝鋒範圍，再利用短暫暈眩輸出。取得穩定裝置會完成第 23 項任務，但劇情還沒結束。",
    guideChapterTwoWalkthroughTitle:"第二章：月墜中繼站",guideChapterTwoRange:"任務 24–33",
    guideChapterTwoWalkthrough:"打倒指揮官後選擇「繼續探索」，再和歐拉交談，東門便會通往月墜中繼站。必須清除全部八名受干擾哨兵才能操作檔案；任務會在 2、4、6 隻時推進，但畫面分母固定顯示完整的 8。戰鬥完成後依序啟動「起源紀錄、記憶紀錄、警告紀錄」。三份紀錄會證明所謂入侵艦隊其實載著難民，而 Helix 把求救訊號改造成武器。從西門返回訊號鎮，向歐拉回報即可完成第 33 項任務。",
    guideChapterThreeWalkthroughTitle:"第三章：灰燼見證者",guideChapterThreeRange:"任務 34–45",
    guideChapterThreeWalkthrough:"完成月墜回報後再次找歐拉，穿過月墜中繼站並使用東門進入灰燼天文台。先找到艾絲特，接著交替調查與戰鬥：擊敗 2 名特工、讀取撤離清單、累計擊敗 4 名、關閉感知干擾器，最後清除全部 6 名再打開黑盒。公開證據會獲得攻擊 +2，但會暴露消息來源；保護艾絲特則獲得最大生命 +8、防禦 +2。帶著選擇經月墜返回歐拉處。兩條分支都會開啟第四章，而且新簡報會記得你的決定。",
    guideChapterFourWalkthroughTitle:"第四章：月背空心檔案庫",guideChapterFourRange:"任務 46–57",
    guideChapterFourWalkthrough:"完成第 45 項任務後再和歐拉交談，依序穿越訊號鎮 → 月墜 → 灰燼，使用灰燼天文台的新東門。進入月背空心檔案庫後，讀取抵達信標、擊敗 2 名追兵、解碼密碼井、累計擊敗 4 名、打開月面育幼紀錄、累計擊敗 6 名，再調查空心核心。清除全部 8 名追兵後，回到核心進行最終選擇。回應庇護所會獲得攻擊 +1、防禦 +1；屏蔽座標則獲得最大生命 +12。最後連續穿過三道西門回到歐拉處，即可完成 57/57。",
  ...
  const fillRegional=(code,text)=>{
    ...
    Object.assign(base,{
      ...
      guideChapterOneWalkthroughTitle:base.guideOverviewTitle,guideChapterOneRange:"1–23",guideChapterOneWalkthrough:`${base.guideOverview} ${base.guideTips}`,
      guideChapterTwoWalkthroughTitle:base.guideChapterTwoTitle,guideChapterTwoRange:"24–33",guideChapterTwoWalkthrough:`${base.guideChapterTwo} ${base.relayMessage1} ${base.relayMessage2} ${base.relayMessage3}`,
      guideChapterThreeWalkthroughTitle:base.guideChapterThreeTitle,guideChapterThreeRange:"34–45",guideChapterThreeWalkthrough:`${base.guideChapterThree} ${base.ashfallSurvivorMessage} ${base.ashfallCoreMessage} ${base.chapter3DebriefBroadcast} ${base.chapter3DebriefProtect}`,
      guideChapterFourWalkthroughTitle:base.guideChapterFourTitle,guideChapterFourRange:"46–57",guideChapterFourWalkthrough:`${base.guideChapterFour} ${base.lunarBeaconMessage} ${base.lunarCipherMessage} ${base.lunarNurseryMessage} ${base.lunarChoiceMessage} ${base.chapter4DebriefAnswer} ${base.chapter4DebriefShield}`,
