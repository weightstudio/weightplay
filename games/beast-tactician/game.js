...
(() => {
  ...
  const unitTypes = [
    {
      ...
      kind: "soldier",
      img: "acornGuard",
      name: { en: "Acorn Guard", "zh-Hant": "橡果守衛", ar: "حارس البلوط" },
      cost: 50,
      hp: 245,
      damage: 14,
      range: 1.25,
      cooldown: 0.8,
      note: { en: "Cheap blocker.", "zh-Hant": "便宜阻擋。", ar: "مدافع منخفض التكلفة." },
    },
    {
      id: "archer",
      kind: "soldier",
      img: "scoutArcher",
      name: { en: "Scout Archer", "zh-Hant": "斥候弓手", ar: "رامٍ كشّاف" },
      cost: 75,
      hp: 85,
      damage: 15,
      range: 4.2,
      cooldown: 1.05,
      note: { en: "Reliable range.", "zh-Hant": "穩定遠程。", ar: "مدى موثوق." },
    },
    {
      id: "sapper",
      kind: "soldier",
      img: "runeSapper",
      name: { en: "Rune Sapper", "zh-Hant": "符文工兵", ar: "مهندس الرون" },
      cost: 95,
      hp: 120,
      damage: 30,
      range: 2.8,
      ...
      slow: 0.34,
      splash: 1.45,
      note: { en: "Area control.", "zh-Hant": "範圍控場。", ar: "تحكم بالمساحة." },
    },
    {
      id: "medic",
      kind: "soldier",
      img: "medicCub",
      name: { en: "Medic Cub", "zh-Hant": "醫護幼獸", ar: "شبل المسعف" },
      cost: 65,
      hp: 135,
      damage: 0,
      range: 3,
      ...
      heal: 30,
      available: false,
      note: { en: "Repairs blockers.", "zh-Hant": "修復阻擋者。", ar: "يصلح وحدات الصد." },
    },
    {
      id: "leo",
      kind: "hero",
      img: "leo",
      name: { en: "Boom Mane Leo", "zh-Hant": "爆鬃雷歐", ar: "ليو عرف الانفجار" },
      cost: 180,
      hp: 265,
      damage: 28,
      range: 1.7,
      ...
      aura: "taunt",
      splash: 1.25,
      note: { en: "Elite frontline hero.", "zh-Hant": "頂級前線英雄。", ar: "بطل نخبة في الخط الأمامي." },
    },
    {
      id: "taro",
      kind: "hero",
      img: "taro",
      name: { en: "Moss Shell Taro", "zh-Hant": "苔殼太郎", ar: "تارو الدرع الطحلبي" },
      cost: 170,
      hp: 310,
      damage: 18,
      range: 1.4,
      cooldown: 1.1,
      slow: 0.42,
      note: { en: "Best route blocker.", "zh-Hant": "最強路線阻擋。", ar: "أفضل مدافع للمسار." },
    },
    {
      id: "orla",
      kind: "hero",
      img: "orla",
      name: { en: "Moon Cap Orla", "zh-Hant": "月帽歐拉", ar: "أورلا قبعة القمر" },
      cost: 145,
      hp: 115,
      damage: 26,
      range: 4.6,
      ...
      bounce: 2,
      bounceRatio: 0.62,
      note: { en: "Long-range magic.", "zh-Hant": "遠程魔法。", ar: "سحر بعيد المدى." },
    },
    {
      id: "fia",
      kind: "hero",
      img: "fia",
      name: { en: "Spark Paw Fia", "zh-Hant": "電爪菲亞", ar: "فيا المخلب الشراري" },
      cost: 140,
      hp: 135,
      damage: 42,
      range: 2.2,
      cooldown: 0.62,
      bossDamage: 0.55,
      note: { en: "Boss striker.", "zh-Hant": "王關輸出。", ar: "مهاجمة الزعيم." },
    },
    {
      id: "rux",
      kind: "hero",
      img: "rux",
      name: { en: "Gear Horn Rux", "zh-Hant": "齒角魯克斯", ar: "روكس قرن التروس" },
      cost: 145,
      hp: 155,
      damage: 20,
      range: 2.6,
      cooldown: 0.95,
      buff: 0.24,
      note: { en: "Buffs nearby soldiers.", "zh-Hant": "強化附近士兵。", ar: "يعزز الجنود القريبين." },
    },
    {
      id: "panko",
      kind: "hero",
      img: "panko",
      name: { en: "Drum Belly Panko", "zh-Hant": "鼓腹潘可", ar: "بانكو البطن الطبلية" },
      cost: 140,
      hp: 150,
      damage: 10,
      range: 2.8,
      ...
      heal: 28,
      available: false,
      note: { en: "Heals blockers.", "zh-Hant": "治療阻擋者。", ar: "يعالج وحدات الصد." },
    },
    {
      id: "deer",
      kind: "hero",
      img: "deer",
      name: { en: "Nature Deer", "zh-Hant": "自然鹿", ar: "غزال الطبيعة" },
      cost: 150,
      hp: 140,
      damage: 18,
      range: 3.3,
      ...
      heal: 15,
      available: false,
      note: { en: "Nature control and healing.", "zh-Hant": "自然控場與治療。", ar: "تحكم طبيعي وعلاج." },
    },
  ];
  ...
  const CAMPAIGN_NAME_TRANSLATIONS = {
    ...
    ar: "بوابة الغابة|الجذور المنقسمة|الجسر المحطم|حديقة الطحلب|ممر ضوء القمر|منعطف الكريستال|معبر الخفافيش|ممر المهندس|غابة الصدى|بوابة الجبّار|درب اللحاء الحديدي|حاجز الأشواك|وادي الخنازير البرية|مسبك الجذور|ساحة العملاق|درب المياه الضبابية|نبع الشفاء|دائرة الأبواغ|أطلال الكهنة|القلب العتيق|اقتراب العاصفة|مفترق الرعد|حاجز الريح|وادي البرق|تاج العاصفة|بوابة الكسوف|متاهة الجذور الفارغة|جسر الغسق|طريق التاج|المواجهة الأخيرة للإمبراطور".split("|"),
  };
  const CAMPAIGN_BOSS_TRANSLATIONS = {
    ...
    ar: "وحش الظلال|جبّار الغابة|عملاق اللحاء الحديدي|العتيق الأخضر|مُدمّر العاصفة|إمبراطور الجذور الفارغة".split("|"),
  };
  ...
  CAMPAIGN_INTEL_TRANSLATIONS.ar = {
    threats: "تختبر الذئاب العادية المنعطف الأول.|يقسم مساران من الجذور القطيع.|تعاقب الكشافة السريعة البناء المتأخر.|تضغط الخنازير البرية على مدافع واحد.|يكسر وحش الظلال الصفوف الضعيفة.|تتجاهل الخفافيش الطائرة المتاهة الأرضية.|تعبر موجتان من الخفافيش الوسط.|تتناوب المجموعات السريعة والثقيلة.|تصل موجات الجو والأرض معًا.|يستدعي جبّار الغابة حرسًا مرافقًا.|تصل حراس اللحاء الحديدي بدرع قابل للكسر.|تحمي المجموعات المحمية المطاردين السريعين.|تضغط صفوف الخنازير على مسار واحد.|تحتاج الدروع والخفافيش إلى ضرر متنوع.|يجدد عملاق اللحاء الحديدي حمايته.|تتعافى مخلوقات الضباب أثناء التقدم.|تواصل الأهداف غير المنهية التعافي.|تتعافى المجموعات المنقسمة في مساراتها.|تطيل الكائنات المدرعة المتعافية كل معركة.|يستعيد العتيق الأخضر صحته على مراحل.|تتسارع الأعداء المصابون.|تستهدف الخفافيش السريعة مسار القلب الخالي.|تتسارع الخنازير بعد فقدان درعها.|تصل دفعات متنوعة في كل موجة.|يسرّع مدمّر العاصفة الحرس القريب.|تجمع مجموعات الكسوف بين الطيران والدروع.|يعود التعافي خلف الصف المدرع.|تغطي الخفافيش السريعة الصفوف الثقيلة.|تصل كل الأخطار السابقة بالتتابع.|يغيّر إمبراطور الجذور الفارغة هيئته مرتين.".split("|"),
    plans: "اصنع منعطفات في المسار بحراس البلوط.|وحّد المسارين قبل إضافة المدى.|ابدأ بتغطية الرامي البعيد.|عزّز مدافعًا وأضف علاجًا.|دع تارو يثبت الزعيم ودع فيا تهاجمه.|غطِّ الزوايا البعيدة بالرماة وأورلا.|أبقِ الضرر البعيد قرب النواة.|أبطئ الخنازير ثم ركّز على الخفافيش.|قسّم الضرر بين المسار والسماء.|اقضِ على الحرس المرافق قبل مهاجمة الزعيم.|اكسر الدرع بنيران متواصلة.|هاجم صف الدروع قبل مرور السريعين.|أنشئ طبقتين من المدافعين.|اجمع ضرر المنطقة مع أبطال المدى.|اكسر الحماية قبل استخدام المهارات القوية.|ركّز النار على هدف واحد.|ضع الضرر الانفجاري قبل المنعطف الأخير.|اجمع المسارين في منطقة إسقاط واحدة.|اكسر الدرع ثم أنهِ الأهداف بسرعة.|احتفظ بتركيز الأبطال لكل مرحلة شفاء.|ضع ضرر الإنهاء قرب النواة.|ضع أورلا خلف المنعطف الأخير.|أبطئ الأعداء قبل كسر الدرع.|وزّع مناطق الضرر بدل تجميعها.|افصل الحرس عن الزعيم بالتبطئة.|كوّن دفاعًا كاملًا للأرض والجو.|استهدف المتعافين بعد كسر الصف المدرع.|اترك منطقة ضرر ثانية قرب النواة.|طوّر كل دور بدل الاعتماد على بطل واحد.|أجب بالترتيب: خفافيش، دروع، ثم الإمبراطور.".split("|"),
  };
  ...
  // Arabic owns the complete game dictionary so Battle never exposes the
  // shared English fallback for labels, decisions, toasts, or accessibility.
  text.ar = {
    title: "حارس الوحوش",
    language: "اللغة",
    audioSettings: "الإعدادات",
    soundEffects: "المؤثرات الصوتية",
    backToLobby: "العودة إلى ألعاب WeightPlay العامة",
    languageControl: "اللغة",
    backToMain: "العودة إلى الرئيسية",
    stageSelector: "اختيار المرحلة",
    stagePages: "صفحات المراحل",
    stagesTab: "المراحل",
    equipmentTab: "المعدات",
    backToStages: "العودة إلى المراحل",
    pauseDecisionTitle: "إيقاف المرحلة {stage}؟",
    pauseDecisionText: "تابع معركة المرحلة {stage} الحالية، أو عد إلى المراحل وخسر الموجة والمدافعين والعملات وصحة النواة.",
    continueBattle: "متابعة المعركة",
    returnToStages: "العودة إلى المراحل",
    localeName: "العربية",
    releaseBadge: "إصدار داخلي مرشح",
    publicReleaseBadge: "متاح للعب الآن",
    menuTitle: "دفاع أبطال البرج",
    menuHint: "ابنِ في أي مكان على شبكة الغابة، وشكّل مسارات الأعداء، وقد أبطال WeightPlay مع جنود الحيوانات عبر 30 مرحلة دفاع.",
    holdNotice: "تبقى الردهة العامة قيد المراجعة حتى يوافق المالك على الإصدار. هذا المسار مخصص للتحقق الداخلي من الإصدار.",
    publicNotice: "ابنِ المدافعين، واحمِ النواة الكريستالية، وافتح المراحل الثلاثين في ست مناطق غابية. يُحفظ التقدم على هذا الجهاز.",
    bestStage: "أفضل مرحلة",
    upgradePoints: "نقاط الترقية",
    diamonds: "الماس",
    start: "ابدأ اللعبة",
    tech: "ترقيات التقنية",
    back: "رجوع",
    ...
    autoWave: "الموجة التالية خلال {seconds} ث",
    waveIntel: "معلومات الموجة",
    waveIntelReady: "التالي: الموجة {wave}/{total} - {enemies}",
    waveIntelActive: "جارية: الموجة {wave}/{total} - المتبقي {remaining} - {enemies}",
    waveIntelDone: "تكتمل المرحلة بعد هذه الموجة.",
    routeOpen: "المسار مفتوح",
    routeBlocked: "المسار مغلق - الأعداء يهاجمون المدافعين",
    coreCritical: "النواة في خطر! احمِ المسار الآن.",
    keyboardFocus: "الخانة {x},{y} - اضغط Enter للبناء أو التحديد، ومفاتيح الأرقام أو Q/E لتغيير الوحدات.",
    buildReady: "جاهز",
    buildNeedCoins: "تحتاج إلى {coins} عملة",
    unitKindHero: "بطل",
    unitKindSoldier: "جندي",
    roleLabel: "الدور",
    attackSpeed: "سرعة الهجوم",
    everySeconds: "كل {seconds} ث",
    unitSupport: "دعم",
    traitLabel: "السمات",
    traitSplash: "ضرر مساحة {tiles} خانات",
    traitSlow: "إبطاء {percent}%",
    traitHealing: "علاج {points}",
    traitBuff: "تعزيز الحلفاء {percent}%",
    traitBounce: "يرتد على {count} أهداف",
    traitBoss: "ضرر الزعيم +{percent}%",
    upgradeAction: "ترقية ({coins})",
    sellAction: "بيع (+{coins})",
    selectedActionInfo: "الترقية: {upgrade} عملة | البيع: +{sell} عملة",
    enemyWolf: "ذئاب ×{count}",
    enemyBoar: "خنازير برية ×{count}",
    enemyBat: "خفافيش ×{count}",
    enemyBoss: "{boss} ×{count}",
    upgrade: "ترقية",
    sell: "بيع",
    revive: "إنعاش النواة (5 ألماسات)",
    reviveConfirm: "تأكيد الإنعاش · {balance} ← {result} ألماسات",
    reviveConfirmLabel: "تأكيد إنعاش النواة. أعد النواة إلى 35 صحة. أنفق 5 ألماسات. الرصيد من {balance} إلى {result}.",
    rerollReward: "إعادة سحب المكافأة (3 ألماسات)",
    rerollRewardConfirm: "تأكيد +{points} نقطة",
    rerollRewardPreview: "تضيف إعادة السحب +{points} نقطة ترقية · الألماس {balance} ← {result}. اضغط مرة أخرى للتأكيد.",
    rerollRewardNeed: "المجموع المحفوظ: {points} نقطة ترقية · {diamonds} ألماسة · تحتاج 3 / لديك {diamonds}.",
    nextStage: "المرحلة التالية",
    retry: "إعادة المحاولة",
    victory: "اكتمل الدفاع!",
    defeat: "سقطت النواة الكريستالية",
    techTitle: "تقنية الحارس الدائمة",
    techHint: "أنفق نقاط الترقية المكتسبة من الانتصارات. الترقيات اختيارية وتُحفظ محليًا.",
    noCoins: "العملات غير كافية.",
    noDiamonds: "الألماس غير كافٍ.",
    lockedStage: "أكمل المرحلة السابقة أولًا.",
    blocked: "المسار مغلق: الأعداء يهاجمون مدافعك.",
    bossIncoming: "يدخل {boss} إلى ساحة المعركة!",
    bossPhase: "يغيّر {boss} تكتيكاته!",
    blockedBuild: "لا يمكن البناء في هذه الخانة.",
    occupied: "يوجد مدافع في هذه الخانة بالفعل.",
    built: "تم نشر {name}.",
    upgraded: "تمت ترقية {name} إلى المستوى {level}.",
    sold: "تم بيع المدافع.",
    reviveUsed: "تم إنعاش النواة.",
    rewardSummary: "المكافأة: +{points} نقطة ترقية، +{diamonds} ألماسة",
    rewardRerolled: "أعيد سحب المكافأة: +{points} نقطة ترقية، +{diamonds} ألماسة",
    savedProgress: "المجموع المحفوظ: {points} نقطة ترقية · {diamonds} ألماسة",
    newRouteUnlocked: "فُتح مسار جديد: المرحلة {stage} — {name}",
    nextRouteReady: "المسار التالي جاهز: المرحلة {stage} — {name}",
    campaignComplete: "اكتملت الحملة: أُنجزت المراحل الثلاثون ومسارات الزعماء الستة.",
    rewardRerollUsed: "أعيد سحب المكافأة.",
    starRating: "{stars}/3 نجوم",
    buildFeedback: "تم النشر",
    upgradeFeedback: "+المستوى {level}",
    sellFeedback: "+{coins} عملة",
    soundOn: "الصوت مفعّل",
    soundOff: "الصوت متوقف",
    soundEnabled: "تم تفعيل الصوت.",
    soundDisabled: "تم إيقاف الصوت.",
    paused: "متوقفة مؤقتًا",
    speedDecision: "سرعة المعركة {current}. فعّل للتغيير إلى {next}.",
    speedPausedDecision: "المعركة متوقفة مؤقتًا. فعّل للمتابعة بسرعة 1x.",
    goldenFrame: "إطار المدافع الذهبي",
    goldenFrameDesc: "إطار ذهبي تجميلي لكل مدافع منشور. التكلفة 15 ألماسة.",
    goldenFrameOwned: "مفتوح",
    goldenFrameBuy: "فتح (15 ألماسة)",
    goldenFrameConfirm: "تأكيد · {balance} ← {result} ألماسة",
    goldenFrameConfirmLabel: "تأكيد إطار المدافع الذهبي. أنفق 15 ألماسة. الرصيد من {balance} إلى {result}.",
    victoryText: "اكتملت المرحلة {stage}. تعاون المسار والحواجز والترقيات وتوقيت الأبطال.",
    defeatText: "محاولة جيدة. جرّب شكل مسار مختلفًا أو طوّر المدافعين الأساسيين مبكرًا.",
    resultPlan: "خطة الدفاع التالية",
    resultPlanWin3: "الدفاع التالي: {stars}/3 نجوم وصحة النواة {core}٪. حافظ على هذا المسار وركّز نيران الأبطال مبكرًا على الزعيم التالي.",
    resultPlanWin2: "الدفاع التالي: {stars}/3 نجوم وصحة النواة {core}٪. طوّر المدافعين مبكرًا وأطل المسار قبل الموجات القوية.",
    resultPlanWin1: "الدفاع التالي: {stars}/3 نجوم وصحة النواة {core}٪. أضف المسعف أو المهندس مبكرًا واترك مسارًا واضحًا مفتوحًا.",
    resultPlanLose: "خطة إعادة المحاولة: أعد تشكيل المسار، واترك طريقًا واضحًا مفتوحًا، وطوّر المدافعين الأساسيين قبل موجة الضغط التالية.",
    boss: "الزعيم",
    bossStage: "مرحلة الزعيم",
    bossPressure: "ضغط الزعيم",
    bossHoldRoute: "احمِ المسار",
    bossNoSignal: "لا يوجد زعيم في الميدان",
    waveClearFeedback: "تم تأمين الموجة {wave}",
    bossShadowName: "وحش الظلال",
    bossForestName: "جبّار الغابة",
    guardianRoute: "مسار الحارس",
    routeGate: "البوابة",
    routeCore: "النواة",
    threatIntel: "الخطر",
    recommendedPlan: "الخطة",
    rewardIntel: "المكافأة",
    cost: "التكلفة",
    range: "المدى",
    hp: "الصحة",
    damage: "الضرر",
    level: "المستوى",
    techPower: "قوة البطل",
    techPowerDesc: "+10% لضرر البطل في كل مستوى.",
    techBulwark: "حصن الحارس",
    techBulwarkDesc: "+12 لصحة المدافعين في كل مستوى.",
    techEconomy: "اقتصاد الغابة",
    techEconomyDesc: "+20 من العملات الابتدائية في كل مستوى.",
    techBuy: "ترقية",
    techBuyLabel: "ترقية {name} من المستوى {current} إلى المستوى {next}. {effect}. التكلفة {cost} نقطة ترقية. الرصيد من {balance} إلى {result}.",
    techNeedLabel: "{name} من المستوى {current} إلى المستوى {next}. {effect}. تحتاج {cost} نقطة ترقية؛ الرصيد {balance}.",
    techMaxLabel: "بلغ {name} الحد الأقصى، المستوى {max}. {effect}.",
    techPowerEffect: "مكافأة ضرر البطل من {current}% إلى {next}%",
    techBulwarkEffect: "مكافأة صحة المدافعين من {current} إلى {next}",
    techEconomyEffect: "مكافأة العملات الابتدائية من {current} إلى {next}",
