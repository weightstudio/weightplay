(() => {
  ...
  const rows = {
    ...
    start: ["Start Game", "開始遊戲", "开始游戏", "ゲーム開始", "게임 시작", "Empezar juego", "Iniciar jogo", "Commencer le jeu", "Spiel starten", "Avvia il gioco", "Начать игру", "खेल शुरू करें", "ابدأ اللعبة"],
    ...
    stages: ["Stages", "關卡", "关卡", "ステージ", "스테이지", "Etapas", "Fases", "Niveaux", "Stufen", "Livelli", "Этапы", "चरण", "المراحل"],
    replay: ["Replay", "重玩", "重玩", "リプレイ", "다시 하기", "Repetir", "Repetir", "Rejouer", "Erneut spielen", "Rigioca", "Повторить", "फिर खेलें", "أعد اللعب"],
    ...
    progressBody: ["Stage {unlocked} / {total}", "關卡 {unlocked}／{total}", "关卡 {unlocked}／{total}", "ステージ {unlocked}／{total}", "스테이지 {unlocked} / {total}", "Nivel {unlocked} / {total}", "Fase {unlocked} / {total}", "Niveau {unlocked} / {total}", "Level {unlocked} / {total}", "Livello {unlocked} / {total}", "Этап {unlocked} / {total}", "चरण {unlocked} / {total}", "المرحلة {unlocked} / {total}"],
    ...
    pathLabel: ["Path", "夜路", "夜路", "道", "경로", "Camino", "Caminho", "Chemin", "Pfad", "Percorso", "Путь", "रास्ता", "المسار"],
    ...
    skillReportLabel: ["Skill Report", "技能報告", "技能报告", "スキルレポート", "연습 내용", "Informe de habilidades", "Relatório de habilidades", "Aperçu des compétences", "Geübte Fähigkeiten", "Riepilogo delle abilità", "Навыки в этой игре", "अभ्यास किए गए कौशल", "المهارات التي تدربت عليها"],
    skillReportText: ["You used clue reading and logical order to connect this path. Every clear is a new chance to practise.", "你運用閱讀線索與邏輯排序完成這段路徑；每次過關都是新的練習機會。", "你运用阅读线索与逻辑排序完成这段路径；每次过关都是新的练习机会。", "手がかりを読み、順序を考えてこの道をつなぎました。クリアするたびに新しい練習になります。", "단서를 읽고 순서를 논리적으로 이어 이 길을 완성했어요. 길을 하나씩 깨며 계속 연습할 수 있어요.", "Leíste las pistas y ordenaste la ruta con lógica. Cada camino completado ofrece otra oportunidad para practicar.", "Você leu as pistas e organizou o caminho com lógica. Cada rota concluída traz uma nova oportunidade de praticar.", "Vous avez lu les indices et ordonné le chemin avec logique. Chaque réussite offre une nouvelle occasion de s’exercer.", "Du hast Hinweise gelesen und den Pfad logisch geordnet. Jeder Abschluss bietet eine neue Übungsmöglichkeit.", "Hai letto gli indizi e ordinato il percorso con logica. Ogni sentiero completato offre una nuova occasione per esercitarti.", "Вы прочитали подсказки и выстроили путь по порядку. Каждый пройденный маршрут даёт новую возможность потренироваться.", "आपने संकेत पढ़कर तार्किक क्रम में रास्ता जोड़ा। हर पूरा रास्ता अभ्यास का नया अवसर देता है।", "قرأت الأدلة ورتبت المسار بمنطق. كل مسار مكتمل يمنحك فرصة جديدة للتدرب."],
