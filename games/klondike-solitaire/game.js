...
const KL_I18N = {
  ...
  const LOCALE_I18N_OVERRIDES = {
    ...
    "es": {
      "ui.loading.preparing": "Preparando...",
      "ui.loading.shuffling": "Barajando...",
      "ui.loading.dealing": "Repartiendo cartas...",
      "ui.loading.preparing_cards": "Preparando cartas...",
      "ui.loading.ready": "Listo",
      "ui.sound.on": "Sonido: activado",
      "ui.sound.off": "Sonido: desactivado",
      "ui.sound.aria_on": "Sonido activado",
      "ui.sound.aria_off": "Sonido desactivado",
      "ui.stats.wins": "Victorias: {wins}",
      "ui.stats.losses": "Derrotas: {losses}",
      "ui.stats.win_rate": "Porcentaje de victorias: {ratio}%",
      "ui.stats.fastest_time": "Mejor tiempo: {time}",
      "ui.stats.least_moves": "Menos movimientos: {moves}",
      ...
      "ui.aria.foundation": "{suit} en la base",
      "ui.card.face_down": "Carta boca abajo",
      ...
      "ui.hint.no_moves": "No hay movimientos disponibles.",
      "ui.hint.draw_stock": "Roba del Mazo para continuar.",
      "ui.hint.recycle_waste": "Recicla el Descarte para continuar.",
      "ui.hint.multi_destinations": "Hay varios destinos disponibles. Arrastra para elegir.",
      "ui.hint.move_waste_destination": "Pista: mueve la carta del Descarte al destino resaltado.",
      "ui.hint.move_tableau_foundation": "Pista: mueve esta carta del cuadro a una base.",
      "ui.hint.move_tableau_stack": "Pista: mueve esta secuencia del cuadro al cuadro resaltado.",
      "ui.hint.auto_finish_blocked": "Finalización automática está disponible cuando solo quedan movimientos hacia las bases.",
      "ui.hint.no_foundation_moves": "Ahora no hay movimientos que solo impliquen las bases.",
      "ui.feedback.undo_applied": "Deshacer aplicado.",
      "ui.result.fastest": "Mejor tiempo: {time}",
      "ui.result.least": "Menos movimientos: {moves}",
      "ui.result.records": "Victorias: {wins} · Derrotas: {losses} · Porcentaje de victorias: {ratio}%",
      "ui.result.record_time": "¡Nuevo mejor tiempo!",
      "ui.result.record_moves": "¡Nuevo récord de menos movimientos!",
      "ui.result.victory_prefix": "Victoria en {time} con {moves} movimientos.",
      "ui.result.victory_body": "{fastest} · {least}",
      "ui.hero.title": "Solitario Klondike",
      "ui.hero.kicker": "Juego de cartas clásico",
      "ui.hero.copy": "Un solitario Klondike clásico con animaciones modernas. Juega en móvil y escritorio con arrastre fluido, movimientos con un toque, finalización automática, Deshacer y pistas en directo.",
      "ui.feature.target_title": "Objetivo",
      "ui.feature.target_text": "Completa las cuatro bases desde el As hasta el Rey.",
      "ui.feature.features_title": "Funciones",
      "ui.feature.features_text": "Arrastra una o varias cartas, selecciona al tocar, usa Robar 1/3, Pista y Finalización automática.",
      "ui.feature.performance_title": "Rendimiento",
      "ui.feature.performance_text": "Movimiento de cartas con transform, menos repintados y animaciones ajustadas para sesiones largas.",
      ...
      "ui.board.foundations": "Bases",
      "ui.board.tableau": "Cuadro",
    ...
    "ar": {
      ...
      "ui.card.face_down": "بطاقة مقلوبة",
      "ui.sound.on": "الصوت: مفعّل",
      "ui.sound.off": "الصوت: متوقف",
      "ui.sound.aria_on": "الصوت مفعّل",
      "ui.sound.aria_off": "الصوت متوقف",
      "ui.draw_mode.label": "وضع السحب",
      "ui.draw_mode.value": "{label}",
      "ui.draw_mode.toggle": "وضع السحب: {label}",
      "ui.draw_mode.option_1": "سحب 1",
      "ui.draw_mode.option_3": "سحب 3",
      "ui.hint.no_moves": "لا توجد حركات متاحة.",
      "ui.hint.draw_stock": "اسحب من الرّزمة للمتابعة.",
      "ui.hint.recycle_waste": "أعد تدوير كومة الهدر للمتابعة.",
      "ui.hint.multi_destinations": "توجد وجهات متعددة. اسحب البطاقة لاختيار الوجهة.",
      "ui.hint.move_waste_destination": "تلميح: انقل البطاقة العليا من الهدر إلى الوجهة المميّزة.",
      "ui.hint.move_tableau_foundation": "تلميح: انقل بطاقة اللوحة هذه إلى الأساس.",
      "ui.hint.move_tableau_stack": "تلميح: انقل تسلسل اللوحة هذا إلى لوحة مميّزة.",
      "ui.hint.auto_finish_blocked": "يتاح الإنهاء التلقائي عندما تبقى حركات الأساس فقط.",
      "ui.hint.no_foundation_moves": "لا توجد حركات للأساس فقط الآن.",
      "ui.feedback.undo_applied": "تم التراجع عن الحركة.",
      "ui.stats.wins": "الانتصارات: {wins}",
      "ui.stats.losses": "الخسائر: {losses}",
      "ui.stats.win_rate": "نسبة الفوز: {ratio}%",
      "ui.stats.fastest_time": "أسرع وقت: {time}",
      "ui.stats.least_moves": "أقل عدد من الحركات: {moves}",
      "ui.result.fastest": "أسرع وقت: {time}",
      "ui.result.least": "أقل عدد من الحركات: {moves}",
      "ui.result.records": "الانتصارات: {wins} · الخسائر: {losses} · نسبة الفوز: {ratio}%",
      "ui.result.record_time": "رقم قياسي جديد لأسرع وقت!",
      "ui.result.record_moves": "رقم قياسي جديد لأقل عدد من الحركات!",
      "ui.result.victory_prefix": "انتصرت خلال {time} وبعدد {moves} حركة.",
      "ui.result.victory_body": "{fastest} · {least}",
  ...
  function fitTableauStack() {
    ...
    if (!canvas || !tableauRow || !piles.length) return;
    ...
    if (fittedStep >= baseStep - 0.1) {
      ...
      canvas.style.setProperty("--card-step", `${fittedStep}px`);
    }
