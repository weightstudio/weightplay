(function(){
  ...
  function startBattle(index,event){
    ...
    run={stageIndex,stage,time:stage.time,core:maxCore,maxCore,wave:1,totalWaves:stage.waves,bossDefeated:false,lane:1,laneMask:1<<1,laneSwitchCount:0,aimX:laneCenters[1],attack:6+save.upgrades.power*2,weapon:"single",units:[],encounters,gates:encounters,enemies:encounters.filter(entry=>entry.kind==="enemy"),particles:[],texts:[],fireClock:0,charge:0,overdrive:0,feedbackLock:0,readyCueShown:false,readyTargetLane:null,readyTargetCount:0,lastReadyUsed:false,overdriveReadyCount:0,overdriveActivationCount:0,overdriveActivationLane:null,overdriveActivationWave:null,peak:6+save.upgrades.power*2,coreHits:0,laneDamage:[0,0,0],resolved:0,paused:false,finished:false,lastGateMessage:"",lastTrackedWave:1};
