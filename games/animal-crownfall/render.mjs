...
export class CrownScene {
  ...
  moveCamera(destination){
    ...
    if(['x','y','width','height'].every(k=>Math.abs(start[k]-destination[k])<.02)){this.view=destination;this.applyCamera();this.paint();return Promise.resolve();}
