(() => {
  ...
  dom.result.addEventListener("keydown",trapResult);dom.retry.addEventListener("click",()=>commitResultAction(()=>startStage(stageIndex)));dom.resultStages.addEventListener("click",()=>commitResultAction(()=>showStage(stageIndex)));dom.next.addEventListener("click",()=>commitResultAction(()=>startStage(Math.min(29,stageIndex+1))));
