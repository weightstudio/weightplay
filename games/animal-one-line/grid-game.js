(() => {
  ...
  let stageIndex=0,attempts=1,visited=[],visitedSet=new Set(),drawing=false,activePointer=null,failed=false,startTime=0,lastPoint=null,hintUsed=false,resultRevealTimer=null,resultSettlementPending=false,windowFocused=true,lifecycleSuspended=false,runClockPausedAt=0;
  ...
  function suspendForeground(){lifecycleSuspended=true;cancelDrawing();pauseRunClock();}
  function resumeForeground(){if(document.hidden||!windowFocused)return;lifecycleSuspended=false;resumeRunClock();}
