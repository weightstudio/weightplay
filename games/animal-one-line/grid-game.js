(() => {
  ...
  let stageIndex=0,attempts=1,visited=[],visitedSet=new Set(),drawing=false,failed=false,startTime=0,lastPoint=null,hintUsed=false,leaveStartedAt=0;
