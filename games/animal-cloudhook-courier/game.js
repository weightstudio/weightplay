(function(){
  ...
  const STAGE_META_AR = [
    ["الإقلاع الأول","درس الفانوس","اجمع الطردين واتجه نحو الفانوس.","أمسك حلقة واحدة، وابنِ تأرجحًا، ثم اترك الحبل نحو الحلقة التالية.","تعلمك أول توصيلة مسار الحبل النظيف."],
    ["الإقلاع الأول","منعطف السحابة المنخفضة","احمل الطرد العلوي قبل المنعطف المنخفض.","الرياح هادئة؛ احمل الطرد العلوي ثم استقر عند الحلقة التالية.","يعلمك مسار الطرد الموجّه طريق الارتفاع."],
    ["الإقلاع الأول","فجوة الميمنة","استخدم الحلقة الوسطى لعبور الفجوة الواسعة.","يمر المسار الآمن فوق السحابة المنخفضة.","يكافئك المسار الأوسع على الصبر."],
    ["الإقلاع الأول","التيار المنقسم","اختر المسار العلوي أو السفلي قبل زوج الأشواك.","حافظ على الزخم أثناء تغيير الارتفاع.","يطلب منك المسار الآن اختيار الممر."],
    ["الإقلاع الأول","نقطة التحقق الأولى","اجمع كل الطرود ثم أتمم تأرجحًا كاملًا قبل التوصيل.","نقطة التحقق: اضغط الحبل لإتمام تأرجح كامل قبل الفانوس.","أُتقنت نقطة التحقق الأولى: أصبح التحكم جزءًا من التوصيل."],
    ["الرياح الجانبية","هبة غربية","قاوم الرياح الجانبية قبل أول إطلاق.","تغيّر الهبات مسارك أثناء الطيران.","تبدأ الرياح الجانبية فصل الطقس."],
    ["الرياح الجانبية","هواء بموجتين","حدّد توقيت إطلاقين بين هبات متناوبة.","لا تطارد الفانوس؛ اقرأ الحلقات.","الإيقاع يتغلب على القوة العشوائية."],
    ["الرياح الجانبية","الطرد العالي","اصعد إلى الطرد العالي ثم عد إلى المسار.","الطرد العالي أكثر أمانًا من أشواك الأرض.","يؤتي التخطيط الرأسي ثماره."],
    ["الرياح الجانبية","انجراف الفانوس","اجمع الطرود المتباعدة بينما يتحرك الفانوس.","ينجرف الهدف؛ حافظ على مرونتك عند الاقتراب.","يغيّر الهدف المتحرك قرارك الأخير."],
    ["الرياح الجانبية","نقطة فحص الطقس","اعبر دورة هبات ووصل إلى الفانوس المتحرك.","نقطة التحقق: انتظر هبة مستقرة قبل الإطلاق.","صرت تقرأ السماء، لا الحلقات فقط."],
    ["الحلقات المتحركة","الحركة الأولى","التقط أول حلقة متحركة بعد اجتيازها لمسارها.","تكافئ الحلقات المتحركة الإمساك القصير.","للحلقات إيقاعها الخاص الآن."],
    ["الحلقات المتحركة","زوج البندول","بدّل بين حلقتين متحركتين.","راقب المرساة قبل الالتزام.","أصبحت الحركة اختيارًا للمسار."],
    ["الحلقات المتحركة","الرف المنزلق","اجمع الطرود عبر الرف المتحرك.","احتفظ بمسار احتياطي للحلقة الأخيرة.","وفّر الزخم للخروج."],
    ["الحلقات المتحركة","تتابع الحلقات","صِل المراسي المتحركة من دون لمس الأشواك.","أطلق حين تعبر الحلقة التالية خط طيرانك.","يحافظ التتابع النظيف على بقاء الساعي في الجو."],
    ["الحلقات المتحركة","نقطة فحص الحركة","أتمم تأرجحًا قبل الاقتراب من الحلقة المتحركة الأخيرة.","نقطة التحقق: يفتح تأرجح متقن النهاية الآمنة.","تحوّل إتقان الحركة الفوضى إلى توقيت."],
    ["ترتيب الطرود","الطرد المعلّم","اجمع الطرود بالترتيب المعلّم.","لن يُحتسب الطرد التالي مبكرًا؛ خطط لمسارك.","أصبح للمسار الآن سجل توصيل."],
    ["ترتيب الطرود","قائمة متفرعة","اتبع ترتيب الطرد العلوي ثم السفلي.","لا تلتقط الطرد المغري أولًا.","يغيّر الترتيب أفضل مسار."],
    ["ترتيب الطرود","فرز ثلاثي الخطوات","افرز ثلاثة طرود بينما تدفعك الرياح جانبًا.","أبقِ ترتيب السجل حاضرًا في خطتك.","تحمي الدقة نتيجتك."],
    ["ترتيب الطرود","الختم المتأخر","صل إلى الطرد الأخير بعد بوابة الأشواك.","احتفظ بإطلاق واحد للختم الأخير.","يغيّر الطرد الأخير مخرجك."],
    ["ترتيب الطرود","نقطة فحص القائمة","أكمل السجل كاملًا ثم تأرجح قبل التوصيل.","نقطة التحقق: الترتيب والتأرجح مهمان معًا.","أصبح السجل جاهزًا لساعٍ حقيقي."],
    ["طقس الفانوس","فانوس المد","اقترب من فانوس ينجرف مع المد.","صوّب إلى موضع الفانوس الحالي، لا إلى نقطة بدايته.","أصبح الهدف نفسه حيًا."],
    ["طقس الفانوس","الوهج الضيق","اعبر الحلقات المتحركة نحو فانوس متحرك ضيق.","استخدم المسار العلوي عندما يرتفع الوهج.","يتفاعل المسار والهدف الآن."],
    ["طقس الفانوس","جيب العاصفة","اعبر نبضات الهبات واجمع كل الطرود.","تعاقب نبضات العاصفة الإطلاق المبكر.","يصنع الصبر نافذة آمنة."],
    ["طقس الفانوس","الاقتراب الطويل","احمل سلسلة طويلة من الطرود إلى الفانوس البعيد.","حافظ على الارتفاع في الاقتراب الأخير.","التحمل شكل آخر من التحكم."],
    ["طقس الفانوس","نقطة فحص الطقس","اقرأ انجراف الفانوس ثم أتمم تأرجحًا كاملًا.","نقطة التحقق: أطلق فقط عندما يعود الفانوس إلى مسارك.","أصبح الساعي قادرًا على توقّع النهاية."],
    ["الإتقان","العدة الكاملة","اجمع بين الهبات والحلقات المتحركة والطرود المرتبة.","كل آليات الفصول السابقة مفعّلة.","يبدأ الإتقان بخطة كاملة."],
    ["الإتقان","التيار الاحتياطي","احتفظ بإطلاق آمن للطرد الأخير.","أقصر طريق ليس دائمًا الأسرع.","يحمي الساعي الجيد خياراته."],
    ["الإتقان","تتابع العاصفة","صِل المراسي المتحركة خلال نبضة عاصفة.","راقب إيقاع الحلقات وإيقاع الرياح معًا.","يصبح الإيقاعان مسارًا واحدًا."],
    ["الإتقان","القائمة الأخيرة","أكمل السجل المرتب واقترب من الفانوس المنجرف.","استخدم تأرجحًا متقنًا لضبط الزاوية الأخيرة.","تُكتسب الرحلة الأخيرة ولا تُمنح."],
  ...
  const stageMeta = (index = currentStage) => {
    const rows = locale === "zh-Hant" ? STAGE_META_ZH : locale === "ar" ? STAGE_META_AR : STAGE_META_EN;
