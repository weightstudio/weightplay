...
const tag = "20260822-reversi-cell-labels-v8";
...
check(source.includes('const GAME_VERSION = "v8"'), "route adapter is not Game v8");
...
check(analytics.includes('const GAME_VERSION = "v8"'), "analytics identity is not v8");
...
check(routeResults.every((row) => row.current), "not all 14 Reversi route shells carry the v8 identity");
