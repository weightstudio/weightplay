(() => {
  ...
  /* SEO130_ARROW_COMPARISON_LOCALES */
  const COMPARISON_COPY={"en":{"title":"Similar directional-block reference","body":"Tap Away 3D and Arrow Escape both ask you to remove one-way blocks in an order that clears the puzzle. Popcore’s game places the blocks on a rotatable 3D shape, so you swipe around the object and choose removable blocks from different angles, with skins, themes and extra challenges. Arrow Escape instead uses 30 handcrafted 2D stages across six rule chapters; blocked taps cost no move and reveal the first blocker, Hint marks one safe next arrow, and later stages add walls, rotating arrows, keys, ice, paired portals and one-way gates. Unlock progress stays in this browser.","disclaimer":"Arrow Escape is an independent WeightPlay game and is not an official version of, endorsed by, licensed by, or affiliated with Tap Away 3D or Popcore.","source":"Official source:"},"zh-Hant":{"title":"相似方向方塊玩法參考","body":"Tap Away 3D 與《箭頭大逃亡》都要求玩家依正確順序移除只能朝單一方向離場的方塊，直到清空謎題。Popcore 的作品使用可旋轉的 3D 立體結構，玩家要滑動視角，從不同角度找出可移除方塊，並包含造型、主題與額外挑戰。《箭頭大逃亡》則是 30 個手工設計的 2D 關卡，分成六個規則章節；點到受阻箭頭不會消耗步數，還會指出第一個阻擋物，提示只標出一個安全下一步，後期再加入牆壁、旋轉箭頭、鑰匙、冰凍、成對傳送門與單向門，解鎖進度保存在目前瀏覽器。","disclaimer":"《箭頭大逃亡》是 WeightPlay 的獨立作品，並非 Tap Away 3D 官方版本，也未獲 Tap Away 3D 或 Popcore 背書、授權，與其沒有隸屬關係。","source":"官方來源："},"zh-Hans":{"title":"相似方向方块玩法参考","body":"Tap Away 3D 与《箭头大逃亡》都要求玩家按正确顺序移除只能朝单一方向离场的方块，直到清空谜题。Popcore 的作品使用可旋转的 3D 立体结构，玩家要滑动视角，从不同角度找出可移除方块，并包含造型、主题和额外挑战。《箭头大逃亡》则提供 30 个手工设计的 2D 关卡，分成六个规则章节；点到受阻箭头不会消耗步数，还会指出第一个阻挡物，提示只标出一个安全的下一步，后期再加入墙壁、旋转箭头、钥匙、冰冻、成对传送门和单向门，解锁进度保存在当前浏览器。","disclaimer":"《箭头大逃亡》是 WeightPlay 的独立作品，并非 Tap Away 3D 官方版本，也未获 Tap Away 3D 或 Popcore 背书、授权，与其没有隶属关系。","source":"官方来源："},"ja":{"title":"似た方向ブロック型ゲームの参考","body":"Tap Away 3D とアローエスケープは、どちらも一方向にしか抜けないブロックを正しい順番で取り除き、パズル全体を空にしていくゲームです。Popcore の作品では回転できる 3D オブジェクトをスワイプし、さまざまな角度から外せるブロックを探し、スキンやテーマ、追加チャレンジも楽しめます。アローエスケープは代わりに、6つのルール章に分かれた30個の手作り2Dステージを収録しています。塞がれた矢印を押しても手数は増えず最初の障害物が示され、ヒントは安全な次の矢印を1つだけ示します。後半では壁、回転矢印、鍵、氷、対になったポータル、一方通行ゲートが加わり、解放状況はこのブラウザーに保存されます。","disclaimer":"アローエスケープは WeightPlay の独立作品であり、Tap Away 3D の公式版ではありません。Tap Away 3D または Popcore からの推奨、許諾、提携もありません。","source":"公式情報："},"ko":{"title":"비슷한 방향 블록 게임 참고","body":"Tap Away 3D와 애로우 이스케이프는 모두 한 방향으로만 빠져나가는 블록을 올바른 순서로 제거해 퍼즐을 비우는 게임입니다. Popcore의 게임은 회전 가능한 3D 형태를 손가락으로 돌려 여러 각도에서 제거할 블록을 찾고, 스킨과 테마, 추가 도전도 제공합니다. 애로우 이스케이프는 대신 여섯 규칙 장으로 구성된 30개의 수제 2D 스테이지를 제공합니다. 막힌 화살표를 눌러도 이동 횟수가 늘지 않고 첫 방해물을 알려 주며, 힌트는 안전한 다음 화살표 하나만 표시합니다. 후반에는 벽, 회전 화살표, 열쇠, 얼음, 짝지어진 포털, 일방통행 문이 추가되고 잠금 해제 진행도는 이 브라우저에 저장됩니다.","disclaimer":"애로우 이스케이프는 WeightPlay의 독립 작품이며 Tap Away 3D의 공식 버전이 아닙니다. Tap Away 3D 또는 Popcore의 보증, 라이선스, 제휴 관계도 없습니다.","source":"공식 출처:"},"es":{"title":"Referencia de bloques direccionales similares","body":"Tap Away 3D y Escape de Flechas comparten la idea de quitar bloques que solo pueden salir en una dirección y hacerlo en un orden que vacíe todo el puzle. El juego de Popcore usa una figura 3D giratoria: deslizas para verla desde distintos ángulos, eliges los bloques que pueden salir y desbloqueas aspectos, temas y retos extra. Escape de Flechas, en cambio, ofrece 30 niveles 2D diseñados a mano y repartidos en seis capítulos de reglas; tocar una flecha bloqueada no gasta movimiento y muestra el primer obstáculo, la pista señala una sola flecha segura y los niveles posteriores añaden muros, flechas giratorias, llaves, hielo, portales emparejados y puertas de un sentido. El progreso desbloqueado se guarda en este navegador.","disclaimer":"Escape de Flechas es un juego independiente de WeightPlay; no es una versión oficial de Tap Away 3D ni está respaldado, licenciado o afiliado con Tap Away 3D o Popcore.","source":"Fuente oficial:"},"pt-BR":{"title":"Referência de blocos direcionais semelhantes","body":"Tap Away 3D e Fuga das Setas têm em comum a ideia de remover blocos que só saem em uma direção, escolhendo uma ordem que limpe todo o quebra-cabeça. No jogo da Popcore, os blocos formam uma estrutura 3D que pode ser girada: você desliza para observar outros ângulos, escolhe os blocos removíveis e desbloqueia visuais, temas e desafios extras. Fuga das Setas usa 30 fases 2D feitas à mão, divididas em seis capítulos de regras; tocar numa seta bloqueada não consome jogada e revela o primeiro obstáculo, a dica marca apenas uma próxima seta segura, e as fases posteriores acrescentam paredes, setas giratórias, chaves, gelo, portais em pares e portas de mão única. O progresso liberado fica salvo neste navegador.","disclaimer":"Fuga das Setas é um jogo independente da WeightPlay; não é uma versão oficial de Tap Away 3D e não é endossado, licenciado nem afiliado a Tap Away 3D ou à Popcore.","source":"Fonte oficial:"},"fr":{"title":"Référence de jeu à blocs directionnels similaire","body":"Tap Away 3D et Arrow Escape demandent tous deux de retirer des blocs qui ne peuvent partir que dans une direction, dans un ordre permettant de vider tout le puzzle. Le jeu de Popcore utilise une forme 3D rotative : on la fait pivoter pour examiner différents angles, choisir les blocs amovibles et débloquer des apparences, des thèmes et des défis supplémentaires. Arrow Escape propose plutôt 30 niveaux 2D conçus à la main et répartis en six chapitres de règles ; toucher une flèche bloquée ne coûte aucun coup et révèle le premier obstacle, l’indice ne marque qu’une prochaine flèche sûre, puis les niveaux avancés ajoutent murs, flèches rotatives, clés, glace, portails jumelés et portes à sens unique. La progression débloquée reste enregistrée dans ce navigateur.","disclaimer":"Arrow Escape est un jeu indépendant de WeightPlay ; ce n’est pas une version officielle de Tap Away 3D et il n’est ni approuvé, ni licencié, ni affilié à Tap Away 3D ou Popcore.","source":"Source officielle :"},"de":{"title":"Referenz für ein ähnliches Richtungsblock-Spiel","body":"Tap Away 3D und Arrow Escape verlangen beide, Blöcke mit nur einer möglichen Ausflugrichtung in einer Reihenfolge zu entfernen, die das gesamte Rätsel leert. Bei Popcore liegen die Blöcke auf einer drehbaren 3D-Form: Du wischst um das Objekt, suchst aus verschiedenen Blickwinkeln entfernbare Blöcke und schaltest Skins, Themen und zusätzliche Herausforderungen frei. Arrow Escape setzt stattdessen auf 30 handgebaute 2D-Stufen in sechs Regelkapiteln. Ein Tipp auf einen blockierten Pfeil kostet keinen Zug und zeigt das erste Hindernis, der Hinweis markiert genau einen sicheren nächsten Pfeil, und spätere Stufen ergänzen Wände, Drehpfeile, Schlüssel, Eis, gepaarte Portale und Einwegtore. Freigeschalteter Fortschritt bleibt in diesem Browser gespeichert.","disclaimer":"Arrow Escape ist ein unabhängiges WeightPlay-Spiel, keine offizielle Version von Tap Away 3D und weder von Tap Away 3D noch von Popcore unterstützt, lizenziert oder mit ihnen verbunden.","source":"Offizielle Quelle:"},"it":{"title":"Riferimento a un gioco simile con blocchi direzionali","body":"Tap Away 3D e Fuga delle Frecce chiedono entrambi di rimuovere blocchi che possono uscire in una sola direzione, scegliendo un ordine che svuoti l’intero rompicapo. Nel gioco di Popcore i blocchi formano una struttura 3D ruotabile: scorri per guardarla da diverse angolazioni, scegli i blocchi rimovibili e sblocchi aspetti, temi e sfide aggiuntive. Fuga delle Frecce usa invece 30 livelli 2D progettati a mano e divisi in sei capitoli di regole; toccare una freccia bloccata non costa una mossa e mostra il primo ostacolo, il suggerimento indica una sola freccia sicura successiva e i livelli avanzati aggiungono muri, frecce rotanti, chiavi, ghiaccio, portali accoppiati e porte a senso unico. I progressi sbloccati restano salvati in questo browser.","disclaimer":"Fuga delle Frecce è un gioco indipendente di WeightPlay; non è una versione ufficiale di Tap Away 3D e non è approvato, concesso in licenza o affiliato a Tap Away 3D o Popcore.","source":"Fonte ufficiale:"},"ru":{"title":"Сравнение с похожей игрой о направленных блоках","body":"Tap Away 3D и «Побег стрелок» предлагают убирать блоки, которые могут выйти только в одном направлении, подбирая порядок, позволяющий полностью очистить головоломку. В игре Popcore блоки образуют вращаемую 3D-фигуру: её нужно поворачивать жестом, искать снимаемые блоки с разных ракурсов и открывать оформления, темы и дополнительные испытания. «Побег стрелок» вместо этого содержит 30 вручную созданных 2D-этапов в шести главах правил. Нажатие на заблокированную стрелку не тратит ход и показывает первое препятствие, подсказка отмечает только одну безопасную следующую стрелку, а поздние этапы добавляют стены, вращающиеся стрелки, ключи, лёд, парные порталы и односторонние ворота. Открытый прогресс сохраняется в этом браузере.","disclaimer":"«Побег стрелок» — независимая игра WeightPlay, а не официальная версия Tap Away 3D; она не одобрена, не лицензирована и не связана с Tap Away 3D или Popcore.","source":"Официальный источник:"},"hi":{"title":"मिलते-जुलते दिशात्मक ब्लॉक खेल का संदर्भ","body":"Tap Away 3D और एरो एस्केप दोनों में एक दिशा में निकलने वाले ब्लॉकों को ऐसे क्रम में हटाना होता है जिससे पूरी पहेली साफ हो जाए। Popcore के खेल में ब्लॉक एक घुमाए जा सकने वाले 3D आकार पर होते हैं; आप आकार को अलग-अलग कोणों से देखने के लिए स्वाइप करते हैं, हट सकने वाले ब्लॉक चुनते हैं और स्किन, थीम तथा अतिरिक्त चुनौतियाँ खोलते हैं। एरो एस्केप इसके बजाय छह नियम अध्यायों में बाँटे गए 30 हाथ से बनाए 2D चरण देता है; रुका हुआ तीर दबाने पर चाल खर्च नहीं होती और पहला अवरोध दिखता है, संकेत केवल एक सुरक्षित अगला तीर बताता है, और आगे के चरणों में दीवारें, घूमते तीर, चाबियाँ, बर्फ, जोड़ी वाले पोर्टल और एकतरफा द्वार जुड़ते हैं। अनलॉक प्रगति इसी ब्राउज़र में सहेजी जाती है।","disclaimer":"एरो एस्केप WeightPlay का स्वतंत्र खेल है; यह Tap Away 3D का आधिकारिक संस्करण नहीं है और Tap Away 3D या Popcore द्वारा समर्थित, लाइसेंस प्राप्त या संबद्ध नहीं है।","source":"आधिकारिक स्रोत:"},"ar":{"title":"مرجع للعبة كتل اتجاهية مشابهة","body":"تشترك Tap Away 3D و«هروب الأسهم» في إزالة كتل لا تخرج إلا في اتجاه واحد، مع اختيار ترتيب يؤدي إلى إخلاء اللغز كله. تضع لعبة Popcore الكتل على شكل ثلاثي الأبعاد قابل للدوران؛ تمرر إصبعك حوله لرؤيته من زوايا مختلفة، وتختار الكتل القابلة للإزالة، وتفتح مظاهر وسمات وتحديات إضافية. أما «هروب الأسهم» فيقدم 30 مرحلة ثنائية الأبعاد مصممة يدويًا ضمن ستة فصول من القواعد؛ الضغط على سهم محجوب لا يستهلك حركة ويكشف أول عائق، والتلميح يحدد سهمًا آمنًا واحدًا للخطوة التالية، ثم تضيف المراحل المتقدمة الجدران والأسهم الدوارة والمفاتيح والجليد والبوابات المزدوجة والبوابات أحادية الاتجاه. ويُحفظ تقدم الفتح في هذا المتصفح.","disclaimer":"«هروب الأسهم» لعبة مستقلة من WeightPlay وليست إصدارًا رسميًا من Tap Away 3D، ولا تحظى بتأييد أو ترخيص أو ارتباط من Tap Away 3D أو Popcore.","source":"المصدر الرسمي:"}};
  function applyComparisonCopy(){const copy=COMPARISON_COPY[locale]||COMPARISON_COPY.en,root=document.querySelector('[data-wp-market-comparison="1.3.0"]');if(!root)return;root.dataset.comparisonLocale=locale;const title=root.querySelector('[data-arrow-compare="title"]'),body=root.querySelector('[data-arrow-compare="body"]'),disclaimer=root.querySelector('[data-arrow-compare="disclaimer"]'),source=root.querySelector('[data-arrow-compare="source"]');if(title)title.textContent=copy.title;if(body)body.textContent=copy.body;if(disclaimer)disclaimer.textContent=copy.disclaimer;if(source)source.textContent=copy.source;}
