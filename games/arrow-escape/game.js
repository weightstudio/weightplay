(() => {
  ...
  let selectedStage=unlocked,currentStage=unlocked,state=null,moves=0,busy=false,lastFocus=null,battleGeneration=0,pendingFeedback="",activeEscapes=new Set(),activePreviewBand=null;
