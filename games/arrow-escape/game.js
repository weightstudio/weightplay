(() => {
  ...
  let selectedStage=unlocked,currentStage=1,state=null,moves=0,busy=false,lastFocus=null,battleGeneration=0,pendingFeedback="",activeEscapes=new Set();
  ...
  function showStage(){if(document.body.dataset.screen==="battle"){battleGeneration++;activeEscapes.clear();busy=false;pendingFeedback="";}setScreen("stage");selectedStage=Math.min(unlocked,currentStage||unlocked);renderStageRail();$("stageBack").focus();}
