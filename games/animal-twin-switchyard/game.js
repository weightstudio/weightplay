(function(){
  ...
  const stages = [
    ...
    { floors:[430,330], platforms:[[{x:245,y:360,w:145,h:16},{x:470,y:330,w:220,h:16}],[{x:200,y:260,w:135,h:16},{x:390,y:235,w:235,h:16}]], shards:[{lane:0,x:305,y:325},{lane:1,x:265,y:225},{lane:0,x:615,y:280}], switches:[], gates:[{x:870,y:400},{x:870,y:300}], hazards:[[],[]] },
