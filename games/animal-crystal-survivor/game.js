  ...
  text.es = {
   ...
   const runtimeLocaleCopy = {
     "zh-Hans": {
       ...
       diamondShopTitle: "巡逻强化", charmName: "水晶护符", charmEffect: "永久起始效果：最大生命 7 → 8 · 拾取范围 54 → 68。", charmOwned: "已拥有并保存：最大生命 8 · 每局拾取范围 68。", charmBuy: "用 {cost} 钻石解锁", charmNeed: "需要 {cost} 颗钻石 · 当前余额 {balance}。", charmBought: "已解锁并保存 · 剩余 {balance} 颗钻石。", charmConfirm: "确认永久强化 · 钻石 {before} → {after}。再次点击。", charmConfirmLabel: "确认水晶护符。消耗 12 颗钻石，余额从 {before} 变为 {after}。",
