...
const descriptions={
  "en": [
    ...
    "Once per run, a fatal hit restores 40 → 60 health and erupts.",
  ...
  "ko": [
    ...
    "전투당 한 번, 치명상 시 체력 40→60 회복 및 폭발.",
  ...
  "es": [
    ...
    "Una vez por partida, un golpe mortal restaura 40→60 de salud y explota.",
  ...
  "pt-BR": [
    ...
    "Uma vez por partida, um golpe fatal restaura 40→60 de vida e explode.",
  ...
  "fr": [
    ...
    "Une fois par partie, un coup fatal rend 40→60 PV et provoque une explosion.",
  ...
  "de": [
    ...
    "Einmal pro Runde heilt ein tödlicher Treffer 40→60 Leben und löst eine Explosion aus.",
  ...
  "it": [
    ...
    "Una volta per partita, un colpo fatale ripristina 40→60 salute ed esplode.",
  ...
  "ru": [
    ...
    "Раз за бой смертельный удар восстанавливает 40→60 здоровья и вызывает взрыв.",
  ...
  "hi": [
    ...
    "हर खेल में एक बार घातक चोट पर 40→60 जीवन लौटता और विस्फोट होता है।",
  ...
  "ar": [
    ...
    "مرة في الجولة، تعيد الضربة القاتلة 40→60 صحة وتسبب انفجارًا.",
