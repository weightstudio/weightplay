(() => {
  ...
  const copy = {
    en: { eyebrow: "Family trail · 6+", title: "Animal Putt Trails", lede: "Read the trail, choose a gentle line, and guide the ball to the flag. Every stroke is a small planning puzzle.", start: "Start the trail", howTo: "How to play", guide: "Drag back from the ball to aim. Release to putt. Short strokes are easier to control; use the banks and stop before the water.", stageEyebrow: "Choose a trail", stages: "Trail map", trail: "Trail", hole: "Hole", par: "Par", best: "Best", strokes: "Strokes", acorns: "Acorns", soundOn: "Sound: on", soundOff: "Sound: off", aim: "Drag back from the ball, then release.", rolling: "Rolling…", clear: "Trail clear", under: "under par", over: "over par", even: "on par", retry: "Retry hole", next: "Next hole", map: "Trail map", complete: "Course complete!", completeCopy: "You earned {acorns} acorns across six calm trails.", back: "Back", water: "Water", holeNames: ["Meadow Gate", "Mossy Bridge", "Moonlit Bend", "Firefly Crossing", "Lantern Loop"], holeTips: ["Use the two meadow banks to reach the flag.", "A light touch keeps the ball away from the stream.", "The moon bridge rewards a patient, angled stroke.", "Thread the fireflies with a soft bank around the water.", "Take the long bank around the water, then soften the final approach."] },
    "zh-tw": { eyebrow: "家庭小徑・6+", title: "動物推桿小徑", lede: "讀懂小徑、選好溫和的路線，把球送到旗子旁。每一桿都是小小的規劃謎題。", start: "開始小徑", howTo: "玩法", guide: "從球的位置向後拖曳來瞄準，放開即可推桿。短桿比較好控制，也可以利用邊界反彈並避開水面。", stageEyebrow: "選擇小徑", stages: "小徑地圖", trail: "小徑", hole: "洞", par: "標準桿", best: "最佳", strokes: "桿數", acorns: "橡果", soundOn: "音效：開", soundOff: "音效：關", aim: "從球的位置向後拖曳，再放開。", rolling: "球正在滾動…", clear: "小徑完成", under: "低於標準", over: "高於標準", even: "標準桿完成", retry: "重試本洞", next: "下一洞", map: "小徑地圖", complete: "球場完成！", completeCopy: "六條小徑一共取得 {acorns} 顆橡果。", back: "返回", water: "水面", holeNames: ["草地入口", "苔蘚小橋", "月光彎道", "螢火交叉口", "燈籠迴環"], holeTips: ["利用草地的兩個邊界，把球送到旗子旁。", "輕輕推桿，讓球避開溪流。", "月光小橋需要耐心的斜角推桿。", "用柔和的反彈繞過水面，穿過螢火微光。", "繞著水面走長邊反彈，最後放輕力道接近球洞。"] },
    "zh-cn": { eyebrow: "家庭小径・6+", title: "动物推杆小径", lede: "读懂小径、选好温和的路线，把球送到旗子旁。每一杆都是小小的规划谜题。", start: "开始小径", howTo: "玩法", guide: "从球的位置向后拖曳来瞄准，松开即可推杆。短杆比较好控制，也可以利用边界反弹并避开水面。", stageEyebrow: "选择小径", stages: "小径地图", trail: "小径", hole: "洞", par: "标准杆", best: "最佳", strokes: "杆数", acorns: "橡果", soundOn: "音效：开", soundOff: "音效：关", aim: "从球的位置向后拖曳，再松开。", rolling: "球正在滚动…", clear: "小径完成", under: "低于标准", over: "高于标准", even: "标准杆完成", retry: "重试本洞", next: "下一洞", map: "小径地图", complete: "球场完成！", completeCopy: "六条小径一共取得 {acorns} 颗橡果。", back: "返回", water: "水面", holeNames: ["草地入口", "苔藓小桥", "月光弯道", "萤火交叉口", "灯笼回环"], holeTips: ["利用草地的两个边界，把球送到旗子旁。", "轻轻推杆，让球避开溪流。", "月光小桥需要耐心的斜角推杆。", "用柔和的反弹绕过水面，穿过萤火微光。", "沿水面外侧用长边反弹，最后放轻力度接近球洞。"] },
    ja: { eyebrow: "ファミリーコース・6+", title: "どうぶつパットトレイル", lede: "コースを読み、やさしいラインを選んで、ボールを旗へ。ひと打ちごとに小さな計画を楽しもう。", start: "コースを始める", howTo: "遊び方", guide: "ボールから後ろへドラッグして狙い、指を離して打ちます。短いショットは調整しやすく、壁を使って水を避けましょう。", stageEyebrow: "コースを選ぶ", stages: "コースマップ", trail: "コース", hole: "ホール", par: "パー", best: "ベスト", strokes: "打数", acorns: "どんぐり", soundOn: "サウンド：オン", soundOff: "サウンド：オフ", aim: "ボールから後ろへドラッグして離します。", rolling: "ボールが転がっています…", clear: "コースクリア", under: "アンダー", over: "オーバー", even: "パー", retry: "もう一度", next: "次のホール", map: "マップ", complete: "コースコンプリート！", completeCopy: "6つのコースでどんぐりを {acorns} 個獲得しました。", back: "戻る", water: "水", holeNames: ["メドウゲート", "モッシーブリッジ", "ムーンライトベンド", "ホタルの交差点", "ランタンループ"], holeTips: ["草地の壁を使って旗へ進みましょう。", "やさしい力で小川を避けます。", "月の橋には落ち着いた斜めのショットが有効です。", "やわらかなバンクで水を避け、ホタルの間を進もう。", "水辺を大きくバンクし、最後は力を弱めてカップへ。"] },
    ko: { eyebrow: "가족 트레일 · 6+", title: "동물 퍼팅 트레일", lede: "길을 읽고 부드러운 선을 골라 공을 깃발까지 보내요. 한 번의 퍼팅마다 작은 계획이 필요해요.", start: "트레일 시작", howTo: "플레이 방법", guide: "공에서 뒤로 드래그해 조준하고 놓으면 퍼팅합니다. 짧은 퍼팅은 조절하기 쉽고, 벽을 이용해 물을 피하세요.", stageEyebrow: "트레일 선택", stages: "트레일 지도", trail: "트레일", hole: "홀", par: "파", best: "최고", strokes: "타수", acorns: "도토리", soundOn: "사운드: 켜짐", soundOff: "사운드: 꺼짐", aim: "공에서 뒤로 드래그한 뒤 놓으세요.", rolling: "공이 굴러가요…", clear: "트레일 클리어", under: "언더 파", over: "오버 파", even: "파", retry: "홀 다시 하기", next: "다음 홀", map: "트레일 지도", complete: "코스 완료!", completeCopy: "여섯 트레일에서 도토리 {acorns}개를 얻었어요.", back: "돌아가기", water: "물", holeNames: ["초원 입구", "이끼 다리", "달빛 굽이", "반딧불 교차로", "랜턴 루프"], holeTips: ["초원의 벽을 이용해 깃발로 가세요.", "가볍게 쳐서 개울을 피하세요.", "달빛 다리는 차분한 대각선 퍼팅이 좋아요.", "부드러운 뱅크 샷으로 물을 피하며 반딧불 사이를 지나가요.", "물을 크게 돌아 뱅크하고 마지막에는 힘을 줄여 컵으로 가요."] },
    es: { eyebrow: "Sendero familiar · 6+", title: "Senderos de Putt Animal", lede: "Lee el sendero, elige una línea suave y guía la bola hasta la bandera. Cada golpe es un pequeño reto de planificación.", start: "Empezar el sendero", howTo: "Cómo jugar", guide: "Arrastra hacia atrás desde la bola para apuntar. Suelta para golpear. Los golpes cortos se controlan mejor; usa los bordes y evita el agua.", stageEyebrow: "Elige un sendero", stages: "Mapa de senderos", trail: "Sendero", hole: "Hoyo", par: "Par", best: "Mejor", strokes: "Golpes", acorns: "Bellotas", soundOn: "Sonido: activo", soundOff: "Sonido: apagado", aim: "Arrastra hacia atrás desde la bola y suelta.", rolling: "La bola rueda…", clear: "Sendero completado", under: "bajo par", over: "sobre par", even: "al par", retry: "Repetir hoyo", next: "Siguiente hoyo", map: "Mapa", complete: "¡Campo completado!", completeCopy: "Conseguiste {acorns} bellotas en seis senderos tranquilos.", back: "Volver", water: "Agua", holeNames: ["Puerta del Prado", "Puente Musgoso", "Curva de Luna", "Cruce de Luciérnagas", "Bucle de Faroles"], holeTips: ["Usa los bordes del prado para llegar a la bandera.", "Un golpe suave mantiene la bola lejos del arroyo.", "El puente lunar premia un golpe diagonal paciente.", "Rodea el agua con un rebote suave y cruza entre las luciérnagas.", "Rodea el agua con un rebote largo y suaviza el golpe final."] },
    "pt-br": { eyebrow: "Trilha em família · 6+", title: "Trilhas de Putt Animal", lede: "Leia a trilha, escolha uma linha suave e leve a bola até a bandeira. Cada tacada é um pequeno desafio de planejamento.", start: "Começar a trilha", howTo: "Como jogar", guide: "Arraste para trás a partir da bola para mirar. Solte para bater. Tacadas curtas são mais fáceis de controlar; use as bordas e evite a água.", stageEyebrow: "Escolha uma trilha", stages: "Mapa de trilhas", trail: "Trilha", hole: "Buraco", par: "Par", best: "Melhor", strokes: "Tacadas", acorns: "Bolotas", soundOn: "Som: ligado", soundOff: "Som: desligado", aim: "Arraste para trás a partir da bola e solte.", rolling: "A bola está rolando…", clear: "Trilha concluída", under: "abaixo do par", over: "acima do par", even: "no par", retry: "Repetir buraco", next: "Próximo buraco", map: "Mapa", complete: "Campo concluído!", completeCopy: "Você ganhou {acorns} bolotas em seis trilhas tranquilas.", back: "Voltar", water: "Água", holeNames: ["Portão do Prado", "Ponte Musgosa", "Curva da Lua", "Travessia dos Vagalumes", "Laço das Lanternas"], holeTips: ["Use as bordas do prado para chegar à bandeira.", "Uma tacada leve mantém a bola longe do riacho.", "A ponte lunar recompensa uma tacada diagonal paciente.", "Use uma rebatida suave para contornar a água entre os vagalumes.", "Faça uma rebatida longa ao redor da água e suavize a aproximação final."] },
    fr: { eyebrow: "Sentier familial · 6+", title: "Sentiers de Putt Animal", lede: "Lis le sentier, choisis une ligne douce et guide la balle vers le drapeau. Chaque coup est un petit défi de planification.", start: "Commencer le sentier", howTo: "Comment jouer", guide: "Fais glisser depuis la balle vers l'arrière pour viser. Relâche pour frapper. Les petits coups sont plus faciles à contrôler; évite l'eau.", stageEyebrow: "Choisis un sentier", stages: "Carte des sentiers", trail: "Sentier", hole: "Trou", par: "Par", best: "Meilleur", strokes: "Coups", acorns: "Glands", soundOn: "Son : activé", soundOff: "Son : désactivé", aim: "Fais glisser vers l'arrière puis relâche.", rolling: "La balle roule…", clear: "Sentier terminé", under: "sous le par", over: "au-dessus du par", even: "dans le par", retry: "Rejouer le trou", next: "Trou suivant", map: "Carte", complete: "Parcours terminé !", completeCopy: "Tu as gagné {acorns} glands sur six sentiers calmes.", back: "Retour", water: "Eau", holeNames: ["Porte des Prés", "Pont Moussu", "Virage Lunaire", "Croisement des Lucioles", "Boucle des Lanternes"], holeTips: ["Utilise les bords de la prairie pour atteindre le drapeau.", "Un coup léger éloigne la balle du ruisseau.", "Le pont lunaire récompense un coup diagonal patient.", "Contourne l’eau avec un rebond doux entre les lucioles.", "Contourne l'eau par une longue bande et adoucis l'approche finale."] },
    de: { eyebrow: "Familienpfad · 6+", title: "Tierische Putt-Pfade", lede: "Lies den Pfad, wähle eine sanfte Linie und führe den Ball zur Flagge. Jeder Schlag ist ein kleines Planungsrätsel.", start: "Pfad starten", howTo: "So wird gespielt", guide: "Ziehe vom Ball aus zurück, um zu zielen. Loslassen schlägt den Ball. Kurze Schläge sind leichter zu steuern; nutze Banden und meide das Wasser.", stageEyebrow: "Pfad wählen", stages: "Pfadkarte", trail: "Pfad", hole: "Loch", par: "Par", best: "Bestwert", strokes: "Schläge", acorns: "Eicheln", soundOn: "Ton: an", soundOff: "Ton: aus", aim: "Vom Ball zurückziehen und loslassen.", rolling: "Der Ball rollt…", clear: "Pfad geschafft", under: "unter Par", over: "über Par", even: "Par", retry: "Loch wiederholen", next: "Nächstes Loch", map: "Pfadkarte", complete: "Kurs geschafft!", completeCopy: "Du hast {acorns} Eicheln auf sechs ruhigen Pfaden gesammelt.", back: "Zurück", water: "Wasser", holeNames: ["Wiesentor", "Moosbrücke", "Mondkurve", "Glühwürmchen-Kreuzung", "Laternenrunde"], holeTips: ["Nutze die Wiesenbanden, um die Flagge zu erreichen.", "Ein sanfter Schlag hält den Ball vom Bach fern.", "Die Mondbrücke belohnt einen geduldigen diagonalen Schlag.", "Umrunde das Wasser mit einem sanften Bandenschlag zwischen den Glühwürmchen.", "Spiele einen langen Bandenschlag um das Wasser und nähere dich sanft."] },
    it: { eyebrow: "Sentiero per famiglie · 6+", title: "Sentieri di Putt Animali", lede: "Leggi il sentiero, scegli una linea delicata e guida la palla alla bandierina. Ogni colpo è un piccolo rompicapo di pianificazione.", start: "Inizia il sentiero", howTo: "Come si gioca", guide: "Trascina indietro dalla palla per mirare. Rilascia per tirare. I colpi brevi sono più facili da controllare; usa i bordi ed evita l'acqua.", stageEyebrow: "Scegli un sentiero", stages: "Mappa dei sentieri", trail: "Sentiero", hole: "Buca", par: "Par", best: "Migliore", strokes: "Colpi", acorns: "Ghiande", soundOn: "Suono: attivo", soundOff: "Suono: spento", aim: "Trascina indietro dalla palla e rilascia.", rolling: "La palla rotola…", clear: "Sentiero completato", under: "sotto il par", over: "sopra il par", even: "in par", retry: "Ripeti buca", next: "Buca successiva", map: "Mappa", complete: "Percorso completato!", completeCopy: "Hai raccolto {acorns} ghiande in sei sentieri tranquilli.", back: "Indietro", water: "Acqua", holeNames: ["Ingresso del Prato", "Ponte Muschioso", "Curva di Luna", "Incrocio delle Lucciole", "Anello delle Lanterne"], holeTips: ["Usa i bordi del prato per raggiungere la bandierina.", "Un colpo leggero tiene la palla lontana dal ruscello.", "Il ponte lunare premia un colpo diagonale paziente.", "Aggira l'acqua con un rimbalzo delicato tra le lucciole.", "Gira intorno all'acqua con un lungo rimbalzo e addolcisci l'avvicinamento finale."] },
    ru: { eyebrow: "Семейная тропа · 6+", title: "Звериные пути для патта", lede: "Изучи тропу, выбери мягкую линию и отправь мяч к флажку. Каждый удар — маленькая задачка на планирование.", start: "Начать тропу", howTo: "Как играть", guide: "Потяни от мяча назад, чтобы прицелиться. Отпусти, чтобы ударить. Короткие удары легче контролировать; используй бортики и избегай воды.", stageEyebrow: "Выбери тропу", stages: "Карта троп", trail: "Тропа", hole: "Лунка", par: "Пар", best: "Лучший", strokes: "Удары", acorns: "Жёлуди", soundOn: "Звук: вкл.", soundOff: "Звук: выкл.", aim: "Потяни от мяча назад и отпусти.", rolling: "Мяч катится…", clear: "Тропа пройдена", under: "ниже пара", over: "выше пара", even: "в пар", retry: "Повторить лунку", next: "Следующая лунка", map: "Карта троп", complete: "Поле пройдено!", completeCopy: "Ты собрал {acorns} желудей на шести спокойных тропах.", back: "Назад", water: "Вода", holeNames: ["Луговые ворота", "Мшистый мост", "Лунный поворот", "Перекрёсток светлячков", "Фонарная петля"], holeTips: ["Используй бортики луга, чтобы добраться до флажка.", "Мягкий удар удержит мяч подальше от ручья.", "Лунный мост любит спокойный диагональный удар.", "Мягко обойди воду отскоком, пробираясь между светлячками.", "Обойди воду длинным отскоком и смягчи последний удар к лунке."] },
    hi: { eyebrow: "परिवार ट्रेल · 6+", title: "ऐनिमल पुट ट्रेल्स", lede: "ट्रेल पढ़ें, नरम लाइन चुनें और गेंद को झंडे तक पहुँचाएँ। हर स्ट्रोक एक छोटी योजना पहेली है।", start: "ट्रेल शुरू करें", howTo: "कैसे खेलें", guide: "निशाना लगाने के लिए गेंद से पीछे की ओर खींचें। पुट करने के लिए छोड़ दें। छोटे स्ट्रोक आसान होते हैं; किनारों का उपयोग करें और पानी से बचें।", stageEyebrow: "ट्रेल चुनें", stages: "ट्रेल मानचित्र", trail: "ट्रेल", hole: "होल", par: "पार", best: "सर्वश्रेष्ठ", strokes: "स्ट्रोक", acorns: "बलूत", soundOn: "ध्वनि: चालू", soundOff: "ध्वनि: बंद", aim: "गेंद से पीछे खींचें और छोड़ दें।", rolling: "गेंद चल रही है…", clear: "ट्रेल पूरा", under: "पार से कम", over: "पार से अधिक", even: "पार पर", retry: "होल फिर खेलें", next: "अगला होल", map: "ट्रेल मानचित्र", complete: "कोर्स पूरा!", completeCopy: "छह शांत ट्रेल्स में आपने {acorns} बलूत पाए।", back: "वापस", water: "पानी", holeNames: ["मीडो गेट", "मॉसी ब्रिज", "मूनलिट बेंड", "जुगनू चौराहा", "लालटेन घेरा"], holeTips: ["झंडे तक पहुँचने के लिए घास के किनारों का उपयोग करें।", "हल्का स्ट्रोक गेंद को धारा से दूर रखता है।", "मून ब्रिज धैर्य वाले तिरछे स्ट्रोक को पसंद करता है।", "पानी के चारों ओर नरम बैंक शॉट लगाकर जुगनुओं के बीच से जाएँ।", "पानी के चारों ओर लंबा बैंक शॉट लगाएँ और अंतिम स्ट्रोक हल्का रखें।"] },
    ar: { eyebrow: "مسار عائلي · 6+", title: "مسارات ضربات الحيوانات", lede: "اقرأ المسار، اختر خطاً لطيفاً، ووجّه الكرة إلى الراية. كل ضربة لغز تخطيط صغير.", start: "ابدأ المسار", howTo: "طريقة اللعب", guide: "اسحب للخلف من الكرة للتصويب، ثم اتركها للضرب. الضربات القصيرة أسهل للتحكم؛ استخدم الحواف وتجنب الماء.", stageEyebrow: "اختر مساراً", stages: "خريطة المسارات", trail: "مسار", hole: "حفرة", par: "الضربات القياسية", best: "الأفضل", strokes: "الضربات", acorns: "البلوط", soundOn: "الصوت: تشغيل", soundOff: "الصوت: إيقاف", aim: "اسحب للخلف من الكرة ثم اتركها.", rolling: "الكرة تتدحرج…", clear: "اكتمل المسار", under: "أقل من القياسي", over: "أكثر من القياسي", even: "على القياسي", retry: "أعد الحفرة", next: "الحفرة التالية", map: "خريطة المسارات", complete: "اكتمل الملعب!", completeCopy: "جمعت {acorns} من ثمار البلوط عبر ستة مسارات هادئة.", back: "رجوع", water: "ماء", holeNames: ["بوابة المرج", "الجسر الطحلبي", "منعطف ضوء القمر", "مفترق اليراعات", "حلقة الفوانيس"], holeTips: ["استخدم حافتي المرج للوصول إلى الراية.", "ضربة خفيفة تبقي الكرة بعيداً عن الجدول.", "يكافئ جسر القمر الضربة القطرية الهادئة.", "تجاوز الماء بضربة ارتداد لطيفة واعبر بين اليراعات.", "تجاوز الماء بارتداد طويل وخفف الضربة الأخيرة نحو الحفرة."] },
  };

  const sixthHoleCopy = {
    en: { name: "Willow Switchback", tip: "Use the willow banks to arc around the pond, then settle into the flag." },
    "zh-tw": { name: "柳影折返", tip: "利用柳樹邊界繞過池塘，再放輕力道接近旗子。" },
    "zh-cn": { name: "柳影折返", tip: "利用柳树边界绕过池塘，再放轻力度接近旗子。" },
    ja: { name: "柳の折り返し", tip: "柳の壁で池を大きく回り、最後は力を弱めて旗へ近づきます。" },
    ko: { name: "버드나무 굽이", tip: "버드나무 벽으로 연못을 돌아 마지막에는 힘을 줄여 깃발에 다가가세요." },
    es: { name: "Curva de Sauces", tip: "Rodea el estanque con los bordes de sauce y suaviza el golpe final hacia la bandera." },
    "pt-br": { name: "Curva dos Salgueiros", tip: "Contorne o lago usando as bordas dos salgueiros e suavize a aproximação final." },
    fr: { name: "Méandre des Saules", tip: "Contourne l'étang avec les bordures de saules, puis adoucis l'approche du drapeau." },
    de: { name: "Weidenkehre", tip: "Spiele an den Weidenbanden um den Teich und nähere dich sanft der Flagge." },
    it: { name: "Ansa dei Salici", tip: "Gira intorno allo stagno usando i bordi dei salici e addolcisci l'avvicinamento alla bandierina." },
    ru: { name: "Ивовый поворот", tip: "Обойди пруд по ивовым бортикам и смягчи последний удар к флажку." },
    hi: { name: "विलो मोड़", tip: "तालाब के चारों ओर विलो किनारों से जाएँ और झंडे तक पहुँचते हुए अंतिम स्ट्रोक हल्का रखें।" },
    ar: { name: "منعطف الصفصاف", tip: "استخدم حواف الصفصاف للالتفاف حول البركة، ثم خفف الضربة الأخيرة نحو الراية." }
  };
  ...
  const keyboardAimLabels = { en: "Use arrow keys to aim, then press Enter to putt.", "zh-tw": "使用方向鍵瞄準，再按 Enter 推桿。", "zh-cn": "使用方向键瞄准，再按 Enter 推杆。", ja: "矢印キーで狙い、Enterでパットします。", ko: "화살표 키로 조준한 뒤 Enter로 퍼팅하세요.", es: "Apunta con las flechas y pulsa Enter para golpear.", "pt-br": "Mire com as setas e pressione Enter para bater.", fr: "Visez avec les flèches, puis appuyez sur Entrée.", de: "Mit den Pfeiltasten zielen, dann Enter zum Putten drücken.", it: "Mira con le frecce, poi premi Invio per colpire.", ru: "Цельтесь стрелками, затем нажмите Enter для удара.", hi: "तीर कुंजियों से निशाना लगाएँ, फिर पुट के लिए Enter दबाएँ।", ar: "صوّب بمفاتيح الأسهم، ثم اضغط Enter للضرب." };
  const localeSelect = document.querySelector("#localeSelect");
  const screens = { main: document.querySelector("#mainScreen"), stage: document.querySelector("#stageScreen"), battle: document.querySelector("#battleScreen") };
  ...
  const holes = [
    { par: 3, start: [150, 520], cup: [800, 170], water: null, walls: [[250, 330, 430, 22], [520, 260, 720, 22]], tint: "#b5e4a5" },
    { par: 4, start: [145, 180], cup: [825, 530], water: [470, 365, 115, 72], walls: [[255, 120, 22, 250], [680, 340, 22, 260]], tint: "#a6d6be" },
  ...
  function summarizeSession(sessionScores, sessionAcorns) { return { totalStrokes: Object.values(sessionScores).reduce((total, value) => total + value, 0), totalAcorns: Object.values(sessionAcorns).reduce((total, value) => total + value, 0) }; }
