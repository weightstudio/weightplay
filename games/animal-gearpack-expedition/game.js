(() => {
  ...
  function newRun(){run={room:0,armor:36,maxArmor:36,gold:8,placed:[],tray:["forge-hammer","leaf-buckler","berry-potion","crystal-lens"],enemyHp:enemies[0].hp,enemyMaxHp:enemies[0].hp};selectedItem=run.tray[0];rotated=false;battleReady=false;resolving=false;saveRun();setTimeout(()=>sound("start"),0);track("game_start");showScreen("battle");}
