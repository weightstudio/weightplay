(function () {
  ...
  function show(screen) { document.querySelectorAll("main[data-screen], section[data-screen]").forEach((node) => { node.hidden = node.dataset.screen !== screen; }); document.body.dataset.screen = screen; $("settingsPanel").hidden = true; $("backBtn").hidden = screen === "main"; }
