const ANIMAL_GUARD_YARD_SHELL_COPY = {
  en: {
    ...
    shopTitle: "Rare Animal Shop", shopHint: "Spend shared WeightPlay diamonds on special animal guards.",
    tabStages: "Stages", tabAnimals: "Animals", tabShop: "Shop",
  },
  "zh-Hant": {
    gameTitle: "動物守衛庭院", language: "語言", back: "返回", backToLobby: "返回大廳",
    walletAria: "動物守衛庭院錢包", beastGuideAria: "野獸圖鑑", stageListAria: "關卡清單",
    ...
    shopTitle: "稀有動物商店", shopHint: "使用 WeightPlay 共用鑽石購買特殊動物守衛。",
    tabStages: "關卡", tabAnimals: "動物", tabShop: "商店",
  },
  "zh-Hans": {
    gameTitle: "动物守卫庭院", language: "语言", back: "返回", backToLobby: "返回大厅",
    walletAria: "动物守卫庭院钱包", beastGuideAria: "野兽图鉴", stageListAria: "关卡列表",
    ...
    shopTitle: "稀有动物商店", shopHint: "使用 WeightPlay 共用钻石购买特殊动物守卫。",
    tabStages: "关卡", tabAnimals: "动物", tabShop: "商店",
  },
  ja: {
    gameTitle: "どうぶつガードヤード", language: "言語", back: "戻る", backToLobby: "ロビーに戻る",
    walletAria: "どうぶつガードヤードのウォレット", beastGuideAria: "野獣図鑑", stageListAria: "ステージ一覧",
    ...
    shopTitle: "レアどうぶつショップ", shopHint: "WeightPlay 共通ダイヤで特別などうぶつガードを購入します。",
    tabStages: "ステージ", tabAnimals: "どうぶつ", tabShop: "ショップ",
  },
  ko: {
    gameTitle: "Animal Guard Yard", language: "언어", back: "뒤로", backToLobby: "로비로 돌아가기",
    walletAria: "Animal Guard Yard 지갑", beastGuideAria: "야수 도감", stageListAria: "스테이지 목록",
    ...
    shopTitle: "희귀 동물 상점", shopHint: "WeightPlay 공용 다이아로 특별한 동물 수호대를 구매하세요.",
    tabStages: "스테이지", tabAnimals: "동물", tabShop: "상점",
  },
  es: {
    gameTitle: "Guardianes del Jardín Animal", language: "Idioma", back: "Volver", backToLobby: "Volver al vestíbulo",
    walletAria: "Monedero de Guardianes del Jardín Animal", beastGuideAria: "Guía de bestias", stageListAria: "Lista de niveles",
    ...
    shopTitle: "Tienda de animales raros", shopHint: "Usa los diamantes compartidos de WeightPlay para conseguir guardianes especiales.",
    tabStages: "Niveles", tabAnimals: "Animales", tabShop: "Tienda",
  },
  "pt-BR": {
    gameTitle: "Animal Guard Yard", language: "Idioma", back: "Voltar", backToLobby: "Voltar ao lobby",
    walletAria: "Carteira do Animal Guard Yard", beastGuideAria: "Guia das feras", stageListAria: "Lista de fases",
    ...
    shopTitle: "Loja de animais raros", shopHint: "Gaste diamantes compartilhados do WeightPlay em guardas animais especiais.",
    tabStages: "Fases", tabAnimals: "Animais", tabShop: "Loja",
  },
  fr: {
    gameTitle: "Animal Guard Yard", language: "Langue", back: "Retour", backToLobby: "Retour au lobby",
    walletAria: "Portefeuille d’Animal Guard Yard", beastGuideAria: "Guide des bêtes", stageListAria: "Liste des niveaux",
    ...
    shopTitle: "Boutique d’animaux rares", shopHint: "Dépensez les diamants partagés de WeightPlay pour des gardiens animaux spéciaux.",
    tabStages: "Niveaux", tabAnimals: "Animaux", tabShop: "Boutique",
  },
  de: {
    gameTitle: "Animal Guard Yard", language: "Sprache", back: "Zurück", backToLobby: "Zurück zur Lobby",
    walletAria: "Animal-Guard-Yard-Geldbörse", beastGuideAria: "Biest-Handbuch", stageListAria: "Stufenliste",
    ...
    shopTitle: "Laden für seltene Tiere", shopHint: "Gib gemeinsame WeightPlay-Diamanten für besondere Tierwächter aus.",
    tabStages: "Stufen", tabAnimals: "Tiere", tabShop: "Laden",
  },
  it: {
    gameTitle: "Animal Guard Yard", language: "Lingua", back: "Indietro", backToLobby: "Torna alla lobby",
    walletAria: "Portafoglio di Animal Guard Yard", beastGuideAria: "Guida alle bestie", stageListAria: "Elenco livelli",
    ...
    shopTitle: "Negozio degli animali rari", shopHint: "Spendi i diamanti condivisi di WeightPlay per guardie animali speciali.",
    tabStages: "Livelli", tabAnimals: "Animali", tabShop: "Negozio",
  },
  ru: {
    gameTitle: "Animal Guard Yard", language: "Язык", back: "Назад", backToLobby: "Вернуться в лобби",
    walletAria: "Кошелёк Animal Guard Yard", beastGuideAria: "Справочник зверей", stageListAria: "Список этапов",
    ...
    shopTitle: "Магазин редких животных", shopHint: "Тратьте общие алмазы WeightPlay на особых защитников-животных.",
    tabStages: "Этапы", tabAnimals: "Животные", tabShop: "Магазин",
  },
  hi: {
    gameTitle: "Animal Guard Yard", language: "भाषा", back: "वापस", backToLobby: "लॉबी पर लौटें",
    walletAria: "Animal Guard Yard वॉलेट", beastGuideAria: "जानवरों की गाइड", stageListAria: "चरण सूची",
    ...
    shopTitle: "दुर्लभ पशु दुकान", shopHint: "विशेष पशु रक्षकों के लिए साझा WeightPlay हीरे खर्च करें।",
    tabStages: "चरण", tabAnimals: "पशु", tabShop: "दुकान",
  },
  ar: {
    gameTitle: "Animal Guard Yard", language: "اللغة", back: "رجوع", backToLobby: "العودة إلى الردهة",
    walletAria: "محفظة Animal Guard Yard", beastGuideAria: "دليل الوحوش", stageListAria: "قائمة المراحل",
    animalUpgradesAria: "ترقيات الحيوانات", animalShopAria: "متجر الحيوانات", menuAria: "قائمة Animal Guard Yard",
    gameScreenAria: "شاشة لعبة Animal Guard Yard الثابتة", sunEnergyAria: "طاقة الشمس", homeHeartsAria: "قلوب المنزل",
    ...
    shopTitle: "متجر الحيوانات النادرة", shopHint: "أنفق ماس WeightPlay المشترك لشراء حراس حيوانات مميزين.",
    tabStages: "المراحل", tabAnimals: "الحيوانات", tabShop: "المتجر",
  },
};
...
(() => {
  ...
  text.ar = {
    gameTitle: "ساحة حراس الحيوانات",
    language: "اللغة",
    back: "رجوع",
    backToLobby: "العودة إلى الردهة",
    walletAria: "محفظة ساحة حراس الحيوانات",
    beastGuideAria: "دليل الوحوش",
    stageListAria: "قائمة المراحل",
    animalUpgradesAria: "ترقيات الحيوانات",
    animalShopAria: "متجر الحيوانات",
    menuAria: "قائمة ساحة حراس الحيوانات",
    gameScreenAria: "شاشة لعبة ساحة حراس الحيوانات الثابتة",
    sunEnergyAria: "طاقة الشمس",
    homeHeartsAria: "قلوب المنزل",
    animalGuardsAria: "حراس الحيوانات",
    defenseLanesAria: "ممرات دفاع الحيوانات",
    chooseStage: "اختر مرحلة",
    menuHint: "ضع حراس الحيوانات وأوقف الوحوش البرية.",
    stages: "المراحل",
    openPause: "إيقاف المعركة مؤقتًا",
    pauseTitle: "المعركة متوقفة مؤقتًا",
    pauseHint: "تابع عندما تكون مستعدًا أو غادر هذه المعركة.",
    resume: "متابعة",
    leaveBattle: "مغادرة المعركة",
    loading: "جارٍ التحميل",
    nextStage: "المرحلة التالية",
    retry: "حاول مرة أخرى",
    lobby: "الردهة",
    locked: "المرحلة مقفلة",
    victory: "تمت حماية الساحة!",
    defeat: "وصلت الوحوش البرية إلى الساحة!",
    resultWin: "أكملت المرحلة {n} وبقيت {hp} من قلوب المنزل.",
    resultLose: "ضع الحراس مبكرًا واجمع كل طاقة الشمس.",
    resultScore: "النتيجة {score}",
    previousBest: "أفضل نتيجة سابقة {score}",
    newBest: "أفضل نتيجة جديدة!",
    improvement: "تحسن {value}%",
    perfectClear: "دفاع مثالي!",
    perfectBadge: "مثالي",
    perfectBonus: "مكافأة الدفاع المثالي +{coins} عملة",
    masteryTitle: "ميداليات الحديقة",
    masteryProgress: "{current}/{total} دفاعات مثالية",
    masteryNext: "المكافأة التالية عند {count} ميداليات",
    masteryComplete: "حصلت على كل ميداليات الحديقة!",
    masteryNewMedal: "حصلت على ميدالية حديقة جديدة!",
    masteryMilestone: "إنجاز الميدالية +{coins} عملة",
    stageCleared: "مكتملة",
    stageBest: "الأفضل {score}",
    progressNew: "تقدم رائع! حقق دفاع الساحة أفضل نتيجة جديدة.",
    progressSteady: "محاولة جيدة. ضع الحراس مبكرًا لتحسن محاولتك التالية.",
    progressNote: "النتائج للمتعة وتتبع التقدم المحلي فقط.",
    stage: "المرحلة {n}",
    wave: "المرحلة {n} - الوحوش المتبقية {left}",
    select: "اختر حيوانًا، ثم اضغط مربعًا عشبيًا.",
    noEnergy: "تحتاج إلى مزيد من الشمس.",
    noCoins: "تحتاج إلى مزيد من العملات.",
    noDiamonds: "تحتاج إلى مزيد من الماس.",
    occupied: "هذا المربع فيه حارس بالفعل.",
    started: "دافع عن الساحة!",
    danger: "⚠️ الوحوش قريبة!",
    kennelTitle: "تدريب الحيوانات",
    kennelHint: "طوّر الحراس بالعملات، وافتح الحيوانات النادرة بالماس.",
    shopTitle: "متجر الحيوانات النادرة",
    shopHint: "أنفق ماس WeightPlay المشترك لشراء حراس حيوانات مميزين.",
    tabStages: "المراحل",
    ...
    unlock: "فتح",
    owned: "مملوك",
    nextLevel: "المستوى التالي {n}",
    nextStats: "+{damage} هجوم / +{hp} صحة / أسرع بـ {cooldown} ثوانٍ",
    unlockHint: "افتح هذا الحارس لتدريبه.",
    coinToken: "عملات",
    diamondToken: "ماس",
    sunToken: "شمس",
    reward: "المكافأة +{coins} عملة",
    unitCat: "قطة",
    unitDog: "كلب",
    unitOwl: "بومة",
    unitFox: "ثعلب",
    roleRanged: "بعيد المدى",
    roleTankMelee: "دبابة قتال قريب",
    roleFastRanged: "بعيد المدى سريع",
    roleCrossLane: "عابر للممرات",
    abilityCat: "كل بذرة رابعة تخترق",
    abilityDog: "عضة تبطئ",
    abilityOwl: "ريشة تبطئ",
    abilityFox: "وابل عابر للممرات",
    catTactic: "كل بذرة رابعة تخترق وحشًا ثانيًا في الممر نفسه.",
    pierce: "اختراق!",
    dogTactic: "يسد الممر وتبطئ عضاته الوحوش لفترة قصيرة.",
    owlTactic: "تحافظ طلقاته السريعة على إبطاء الوحوش المندفعة.",
    foxTactic: "يطلق ورقة قوية ثم يدعم ممرًا قريبًا بوابل أخف.",
    costShort: "التكلفة",
    atkShort: "الهجوم",
    hpShort: "الصحة",
    beastGuideTitle: "دليل الوحوش",
    beastGuideHint: "تعرف إلى دور كل وحش بري قبل اختيار المرحلة.",
    threatPreview: "تهديدات المرحلة",
    threatNormal: "عادي",
    threatFast: "سريع",
    threatShield: "مدرع",
    threatHealer: "معالج",
    threatBurrow: "حفّار",
    threatThief: "سارق الشمس",
    threatBoss: "زعيم",
    beastNormalDesc: "وحوش متوازنة. أوقفها بالقطط أو الكلاب مبكرًا.",
    beastFastDesc: "وحوش سريعة تندفع في الممرات. ضع الحراس قبل ظهورها.",
    beastShieldDesc: "وحوش مدرعة ذات صحة عالية. استخدم حراسًا مدربين أقوى.",
    beastHealerDesc: "يعيد المعالج صحة الوحش أمامه. ركز عليه قبل أن يتعافى الممر.",
    beastBurrowDesc: "يحذر الحفّار قبل انتقاله إلى ممر قريب. حافظ على تغطية ممرين.",
    beastThiefDesc: "يسرق سارق الشمس 12 من طاقة الشمس إن لم توقفه قبل أن تتوهج حقيبته.",
    beastBossDesc: "يزأر الزعيم ويبطئ الحراس القريبين. ابنِ دفاعًا متعدد الطبقات.",
    bossRoar: "زئير الزعيم!",
    bossShell: "الصدفة مغلقة!",
    bossShellOpen: "الصدفة مفتوحة!",
    bossBurrow: "تغيير الممر!",
    bossRush: "الاندفاع قادم!",
    bossGale: "دفعة الريح!",
    bossMoon: "نبضة القمر!",
    healerPulse: "شفاء",
    thiefPulse: "-12 شمس",
    ...
    shield: "وحوش مدرعة",
    swarm: "ليلة السرب",
    boss: "زعيم عند البوابة",
    basic: "الدفاع الأول",
    crossfire: "كمين عابر للممرات",
    tankTrial: "اندفاع المدرعين",
    grandBoss: "حديقة الزعيم الكبير",
    stagePlan1: "ابدأ بضرر القطة، ثم أضف كلبًا قبل الوحوش الأخيرة.",
    stagePlan2: "تهاجم الوحوش السريعة الممرات الخارجية. ضع كلبًا حاجزًا مبكرًا.",
    stagePlan3: "الوحوش المدرعة صعبة. ركز القطط وأضف إبطاء البومة.",
    stagePlan4: "تمتلئ الممرات الوسطى. ابنِ الوسط أولًا ثم الجانبين.",
    stagePlan5: "مرحلة زعيم. سد ممر الزعيم وأبطئه بالبوم.",
    stagePlan6: "ممرات وسرعة أكثر. طوّر الكلاب ووزّع ضرر القطط.",
    stagePlan7: "مرحلة مليئة بالمدرعين. استخدم إبطاء البومة وانفجار الثعلب إن كان مفتوحًا.",
    stagePlan8: "زعيم كبير. احتفظ بالشمس للممرات الوسطى والحواجز الإضافية.",
  };
  ...
  const arabicStageCopy = [
    ...
    ["درع بين البرسيم", "ضع الكلب في الأمام والحراس بعيدَي المدى خلفه."],
    ["اندفاع الغسق", "راقب تحذير الممر واستعد قبل دخول الوحوش السريعة."],
    ["بوابة القرن الطحلبي", "يزأر وحيد القرن؛ وزّع الحراس بين المواضع الأمامية والخلفية."],
    ["أوراق الشفاء", "ركز على المعالج قبل أن يعيد صحة الوحش أمامه."],
    ["الدرع الصبور", "ضع هجمات القطة خلف الكلب بينما يكون المعالج مكشوفًا."],
    ["تعافٍ تحت المطر", "يمنح إبطاء البومة وقتًا لإنهاء المعالجين بين موجات المدرعين."],
    ["الموكب المنشوري", "احتفظ بالشمس لممرين كاملين بدلًا من وضع حراس ضعفاء كثيرين."],
    ["ساحة الصدفة المنشورية", "تغلق السلحفاة صدفتها؛ احتفظ بالضرر القوي حتى تفتحها."],
    ["التربة الرخوة", "يحذر الحفّار قبل صعوده أو هبوطه إلى ممر آخر."],
    ["الأنفاق المتقاطعة", "استخدم الثعلب أو وزّع الحراس بعيدَي المدى على الممرات المجاورة."],
    ["الحفر والدرع", "لا تدع حاجزًا واحدًا يحمل الممر الأوسط كله."],
    ["كمين تحت الأوراق", "اقرأ أيقونة التحذير؛ قد يغادر الحفّار ممره الأول."],
    ["قاعة زعيم الغرير", "يغيّر الزعيم الممر مرتين؛ أبقِ الممرات الوسطى الثلاثة جاهزة."],
    ["حقيبة الشمس الفارغة", "أوقف سارقي الشمس قبل أن تتوهج حقيبتهم ويسرقوا 12 شمسًا."],
    ["احمِ الحصاد", "اجمع القطرات بسرعة وأنفق الشمس قبل أن يسرقها سارق."],
    ["آثار ساخنة", "احجب السارق بينما تبطئ البومة مرافقه السريع."],
    ["تقاطع الجمر", "احتفظ بحاجز للممر الذي يحدده تحذير الاندفاع."],
    ["ساحة العرف المتّقد", "يعلن الخنزير اندفاعه؛ يمتصه الكلب بينما يطلق الحراس الخلفيون النار."],
    ["بذور في مهب الريح", "تصل الوحوش السريعة بالتناوب إلى الممرين الخارجيين."],
    ["الريشة والصدفة", "اجمع بين إبطاء البومة واختراق القطة ضد المدرعين المتجمعين."],
    ["الأنفاق العاصفة", "تختبر الحفّارات والوحوش السريعة تغطية الممرات المجاورة."],
    ["إنذار القمة العالية", "ابنِ من الوسط إلى الخارج قبل وصول الريح العاتية."],
    ["قمة جناح الريح", "يؤخر النسر هجمات الحراس؛ وزّع الحراس الأقوياء على الممرات."],
    ["مزيج ضوء القمر", "حدد الأيقونة أولًا: المعالج والسارق والحفّار يحتاجون إلى إجابات مختلفة."],
    ["ثلاثة ممرات هادئة", "جهّز ثلاثة دفاعات كاملة قبل وصول المرافق المختلط."],
    ["تبديل ضوء النجوم", "سيتبدل الحفّار بين الممرات بينما يضغط السارق على مخزون الشمس."],
    ["الاقتراب من التاج", "احتفظ بشمس ممر كامل لنبضة القمر للحارس الأخير."],
    ["حديقة التاج القمري", "يؤخر الأيل كل الحراس ويعالج نفسه بنبضة قمرية؛ استخدم الأدوار الأربعة."],
  ];
  stages.forEach((stage, index) => {
    const [title, plan] = arabicStageCopy[index];
    stage.title.ar = title;
    stage.plan.ar = plan;
  });
