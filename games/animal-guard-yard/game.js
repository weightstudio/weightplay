const ANIMAL_GUARD_YARD_SHELL_COPY = {
  ...
  ar: {
    gameTitle: "ساحة حراس الحيوانات", language: "اللغة", back: "رجوع", backToLobby: "العودة إلى الردهة",
    walletAria: "محفظة ساحة حراس الحيوانات", beastGuideAria: "دليل الوحوش", stageListAria: "قائمة المراحل",
...
(() => {
  ...
  const __wpReadMeasurement = () => ({ ...__wpMeasurement,
    ...
    paused: Boolean(paused || lifecycleSuspended), node: document.body,
  ...
  function activateScene(scene) {
    ...
    const __wpReturn = (sceneGeneration);
...
return __wpReturn;
  ...
  function showMenu() {
    ...
    running = false;
    (__wpNotifyMeasurement(), paused = false);
  ...
  function showPause() {
    ...
    running = false;
    (__wpNotifyMeasurement(), paused = true);
    updateHud();
    cancelAnimationFrame(raf);
