(function () {
  ...
  const relatedGuideCopy = {
    ...
    ko:{relatedTitle:"관련 게임",relatedIntro:"압박 속에서 계속 계획하고 싶다면 다음 게임을 플레이해 보세요:",relatedBeastTitle:"Beast Guardian",relatedBeastDescription:"열린 숲길을 만들고 수호자를 배치하며, 바뀌는 여섯 보스 규칙에 맞춰 수정 핵을 지키세요.",relatedRuneTitle:"동물 룬 전술",relatedRuneDescription:"룬 역할이 분명한 분대를 준비하고, 변화하는 적 편성에 맞춰 이동과 능력 타이밍을 잡으세요."},
