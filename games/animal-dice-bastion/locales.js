(function () {
  "use strict";
  const en = {
    title:"Dice Bastion",loading:"Awakening the guardian runes…",language:"Language",
    ...
    progressTitle:"Growing defenses",progressText:"New defenses add armor, swarms, healers, haste, slot locks, champion escorts, and distinct Boss encounters.",
  ...
  const core = {
    "zh-Hant":{title:"骰靈堡壘",loading:"正在喚醒守護符文…",language:"語言",start:"開始遊戲",stages:"關卡",team:"隊伍",equipment:"裝備",summon:"召喚",rally:"集結",burst:"符文爆發",reroll:"重擲",core:"核心",wave:"波次",charge:"能量",victory:"堡壘守住了！",defeat:"暗影抵達了水晶",next:"下一關",retry:"重玩",continue:"繼續",returnStages:"返回關卡",locked:"未解鎖",boss:"首領"},
    "zh-Hans":{title:"骰灵堡垒",loading:"正在唤醒守护符文…",language:"语言",start:"开始游戏",stages:"关卡",team:"队伍",equipment:"装备",summon:"召唤",rally:"集结",burst:"符文爆发",reroll:"重掷",core:"核心",wave:"波次",charge:"能量",victory:"堡垒守住了！",defeat:"暗影抵达了水晶",next:"下一关",retry:"重玩",continue:"继续",returnStages:"返回关卡",locked:"未解锁",boss:"首领"},
    ja:{title:"ダイス砦",loading:"守護ルーンを起こしています…",language:"言語",start:"ゲーム開始",stages:"ステージ",team:"チーム",equipment:"装備",summon:"召喚",rally:"結集",burst:"ルーンバースト",reroll:"振り直す",core:"コア",wave:"ウェーブ",charge:"チャージ",victory:"砦を守った！",defeat:"影がクリスタルに到達した",next:"次のステージ",retry:"リプレイ",continue:"続ける",returnStages:"ステージへ戻る",locked:"ロック",boss:"ボス"},
    ko:{title:"다이스 요새",loading:"수호 룬을 깨우는 중…",language:"언어",start:"게임 시작",stages:"스테이지",team:"팀",equipment:"장비",summon:"소환",rally:"집결",burst:"룬 폭발",reroll:"다시 굴리기",core:"코어",wave:"웨이브",charge:"충전",victory:"요새를 지켰습니다!",defeat:"그림자가 수정에 도달했습니다",next:"다음 스테이지",retry:"다시 플레이",continue:"계속",returnStages:"스테이지로",locked:"잠김",boss:"보스"},
    es:{title:"Bastión de Dados",loading:"Despertando las runas guardianas…",language:"Idioma",start:"Iniciar juego",stages:"Fases",team:"Equipo",equipment:"Equipo",summon:"Invocar",rally:"Reagrupar",burst:"Estallido rúnico",reroll:"Relanzar",core:"Núcleo",wave:"Oleada",charge:"Carga",victory:"¡Bastión asegurado!",defeat:"Las sombras alcanzaron el cristal",next:"Siguiente fase",retry:"Repetir",continue:"Continuar",returnStages:"Volver a fases",locked:"Bloqueado",boss:"Jefe"},
    "pt-BR":{title:"Bastião dos Dados",loading:"Despertando as runas guardiãs…",language:"Idioma",start:"Iniciar jogo",stages:"Fases",team:"Equipe",equipment:"Equipamento",summon:"Invocar",rally:"Reunir",burst:"Explosão rúnica",reroll:"Rolar de novo",core:"Núcleo",wave:"Onda",charge:"Carga",victory:"Bastião protegido!",defeat:"As sombras chegaram ao cristal",next:"Próxima fase",retry:"Jogar novamente",continue:"Continuar",returnStages:"Voltar às fases",locked:"Bloqueado",boss:"Chefe"},
    fr:{title:"Bastion des Dés",loading:"Éveil des runes gardiennes…",language:"Langue",start:"Commencer",stages:"Niveaux",team:"Équipe",equipment:"Équipement",summon:"Invoquer",rally:"Ralliement",burst:"Explosion runique",reroll:"Relancer",core:"Cœur",wave:"Vague",charge:"Charge",victory:"Bastion sécurisé !",defeat:"Les ombres ont atteint le cristal",next:"Niveau suivant",retry:"Rejouer",continue:"Continuer",returnStages:"Retour aux niveaux",locked:"Verrouillé",boss:"Boss"},
  ...
  Object.assign(core["zh-Hant"],{
    title:"骰靈堡壘",loading:"正在喚醒守護符文…",language:"語言",backLobby:"返回 WeightPlay",backMain:"返回主頁",backStages:"返回關卡",
  ...
  const relatedGuideCopy = {
    en:{relatedTitle:"Related Games",relatedIntro:"If you want to keep planning under pressure, try these next:",relatedBeastTitle:"Beast Guardian",relatedBeastDescription:"Build open forest routes, place defenders, and adapt to six changing Boss rules around a crystal core.",relatedRuneTitle:"Animal Rune Tactics",relatedRuneDescription:"Prepare a squad from readable rune roles, then time movement and abilities against evolving enemy formations."},
    "zh-Hant":{relatedTitle:"相關遊戲",relatedIntro:"如果你想繼續在壓力下規劃防線，可以接著挑戰：",relatedBeastTitle:"獸王守衛",relatedBeastDescription:"建立暢通的森林路線、安排防守者，在六種變化的首領規則下守住水晶核心。",relatedRuneTitle:"動物符文戰棋",relatedRuneDescription:"從清楚的符文角色組成隊伍，再配合敵方編隊的變化掌握移動與技能時機。"},
    "zh-Hans":{relatedTitle:"相关游戏",relatedIntro:"如果你想继续在压力下规划防线，可以接着挑战：",relatedBeastTitle:"兽王守卫",relatedBeastDescription:"建立畅通的森林路线、安排防守者，在六种变化的首领规则下守住水晶核心。",relatedRuneTitle:"动物符文战棋",relatedRuneDescription:"从清楚的符文角色组成队伍，再配合敌方编队的变化掌握移动与技能时机。"},
    ja:{relatedTitle:"関連ゲーム",relatedIntro:"プレッシャー下のルート計画を続けたいなら、次はこちら：",relatedBeastTitle:"ビースト戦術家",relatedBeastDescription:"森の通路を開き、防衛役を配置し、変化する6種類のボス規則に対応して結晶核を守ります。",relatedRuneTitle:"どうぶつルーン戦術",relatedRuneDescription:"役割が分かる部隊を編成し、変化する敵編成に合わせて移動と能力のタイミングを読みます。"},
    ko:{relatedTitle:"관련 게임",relatedIntro:"압박 속에서 계속 계획하고 싶다면 다음 게임을 플레이해 보세요:",relatedBeastTitle:"야수 수호자",relatedBeastDescription:"열린 숲길을 만들고 수호자를 배치하며, 바뀌는 여섯 보스 규칙에 맞춰 수정 핵을 지키세요.",relatedRuneTitle:"동물 룬 전술",relatedRuneDescription:"룬 역할이 분명한 분대를 준비하고, 변화하는 적 편성에 맞춰 이동과 능력 타이밍을 잡으세요."},
    es:{relatedTitle:"Juegos relacionados",relatedIntro:"Si quieres seguir planificando bajo presión, prueba estos juegos:",relatedBeastTitle:"Guardián de Bestias",relatedBeastDescription:"Abre rutas en el bosque, coloca defensores y adapta seis reglas de jefe para proteger el núcleo de cristal.",relatedRuneTitle:"Tácticas de Runas Animales",relatedRuneDescription:"Prepara un escuadrón con roles rúnicos claros y mide el movimiento y las habilidades según cambian los enemigos."},
    "pt-BR":{relatedTitle:"Jogos relacionados",relatedIntro:"Se quiser continuar planejando sob pressão, experimente estes:",relatedBeastTitle:"Guardião das Feras",relatedBeastDescription:"Abra rotas na floresta, posicione defensores e adapte-se a seis regras de chefes para proteger o núcleo de cristal.",relatedRuneTitle:"Táticas de Runas Animais",relatedRuneDescription:"Monte um esquadrão com funções rúnicas claras e acerte o momento de mover e usar habilidades contra formações inimigas mutáveis."},
    fr:{relatedTitle:"Jeux associés",relatedIntro:"Pour continuer à planifier sous pression, essayez ceux-ci :",relatedBeastTitle:"Gardien des bêtes",relatedBeastDescription:"Ouvrez des routes dans la forêt, placez des défenseurs et adaptez-vous à six règles de boss pour protéger le cœur de cristal.",relatedRuneTitle:"Tactiques runiques animales",relatedRuneDescription:"Préparez une escouade aux rôles runiques lisibles, puis dosez déplacements et capacités face aux formations ennemies."},
    de:{relatedTitle:"Verwandte Spiele",relatedIntro:"Wenn du unter Druck weiter planen möchtest, probiere diese Spiele:",relatedBeastTitle:"Bestienwächter",relatedBeastDescription:"Öffne Waldwege, platziere Verteidiger und passe dich sechs wechselnden Bossregeln an, um den Kristallkern zu schützen.",relatedRuneTitle:"Tierische Runentaktik",relatedRuneDescription:"Stelle ein Team mit klaren Runenrollen zusammen und timen Bewegung und Fähigkeiten gegen wechselnde Feindformationen."},
    it:{relatedTitle:"Giochi correlati",relatedIntro:"Se vuoi continuare a pianificare sotto pressione, prova questi:",relatedBeastTitle:"Guardiano delle bestie",relatedBeastDescription:"Apri percorsi nella foresta, posiziona difensori e adatta la strategia a sei regole Boss variabili per proteggere il nucleo di cristallo.",relatedRuneTitle:"Tattiche delle rune animali",relatedRuneDescription:"Prepara una squadra con ruoli runici chiari e scegli il momento giusto per movimenti e abilità contro formazioni nemiche mutevoli."},
    ru:{relatedTitle:"Похожие игры",relatedIntro:"Если хотите и дальше планировать под давлением, попробуйте эти игры:",relatedBeastTitle:"Страж зверей",relatedBeastDescription:"Прокладывайте лесные пути, размещайте защитников и подстраивайтесь под шесть меняющихся правил боссов, защищая кристальное ядро.",relatedRuneTitle:"Тактика животных с рунами",relatedRuneDescription:"Соберите отряд с понятными ролями рун и выбирайте момент для перемещений и способностей против меняющихся построений врага."},
    hi:{relatedTitle:"संबंधित खेल",relatedIntro:"अगर आप दबाव में योजना बनाना जारी रखना चाहते हैं, तो ये खेल आज़माएँ:",relatedBeastTitle:"पशु रक्षक",relatedBeastDescription:"खुले वन मार्ग बनाएँ, रक्षकों को रखें और छह बदलते बॉस नियमों के अनुसार क्रिस्टल कोर की रक्षा करें।",relatedRuneTitle:"पशु रूण रणनीति",relatedRuneDescription:"स्पष्ट रूण भूमिकाओं वाली टुकड़ी तैयार करें और बदलती शत्रु संरचनाओं के अनुसार चाल व क्षमताओं का समय चुनें।"},
    ar:{relatedTitle:"ألعاب ذات صلة",relatedIntro:"إذا أردت مواصلة التخطيط تحت الضغط، فجرّب هذه الألعاب:",relatedBeastTitle:"حارس الوحوش",relatedBeastDescription:"افتح مسارات الغابة، وضع المدافعين، وتكيّف مع ست قواعد متغيرة للزعماء لحماية النواة البلورية.",relatedRuneTitle:"تكتيكات الرون الحيواني",relatedRuneDescription:"جهّز فرقة بأدوار رون واضحة، ثم اضبط توقيت الحركة والقدرات أمام تشكيلات الأعداء المتغيرة."}
  };
  Object.assign(en,relatedGuideCopy.en);
  Object.entries(relatedGuideCopy).forEach(([code,values])=>{if(code!=="en")Object.assign(core[code],values);});
  ...
  const conciseGuide = {
    en:["Growing defenses","Choose your opening guardian, then summon and merge matching affinity and rank. Keep an empty slot for the next draw, save orders for dangerous waves, and protect the crystal. Merges reroll affinity; Reforge keeps rank but costs the third star.","New defenses add armor, swarms, healers, haste, slot locks, champion escorts, and distinct Boss encounters."],
    'zh-Hant':["逐步進階的防線","先選開場守護獸，再召喚並合併相同屬性、相同階級的守護獸。留一格給下一次召喚，把指令留給危險波次，守住水晶。合併會重抽屬性；重鑄保留階級，但本局無法取得第三顆星。","後續防線會加入護甲、怪群、治療者、加速、符文格封鎖、菁英護衛與不同首領。"],
    'zh-Hans':["逐步进阶的防线","先选开场守护兽，再召唤并合并相同属性、相同阶级的守护兽。留一格给下一次召唤，把指令留给危险波次，守住水晶。合并会重抽属性；重铸保留阶级，但本局无法获得第三颗星。","后续防线会加入护甲、怪群、治疗者、急速、插槽锁、冠军护卫与不同首领。"],
    ja:["広がる防衛戦","最初の守護獣を選び、同じ属性とランクを召喚・合成しましょう。次の召喚用に空きを残し、危険な敵の波に指令を使って水晶を守ります。合成後の属性は抽選されます。再鋳造はランクを保ちますが、星3個は獲得できません。","新たな防衛戦では、アーマー、スウォーム、ヒーラー、ヘイスト、スロットロック、チャンピオン護衛、さまざまなボスが登場します。"],
    ko:["단계적으로 깊어지는 방어","첫 수호수를 고른 뒤 같은 속성과 등급을 소환하고 합치세요. 다음 소환을 위해 빈칸을 남기고 위험한 적 무리에 명령을 사용해 수정을 지키세요. 합치면 속성이 다시 정해집니다. 재련은 등급을 유지하지만 별 세 개를 받을 수 없습니다.","새 방어전에서는 갑옷, 무리, 치유사, 가속, 슬롯 잠금, 챔피언 호위와 다양한 보스가 등장합니다."],
    es:["Defensas progresivas","Elige tu primer guardián y fusiona los de igual afinidad y rango. Reserva un hueco para invocar y guarda las órdenes para las oleadas peligrosas. La fusión sortea otra afinidad; Reforjar conserva el rango, pero impide ganar la tercera estrella.","Las nuevas defensas incorporan armaduras, enjambres, sanadores, prisa, bloqueos de ranuras, escoltas de campeones y jefes distintos."],
    'pt-BR':["Defesas progressivas","Escolha o primeiro guardião e una os de mesma afinidade e nível. Deixe um espaço para invocar e guarde ordens para ondas perigosas. A fusão sorteia outra afinidade; Reforjar mantém o nível, mas impede a terceira estrela.","Novas defesas apresentam armaduras, enxames, curandeiros, aceleração, bloqueios de slots, escoltas de campeões e chefes distintos."],
    fr:["Des défenses progressives","Choisissez le premier gardien puis fusionnez ceux de même affinité et rang. Gardez une case libre et réservez les ordres aux vagues dangereuses. La fusion tire une nouvelle affinité ; Reforge conserve le rang mais empêche la troisième étoile.","Les nouvelles défenses introduisent armures, essaims, soigneurs, accélérations, emplacements verrouillés, escortes de champions et des boss variés."],
    de:["Wachsende Verteidigung","Wähle den ersten Wächter und verschmelze gleiche Affinitäten und Ränge. Halte ein Feld für die nächste Beschwörung frei und spare Befehle für gefährliche Wellen. Fusion würfelt die Affinität neu aus; Umschmieden behält den Rang, verhindert aber den dritten Stern.","Neue Verteidigungen führen Rüstung, Schwärme, Heiler, Eile, Slot-Sperren, Champion-Eskorten und unterschiedliche Bosse ein."],
    it:["Difese progressive","Scegli il primo guardiano e fondi quelli con affinità e grado uguali. Lascia uno spazio libero e conserva gli ordini per le ondate pericolose. La fusione sorteggia una nuova affinità; Riforgia mantiene il grado ma impedisce la terza stella.","Le nuove difese introducono armature, sciami, guaritori, rapidità, blocchi degli slot, scorte di campioni e boss diversi."],
    ru:["Растущая оборона","Выберите первого стража и объединяйте одинаковые стихии и ранги. Оставляйте место для призыва и берегите приказы для опасных волн. Слияние случайно меняет стихию; перековка сохраняет ранг, но лишает третьей звезды.","В новых оборонительных рубежах появляются доспехи, стаи, целители, ускорение, замки слотов, сопровождение чемпионов и разные боссы."],
    hi:["बढ़ती रक्षा चुनौती","पहला रक्षक चुनें और समान गुण व स्तर वाले रक्षकों को मिलाएँ। अगले आह्वान के लिए जगह रखें और खतरनाक लहरों के लिए आदेश बचाएँ। मिलाने पर गुण फिर चुना जाता है; पुनर्गठन स्तर बचाता है, लेकिन तीसरा सितारा नहीं मिलता।","नई रक्षा चुनौतियाँ कवच, झुंड, उपचारक, जल्दबाजी, स्लॉट ताले, चैंपियन एस्कॉर्ट और अलग-अलग बॉस लाती हैं।"],
    ar:["دفاعات متدرجة","اختر الحارس الأول وادمج الحراس المتطابقين في السمة والرتبة. اترك خانة للاستدعاء واحتفظ بالأوامر للموجات الخطرة. الدمج يختار سمة جديدة عشوائيًا؛ إعادة التشكيل تحفظ الرتبة لكنها تمنع النجمة الثالثة.","تضيف الدفاعات الجديدة الدروع والأسراب والمعالجين والتسرع وأقفال الفتحات ومرافقي الأبطال وزعماء متنوعين."]
  };
  for (const [code,[progressTitle,guideDetail,progressText]] of Object.entries(conciseGuide)) Object.assign(dictionaries[code],{progressTitle,guideDetail,progressText});
  ...
  for (const [code,[next]] of Object.entries(progressionCopy)) Object.assign(dictionaries[code],{next});
  const actionCopy={
    en:['Rally','Burst','Reforge'], 'zh-Hant':['集結','爆發','重塑'], 'zh-Hans':['集结','爆发','重塑'],
    ja:['集結','バースト','再鍛造'],ko:['집결','폭발','재련'],
    es:['Alentar','Estallido','Reforjar'],'pt-BR':['Reunir','Explosão rúnica','Reforjar'],
