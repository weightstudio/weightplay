(function () {
  ...
  const common = {
    ...
    mergeHint: "Select two matching characters to merge.",
    selected: "Selected",
    empty: "Empty lane",
    lane: "Lane",
    pause: "Pause",
  ...
  const dictionaries = {
    ...
    "zh-Hant": {
      ...
      battleTitle: "墨線守衛", enemyCamp: "敵軍陣地", allyCamp: "阿斗營地", commandPost: "敵軍指揮所", adou: "阿斗", hp: "生命", wave: "波次", buns: "饅頭", recruit: "徵召", recruitHint: "消耗 3 個饅頭召集新部隊。", mergeHint: "選取兩個相同文字進行合成。", selected: "已選取", empty: "空戰線", lane: "戰線", pause: "暫停", hint: "提示",
