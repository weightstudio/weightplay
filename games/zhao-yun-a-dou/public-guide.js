...
(() => {
  ...
  for (const [locale, [mission, progression, designNote]] of Object.entries(details)) {
    ...
    guide.faq = [[runtime.army, runtime.armyOdds+' '+runtime.armyAuto], [runtime.promotion, runtime.armyStars], [runtime.chargeAction, runtime.chargeAuto], [runtime.talents, runtime.talentHelp]];
  ...
  const frameRoot = document.getElementById('gameFrame');
  if (frameRoot?.contains(root)) frameRoot.after(root);
