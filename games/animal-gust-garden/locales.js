(function () {
  ...
  const en = {
    ...
    coverAlt: "Concept sketch of seeds riding a gentle breeze through a meadow garden", intro: "Choose a seed, point the vane, and guide every seed to a flower without brushing a thorn.",
  ...
  const zh = {
    ...
    coverAlt: "種子乘著微風穿過草甸花園的概念草圖", intro: "選一顆種子、指向風向，讓每顆種子抵達花朵並避開荊棘。",
