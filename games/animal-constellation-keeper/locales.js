...
(() => {
  ...
  const guideEnhancements = {
    en: { campaignTitle: "Campaign and checkpoints", campaignText: "Six arcs contain five maps each, for 30 authored maps. Clearing a map unlocks the next one; checkpoints at maps 5, 10, 15, 20, 25, and 30 mark the end of each arc.", readingTitle: "Reading a star map", readingText: "Each map shows a 3×3 board, three candidate answers, and two visible relation clues. Treat above, below, left, right, and diagonal positions literally before choosing.", faqCampaignQuestion: "How many maps are included?", faqCampaignAnswer: "There are 30 authored maps arranged as six five-map arcs.", faqChoiceQuestion: "What happens after a wrong choice?", faqChoiceAnswer: "The wrong board remains visible, and the map can be checked again without losing progress.", faqSaveQuestion: "Is an account required?", faqSaveAnswer: "No. Progress and best checks use this browser's local storage when available.", faqRuleQuestion: "What clues should I read?", faqRuleAnswer: "Compare the two visible relations, including above, below, left, right, or diagonal positions, with each candidate board.", relatedTitle: "Related Games", relatedIntro: "If you enjoy checking spatial rules before committing to a move, try these other WeightPlay puzzles.", relatedOneTitle: "One Line", relatedOneDescription: "Trace one continuous route through authored trails while avoiding walls and moving shadows.", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "Rotate linked bamboo pipes to carry water from a carved spring to a flowering basin without gaps." },
    "zh-Hant": { campaignTitle: "流程與檢查點", campaignText: "六個篇章各有五幅地圖，共 30 幅原創地圖。完成一幅就會開放下一幅；第 5、10、15、20、25、30 幅是每個篇章的檢查點。", readingTitle: "讀懂星圖", readingText: "每幅地圖都有 3×3 星盤、三個候選答案與兩條可見關係線索。選擇前，請把上、下、左、右與斜向位置照字面讀清楚。", faqCampaignQuestion: "共有多少幅地圖？", faqCampaignAnswer: "共有 30 幅原創地圖，分成六個五圖篇章。", faqChoiceQuestion: "選錯後會怎樣？", faqChoiceAnswer: "錯誤星圖會留在畫面上，你可以再次檢查，不會失去進度。", faqSaveQuestion: "需要帳號嗎？", faqSaveAnswer: "不需要。可用時，進度與最佳檢查次數只使用這個瀏覽器的本機儲存。", faqRuleQuestion: "應該讀哪些線索？", faqRuleAnswer: "把兩條可見關係，包含上、下、左、右或斜向位置，與每個候選星盤逐一比較。", relatedTitle: "相關遊戲", relatedIntro: "如果你喜歡先確認空間規則再行動，也可以試試這些 WeightPlay 益智遊戲。", relatedOneTitle: "One Line 一筆到底", relatedOneDescription: "穿過原創路線畫出一條連續路徑，同時避開牆壁與移動陰影。", relatedTwoTitle: "Panko 的竹林水道", relatedTwoDescription: "旋轉相連竹管，讓水從雕刻泉眼流到開花水池，中途不能斷路。" },
    "zh-Hans": { campaignTitle: "流程与检查点", campaignText: "六个篇章各有五幅地图，共 30 幅原创地图。完成一幅就会开放下一幅；第 5、10、15、20、25、30 幅是每个篇章的检查点。", readingTitle: "读懂星图", readingText: "每幅地图都有 3×3 星盘、三个候选答案和两条可见关系线索。选择前，请按字面读清上、下、左、右和斜向位置。", faqCampaignQuestion: "共有多少幅地图？", faqCampaignAnswer: "共有 30 幅原创地图，分成六个五图篇章。", faqChoiceQuestion: "选错后会怎样？", faqChoiceAnswer: "错误星图会留在画面上，你可以再次检查，不会失去进度。", faqSaveQuestion: "需要账号吗？", faqSaveAnswer: "不需要。可用时，进度和最佳检查次数只使用此浏览器的本地存储。", faqRuleQuestion: "应该读哪些线索？", faqRuleAnswer: "把两条可见关系（包括上、下、左、右或斜向位置）与每个候选星盘逐一比较。", relatedTitle: "相关游戏", relatedIntro: "如果你喜欢先确认空间规则再行动，也可以试试这些 WeightPlay 益智游戏。", relatedOneTitle: "One Line 一笔到底", relatedOneDescription: "穿过原创路线画出一条连续路径，同时避开墙壁和移动阴影。", relatedTwoTitle: "Panko 的竹林水道", relatedTwoDescription: "旋转相连竹管，让水从雕刻泉眼流到开花水池，中途不能断路。" },
    ja: { campaignTitle: "キャンペーンとチェックポイント", campaignText: "5マップずつの6アーク、全30マップを収録しています。クリアすると次が開き、5、10、15、20、25、30マップ目が各アークの区切りです。", readingTitle: "星マップの読み方", readingText: "各マップには3×3の盤面、3つの候補、2つの関係ヒントがあります。上・下・左・右・斜めの位置をそのまま読んで選びます。", faqCampaignQuestion: "マップはいくつありますか？", faqCampaignAnswer: "5マップずつ6アーク、全30マップです。", faqChoiceQuestion: "間違えるとどうなりますか？", faqChoiceAnswer: "間違えた盤面は残るので、進行を失わずにもう一度確認できます。", faqSaveQuestion: "アカウントは必要ですか？", faqSaveAnswer: "必要ありません。進行とベスト記録は利用できる場合、このブラウザのローカル保存だけを使います。", faqRuleQuestion: "どのヒントを読みますか？", faqRuleAnswer: "上下左右や斜めを含む2つの関係を、各候補の盤面と比べます。", relatedTitle: "関連ゲーム", relatedIntro: "空間ルールを確認してから動くのが好きなら、こちらのWeightPlayパズルもどうぞ。", relatedOneTitle: "One Line", relatedOneDescription: "壁や動く影を避けながら、作られた道を一本の連続線でたどります。", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "つながった竹パイプを回し、切れ目なく泉から花の池へ水を通します。" },
    ko: { campaignTitle: "캠페인과 체크포인트", campaignText: "5개 맵으로 된 6개 아크, 총 30개 맵이 있습니다. 맵을 클리어하면 다음 맵이 열리고 5, 10, 15, 20, 25, 30번 맵이 각 아크의 체크포인트입니다.", readingTitle: "별 지도 읽기", readingText: "각 맵에는 3×3 보드, 세 가지 후보, 두 가지 관계 단서가 있습니다. 선택하기 전에 위·아래·왼쪽·오른쪽·대각선 위치를 그대로 읽어 보세요.", faqCampaignQuestion: "맵은 몇 개인가요?", faqCampaignAnswer: "5개씩 6개 아크로 구성된 총 30개의 맵이 있습니다.", faqChoiceQuestion: "틀리게 고르면 어떻게 되나요?", faqChoiceAnswer: "틀린 보드가 화면에 남아 진행을 잃지 않고 다시 확인할 수 있습니다.", faqSaveQuestion: "계정이 필요한가요?", faqSaveAnswer: "아니요. 가능한 경우 진행과 최고 기록은 이 브라우저의 로컬 저장소만 사용합니다.", faqRuleQuestion: "어떤 단서를 읽어야 하나요?", faqRuleAnswer: "위·아래·왼쪽·오른쪽·대각선을 포함한 두 관계를 각 후보 보드와 비교하세요.", relatedTitle: "관련 게임", relatedIntro: "움직이기 전에 공간 규칙을 확인하는 퍼즐을 좋아한다면 WeightPlay의 다른 퍼즐도 시도해 보세요.", relatedOneTitle: "One Line", relatedOneDescription: "벽과 움직이는 그림자를 피하며 만들어진 길을 하나의 연속 선으로 따라갑니다.", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "연결된 대나무 파이프를 돌려 끊김 없이 샘에서 꽃 연못까지 물을 보냅니다." },
    es: { campaignTitle: "Campaña y puntos de control", campaignText: "Hay seis arcos de cinco mapas, 30 mapas creados a mano. Al superar un mapa se desbloquea el siguiente; los mapas 5, 10, 15, 20, 25 y 30 cierran cada arco.", readingTitle: "Leer un mapa estelar", readingText: "Cada mapa muestra un tablero 3×3, tres respuestas posibles y dos pistas de relación. Lee literalmente las posiciones arriba, abajo, izquierda, derecha y diagonal.", faqCampaignQuestion: "¿Cuántos mapas hay?", faqCampaignAnswer: "Hay 30 mapas creados a mano, organizados en seis arcos de cinco mapas.", faqChoiceQuestion: "¿Qué ocurre tras una elección incorrecta?", faqChoiceAnswer: "El tablero incorrecto permanece visible y puedes comprobarlo otra vez sin perder progreso.", faqSaveQuestion: "¿Hace falta una cuenta?", faqSaveAnswer: "No. Cuando está disponible, el progreso y el mejor resultado usan solo el almacenamiento local de este navegador.", faqRuleQuestion: "¿Qué pistas debo leer?", faqRuleAnswer: "Compara las dos relaciones visibles, incluidas las posiciones diagonales, con cada tablero candidato.", relatedTitle: "Juegos relacionados", relatedIntro: "Si te gusta comprobar reglas espaciales antes de moverte, prueba estos otros puzles de WeightPlay.", relatedOneTitle: "One Line", relatedOneDescription: "Traza una ruta continua por recorridos creados a mano evitando paredes y sombras móviles.", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "Gira tuberías de bambú conectadas para llevar agua de un manantial tallado a una poza floral sin cortes." },
    "pt-BR": { campaignTitle: "Campanha e checkpoints", campaignText: "São seis arcos de cinco mapas, com 30 mapas autorais. Ao concluir um mapa, o próximo é liberado; os mapas 5, 10, 15, 20, 25 e 30 encerram cada arco.", readingTitle: "Lendo um mapa estelar", readingText: "Cada mapa mostra um tabuleiro 3×3, três respostas candidatas e duas pistas de relação. Leia literalmente as posições acima, abaixo, à esquerda, à direita e na diagonal.", faqCampaignQuestion: "Quantos mapas existem?", faqCampaignAnswer: "São 30 mapas autorais, organizados em seis arcos de cinco mapas.", faqChoiceQuestion: "O que acontece depois de uma escolha errada?", faqChoiceAnswer: "O tabuleiro errado continua visível e pode ser conferido novamente sem perder o progresso.", faqSaveQuestion: "Preciso de uma conta?", faqSaveAnswer: "Não. Quando disponível, o progresso e o melhor resultado usam apenas o armazenamento local deste navegador.", faqRuleQuestion: "Quais pistas devo ler?", faqRuleAnswer: "Compare as duas relações visíveis, incluindo posições diagonais, com cada tabuleiro candidato.", relatedTitle: "Jogos relacionados", relatedIntro: "Se você gosta de conferir regras espaciais antes de agir, experimente estes outros quebra-cabeças da WeightPlay.", relatedOneTitle: "One Line", relatedOneDescription: "Trace uma rota contínua por trilhas autorais, desviando de paredes e sombras móveis.", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "Gire tubos de bambu conectados para levar água de uma fonte esculpida a um lago florido sem falhas." },
    fr: { campaignTitle: "Campagne et points de contrôle", campaignText: "Six arcs de cinq cartes forment 30 cartes conçues à la main. Terminer une carte déverrouille la suivante ; les cartes 5, 10, 15, 20, 25 et 30 terminent chaque arc.", readingTitle: "Lire une carte céleste", readingText: "Chaque carte présente un plateau 3×3, trois réponses possibles et deux indices de relation. Lisez littéralement les positions au-dessus, dessous, à gauche, à droite et en diagonale.", faqCampaignQuestion: "Combien de cartes sont incluses ?", faqCampaignAnswer: "Il y a 30 cartes conçues à la main, réparties en six arcs de cinq cartes.", faqChoiceQuestion: "Que se passe-t-il après un mauvais choix ?", faqChoiceAnswer: "Le plateau incorrect reste visible et peut être vérifié à nouveau sans perdre la progression.", faqSaveQuestion: "Faut-il un compte ?", faqSaveAnswer: "Non. Si le stockage est disponible, la progression et le meilleur score restent dans ce navigateur.", faqRuleQuestion: "Quels indices dois-je lire ?", faqRuleAnswer: "Comparez les deux relations visibles, y compris les positions diagonales, avec chaque plateau proposé.", relatedTitle: "Jeux associés", relatedIntro: "Si vous aimez vérifier les règles spatiales avant d'agir, essayez ces autres puzzles WeightPlay.", relatedOneTitle: "One Line", relatedOneDescription: "Tracez un parcours continu dans des pistes conçues à la main en évitant murs et ombres mobiles.", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "Faites pivoter des tuyaux de bambou reliés pour conduire l'eau d'une source sculptée à un bassin fleuri sans coupure." },
    de: { campaignTitle: "Kampagne und Checkpoints", campaignText: "Sechs Arcs mit je fünf Karten ergeben 30 handgefertigte Karten. Eine abgeschlossene Karte schaltet die nächste frei; die Karten 5, 10, 15, 20, 25 und 30 markieren das Ende jedes Arcs.", readingTitle: "Eine Sternkarte lesen", readingText: "Jede Karte zeigt ein 3×3-Brett, drei Antwortmöglichkeiten und zwei sichtbare Beziehungshinweise. Lies oben, unten, links, rechts und diagonal wörtlich.", faqCampaignQuestion: "Wie viele Karten gibt es?", faqCampaignAnswer: "Es gibt 30 handgefertigte Karten in sechs Arcs mit je fünf Karten.", faqChoiceQuestion: "Was passiert nach einer falschen Wahl?", faqChoiceAnswer: "Das falsche Brett bleibt sichtbar und kann erneut geprüft werden, ohne den Fortschritt zu verlieren.", faqSaveQuestion: "Brauche ich ein Konto?", faqSaveAnswer: "Nein. Fortschritt und Bestwert werden, wenn möglich, nur lokal in diesem Browser gespeichert.", faqRuleQuestion: "Welche Hinweise soll ich lesen?", faqRuleAnswer: "Vergleiche die beiden sichtbaren Beziehungen, einschließlich diagonaler Positionen, mit jedem Antwortbrett.", relatedTitle: "Ähnliche Spiele", relatedIntro: "Wenn du räumliche Regeln gern vor dem Zug prüfst, probiere diese anderen WeightPlay-Rätsel.", relatedOneTitle: "One Line", relatedOneDescription: "Ziehe eine durchgehende Route durch handgefertigte Pfade und meide Wände und bewegte Schatten.", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "Drehe verbundene Bambusrohre, damit Wasser ohne Lücken von einer geschnitzten Quelle zum Blütenteich fließt." },
    it: { campaignTitle: "Campagna e checkpoint", campaignText: "Sei archi da cinque mappe formano 30 mappe create a mano. Completare una mappa sblocca la successiva; le mappe 5, 10, 15, 20, 25 e 30 chiudono ogni arco.", readingTitle: "Leggere una mappa stellare", readingText: "Ogni mappa mostra una griglia 3×3, tre risposte candidate e due indizi di relazione. Leggi alla lettera le posizioni sopra, sotto, a sinistra, a destra e in diagonale.", faqCampaignQuestion: "Quante mappe ci sono?", faqCampaignAnswer: "Ci sono 30 mappe create a mano, divise in sei archi da cinque mappe.", faqChoiceQuestion: "Cosa succede dopo una scelta sbagliata?", faqChoiceAnswer: "La griglia sbagliata resta visibile e puoi controllarla di nuovo senza perdere i progressi.", faqSaveQuestion: "Serve un account?", faqSaveAnswer: "No. Quando disponibile, progressi e miglior risultato usano solo la memoria locale di questo browser.", faqRuleQuestion: "Quali indizi devo leggere?", faqRuleAnswer: "Confronta le due relazioni visibili, comprese le posizioni diagonali, con ogni griglia candidata.", relatedTitle: "Giochi correlati", relatedIntro: "Se ti piace controllare le regole spaziali prima di muoverti, prova questi altri rompicapi WeightPlay.", relatedOneTitle: "One Line", relatedOneDescription: "Traccia un percorso continuo su sentieri creati a mano evitando muri e ombre in movimento.", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "Ruota tubi di bambù collegati per portare l'acqua da una sorgente scolpita a una vasca fiorita senza interruzioni." },
    ru: { campaignTitle: "Кампания и контрольные точки", campaignText: "Шесть арок по пять карт образуют 30 созданных вручную карт. После прохождения карты открывается следующая; карты 5, 10, 15, 20, 25 и 30 завершают арки.", readingTitle: "Как читать карту звёзд", readingText: "На каждой карте есть поле 3×3, три варианта ответа и две видимые подсказки о связях. Буквально учитывай позиции сверху, снизу, слева, справа и по диагонали.", faqCampaignQuestion: "Сколько карт в игре?", faqCampaignAnswer: "Всего 30 созданных вручную карт в шести арках по пять карт.", faqChoiceQuestion: "Что будет после ошибочного выбора?", faqChoiceAnswer: "Неверное поле останется видимым, и его можно проверить снова без потери прогресса.", faqSaveQuestion: "Нужен ли аккаунт?", faqSaveAnswer: "Нет. Прогресс и лучший результат, если хранилище доступно, сохраняются только в этом браузере.", faqRuleQuestion: "Какие подсказки читать?", faqRuleAnswer: "Сравни две видимые связи, включая диагональные позиции, с каждым полем-кандидатом.", relatedTitle: "Похожие игры", relatedIntro: "Если тебе нравится проверять пространственные правила перед ходом, попробуй другие головоломки WeightPlay.", relatedOneTitle: "One Line", relatedOneDescription: "Проводи непрерывный маршрут по созданным вручную трассам, избегая стен и движущихся теней.", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "Поворачивай соединённые бамбуковые трубы, чтобы провести воду от резного источника к цветущему бассейну без разрывов." },
    hi: { campaignTitle: "अभियान और चेकपॉइंट", campaignText: "छह आर्क में पाँच-पाँच मानचित्र हैं, यानी कुल 30 बनाए गए मानचित्र। मानचित्र पूरा करने पर अगला खुलता है; 5, 10, 15, 20, 25 और 30 हर आर्क के अंत हैं।", readingTitle: "तारों का मानचित्र पढ़ना", readingText: "हर मानचित्र में 3×3 बोर्ड, तीन विकल्प और संबंधों के दो संकेत होते हैं। चुनने से पहले ऊपर, नीचे, बाएँ, दाएँ और तिरछी स्थिति को उसी अर्थ में पढ़ें।", faqCampaignQuestion: "कुल कितने मानचित्र हैं?", faqCampaignAnswer: "छह पाँच-मानचित्र आर्क में कुल 30 बनाए गए मानचित्र हैं।", faqChoiceQuestion: "गलत चुनाव के बाद क्या होता है?", faqChoiceAnswer: "गलत बोर्ड दिखता रहता है और प्रगति खोए बिना फिर जाँचा जा सकता है।", faqSaveQuestion: "क्या खाता चाहिए?", faqSaveAnswer: "नहीं। उपलब्ध होने पर प्रगति और श्रेष्ठ जाँच संख्या केवल इसी ब्राउज़र में स्थानीय रूप से रखी जाती है।", faqRuleQuestion: "कौन से संकेत पढ़ने चाहिए?", faqRuleAnswer: "ऊपर, नीचे, बाएँ, दाएँ या तिरछे सहित दोनों संबंधों को हर विकल्प बोर्ड से मिलाएँ।", relatedTitle: "संबंधित गेम", relatedIntro: "अगर चाल से पहले स्थानिक नियम जाँचना पसंद है, तो WeightPlay की ये पहेलियाँ भी आज़माएँ।", relatedOneTitle: "One Line", relatedOneDescription: "दीवारों और चलती छायाओं से बचते हुए बनाए गए रास्तों पर एक लगातार रेखा खींचें।", relatedTwoTitle: "Panko's Bamboo Waterway", relatedTwoDescription: "जुड़े बाँस के पाइप घुमाकर पानी को तराशी हुई झरने से फूलों वाले ताल तक बिना खाली जगह पहुँचाएँ।" },
