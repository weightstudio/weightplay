(()=>{
  ...
  function build(actor,lane,dt,isPlayer=false){
    ...
    if(isPlayer){
      const first=!run.firstBridge;run.firstBridge=true;run.routeAssistActive=false;say(t("building",{lane:lane+1}),first?1.05:.4,first?"bridge-first":"bridge");playCue("success",140);
    }
