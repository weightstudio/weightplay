(()=>{
  ...
  let run=null,lastFrame=0,raf=0,keys=new Set(),pointerDown=false,lifecyclePaused=false,windowFocused=document.hasFocus(),documentVisible=!document.hidden,resultActionClaimed=false;
