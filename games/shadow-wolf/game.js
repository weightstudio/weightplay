(() => {
  ...
  Object.assign(text, {
    ...
    ru: {
      ...
      diamondShopTitle: "Постоянное улучшение",
      languageSelector: "Выбор языка",
      backToMain: "Вернуться в главное меню",
      stageSelection: "Выбор этапа",
      stageRail: "Лента этапов",
      backToStages: "Вернуться к этапам",
      pauseBattle: "Пауза",
      resumeBattle: "Продолжить бой",
      moveLeft: "Движение влево",
      moveRight: "Движение вправо",
      attackAction: "Атака",
      controlLegend: "A/D — движение · W/Пробел — прыжок · J — атака · K/Shift — рывок",
      roomLabel: "Этап",
      keyLabel: "Очки",
      arenaLabel: "Арена Теневого Волка",
      stageEyebrow: "ЭКСПЕДИЦИЯ",
      stageTitle: "Выберите экспедицию",
      stageHint: "Перетащите ленту и выберите открытый этап. Боссы появляются на этапах 5, 10, 15, 20, 25 и 30.",
      menu: "Меню",
      hudHp: "Здоровье волка",
      tryAgain: "Повторить попытку",
      nextStage: "Следующий этап",
      replayStage: "Повторить этап",
      backToMenu: "Вернуться к этапам",
      resultDisclaimer: "Только для развлечения и отслеживания локального прогресса.",
      report_skill_partial: "Маршрут ещё открыт: следите за циклом предупреждений и берегите рывок или двойной прыжок для окна контратаки.",
    },
    hi: {
