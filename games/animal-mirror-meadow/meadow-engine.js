...
export const LEVELS = [
  ...
  level('return',[7,5,2],[[5,5,0],[2,2,0],[2,0,1]],[[4,0],[0,2]],{gates:[[[5,2],[2,5]]],prisms:[1]}),
  level('festival',[-1,4,0],[[1,4,1],[5,4,0],[3,1,1],[5,1,1]],[[6,4],[3,0],[5,6],[5,0]],{prisms:[0,1,2],gates:[[[1,1],[3,3]]],walls:[[0,1],[3,6]],checkpoint:true}),
];
