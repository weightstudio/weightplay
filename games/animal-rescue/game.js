...
function localizeGamePageSupport() {
  ...
  if (support.tutorial) (__wpNotifyMeasurement(), document.querySelector(".wp-tutorial-button")?.setAttribute("aria-label", support.tutorial));
...
function resetLevel() {
  ...
  __wpReplayStart(() => startLevel(activeIndex));
}
